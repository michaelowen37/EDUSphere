...
export const STORIES = {
  'count-to-3': {
  about: 'Mike at the creek with a job: three stones, not a pile',
    ...
    words: [
    'Mike had a job. Three stones from the creek. Not a pile. Three. He nodded. Easy.',
    ...
    'So Mike put one stone on the flat rock. One. He put another next to it. Two. One more. Three. Then he stopped.',
    'Three stones. Not a pile. He held up three fingers. Three!',
    'All three got skipped across the water. Each one bounced. Plip. Plip. Plip.',
    'Touch and count. One, two, three. A number is where you stop.',
    ],
  },
  'count-to-5': {
  about: 'a mother duck who counted her ducklings with her beak, and the one that was missing',
    title: 'Five ducklings', art: 'S2', cast: [], more: [{ serial: 'S31', after: 0, alt: 'The mother duck leading a wobbly line across the pond' }, { serial: 'S1493', after: 2, alt: 'Ducklings swapping places, splashing' }, { serial: 'S1494', after: 3, alt: 'The mother touching each duckling with her beak, one by one' }, { serial: 'S1495', after: 5, alt: 'The fifth duckling chasing a bug in the reeds' }],
    alt: 'A mother duck on a pond with ducklings in a wobbly line behind her, one gap in the line',
    words: [
    'Every morning a mother duck swam across the pond. Behind her came her ducklings. A wobbly yellow line.',
    'One morning the line felt short. She could not tell why. Something was wrong.',
    'She looked back. Ducklings wiggle. They swap places. They splash. Looking was no help.',
    'So she counted the way ducks count. One bump of the beak for each. One. Two. Three. Four.',
    'The last number was four. But there should be five. Four is not five. One was missing!',
    'She turned back. There, in the reeds, was the fifth. Chasing a bug. Peep! She bumped it too. Five.',
    'Count one at a time. The last number you say is how many.',
    ],
  },
  'magnets': {
  about: 'a boat in the fog, and the needle that always knew north',
    title: 'The needle that knew', art: 'S3', cast: [], more: [{ serial: 'S33', after: 0, alt: 'Fog rolling in behind the boat' }, { serial: 'S34', after: 1, alt: 'The fisherman turning in circles, lost' }, { serial: 'S1742', after: 2, alt: 'The needle swinging, wobbling, settling north' }, { serial: 'S1743', after: 4, alt: 'A magnet picking up a nail but not a rock' }],
    alt: 'A small fishing boat in thick fog, a compass needle glowing on the deck',
    words: [
    'A little fishing boat went out one morning. The fog rolled in behind it. Thick fog. The sea and the sky turned the same gray.',
    'The fisherman could not see the shore. He could not see the sun. He turned the boat in a circle. He did not know which way was home.',
    'He took out a needle on a string. A magnet needle. It swung, wobbled, and settled, pointing north. A magnet always does.',
    'North was that way. So home was that way. He followed the needle through the fog. Then the shore came out of the gray.',
    'A magnet pulls even when you cannot see what pulls it. The whole Earth is a magnet, pulling the needle north.',
    'Back home, his daughter tested the magnet. It grabbed a nail. It grabbed a spoon. It ignored a rock and a pencil. Iron and steel only.',
    'A magnet pulls iron and steel, not rocks or paper. A compass needle points north.',
    ],
  },
  'telling-time': {
  about: 'a town with one clock, and the day the hands taught everyone to read it',
    title: 'The clock that ran the town', art: 'S4', cast: [], more: [{ serial: 'S35', after: 0, alt: 'The one clock high on the tower' }, { serial: 'S36', after: 1, alt: 'The bread late, the bus early, children waiting at the gate' }, { serial: 'S1706', after: 3, alt: 'The short hand pointing at the 8' }, { serial: 'S1707', after: 4, alt: 'The long hand at the 12, the town on time' }],
    alt: 'A tall clock tower over a small town square, people looking up at it',
    words: [
    'In one small town, nobody owned a watch. There was one clock, high on the tower. All of them looked up at it. But nobody knew how to read it.',
    'The bread was late. The bus was early. The children waited at the gate. The baker waited at the oven. Nothing happened when it should.',
    'A girl named Lena climbed the tower to look. The clock had two hands. One short. One long. They did not move the same way.',
    'The short hand pointed at the 8. That was the hour. Eight. The long hand pointed at the 12. That meant no minutes past. Eight o\'clock.',
    'Lena ran down and told everyone. Short hand, hour. Long hand, minutes. Long hand at 12, on the hour. Long hand at 6, half past.',
    'The bread came out at seven. The bus came at eight. The gate opened at half past. The town ran on time, because now the town could read.',
    'The short hand is the hour. The long hand is the minutes.',
    ],
  },
  'fraction-meaning': {
  about: 'a baker with one quarter cup and a recipe that asked for three quarters',
    title: 'The broken cups', art: 'S5', cast: [], more: [{ serial: 'S37', after: 0, alt: 'Measuring cups tumbling off a kitchen shelf, one small cup landing safe on the counter' }, { serial: 'S38', after: 1, alt: 'A little boy holding up a wide coffee mug beside his sister and her one small measuring cup' }, { serial: 'S1746', after: 3, alt: 'Four equal scoops of sugar side by side, together making one whole cup' }, { serial: 'S1747', after: 4, alt: 'The girl leveling a heaped quarter cup of sugar with a butter knife over the mixing bowl' }, { serial: 'S1748', after: 5, alt: 'A lemon cake on a table at a harvest fair, neighbors reaching for slices' }],
    alt: 'A young baker in a warm kitchen holding one small measuring cup over a bowl, broken cups on the floor',
    words: [
    'The morning of the harvest fair, Maya was baking a lemon cake for the whole street. The kitchen smelled of butter. She reached for her measuring cups and knocked the set off the shelf. Clink, clink, crack. Every cup broke but one: the smallest, marked one quarter.',
    'The recipe asked for three quarters of a cup of sugar and one whole cup of milk. Maya had one tiny cup and forty neighbors expecting cake. Her little brother held up a coffee mug. Just fill this most of the way, he said.',
    'But where is three quarters of a mug? This one was fatter at the top than the bottom, and nobody had cut it into four equal parts. A guess could make the cake too sweet, or not sweet enough.',
    'Then Maya looked at the little cup again. Four of these, all the same size, fill one whole cup. The bottom number, four, told her how many equal parts make a whole. The top number, three, told her how many to use.',
    'She filled the little cup and leveled it with a knife. Pour. Fill. Pour. Fill. Pour. Three quarters of a cup, exactly. The milk was the same trick: four quarters make one whole cup.',
    'A fraction is not a strange kind of number. It is an instruction: cut the whole into equal parts, and take this many. The parts must be equal, or the counting means nothing. Maya\'s cake was gone by noon.',
    ],
  },
  'water-cycle': {
  about: 'a painter watching a lake rise into mist and fall as rain',
    title: 'The lake that would not stay', art: 'S6', cast: ['Chloe'], more: [{ serial: 'S39', after: 0, alt: 'A teenage girl painting a lake at sunrise, mist rising off the water' }, { serial: 'S40', after: 2, alt: 'Rain falling on the same lake, the painter under an umbrella, puddles gathering' }, { serial: 'S2006', after: 3, alt: 'Dew drops on the grass beside an easel on a cold morning' }, { serial: 'S2007', after: 4, alt: 'A spring bubbling up among rocks at the edge of a lake' }, { serial: 'S2008', after: 5, alt: 'A wall of small paintings of the same lake in every season' }],
    ...
    'On the coldest mornings the grass by her easel was wet though it had not rained. Water vapor in the air had touched the cold grass and turned back into drops: condensation, the same step that builds a cloud. In February the rain came down as snow, and in March the snow melted and ran back to the lake.',
    'Some rain never reached the lake by the streams. It soaked into the ground and moved slowly through the soil and rock underneath, feeding the springs that bubbled up by the shore. Trees drank it too, and breathed some of it back out through their leaves.',
  ...
  about: 'a boy whose plant leaned toward the window',
    diagram: { kind: 'leaf' }, title: 'The flower in the basement', art: 'S8', more: [{ serial: 'S43', after: 1, alt: 'A boy watering a potted plant on a sunny windowsill, light streaming in' }, { serial: 'S44', after: 4, alt: 'The same plant leaning toward the window, a soft cutaway of one leaf drinking light' }], cast: [],
  ...
  about: 'a professor who found the pattern in the elements',
    diagram: { kind: 'periodic', group: 1 }, title: 'The professor who guessed', art: 'S11', more: [{ serial: 'S49', after: 0, alt: 'An older professor at a chalkboard with a hand-drawn grid of squares behind him, a lecture hall' }, { serial: 'S50', after: 2, alt: 'A lab bench close up: a jar of shiny metal shavings, a glass tube of pale gas, a wooden tray of rock samples' }], cast: ['Frederick'],
...
STORIES['texas-revolution'] = {
  about: 'thirteen days at the Alamo, eighteen minutes at San Jacinto, and why Texans remember the loss',
  more: [{ serial: 'S55', after: 0, alt: 'An elderly woman and a boy at a kitchen table over a hand-drawn map of Texas rivers' }, { serial: 'S56', after: 1, alt: 'The stone walls of the old Alamo mission at dawn under a single flag' }, { serial: 'S15', after: 3, alt: 'A wide grassy field at a bend where two waters meet, a line of tents in the morning mist' }, { serial: 'S1911', after: 5, alt: 'Texan soldiers running forward across a field at San Jacinto, shouting' }, { serial: 'S1912', after: 6, alt: 'The Lone Star flag of Texas waving over a small town' }],
  title: 'The thirteen days', art: 'S14', cast: ['Georgette', 'Mike'],
  ...
  words: [
    'Mike wanted to know why the most famous battle in Texas was one Texas lost. Georgette poured the tea, spread an old map on the table and put her finger on San Antonio.',
    'In the fall of 1835, she said, Texans rose up against Mexico. Late that winter, Santa Anna\'s army surrounded the Alamo, an old mission in San Antonio. On March 2, 1836, while it was still under siege, Texans signed a declaration that Texas was free.',
    'About two hundred defenders held the Alamo for thirteen days. On March 6, the army broke through, and the defenders who fought were killed. A few women, children and one enslaved man named Joe survived to tell what happened.',
    'Georgette slid her finger east to a bend where two waters met. About six weeks later, here at San Jacinto, Sam Houston\'s army attacked on the afternoon of April 21. The battle lasted eighteen minutes. Santa Anna was captured the next day, and Texas was free.',
    'Mike looked from one finger to the other. So why remember the loss?',
    'Because the Texans at San Jacinto did, Georgette said. They charged shouting, Remember the Alamo, and the name carried them. Many Texans believe those thirteen days also bought the rest of Texas time.',
    'For nine years Texas was its own country, the Republic of Texas, and Sam Houston was elected its first president. That is why its flag has one star. Georgette folded the map. Some defeats are not the end of a story. They are part of the price of the ending.',
  ],
};
...
STORIES['negative-numbers'] = {
  about: 'an elevator and a thermometer that both went below zero',
  more: [{ serial: 'S59', after: 0, alt: 'An elevator panel with minus 3 lit and the button for 2 waiting' }, { serial: 'S60', after: 2, alt: 'A stairwell with floors above and below ground, an elevator door open at a lower level' }, { serial: 'S2072', after: 3, alt: 'An outdoor thermometer on a frosty wall reading minus five, a sunny lunchtime reading of three beside it' }, { serial: 'S2073', after: 4, alt: 'A number line from minus five to five with minus three and minus five marked and their distances from zero drawn' }, { serial: 'S2074', after: 5, alt: 'A woman counting floors on her fingers in an elevator going down' }],
  ...
  words: [
    ...
    'Outside, the bank sign showed the temperature: minus five in the morning, three by lunch. A rise of eight degrees, five up to zero and three more. It was the same counting as the elevator, turned sideways into weather.',
    'Her niece asked which was bigger, minus three or minus five. Minus three, because it sits higher, closer to zero. Their distances from zero, three and five, have a name of their own: absolute value. Distance is never negative, whichever side of zero you start from.',
...
STORIES['ratios'] = {
  ...
  more: [{ serial: 'S61', after: 0, alt: 'A young woman in a paint shop mixing blue and yellow into a pot, shelves of pigments' }, { serial: 'S62', after: 1, alt: 'A tiny scrap of card with a perfect blob of leaf green beside a jar of the wrong green' }, { serial: 'S2066', after: 3, alt: 'A row of green paint samples, each mixed from a different number of spoonfuls, on a workbench' }, { serial: 'S2067', after: 4, alt: 'Three small paint jars priced 12 dollars beside one big jar priced 13 dollars' }, { serial: 'S2068', after: 5, alt: 'A jar of green paint beside a drawing of the jar split into three parts, two blue and one yellow' }],
  title: 'Two blues to one yellow', art: 'S18', cast: ['Chloe'],
  ...
  words: [
    ...
    'At the paint shop she used the same idea on prices. Three small jars cost 12 dollars, so one jar cost 4. A big jar held as much as four small ones and cost 13 dollars. Four small jars would have cost 16, so working out the price of one, a unit rate, showed the big jar was the better buy.',
    'She also noticed that two to one meant the green was two thirds blue. Two parts out of every three were blue, and one part out of three was yellow. A ratio compares the parts to each other; a fraction compares a part to the whole.',
...
STORIES['industrial-revolution'] = {
  ...
  title: 'The loom in the valley', art: 'S19', more: [{ serial: 'S63', after: 1, alt: 'A river with a water wheel turning beside a stone mill, a quiet village' }, { serial: 'S64', after: 3, alt: 'A smoky mill town with tall chimneys, rows of brick houses and a steam engine' }], cast: [],
...
STORIES['main-idea'] = {
  about: 'a boy who told his grandmother a whole movie in eleven minutes, and the one sentence that said what it was about',
  more: [{ serial: 'S65', after: 0, alt: 'A boy running up the porch steps waving his arms, still full of the movie' }, { serial: 'S66', after: 1, alt: 'A girl with a lantern on dark rocks by the sea, a lighthouse gone dark in a storm' }, { serial: 'S1761', after: 3, alt: 'A bicycle wheel with every spoke pointing to the middle, lit warm on a porch' }, { serial: 'S1762', after: 5, alt: 'Bees moving between pink apple blossoms in a sunny orchard' }, { serial: 'S1763', after: 6, alt: 'Small details drawn as helpers holding up one big idea, like a crowd lifting a banner' }],
  ...
  words: [
    'Mateo came home from the movies bursting. His abuela had stayed home with a sore knee, so she asked him what the film was about. He sat on the porch step and took a big breath.',
    'He told her about the boat, the storm, the dog, the lighthouse going dark, the girl with the lantern and the ending. It took eleven minutes. She nodded through all of it. Then she said, "Yes, but what was it about?"',
    'Mateo frowned. He had just told her. Every piece of it had happened. He started again, faster, and she held up a hand. Not what happened, she said. What was it about?',
    'He thought about it. The boat, the dog and the storm were all pointing at one thing, the way the spokes of a bike wheel point at the middle. It was about a girl who would not give up until everyone was safe, he said.',
    'His abuela smiled. "Now I have seen it." One sentence had done what eleven minutes could not.',
    'The next day his teacher handed out a paragraph about bees. Bees carry pollen from flower to flower. They make honey. Without them, apple trees grow far fewer apples. Mateo asked his abuela\'s question: what is the whole thing about? Bees help people. The rest were details holding that up.',
    'Every story, every paragraph, every page has one idea its details are working for. Look first at the first and last sentences. Find the sentence the others lean on, and you have the main idea.',
  ],
};
STORIES['weather-and-seasons'] = {
  about: 'a letter about snow that arrived in July, and the tilt of the Earth',
  more: [{ serial: 'S67', after: 0, alt: 'A small backyard weather station with a thermometer and a rain gauge under a blazing summer sky' }, { serial: 'S68', after: 1, alt: 'A boy in a scarf and mittens building a snowman in a mountain town' }, { serial: 'S1788', after: 3, alt: 'A globe tilted on its stand with a lamp shining on it, a teacher\'s hands turning it' }, { serial: 'S1789', after: 4, alt: 'The Earth circling a bright Sun, leaning the same way all year' }, { serial: 'S1790', after: 6, alt: 'Two children waving, one in summer sun and one in winter snow, split down the middle of the picture' }],
  ...
  words: [
    'Every morning in July, Ava checked the weather station in her Texas backyard. The thermometer read a hundred degrees by noon. The rain gauge had been dry for three weeks. Weather is what the sky is doing today, and today it was baking.',
    'Then a letter came from her pen pal, Jack, who lives in the mountains of Australia. He wrote about snow. He had built a snowman in the yard and could not feel his fingers. In July.',
    'Ava read it twice. Same month, same planet. How could she be sweating while he wore a scarf? Was the Sun closer to Texas?',
    'Her teacher held up a globe and tilted it. The Earth leans. As it travels around the Sun, one half leans toward the light and gets long days and high sun. That is summer. The other half leans away and gets short days and low sun. That is winter.',
    'In July, the northern half leans in, and Texas bakes. The southern half leans out, and Australia shivers. In January they swap. The Earth is even a little farther from the Sun in July, which surprised Ava most.',
    'The pattern comes back every year, in the same order. Spring warms, summer is hottest, fall cools, winter is coldest. Jack\'s seasons run the same circle, just half a year apart.',
    'Weather is today, and you measure it with tools. Seasons are the pattern, and you can plan for them. They are not about how close the Sun is. They are about which way you are leaning.',
  ],
};
STORIES['dna-and-genes'] = {
  about: 'a pale fox cub among red ones',
  diagram: { kind: 'basepairs' }, title: 'The recipe book', art: 'S22', more: [{ serial: 'S69', after: 0, alt: 'A family of foxes at a den entrance, one pale cub among red cubs' }, { serial: 'S70', after: 2, alt: 'A twisted ladder rising like a spiral staircase, rungs in two colors, glowing softly' }], cast: [],
...
STORIES['day-and-night'] = {
  about: 'a rooster who was sure he made the sun come up, and the morning he slept in',
  more: [{ serial: 'S71', after: 0, alt: 'The rooster crowing, the sun just peeking up' }, { serial: 'S1577', after: 2, alt: 'The sun up high, the rooster waking with a jump' }, { serial: 'S1578', after: 3, alt: 'The Earth turning slowly like a ball, drawn simply' }, { serial: 'S1579', after: 4, alt: 'The moon over the barn at night' }],
  title: 'The rooster and the sun', art: 'S23', cast: [],
  alt: 'A rooster on a fence crowing at a rising sun',
  words: [
    'Every morning the rooster crowed. Every morning the sun came up. The rooster was sure he did it. One crow, and up came the sun.',
    'One morning he slept in. He was tired from a long day. He tucked his beak under his wing.',
    'When he woke up, the sun was already high. It had come up without him! The rooster was shocked.',
    'The sun did not need the rooster. The Earth turns slowly, like a ball rolling in a big room.',
    'Your side of the Earth turns to face the sun. Then it is day. It turns away. Then it is night. The moon comes out.',
    'The rooster crowed anyway. Just in case. But now he knew. Day and night were the Earth turning.',
    'Sun in the day, moon at night. Day and night are the Earth turning.',
  ],
};
...
STORIES['percents'] = {
  ...
  diagram: { kind: 'percentgrid', shaded: 50 }, title: 'Half off what?', art: 'S25', more: [{ serial: 'S75', after: 0, alt: 'A small clothes shop with winter coats on a rack and a paper sale sign in the window' }, { serial: 'S76', after: 2, alt: 'Two price tags on one coat sleeve, one crossed out and one circled, close up' }], cast: [],
...
STORIES['habitats'] = {
  about: 'a hermit crab that outgrew its shell, and the home that fit',
  more: [{ serial: 'S81', after: 0, alt: 'The crab crawling out of a shell too small' }, { serial: 'S82', after: 1, alt: 'The crab hurrying from rock to rock' }, { serial: 'S1744', after: 2, alt: 'An empty spiral shell in the tide pool' }, { serial: 'S1745', after: 4, alt: 'A fish, a bird and the crab, each in its own home' }],
  title: 'The crab with no shell', art: 'S28', cast: [],
  alt: 'A small hermit crab on wet sand beside an empty spiral shell in a tide pool',
  words: [
    'A little hermit crab had grown too big for its shell. It crawled out onto the sand with no home. The sun was hot. A gull circled.',
    'The crab hurried from rock to rock. It wanted a home that fit. Too small. Too big. Too broken.',
    'Then it found an empty spiral shell in the tide pool. It backed in. It fit just right. The crab pulled the shell over itself and was safe.',
    'A habitat is where a living thing has what it needs. Food. Water. Shelter. Room. For the crab, that is the shore. Tide pools and spare shells.',
    'The fish needs the sea. The gull needs the cliff. The crab needs the shore. Each one has a home that fits.',
    'A girl watched the crab settle in. She put the shell back where she found it. The crab would need it again someday.',
    'A habitat is a home with what a living thing needs.',
  ],
};
STORIES['kinds-of-weather'] = {
  about: 'a puddle by the gate, and the weather that made it, took it, and brought it back',
  more: [{ serial: 'S84', after: 0, alt: 'Rain falling in the dark on the gate' }, { serial: 'S1580', after: 1, alt: 'The sun out, the puddle shrinking' }, { serial: 'S1581', after: 4, alt: 'Wind blowing leaves across a dry patch' }, { serial: 'S1582', after: 5, alt: 'A puddle by the gate three ways: rained into, dried by the sun, then covered in white snow' }],
  title: 'The puddle by the gate', art: 'S83', cast: [],
  alt: 'A small girl in boots looking at a puddle by a wooden gate under a clearing sky',
  words: [
    'Rain came in the night. Pit, pat, on the roof. In the morning there was a puddle by the gate. Rosa splashed in it.',
    'Then the sun came out. Warm. Bright. By lunch the puddle was small. By dinner it was gone. Just a dark spot.',
    'The next day the wind blew. Leaves ran across the yard. Rosa\'s hat blew off. No puddle.',
    'Then one cold morning, white flakes fell. Snow! It landed on the gate. It did not splash. It sat.',
    'Rain, sun, wind, snow. Every day the sky did something different. Rosa looked out each morning to see.',
    'Rain made the puddle. Sun took it. Snow put a white one there instead. The sky was never the same twice.',
    'Weather is what the sky is doing today. Look out the window and see.',
  ],
};
STORIES['living-or-not'] = {
  about: 'a rock and a snail, the same size and gray, and only one of them moved',
  more: [{ serial: 'S87', after: 0, alt: 'The rock and the snail, matching gray shapes' }, { serial: 'S88', after: 1, alt: 'The snail stretching out its eyes' }, { serial: 'S1584', after: 4, alt: 'The rock, unmoved, a leaf on top of it' }, { serial: 'S1585', after: 5, alt: 'The snail gone, a silver trail on the path' }],
  title: 'The rock and the snail', art: 'S86', cast: [],
  alt: 'A small boy crouched on a garden path looking at a gray rock and a gray snail side by side',
  words: [
    'On the path there was a rock. Next to it was a snail. They were the same size. They were the same gray. Leo looked at both.',
    'The rock did nothing. It sat. The snail poked out two eyes. It stretched. It ate a leaf. Slowly.',
    'Leo put a leaf on the rock. The rock did not eat it. The leaf just sat there.',
    'He came back after lunch. The rock was where he left it. The snail was gone. Only a silver trail.',
    'The snail grew. It ate. It moved. It needed water and food. The rock needed nothing. It never would.',
    'A rock is not alive. A snail is. They can look alike. Watch, and you will know.',
    'Living things grow and need food and water. A rock does not.',
  ],
};
STORIES['what-plants-need'] = {
  about: 'a bean seed on a windowsill, and the two things it drank',
  more: [{ serial: 'S90', after: 0, alt: 'A bean seed going into dark soil' }, { serial: 'S1586', after: 1, alt: 'A green sprout pushing up' }, { serial: 'S1587', after: 4, alt: 'The plant standing tall and green again on the sunny windowsill' }, { serial: 'S1588', after: 5, alt: 'A pot moved into a dark cupboard, the plant drooping' }],
  title: 'The bean on the windowsill', art: 'S89', cast: [],
  alt: 'A small girl watering a bean sprout in a pot on a sunny windowsill',
  words: [
    'A bean seed went into a pot of soil. Mia pushed it down with her thumb. Every morning it got a drink of water.',
    'One day a green sprout came up. Then a leaf. Then two. Mia checked it every morning.',
    'The plant leaned. It leaned toward the window. Toward the sun. Every day, a little more.',
    'Mia moved the pot into a cupboard, just to see. Dark. Three days later the plant drooped. Its leaves went pale.',
    'Back to the windowsill. Water. Sun. In two days it stood up again. Greener than before.',
    'Water and sun. The plant drank both. Take one away, and it wilted. Give both, and it grew.',
    'A plant needs water and the sun to grow.',
  ],
};
STORIES['hot-and-cold'] = {
  about: 'a cup of cocoa, a snow cone, and the room that made them both the same',
  more: [{ serial: 'S93', after: 0, alt: 'Steam rising from a cup of cocoa' }, { serial: 'S1589', after: 1, alt: 'A snow cone, cold and bright' }, { serial: 'S1590', after: 4, alt: 'The snow cone melting into a puddle' }, { serial: 'S1591', after: 5, alt: 'Both cups sitting on the table, neither hot nor cold' }],
  title: 'Two cups', art: 'S92', cast: [],
  alt: 'A small boy at a kitchen table with a steaming cup of cocoa and a dripping snow cone',
  words: [
    'The cocoa was hot. Steam came up from the cup. Sam had to blow on it. And wait. And blow again.',
    'The snow cone was cold. It made his teeth hurt. It made his hands wet. He ate it fast.',
    'He left half the cocoa on the table. He left half the snow cone next to it. Then he went to play.',
    'When he came back, the cocoa was not hot anymore. Just warm. Then not even warm.',
    'The snow cone was not cold anymore. It was a puddle of juice. Both cups felt the same.',
    'Hot things cool down. Cold things warm up. It all ends up like the room.',
    'Hot things warm us. Cold things chill us. Then they both become the room.',
  ],
};
...
STORIES['red-and-blue'] = {
  ...
  more: [{ serial: 'S96', after: 0, alt: 'The red ball rolling down the yard' }, { serial: 'S1364', after: 2, alt: 'Mia and Sam each pointing at a different ball' }, { serial: 'S1365', after: 4, alt: 'Mia hugging the red ball to her chest' }],
  title: 'Two balls', art: 'S95', cast: [],
  alt: 'A small girl on green grass between a red ball and a blue ball, a boy watching from the porch',
  words: [
    'Mia had a ball. It was red. Red like a strawberry. She rolled it down the yard.',
    'Sam had a ball too. It was blue. Blue like the sky. He rolled his ball after hers.',
    'Bump! The two balls hit. They stopped together in the grass. Mia ran over. Sam ran over.',
    'Which one was mine? said Mia. They were the same size. They were the same shape. They felt the same.',
    'Mia looked hard. Then she smiled. Mine is red, she said. She picked up the red ball.',
    'Sam laughed. Mine is blue, he said. He picked up the blue ball. He took it home.',
    'Red and blue are colors. Colors tell things apart, even when all else is the same.',
  ],
};
STORIES['big-and-small'] = {
  about: 'a big dog, a small dog, and one small bed that only one of them fit',
  more: [{ serial: 'S99', after: 0, alt: 'The big dog stretched out, longer than the rug' }, { serial: 'S1373', after: 3, alt: 'The big dog squeezed onto the small bed, legs hanging off' }, { serial: 'S1375', after: 5, alt: 'The big dog on the big rug, both dogs asleep' }],
  title: 'One small bed', art: 'S98', cast: [],
  alt: 'A big brown dog and a small white dog in a living room, one small dog bed on the rug',
  words: [
    'Max was a big dog. He was long. He was tall. When he lay down, he filled the rug.',
    'Bean was a small dog. She was short. She was light. She could fit in a basket.',
    'There was one bed. It was a small bed. Both dogs wanted it.',
    'Max tried it first. He squeezed in. His legs hung off. His tail hung off. He did not fit.',
    'Bean tried it. She curled up. Her nose touched her tail. Just right.',
    'Max sighed. He lay down on the big rug. Both dogs fell asleep.',
    'Big is more room. Small is less. A small bed is for a small dog.',
  ],
};
STORIES['one-and-two'] = {
  about: 'one duck alone on a pond, and the splash that made two',
  more: [{ serial: 'S102', after: 1, alt: 'The duck quacking, ripples going out, nobody answering' }, { serial: 'S1376', after: 3, alt: 'A big splash of water' }, { serial: 'S1378', after: 5, alt: 'Two ducks quacking at each other, two ripples' }],
  title: 'Splash', art: 'S101', cast: [],
  alt: 'One white duck on a still pond at morning, reeds around the edge',
  words: [
    'One duck swam on the pond. One. All by itself. The water was still.',
    'It quacked. Quack! Nobody quacked back. Only the wind moved.',
    'Then, a shape in the sky. Wings. Feathers. Coming closer.',
    'Splash! Another duck landed. Water flew up. The first duck jumped.',
    'Now there were two. Two ducks. Two heads. Two tails. They swam together.',
    'Quack, quack! Two quacks, not one. The pond was not quiet anymore.',
    'One, then two. One more makes two.',
  ],
};
STORIES['please-and-thank-you'] = {
  ...
  words: [
    'Cookies! Sam smelled them. Warm ones. On a plate. He ran to the table.',
    'He grabbed. The plate went up. Out of reach. No cookie.',
    'He grabbed again. The plate went up again. Sam frowned. Still no cookie.',
    'Mom waited. She was smiling. What is the magic word?',
    'Sam thought. Then he said it. Cookie, please? The plate came down.',
    'He took one. It was warm. Thank you! he said. Mom smiled bigger.',
...
STORIES['colours'] = {
  ...
  words: [
    'It rained all morning. Lena watched the drops run down the glass. Drip. Drip. She wanted to go out.',
    'Then the rain stopped. The sun came out. The whole yard sparkled.',
    'Lena ran outside. She looked up. A rainbow! It went all the way across the sky.',
    'She wanted to name it. But it had so many colors. Where to start?',
    'Dad said, start at the top. Red. Lena said, red. Then orange. Then yellow. Then green.',
    'Blue. Purple. Six colors. She said them all. One at a time. Then she said them again, fast.',
    'Every color has a name. Say them one at a time.',
  ],
};
STORIES['patterns'] = {
  about: 'red bead, blue bead, and the way to find what comes next',
  more: [{ serial: 'S111', after: 0, alt: 'A bowl of red and blue beads' }, { serial: 'S1445', after: 2, alt: 'The boy holding one bead over the string, unsure' }, { serial: 'S1447', after: 5, alt: 'A long finished necklace, red and blue all the way' }],
  title: 'Red, blue, red, blue', art: 'S110', cast: [],
  alt: 'A small boy threading red and blue beads onto a string at a craft table',
  words: [
    'Kai was making a necklace. A bowl of beads. Red ones. Blue ones. A long string.',
    'Red bead. Blue bead. Red bead. Blue bead. He threaded them on.',
    'Then he stopped. What comes next? He held a bead in the air. He did not know.',
    'Grandma said, look back. Kai looked at the string. Red, blue, red, blue.',
    'He said it out loud. Red, blue, red, blue. Red! The next one was red. He knew!',
    'Red, blue, red, blue, all the way to the end. The necklace was long. Grandma put it on.',
    'A pattern repeats. Say it out loud to find what comes next.',
  ],
};
STORIES['taking-turns'] = {
  about: 'one swing, two children, and counting to ten so both could fly',
  more: [{ serial: 'S114', after: 0, alt: 'Two children both holding the swing, pulling' }, { serial: 'S1460', after: 3, alt: 'One child swinging high, the other counting' }, { serial: 'S1462', after: 4, alt: 'A boy jumping off the swing as a girl sits down, the boy starting to count' }],
  title: 'Count to ten', art: 'S113', cast: [],
  alt: 'Two small children at one swing on a playground, one on it and one counting on her fingers',
  words: [
    'One swing. Two children. Sam and Rosa. Both wanted it. Both wanted it now.',
    'Pull. Pull. Sam pulled one way. Rosa pulled the other. Nobody swung.',
    'You go, said Rosa. Then I go. She let go of the swing. Sam sat down.',
    'Rosa counted. One, two, three. Sam swung high. Four, five, six. Higher.',
    'Seven, eight, nine, ten! Sam jumped off. Rosa sat down. Now Sam counted.',
    'Ten for Sam. Ten for Rosa. Both of them swung. Both of them flew.',
    'Wait, and then it is your turn. Count to ten.',
  ],
};
STORIES['listen-for-rhymes'] = {
  about: 'a cat on a mat with a hat, and the sound that made them rhyme',
  more: [{ serial: 'S117', after: 0, alt: 'A cat sitting on a striped mat' }, { serial: 'S1469', after: 2, alt: 'The cat putting on a tall hat' }, { serial: 'S1470', after: 4, alt: 'A bat flying past the window' }],
  title: 'Cat, mat, hat', art: 'S116', cast: [],
  alt: 'A small girl in bed giggling at a picture book of a cat in a hat sitting on a mat',
  words: [
    'At bedtime, Mom read a rhyme. A cat sat on a mat. Rosa giggled. Cat. Mat.',
    'Hear it? said Mom. Rosa listened. Cat. Mat. They ended the same. At. At.',
    'The cat put on a hat. Hat! Rosa said it. Cat, mat, hat. All the same at the end.',
    'What else? said Mom. Rosa thought. She thought hard.',
    'Bat! A bat flew past the window. Cat, mat, hat, bat. Four words, one ending.',
    'They made up more. Rat. Sat. Fat. Rosa was still saying them when she fell asleep.',
    'Rhymes end the same way. Listen for the ending.',
  ],
};
// The rest of pre-K, in the fewest words that still make a story.
STORIES['find-the-match'] = {
  about: 'one red mitten, cold hands, and the hunt through the basket for its twin',
  more: [{ serial: 'S120', after: 0, alt: 'Snow falling outside a window, the boy pressing his nose to the glass' }, { serial: 'S121', after: 2, alt: 'The basket of mittens tipped over, all colors on the floor' }, { serial: 'S1369', after: 5, alt: 'Two red mittens on two hands, the boy grinning in the snow' }],
  title: 'The other mitten', art: 'S119', cast: [],
  alt: 'A small boy holding one red mitten by the door, a basket of mixed mittens beside him',
  words: [
    'Snow! Leo wanted to go out. He needed his mittens. He found one. It was red.',
    'One mitten. Two hands. One hand would be cold. Where was the other one?',
    'Leo tipped the basket over. Mittens went all over. Blue ones. Black ones. Striped ones.',
    'He held up a blue one. No. Not the same. He held up a big black one. No. Too big.',
    'Then he saw it. A red one. Small. Soft. Just like the first. He put them side by side. A match!',
    'Two red mittens. Two warm hands. Leo ran out into the snow.',
    'Same means just alike. Look for the same color and the same size.',
  ],
};
STORIES['match-the-animals'] = {
  about: 'a duckling looking for one just like itself in a busy farmyard',
  more: [{ serial: 'S123', after: 0, alt: 'The duckling alone by the barn door, looking around' }, { serial: 'S1370', after: 2, alt: 'The duckling next to a goat, much bigger' }, { serial: 'S1372', after: 5, alt: 'Two ducklings side by side, both yellow, both peeping' }],
  title: 'Like me?', art: 'S122', cast: [],
  alt: 'A small yellow duckling in a farmyard looking up at a hen, a goat and a cat',
  words: [
    'A little duckling woke up alone. The barn was big. Where was everyone? Is there anyone like me?',
    'It saw a hen. The hen had feathers. But they were brown. It clucked. No. Not like me.',
    'It saw a goat. The goat was big. It had horns. It said maa. No. Not like me.',
    'It saw a cat. The cat was soft. But it had fur, not feathers. It said meow. No. Not like me.',
    'The duckling sat down in the straw. It peeped one small peep.',
    'Peep! Something peeped back. Another duckling! Same yellow. Same feathers. Same peep. Yes. Just like me!',
    'The same means just alike. Look, then look again, then say yes.',
  ],
};
STORIES['more-or-fewer'] = {
  about: 'two bowls of grapes, and Ana picking the one with more',
  more: [{ serial: 'S126', after: 0, alt: 'A full bowl of grapes piled high' }, { serial: 'S1379', after: 2, alt: 'The girl looking from one bowl to the other' }, { serial: 'S1380', after: 4, alt: 'The girl pointing at the full bowl' }],
  title: 'Two bowls', art: 'S125', cast: [],
  alt: 'A small girl at a kitchen table between two bowls of green grapes, one full and one nearly empty',
  words: [
    'Two bowls sat on the table. Both had grapes. Green ones. Cold from the fridge.',
    'This bowl was full. Grapes piled up high. That bowl had three. Just three, at the bottom.',
    'Ana looked at one. Ana looked at the other. Which one had more? She wanted more.',
    'She counted the small bowl. One. Two. Three. That was all.',
    'She did not count the big bowl. She could see it. It was full. More!',
    'Ana picked the full bowl. She ate one grape. Then another. There were plenty.',
    'More means a bigger group. The full bowl has more.',
  ],
};
STORIES['first-marks'] = {
  about: 'a fat crayon, a dot, and the line that went off the page',
  more: [{ serial: 'S129', after: 1, alt: 'One red dot on the white page' }, { serial: 'S1382', after: 3, alt: 'The crayon moving, a wobbly line growing' }, { serial: 'S1384', after: 5, alt: 'A page full of lines going every way' }],
  title: 'The first line', art: 'S128', cast: [],
  alt: 'A small child pressing a fat red crayon onto white paper at a low table',
  words: [
    'Kai had a new crayon. It was fat. It was red. He held it tight.',
    'He pressed it on the paper. It made a dot. One red dot.',
    'A dot is nice. But it just sits there. It does not go anywhere.',
    'Kai moved his hand. The dot grew a tail. The tail got longer. It was a line! A wobbly line.',
    'The line went across. It went up. It went right off the page. Kai laughed.',
    'He made another. And another. Lines all over. His page was full.',
    'Start at the dot. Follow the line. A line is a dot that went for a walk.',
  ],
};
STORIES['three-dots'] = {
  about: 'three dots on a page, and the shape that showed up when Rosa joined them',
  more: [{ serial: 'S132', after: 0, alt: 'Three dots alone on a page, nothing joining them' }, { serial: 'S133', after: 2, alt: 'A line from dot one to dot two' }, { serial: 'S1386', after: 4, alt: 'The last line back to dot one' }],
  title: 'One, two, three', art: 'S131', cast: [],
  alt: 'A small girl with a crayon over a page with three numbered dots',
  words: [
    'One. Two. Three. Three dots on the page. Just dots. Rosa looked at them.',
    'What were they for? Dots do not do anything. They just sit.',
    'Rosa put her crayon on dot one. She drew to dot two. A line!',
    'From two, she drew to three. Another line! Now there was a corner.',
    'From three, she drew back to one. The last line. The lines met.',
    'Rosa held up the page. The dots had become a shape. Three sides. Three corners. A triangle!',
    'Start at 1. Draw to each dot in order. The dots know the way.',
  ],
};
STORIES['yellow-and-green'] = {
  ...
  words: [
    'The sun came up. It was round. It was yellow. Bright yellow, like a lemon.',
    'Theo went outside. The air was fresh. Something cool was under his feet.',
    'He sat down. He touched it. Grass. Green grass. Soft and cool.',
    'He looked up. Yellow. He looked down. Green. Yellow up. Green down.',
    'Theo lay back. Warm sun on his face. Cool grass on his arms.',
...
STORIES['triangles-too'] = {
  about: 'a slice of pizza, three corners counted, and a shape with a name',
  more: [{ serial: 'S138', after: 0, alt: 'A whole pizza cut into slices' }, { serial: 'S1391', after: 2, alt: 'A finger on the first corner' }, { serial: 'S1393', after: 6, alt: 'A triangle drawn next to the slice' }],
  title: 'Pizza corners', art: 'S137', cast: [],
  alt: 'A small boy holding a slice of pizza, pointing at one corner',
  words: [
    'Dinner was pizza. A big round pizza. Cut into slices.',
    'Diego took a slice. It had a pointy end. It had a wide end. It was hot.',
    'He counted the corners. One corner. At the point.',
    'Two corners. Three corners. At the wide end. Then no more. He counted again. Three.',
    'Three corners. Three sides. Diego knew that shape. A triangle!',
    'He drew one on his napkin. Three lines. Three corners. It looked like his pizza.',
    'A triangle has three corners. Count them. One, two, three.',
  ],
};
STORIES['big-and-little'] = {
  about: 'two shoes by the door, one that swallowed a foot and one that fit',
  more: [{ serial: 'S141', after: 0, alt: 'Two shoes by the door, one big and one little' }, { serial: 'S1394', after: 2, alt: 'The girl wobbling as the big shoe slips off her foot' }, { serial: 'S1396', after: 5, alt: 'Dad putting on the big boot, the girl in her little shoe' }],
  title: 'Two shoes', art: 'S140', cast: [],
  alt: 'A small girl by a front door with one foot in a huge boot and one in a tiny sneaker',
  words: [
    'By the door, two shoes. One big. One little. Lena looked at both.',
    'She tried the big one. Her foot went in. And in. And in. It swam inside.',
    'She tried to walk. Clomp. Wobble. The big shoe fell off.',
    'She tried the little one. Her foot went in. It stopped. Just right.',
    'The big shoe was Dad\'s. The little shoe was hers.',
    'Dad put on the big one. Lena put on the little one. They went out together.',
    'Big and little. Point to the big one. Point to the little one.',
  ],
};
STORIES['circle-and-square'] = {
  about: 'a ball that rolled down the ramp and a block that would not',
  more: [{ serial: 'S144', after: 1, alt: 'The ball rolling down the ramp' }, { serial: 'S1400', after: 3, alt: 'The girl pushing the block, it tipping once and stopping' }, { serial: 'S1402', after: 5, alt: 'The girl rolling the ball again, laughing' }],
  title: 'Roll or sit', art: 'S143', cast: [],
  alt: 'A small girl at the top of a wooden ramp with a ball in one hand and a block in the other',
  words: [
    'Ana had a ramp. She had a ball. She had a block. Which one would roll?',
    'She put the ball at the top. Whee! It rolled down. Fast. All the way.',
    'She put the block at the top. It sat there. It did not move.',
    'She gave it a push. It tipped over. Then it stopped. No rolling.',
    'Ana looked at the ball. Round all over. She looked at the block. Corners. Flat sides.',
    'Round rolls. Corners sit. Ana rolled the ball again. Whee!',
    'A circle is round. A square has corners.',
  ],
};
STORIES['a-and-b'] = {
  about: 'big letters on a party banner, and the two Grandma named first',
  more: [{ serial: 'S147', after: 0, alt: 'The banner across the room, letters big and bright' }, { serial: 'S1403', after: 2, alt: 'Grandma pointing at the first letter' }, { serial: 'S1405', after: 4, alt: 'Grandma pointing at the next big letter on a birthday banner while a small boy watches' }],
  title: 'A, then B', art: 'S146', cast: [],
  alt: 'A small boy looking up at a birthday banner with big colorful letters, balloons around it',
  words: [
    'It was a party. A banner hung across the room. It had big letters on it.',
    'Kai looked up. He knew they were letters. He did not know their names.',
    'Grandma came over. She pointed at the first one. That is A, she said.',
    'A. It was tall. It had a bar across. Kai said it. A.',
    'Next to it was B. Round on one side. B, said Grandma. A, then B.',
    'Kai said them together. A. B. Grandma clapped. He said them again.',
    'A and B are letters. A comes first. B comes next.',
  ],
};
STORIES['not-the-same'] = {
  about: 'four apples in a row, and the one that did not belong',
  more: [{ serial: 'S150', after: 0, alt: 'Four apples in a row on a wooden counter' }, { serial: 'S1406', after: 2, alt: 'Three red apples, side by side' }, { serial: 'S1408', after: 5, alt: 'The girl taking a big bite of the green apple' }],
  ...
  words: [
    ...
    'Three apples were red. Same color. Same shine.',
    'One apple was green. Not like the others. Different!',
    'Mia pointed. That one. The green one. Dad nodded.',
    'Mia picked it up. She took a bite. Crunch. It was sour. And good.',
    'Different means not alike. Find the one that does not match.',
  ],
};
STORIES['listen-and-tap-pictures'] = {
  about: 'a word said out loud, and the picture that matched it',
  more: [{ serial: 'S153', after: 0, alt: 'Three picture cards laid out on a table' }, { serial: 'S154', after: 2, alt: 'The boy tapping the dog card' }, { serial: 'S1410', after: 4, alt: 'The boy tapping the cup card' }],
  title: 'Where is the dog?', art: 'S152', cast: [],
  alt: 'A small boy at a low table with picture cards: a dog, a cup and a hat',
  words: [
    'Three cards lay on the table. A dog. A cup. A hat. Leo looked at them.',
    'Dog, said his sister. Where is the dog?',
    'Leo looked. There! He tapped it. The dog card. His sister cheered.',
    'Cup, she said. Where is the cup? Leo looked again.',
    'There! Tap. The cup. Then, hat. Tap. The hat.',
    'Every word had a picture. Leo found them all. He wanted more cards.',
    'Listen to the word. Find its picture. Tap it.',
  ],
};
STORIES['animal-sounds'] = {
  about: 'a moo, a quack and a meow, and who made each one',
  more: [{ serial: 'S156', after: 0, alt: 'The girl at the fence, ears open, listening' }, { serial: 'S1412', after: 2, alt: 'A duck by the pond, quacking' }, { serial: 'S1414', after: 4, alt: 'The girl pointing at the cow' }],
  title: 'Who said that?', art: 'S155', cast: [],
  alt: 'A small girl at a farm fence with a cow, a duck and a cat looking over it',
  words: [
    'Rosa stood at the fence. She heard a sound. Moo! Who said that?',
    'She looked. A cow. Big and brown. Moo, it said again. The cow!',
    'Then, quack! Who said that? Rosa looked. A duck by the pond. The duck!',
    'Then, meow! Who said that? Rosa looked up. A cat on the post. The cat!',
    'Rosa played a game. Moo! She pointed at the cow. Quack! The duck.',
    'Meow! The cat. Every animal had its own sound. Rosa knew them all.',
...
STORIES['same-and-different'] = {
  ...
  words: [
    'Kai needed socks. He dug in the drawer. He found two with stripes. Blue and white.',
    'He held them together. Stripes and stripes. The same size. The same? They looked it.',
    'Look again, said Mom. Kai looked closer. Closer still. His nose almost touched them.',
    'One sock had a hole! Right at the toe. His finger went through it. The other sock had no hole.',
    'This one has a hole. That one does not. They were not the same after all. Different!',
    'Kai wore the good sock. He waved the holey one. Mom laughed and got the sewing box.',
...
STORIES['match-the-vehicles'] = {
  ...
  words: [
    'Sam had a red car. Small. Shiny. Vroom! He wanted to race it. But a race needs two.',
    'He looked down the line. A truck? He held it up. No. Too big. Not the same.',
    'A bus? Yellow. Long. No. A tractor? Green, with big wheels. No.',
    'Sam looked and looked. Then, at the end of the line, something red.',
    'Another red car! Same size. Same shine. Same four wheels. He put them side by side. Twins!',
    'Two red cars. Vroom, vroom. They raced across the rug. The red one won. And the red one came second.',
...
STORIES['match-the-things'] = {
  ...
  words: [
    'Ana was helping. Dishes were on the table. A jumble. Cups. Spoons. Plates.',
    'She found a cup. Then another cup. Blue, like the first. Together. Twins.',
    'She found a spoon. What went with it? A cup? No. A cup is not a spoon.',
    'She hunted. There. Another spoon. Shiny. Together. Twins.',
    'A plate. Another plate. Together. Every thing on the table had a twin.',
    'Ana set them out in pairs. Cup, cup. Spoon, spoon. Plate, plate. The table looked neat.',
...
STORIES['match-the-water-animals'] = {
  ...
  words: [
    'Leo lay on his tummy by the pond. He looked in. The water was full of animals.',
    'A fish. Orange. Then another fish, just the same. Two fish. They swam together.',
    'A frog sat on a rock. Green, with a white belly. Where was its twin?',
    'Leo looked in the reeds. He looked under the leaves. He looked on the log.',
    'There! On the lily pad. Another frog, just the same. Green. White belly. Two frogs.',
    'Two ducks floated by. Two of each. In the pond, everyone had a match.',
...
STORIES['match-the-land-animals'] = {
  ...
  words: [
    'Two rabbits hopped by. The same ears. The same hop. The same white tails.',
    'Two cows stood in the field. The same spots. The same slow chew. Moo. Moo.',
    'One pig rolled in the mud. Pink. Round. Just one. Rosa frowned. Where was its twin?',
    'She looked in the barn. She looked by the trough. She looked behind the hay.',
    'Then, splat! Another pig flopped into the mud. Pink. Round. Just the same. Two pigs.',
    'Two by two. Rabbits, cows, pigs. Every animal on the farm had a match.',
...
STORIES['match-the-shapes'] = {
  ...
  words: [
    'Diego had a box with holes. A round hole. A square hole. A triangle hole. And a block.',
    'The block had three corners. He tried the round hole. Push. No fit. It stuck.',
    'He tried the square hole. Push. Push harder. No fit. He was getting cross.',
    'Mom said, look at the block. Look at the hole. Are they the same shape?',
    'Three corners on the block. Three corners on the triangle hole. Yes! The same. In it went. Plop.',
    'Diego picked up the round block. Which hole? The round one. Plop. He knew now.',
...
STORIES['match-the-solids'] = {
  ...
  words: [
    'Mia had a pile of shapes. Some were cubes. Some were balls. She wanted to build.',
    'A cube. Another cube, just the same. She put one on top. It stayed. A tower!',
    'A ball. Another ball. She put one on top of the cube. It wobbled. It rolled off.',
    'She tried again. The ball rolled off again. Balls do not stack. Balls roll.',
    'Mia matched them up. Cubes with cubes. Balls with balls. The ones alike went together.',
    'The cubes made a tall tower. The balls went in a basket. Each thing in its place.',
...
STORIES['more-and-fewer-5'] = {
  ...
  words: [
    'Theo sat on the dock. Five ducks floated by. He counted. One, two, three, four, five.',
    'Five ducks. Five fingers. He held up his whole hand. Five!',
    'Then, flap, flap, flap! Three ducks flew away. Up over the trees. Gone.',
    'Theo looked at the water. He counted again. One, two. Only two ducks were left.',
    'Two is fewer than five. Five was more. He held up two fingers. Then five. Then two.',
    'Two ducks quacked at him. The pond seemed quiet now. More ducks was noisier.',
    'More is the bigger group. Fewer is the smaller group.',
  ],
};
STORIES['bigger-and-smaller'] = {
  about: 'three pumpkins, one wagon, and the one that fit',
  more: [{ serial: 'S183', after: 1, alt: 'A huge pumpkin, taller than the wagon' }, { serial: 'S1443', after: 4, alt: 'A middle pumpkin sitting snug in the wagon' }, { serial: 'S1444', after: 5, alt: 'The girl pulling the wagon home, one pumpkin riding' }],
  title: 'The pumpkin wagon', art: 'S182', cast: [],
  alt: 'A small girl pulling a red wagon through a pumpkin patch, pumpkins of every size around her',
  words: [
    'It was pumpkin day. Rosa had a red wagon. She wanted one pumpkin to take home.',
    'She saw a huge one. Bigger than the wagon! She pushed. It did not move. Too big.',
    'She saw a tiny one. Small as her fist. She put it in. It rolled around. Too small.',
    'Rosa walked the whole patch. Big ones. Little ones. She wanted just right.',
    'There. A middle one. Not huge. Not tiny. She lifted it. It fit the wagon. Snug.',
    'Bigger takes more room. Smaller takes less. Rosa pulled her pumpkin home.',
    'Bigger takes more room. Smaller takes less.',
  ],
};
STORIES['first-strokes'] = {
  about: 'a foggy window, one finger, and lines that went every way',
  more: [{ serial: 'S186', after: 0, alt: 'A foggy window with nothing on it yet' }, { serial: 'S1451', after: 2, alt: 'A line across, crossing the first' }, { serial: 'S1453', after: 5, alt: 'The whole window covered in lines' }],
  title: 'Lines on the window', art: 'S185', cast: [],
  alt: 'A small girl drawing on a foggy window with one finger, rain outside',
  words: [
    'It was raining. The window was fogged up. Ana pressed her finger on it. It squeaked.',
    'Her finger went down. It left a line. A clear line in the fog. Straight down.',
    'She drew across. Another line. It crossed the first one. A plus sign.',
    'Then a wavy one. Up and down, up and down. Like a wave. Like a snake.',
    'Down. Across. Wavy. Lines can go any way you like. Ana drew and drew.',
    'Soon the whole window was lines. She could see the yard through them.',
    'Start at the dot. Follow the line. A line goes where your finger goes.',
  ],
};
STORIES['connect-the-dots'] = {
  about: 'dots that hid a picture until Leo joined them in order',
  more: [{ serial: 'S189', after: 0, alt: 'A page of dots with tiny numbers' }, { serial: 'S1454', after: 2, alt: 'Dots up to four joined, a corner showing' }, { serial: 'S1456', after: 5, alt: 'A star, all the dots joined' }],
  title: 'What is it?', art: 'S188', cast: [],
  alt: 'A small boy joining numbered dots on a page with a crayon, a shape half made',
  words: [
    'Leo had a page of dots. Each dot had a tiny number. What was hiding in there?',
    'One to two. He drew a line. Two to three. Another line. What is it?',
    'Three to four. Four to five. A corner. Then another corner. Leo could not tell yet.',
    'Is it a house? he guessed. Is it a boat? He kept going. Six. Seven.',
    'Eight! The last line. Leo sat back. Points all around. A star!',
    'The dots had known all along. They just needed to be joined in order.',
    'Start at 1. Draw to each dot in order. The picture comes out.',
  ],
};
STORIES['draw-the-shapes'] = {
  about: 'a circle with a gap, and the finger that went all the way back to the dot',
  more: [{ serial: 'S192', after: 0, alt: 'A green dot on the page, the crayon on it' }, { serial: 'S1457', after: 2, alt: 'A circle with a gap, not closed' }, { serial: 'S1459', after: 4, alt: 'A closed circle, the crayon back at the dot' }],
  title: 'Back to the dot', art: 'S191', cast: [],
  alt: 'A small girl drawing a circle with a fat crayon, nearly back to the starting dot',
  words: [
    'Mia put her crayon on the dot. Start here. Go round. She started.',
    'Round. Round. The curve grew. It was like a moon. Then like a bowl.',
    'She stopped. She looked. Her circle had a gap. A door in it. Not a circle yet.',
    'Almost there, said her teacher. Keep going. Do not stop early.',
    'Mia kept going. Round. Round. Back to the dot. The gap closed. A circle!',
    'She drew another. All the way round, no stopping. Two circles. Then three.',
    'Start at the dot. Go all the way around. Back to the dot.',
  ],
};
STORIES['big-bigger-biggest'] = {
  about: 'three bowls, three bears, and the size that fit each one',
  more: [{ serial: 'S195', after: 0, alt: 'Three bowls in a row, small to large' }, { serial: 'S1463', after: 2, alt: 'The big bear with the little bowl, too small' }, { serial: 'S1465', after: 5, alt: 'All three bears eating from the right bowls' }],
  title: 'Three bowls', art: 'S194', cast: [],
  alt: 'Three bears at a wooden table with three bowls of porridge, little, middle and big',
  words: [
    'Three bears. Three bowls. A little bowl. A middle bowl. A big bowl.',
    'Little bear grabbed the big bowl. Too heavy! It wobbled. Porridge spilled.',
    'Big bear took the little bowl. Too small! One bite and it was empty.',
    'Middle bear looked at the middle bowl. Not too big. Not too small. Just right.',
    'Little bear took the little bowl. Big bear took the big bowl. Now everyone matched.',
    'Little, middle, biggest. Three bears, three bowls, three sizes in a row.',
    'Little, middle, biggest. Three sizes in a row.',
  ],
};
STORIES['helpers-all-around'] = {
  about: 'a crossing guard, a bus driver, a nurse, and a morning full of helpers',
  more: [{ serial: 'S198', after: 0, alt: 'The crossing guard holding up a stop sign, cars stopping' }, { serial: 'S1466', after: 2, alt: 'The nurse putting a bandage on a scraped knee' }, { serial: 'S1468', after: 5, alt: 'The boy at the dinner table telling his family' }],
  title: 'Helpers', art: 'S197', cast: [],
  alt: 'A small boy crossing a street with a crossing guard, a school bus waiting at the curb',
  words: [
    'Kai walked to school. Cars zoomed by. The crossing guard held up her sign. The cars stopped. Kai crossed.',
    'The bus pulled up. The driver opened the door. Good morning, he said. Kai climbed in.',
    'At school, Kai fell. His knee hurt. The nurse cleaned it. A bandage. All better.',
    'A fire truck drove by the window. The driver waved. Kai waved back.',
    'Helpers were all around him. Each one had a job. Each one helped.',
    'At dinner, Kai told everyone. The guard. The bus driver. The nurse. The fire truck. Four helpers, one day.',
    'Helpers are all around. Every helper has a job.',
  ],
};
STORIES['first-sounds'] = {
  about: 'Ben, Sam, and Mia, and the sounds their names start with',
  more: [{ serial: 'S201', after: 0, alt: 'Ben with his lips pressed together for buh' }, { serial: 'S202', after: 2, alt: 'Sam hissing like a snake, sss' }, { serial: 'S1473', after: 4, alt: 'A ball, a sun and a moon drawn beside each child' }],
  title: 'Buh and sss', art: 'S200', cast: [],
  alt: 'A teacher on a classroom rug asking a small boy the first sound of his name, the boy pressing his lips together',
  words: [
    'Ben, said the teacher. What does Ben start with? Ben pressed his lips. Buh. Ben starts with buh.',
    'Sam, said the teacher. Sam thought. He said his name slowly. Sss-am.',
    'Sss! Like a snake. Sam starts with sss. He hissed. Everyone laughed.',
    'Mia, said the teacher. Mia closed her lips and hummed. Mmm. Mia starts with mmm.',
    'Buh, like ball. Sss, like sun. Mmm, like moon. Every name had a first sound.',
    'They pointed at each other. Buh! Sss! Mmm! They did it all the way to snack time.',
    'Listen to the start of the word. That is the first sound.',
  ],
};
STORIES['which-came-first'] = {
  about: 'a roar, a squawk, and remembering which one came first',
  more: [{ serial: 'S204', after: 0, alt: 'The lion with its mouth wide, roaring' }, { serial: 'S1476', after: 4, alt: 'A boy listening hard as a duck quacks first and a cow moos after' }, { serial: 'S1477', after: 5, alt: 'The boy playing the sound game all day, pointing at animals in the order he hears them' }],
  title: 'The roar came first', art: 'S203', cast: [],
  alt: 'A small boy at a zoo with a lion and a parrot, his hand cupped to his ear',
  words: [
    'Leo was at the zoo. Roar! Then, squawk! Two sounds. Which one came first?',
    'Leo had to think back. He closed his eyes. What did he hear first?',
    'The roar. That was the lion. It came first. Then the squawk. The parrot came after.',
    'Dad tried again. Quack! Then, moo! Which came first?',
    'Leo held the first sound in his head. Quack. The duck came first. The cow came after.',
    'All day, Leo played the game. First sound, then the next. He never mixed them up.',
    'Hold the first sound in your head while you hear the rest.',
  ],
};
STORIES['which-came-second'] = {
  about: 'a whistle, a tick and a woof, and which one came second',
  more: [{ serial: 'S207', after: 0, alt: 'The kettle whistling on the stove' }, { serial: 'S1478', after: 3, alt: 'The dog barking at the door' }, { serial: 'S1479', after: 4, alt: 'The girl holding up three fingers' }],
  title: 'Whistle, tick, woof', art: 'S206', cast: [],
  alt: 'A small girl in a kitchen with a kettle, a clock and a dog, three sounds in the air',
  words: [
    'In the kitchen, three sounds. Whistle. Tick. Woof. The kettle, the clock, the dog.',
    'Which came second? asked Grandpa. Not the first. Not the last. The middle one.',
    'Ana thought. Whistle was first. Woof was last. So the middle was... tick! The clock.',
    'Which came last? Ana knew that one. Woof. The dog. It was still barking.',
    'She held up three fingers. First, whistle. Second, tick. Last, woof.',
    'Grandpa made new sounds. Clap. Stomp. Snap. Ana found the second one every time.',
    'Keep the sounds in a row in your head. Then point to the one you want.',
  ],
};
STORIES['big-letters'] = {
  ...
  words: [
    'The bus came. Yellow and big. On its side were letters. Big ones. Sam looked up.',
    'He did not know them yet. Three shapes. One round. One like a cup. One curvy.',
    'His sister said, that is B. B says its name. Bee. Sam said, bee.',
    'That is U. It says you. And that is S. It says ess. Like a snake.',
    'B. U. S. Sam said them together. Bee, you, ess. Bus! The letters spelled the bus!',
    'Every day after that, Sam read the bus. B, U, S. He read it to everyone.',
    'Every letter has a name. Say it when you see it.',
  ],
};
STORIES['first-letter-tracing'] = {
  about: 'a stick, wet sand, and the first letter Diego ever made',
  more: [{ serial: 'S213', after: 0, alt: 'The stick touching a dot in the sand' }, { serial: 'S1484', after: 2, alt: 'The boy smoothing the sand flat again' }, { serial: 'S1486', after: 4, alt: 'A finished letter T in the sand, the boy standing over it' }],
  title: 'A letter in the sand', art: 'S212', cast: [],
  alt: 'A small boy drawing a big letter in wet sand with a stick, waves behind him',
  words: [
    'Diego had a stick. The sand was wet. Dad made a dot. Start at the dot, he said.',
    'Diego pushed the stick. It went wiggly. It went the wrong way. That was not a letter.',
    'He smoothed the sand flat. He found the dot again. He tried again.',
    'Follow the arrow. Down. A straight line. Lift the stick. Now across the top.',
    'A letter! A big T. It stood in the sand. Diego stood over it. He made it.',
    'A wave came. It washed the T away. Diego laughed. He made another one.',
    'Start at the dot. Follow the arrow. Lift, then go again.',
  ],
};
STORIES['more-big-letters'] = {
  ...
  words: [
    'Mia had a pile of sticks. Flat ones. Colored ones. Could sticks make letters?',
    'One stick down. One stick across the bottom. An L! Mia clapped.',
    'Could they make more? She tried. One stick down again.',
    'One stick across the top this time. A T! A different letter from the same two sticks.',
    'One stick down. One across the top. One across the middle. Three sticks. An F!',
...
STORIES['trace-straight-letters'] = {
  about: 'down, then across, and the L, T and F that came from one move',
  more: [{ serial: 'S219', after: 0, alt: 'A finger going down, then across the bottom' }, { serial: 'S1490', after: 2, alt: 'The finger going down, then across the top' }, { serial: 'S1491', after: 4, alt: 'The letter T finished' }],
  title: 'Down, then across', art: 'S218', cast: [],
  alt: 'A small boy tracing L, T and F on a worksheet with a fat crayon',
  words: [
    'Down, then across. Kai traced it. Down the line. Across the bottom. An L.',
    'That was easy. But his teacher said, what if across went on top?',
    'Kai tried. Down. Then across the top. A T! A hat on a stick.',
    'Now across the top, and across the middle too. Two acrosses. An F!',
    'Down, then across. Three letters from one move. Kai traced them all again.',
    'L for lamp. T for tree. F for fish. He said them as he went.',
...
STORIES['rules-and-helpers'] = {
  ...
  more: [{ serial: 'S222', after: 0, alt: 'A traffic jam of children on the slide, all going at once' }, { serial: 'S1592', after: 2, alt: 'The teacher holding up one finger' }, { serial: 'S1593', after: 3, alt: 'Children taking turns down the slide one at a time, laughing' }, { serial: 'S1594', after: 4, alt: 'A fire truck going by, the driver waving' }],
  ...
  words: [
    ...
    'The teacher made a rule. One at a time. Wait at the top. Go when the bottom is clear.',
    'Now the slide was fun again. Whee! Diego went. Then Rosa. Then Kai. No bumps. No tears.',
    'Then a fire truck came by. The driver waved. A helper, with a job for the whole town.',
    'Rules keep us safe. Helpers do jobs for everyone. Rosa waved at the truck with both arms.',
...
STORIES['needs-and-wants'] = {
  ...
  more: [{ serial: 'S225', after: 0, alt: 'The toy on the shelf, bright and shiny' }, { serial: 'S1595', after: 1, alt: 'The girl holding her tummy' }, { serial: 'S1596', after: 4, alt: 'A girl at the kitchen table eating warm bread with butter, smiling' }, { serial: 'S1597', after: 5, alt: 'The girl walking out with the bread, waving to the toy' }],
  title: 'Bread or the toy', art: 'S224', cast: [],
  alt: 'A small girl at a store counter looking from a loaf of bread to a toy, a few coins in her hand',
  words: [
    'Ana had money for one thing. She held the coins tight. Bread, or the toy? She wanted the toy. She really wanted the toy.',
    'But her tummy rumbled. Loud. Her mom asked, which one do we need?',
    'Ana thought. We need to eat. We want to play. Need comes first.',
    'Ana picked the bread. The toy could wait. Her tummy could not.',
    'At home, she ate warm bread with butter. Her tummy stopped rumbling. That was better than a toy.',
    'Next week, with new coins, she came back. The toy was still there. This time she could pick it.',
...
STORIES['our-flag-and-holidays'] = {
  ...
  more: [{ serial: 'S228', after: 0, alt: 'The flag rising up the pole in the morning' }, { serial: 'S1598', after: 1, alt: 'The teacher bringing a small flag to his desk' }, { serial: 'S1599', after: 3, alt: 'A finger counting thirteen stripes' }, { serial: 'S1600', after: 5, alt: 'The blue corner full of white stars' }],
  title: 'Up went the flag', art: 'S227', cast: [],
  alt: 'A small boy watching a big flag go up a pole in a schoolyard, his finger counting stripes',
  words: [
    'Up went the flag. Red. White. Blue. It waved in the wind. Sam wanted to know what was on it. It was too far up to see.',
    'So the teacher brought a small one down to his desk. The same flag. Just little.',
    'Sam counted the stripes. Red, white, red, white. Thirteen. He counted the stars. That took a while. Fifty!',
    'Fifty stars for fifty states. Thirteen stripes for the first thirteen. Red, white and blue.',
    'On holidays, the flag went up early. On the Fourth of July, everyone waved a little one.',
    'Sam drew the flag at home. He ran out of room for the stars at thirty. He did his best.',
...
STORIES['jobs-people-do'] = {
  ...
  more: [{ serial: 'S231', after: 0, alt: 'The baker with a big bowl and a spoon' }, { serial: 'S1601', after: 3, alt: 'The mail carrier with a full bag' }, { serial: 'S1602', after: 4, alt: 'A girl playing baker with a toy bowl and a wooden spoon' }, { serial: 'S1603', after: 5, alt: 'The girl playing mail carrier with a paper bag of letters, handing one to her dad for a hug' }],
  ...
  words: [
    'In the morning, Lena watched everyone go to work. The baker went to bake bread. The nurse went to help the sick. The mail carrier went with a bag of letters.',
    'Why did they all go? Lena thought they just liked it. Her dad said, they get paid, too.',
    'People work to earn money. Money buys needs. Food. A home. Shoes when yours get small.',
    'And every job has its tools. The baker had a bowl. The nurse had a stethoscope. The mail carrier had a big bag.',
    'Lena played baker. A toy bowl. A wooden spoon. She baked pretend bread all afternoon.',
    'Then she played mail carrier. A paper bag. Letters for every room. She got paid in hugs.',
...
STORIES['voting-in-class'] = {
  ...
  more: [{ serial: 'S234', after: 0, alt: 'Half the class pointing at a dragon book, half at a dog book' }, { serial: 'S1604', after: 2, alt: 'Hands up for the dragon, the teacher counting' }, { serial: 'S1605', after: 3, alt: 'A class cheering as a stuffed dragon wins the vote, a stuffed dog waiting for next week' }, { serial: 'S1606', after: 4, alt: 'The dragon book being read, the dog book waiting on the shelf' }],
  title: 'Hands up', art: 'S233', cast: [],
  alt: 'Children on a classroom rug with their hands up, a teacher holding two picture books',
  words: [
    'Two books for story time. A dragon book. A dog book. Half the class wanted the dragon. Half wanted the dog. Everyone shouted.',
    'Nobody could hear. Shouting did not pick a book. It only made it loud.',
    'The teacher said, hands up for the dragon. She counted. Nine. Hands up for the dog. She counted. Seven.',
    'One vote each. Nine is more than seven. The dragon won. The dog would get next week.',
    'Nobody shouted. Everyone had counted. Even the dog voters nodded. It was fair.',
    'The dragon book was good. And next week, the dog book was good too. Both got their turn.',
    'One vote each. More votes wins.',
  ],
};
STORIES['our-two-flags'] = {
  about: 'two flags on one pole, and the boy who counted one star and fifty',
  more: [{ serial: 'S237', after: 0, alt: 'Two flags waving on one pole' }, { serial: 'S1607', after: 2, alt: 'The top flag with fifty small stars' }, { serial: 'S1608', after: 4, alt: 'The Texas flag with its one big star' }, { serial: 'S1609', after: 5, alt: 'The boy saluting both flags' }],
  title: 'Two flags, one pole', art: 'S236', cast: [],
  alt: 'A small boy looking up at two flags on one pole, fifty stars on the top one and one big star below',
  words: [
    'Two flags flew on one pole. Kai asked why. One flag is enough, he said. Why two?',
    'His teacher asked him to count the stars on each one. Kai squinted up.',
    'The top one had fifty. One star for every state. Too many to count fast. The one below had one big star.',
    'That was the flag for Texas. Our state. One star. The Lone Star.',
    'Two flags. One for the country. One for home. Both on one pole, waving together.',
    'Kai saluted both. Then he drew them. Fifty little stars, and one big one.',
    'Fifty stars for the country. One star for Texas.',
  ],
};
STORIES['count-to-10'] = {
  about: 'ten steps up to a slide, and the boy who kept losing count halfway',
  more: [{ serial: 'S240', after: 0, alt: 'The tall slide with its long ladder' }, { serial: 'S1496', after: 2, alt: 'The boy looking back down at his row of toys, lost and frowning' }, { serial: 'S1497', after: 4, alt: 'The boy back at the bottom, finger on the first step' }, { serial: 'S1498', after: 5, alt: 'The boy at the top with both arms up' }],
  title: 'Ten steps', art: 'S239', cast: [],
  alt: 'A small boy climbing the ladder of a tall slide, counting each step out loud',
  words: [
    'Sam wanted to know how many steps went up the big slide. It was tall. It was the best slide in the park.',
    'He climbed and counted. One, two, three, four. Then a bird flew by. A blue one. He watched it.',
    'When he looked back down, he had lost his place. Was he on five? Six? He did not know.',
    'He tried to start again from the middle. That did not work. The numbers came out wrong.',
    'So he went to the bottom. He put his finger on the first step. One. Then two. Slowly.',
    'Five, six, seven. Higher and higher. Eight, nine, ten. The top! Ten steps. Then, whoosh, down the slide.',
    'Count one at a time. The last number is how many.',
  ],
};
STORIES['tracing-numbers'] = {
  about: 'a number two that came out as a snake, until Lena started at the dot',
  more: [{ serial: 'S243', after: 0, alt: 'A wobbly snake shape where a 2 should be' }, { serial: 'S1499', after: 1, alt: 'The girl starting to trace in the middle of a big number two, unsure' }, { serial: 'S1500', after: 4, alt: 'A finger on the dot, then curving round and down' }, { serial: 'S1501', after: 5, alt: 'A row of big numbers, each with its own green starting dot, the girl tracing them proudly' }],
  title: 'Start at the dot', art: 'S242', cast: [],
  alt: 'A small girl tracing a big number 2 on paper, a green dot at the top of the curve',
  words: [
    'Lena tried to draw a two. It came out like a snake. She tried again. A snake with a hat. Her brother laughed.',
    'Where did a two even start? Lena had no idea. She kept starting in the middle.',
    'Her teacher put a green dot at the top. Start here, she said. Then curve round. Then down.',
    'Lena put her finger on the dot. Round. Down. Along the bottom. Stop. A two! Every time.',
    'She did a three. Dot at the top. Round, round. A three. A five. Dot, down, round.',
    'Every number had its own dot. Once she knew where to start, the rest followed.',
    'Start at the dot. Follow the arrow. That draws the number.',
  ],
};
STORIES['one-more-one-less'] = {
  about: 'four cookies on a plate, one more, one less, and a boy who kept count',
  more: [{ serial: 'S246', after: 0, alt: 'Four cookies on a blue plate' }, { serial: 'S1502', after: 1, alt: 'The boy counting on his fingers' }, { serial: 'S1503', after: 4, alt: 'A boy watching cookies come and go on a plate, keeping track in his head' }, { serial: 'S1504', after: 5, alt: 'A sister taking one, four left and a cookie in her hand' }],
  title: 'One more, one less', art: 'S245', cast: [],
  alt: 'A small boy at a kitchen table watching a plate of cookies, one hand reaching',
  words: [
    'Four cookies sat on the plate. Chocolate ones. Mom put one more on. Diego said, now there are lots.',
    'Mom said, how many? Diego was not sure. He did not want to count them all again. Cookies do not wait.',
    'One more than four is the next number, said Mom. Diego counted up. Four, five. Five cookies!',
    'Then his sister came in. She ate one. Crunch. One less than five is the number before. Four.',
    'Diego kept track without counting. One more, the next number. One less, the number before.',
    'Then he ate one himself. Four, three. Mom put two more on. Three, four, five. He had it now.',
    'One more is the next number. One less is the number before.',
  ],
};
STORIES['joining-and-taking-away'] = {
  about: 'cars in a toy garage, some driving in and one driving out',
  more: [{ serial: 'S249', after: 0, alt: 'Two cars parked in the little garage' }, { serial: 'S1505', after: 1, alt: 'The garage jumbled with cars' }, { serial: 'S1506', after: 4, alt: 'A finger touching each car, counting' }, { serial: 'S1507', after: 5, alt: 'One car driving out of the garage' }],
  title: 'Cars in the garage', art: 'S248', cast: [],
  alt: 'A small girl playing with a toy garage, two cars inside and three rolling in',
  words: [
    'Two cars sat in the toy garage. A red one. A green one. Ana rolled three more in. Vroom.',
    'Was it more cars now, or fewer? Ana said more. But how many? The cars were all jumbled.',
    'She counted. One finger on each car. One, two, three, four, five. Five cars. Joining made five.',
    'Then one car drove away. Out the door and across the rug.',
    'Taking away leaves fewer. Ana counted again. One, two, three, four. Four cars now.',
    'She rolled two more in. Joining. Six. She drove three out. Taking away. Three. The garage was busy all morning.',
    'Joining makes more. Taking away leaves fewer. Count to find out how many.',
  ],
};
STORIES['comparing-numbers'] = {
  about: 'six blocks, four blocks, and a way to settle which pile was bigger',
  more: [{ serial: 'S252', after: 0, alt: 'Two piles of blocks side by side' }, { serial: 'S1508', after: 2, alt: 'The blocks lined up in two rows' }, { serial: 'S1509', after: 3, alt: 'A finger counting up past four to six' }, { serial: 'S1510', after: 5, alt: 'The children building one big tower together' }],
  title: 'Which is bigger?', art: 'S251', cast: [],
  alt: 'Two children with two piles of blocks on a rug, one pile taller than the other',
  words: [
    'Leo had six blocks. His friend Max had four. Max said four was bigger. Leo said six.',
    'They both said it louder. Then louder still. Louder did not help. Neither could show it.',
    'Leo lined his blocks up. Max lined his up. Two rows. One row was longer.',
    'Leo counted up. One, two, three, four. There was four, Max\'s pile. Five, six. There was six.',
    'Six came later when you count. Later means bigger. Six is bigger than four.',
    'Max nodded. Then they put all the blocks together. Ten! A tower taller than both of them.',
...
STORIES['shapes'] = {
  ...
  more: [{ serial: 'S255', after: 0, alt: 'The round clock on the wall' }, { serial: 'S1511', after: 1, alt: 'A finger going round and round the clock, no corners' }, { serial: 'S1512', after: 2, alt: 'A finger stopping at each corner of the window' }, { serial: 'S1513', after: 4, alt: 'A triangle roof drawn on paper, three corners' }],
  title: 'Counting corners', art: 'S254', cast: [],
  alt: 'A small girl in a bedroom pointing at a round clock and a square window',
  words: [
    ...
    'On the window her finger stopped. Corner. Then again. Corner. Four times. Four corners. Four sides.',
    'A square has four. A circle has none. That is how you tell them apart.',
    'Rosa looked around the room. Her book. Four corners. Her ball. None. Her paper hat. Three!',
    'Three corners, three sides. A triangle. She found shapes all day.',
    'Count the sides and corners to tell shapes apart.',
  ],
};
STORIES['tracing-shapes'] = {
  about: 'a square that Kai could not close, until he went all the way around',
  more: [{ serial: 'S258', after: 0, alt: 'A square with one side missing, like a cup' }, { serial: 'S1514', after: 2, alt: 'A finger at the dot, going across' }, { serial: 'S1515', after: 3, alt: 'Down, then back across, then up' }, { serial: 'S1516', after: 5, alt: 'A closed square, the finger back at the dot' }],
  title: 'All the way around', art: 'S257', cast: [],
  alt: 'A small boy tracing a square on paper, his finger nearly back at the starting dot',
  words: [
    ...
    'Start at the dot, said his teacher. Across. Down. Back across. Up. All the way around, back to the dot.',
    'Kai tried. Across. Down. Back across. Up! His finger came back to the dot. The gap was gone.',
    'A square. Four sides. He traced it again. And again. No gaps.',
    'Then a triangle. Three sides, all the way around. Then a circle. Round and back to the dot.',
    'Start at the dot and go all the way around.',
  ],
};
STORIES['counting-by-tens'] = {
  about: 'a room full of fingers, counted ten at a time',
  more: [{ serial: 'S261', after: 0, alt: 'The girl counting one finger at a time, tired' }, { serial: 'S262', after: 2, alt: 'One friend with ten fingers up' }, { serial: 'S1518', after: 3, alt: 'The girl jumping from friend to friend, ten, twenty, thirty' }, { serial: 'S1519', after: 4, alt: 'All ten friends with hands up, one hundred' }],
  ...
  words: [
    ...
    'There were too many fingers to count one by one. Her teacher smiled. Every friend has ten, she said.',
    'Ten. Mia looked at one friend. Ten fingers. She looked at the next. Ten more. Twenty!',
    'So she counted by tens. Ten. Twenty. Thirty. Forty. Fifty. Every friend was one jump.',
    'Sixty. Seventy. Eighty. Ninety. One hundred! Ten friends. One hundred fingers.',
    'It took a minute. Not the whole morning. Mia counted the toes next. Ten each. One hundred again.',
...
STORIES['longer-and-heavier'] = {
  ...
  more: [{ serial: 'S264', after: 0, alt: 'The stick and the rock side by side on the bank' }, { serial: 'S265', after: 2, alt: 'The stick reaching all the way across the creek' }, { serial: 'S1520', after: 3, alt: 'The boy trying to lift the rock with both hands' }, { serial: 'S1522', after: 5, alt: 'The boy sitting on the rock, holding the stick like a flag' }],
  title: 'The stick and the rock', art: 'S263', cast: [],
  alt: 'A small boy at a creek holding a long stick across the water, a big rock at his feet',
  words: [
    ...
    'Bigger, it turned out, was two different things.',
    'The stick was long. He laid it down. It reached all the way across the creek. Longer reaches further.',
    'The rock was heavy. He tried to lift it. He needed both hands. He grunted. Heavier is harder to lift.',
    'The stick was easy to lift. One hand. But it was long. The rock was short. But it was heavy.',
    'Sam sat on the rock. He held the stick up like a flag. Longest and heaviest, both his.',
    'Longer reaches further. Heavier is harder to lift.',
  ],
};
STORIES['sorting'] = {
  about: 'a mountain of socks that would not pair up until they were sorted by color',
  more: [{ serial: 'S267', after: 0, alt: 'A huge pile of clean socks on the bed' }, { serial: 'S1523', after: 3, alt: 'Red socks in one pile, blue in another, white in a third' }, { serial: 'S1524', after: 4, alt: 'The girl counting the red pile on her fingers' }, { serial: 'S1525', after: 5, alt: 'Pairs of socks rolled up in a neat row' }],
  title: 'The sock pile', art: 'S266', cast: [],
  alt: 'A small girl sitting in a pile of mixed socks, three small piles starting to form beside her',
  words: [
    'Ana had a mountain of clean socks to pair up. She grabbed two. Red and blue. No. Two more. Blue and white. No.',
    'Every pair she grabbed was wrong. The pile did not get smaller. Ana flopped back on the bed.',
    'Her mom said, sort first. Put the ones alike together. Then match.',
    'Red socks here. Blue socks there. White socks in the middle. Alike with alike. Three piles.',
    'Then she counted each pile. Six red. Four blue. Two white. Now matching was easy. Red with red.',
    'Three red pairs. Two blue pairs. One white pair. Six rolled-up balls in a row. The mountain was gone.',
...
STORIES['solids'] = {
  ...
  more: [{ serial: 'S270', after: 0, alt: 'The ball rolling off the block' }, { serial: 'S1526', after: 2, alt: 'Blocks stacked in a tower' }, { serial: 'S1527', after: 3, alt: 'A can rolling on its side, then standing up' }, { serial: 'S1528', after: 4, alt: 'A party hat on top of the tower' }],
  title: 'Roll, stack, point', art: 'S269', cast: [],
  alt: 'A small boy with a ball, a block, a can and a party hat lined up on the floor',
  words: [
    ...
    'A ball rolls. That is a sphere. Round all over. A block stacks. That is a cube. Flat sides.',
    'A can rolls on its side. But stand it up, and it stacks. That is a cylinder. Both!',
    'A party hat comes to a point. That is a cone. It sat on top of the tower like a roof.',
    'Cube, cube, cylinder, cone. A tower. The ball rolled around the bottom. It could not join.',
    'Solid shapes are things you can hold: sphere, cube, cylinder, cone.',
  ],
};
STORIES['making-ten'] = {
  about: 'ten fingers, three folded down, and the seven still up',
  more: [{ serial: 'S273', after: 0, alt: 'Both hands open, ten fingers up' }, { serial: 'S1529', after: 2, alt: 'The girl counting the fingers still up' }, { serial: 'S1530', after: 3, alt: 'Two down, eight up' }, { serial: 'S1531', after: 5, alt: 'A row of hands, each showing a different pair' }],
  title: 'Partners for ten', art: 'S272', cast: [],
  alt: 'A small girl holding up her hands with three fingers folded down and seven up',
  words: [
    ...
    'She counted them once. Seven. Three and seven. Together they were ten. Partners!',
    'Fold two down, said the teacher. Rosa did. Eight up. Two and eight. Partners too.',
    'Fold five down. Five up. Five and five. Fold one down. Nine up. One and nine.',
    'Every number had a partner. Rosa went through them all. She did not have to count anymore. Her hands knew.',
    'Every number up to nine has a partner that makes ten.',
  ],
};
STORIES['more-and-fewer-10'] = {
  about: 'two buckets of shells at the beach, and which one had more',
  more: [{ serial: 'S276', after: 0, alt: 'A big bucket and a small bucket side by side' }, { serial: 'S277', after: 2, alt: 'Shells tipped out of the big bucket into a row' }, { serial: 'S1533', after: 3, alt: 'Six shells in a shorter row' }, { serial: 'S1534', after: 4, alt: 'The boy holding up the small bucket, grinning' }],
  title: 'Two buckets', art: 'S275', cast: [],
  alt: 'A small boy at the beach with two buckets of shells, looking from one to the other',
  words: [
    'Leo had two buckets of shells. Which one had more? One bucket was big. It looked like more. His sister said no.',
    'A bigger bucket does not mean more shells. Leo had to check.',
    'He tipped the big bucket out. He lined the shells up. He counted. Eight shells.',
    'He tipped the small bucket out. Another row. He counted. Six shells. Six. That was fewer.',
    'Eight is bigger than six. The big bucket had more after all. But only by two.',
    'Then his sister found five more shells. She put them in the small bucket. Now that one had eleven. More!',
...
STORIES['letter-names'] = {
  ...
  more: [{ serial: 'S279', after: 0, alt: 'The boy stuck on the letter D, the rest of the letters faded' }, { serial: 'S1535', after: 3, alt: 'The boy singing, letters lighting up one by one' }, { serial: 'S1536', after: 4, alt: 'A boy singing all the way to the end of the alphabet song while his big sister claps' }, { serial: 'S1537', after: 5, alt: 'The boy at the front of the bus singing for everyone' }],
  ...
  words: [
    ...
    'His sister leaned over the seat. Sing it, she said. Ben said he could not sing letters. But the bus was long. He tried.',
    'A, B, C, D, E, F, G. The tune pulled the next letter out. He did not have to think.',
    'H, I, J, K. Still going. L, M, N, O, P. The letters lined up like the bus seats.',
    'Q, R, S. T, U, V. W, X. Y and Z! He got all the way to the end. His sister clapped.',
    'The next day he sang it for the whole bus. Then he sang it backward, just to see. That was harder.',
...
STORIES['big-and-small-letters'] = {
  ...
  more: [{ serial: 'S282', after: 0, alt: 'The two cards side by side, one tall and one with a tail' }, { serial: 'S1538', after: 2, alt: 'The teacher pointing at her own mouth, saying guh' }, { serial: 'S1539', after: 3, alt: 'A tall letter and a small letter dressed in different clothes, holding hands like twins' }, { serial: 'S1540', after: 5, alt: 'A row of pairs: B and b, D and d, G and g' }],
  title: 'Big G, small g', art: 'S281', cast: [],
  alt: 'A small girl holding two cards, a big G in one hand and a small g in the other',
  words: [
    'Mia had two cards. One said G. One said g. They did not look alike at all. One was tall. One had a tail like a monkey.',
    'She was sure they were two different letters. Two cards, two letters. Her teacher shook her head.',
    'Say the sound, her teacher said. Mia looked at the big G. Guh. She looked at the small g. Guh.',
    'Same sound! Same letter. Just in different clothes. One dressed up tall. One dressed down small.',
    'Mia tried more cards. B and b. Buh, buh. D and d. Duh, duh. Every pair said the same thing.',
    'She lined them up. Big on top, small underneath. Twenty-six pairs. Fifty-two cards. One alphabet.',
...
STORIES['letter-sounds'] = {
  ...
  more: [{ serial: 'S285', after: 0, alt: 'The boy saying ball, the teacher asking a question' }, { serial: 'S286', after: 2, alt: 'The boy with his lips pressed together, feeling the pop' }, { serial: 'S1542', after: 4, alt: 'The boy pointing at a bus, then a bird' }, { serial: 'S1543', after: 5, alt: 'A letter B with a ball, a bat, a bug, a bus and a bird around it' }],
  title: 'Buh for ball', art: 'S284', cast: [],
  alt: 'A small boy bouncing a red ball on a playground, a big letter B drawn in the air beside him',
  words: [
    'Leo said ball, and his teacher asked what sound it started with. Leo said B. She said, that is its name. What is its sound?',
    'A letter had a name and a sound? Leo had not known that. He said ball again, slowly. Ball.',
    'He felt his lips pop at the start. Buh. That was it. That was the sound.',
    'Buh. B was the letter. Buh was the sound. Ball started with buh. So did bat. So did bug.',
    'Leo looked around. Bus. Buh! Bird. Buh! Bench. Buh! The playground was full of buh.',
    'He found seven things that started with buh before recess ended. He bounced the ball on every one.',
...
STORIES['beginning-sounds'] = {
  ...
  more: [{ serial: 'S288', after: 0, alt: 'The girl holding up a cup, shaking her head' }, { serial: 'S1544', after: 1, alt: 'The girl sitting on the floor, stuck' }, { serial: 'S1545', after: 2, alt: 'A mitten on the dresser, the girl noticing it' }, { serial: 'S1546', after: 4, alt: 'A mitten, a moon and a mouse in a row' }],
  title: 'What starts with mmm', art: 'S287', cast: [],
  alt: 'A small girl in her bedroom holding a mitten up high, a cup and a hat on the floor',
  words: [
    'Ana had to find something that started with mmm. She held up a cup. Cup. No mmm. She held up a hat. Hat. No mmm.',
    'She sat on the floor. Nothing in her room started with mmm. Not her bed. Not her book. Not her ball.',
    'Then she saw her mitten on the dresser. She said it slowly. Mmm-itten. Her lips closed. They hummed.',
    'Mmm! That was it. Mitten started with mmm. She held it up high.',
    'What else? She looked out the window. The moon! Mmm-oon. Under the bed, a toy mouse. Mmm-ouse.',
    'Mitten, moon, mouse. Three things. She hummed mmm all through dinner. Milk! Meat! Mmm.',
    'Say the name. Hear the first sound. Match it to the letter.',
  ],
};
STORIES['rhymes'] = {
  about: 'a cat, a hat and a bat, and the ending they all shared',
  more: [{ serial: 'S291', after: 0, alt: 'A cat sitting on a hat in the picture book' }, { serial: 'S1550', after: 1, alt: 'The girl listening hard, puzzled at how two words sound alike' }, { serial: 'S1551', after: 2, alt: 'A bat flying into the picture' }, { serial: 'S1552', after: 4, alt: 'The girl clapping at each matching sound' }],
  title: 'Cat, hat, bat', art: 'S290', cast: [],
  alt: 'A small girl in bed with a picture book, a cat, a hat and a bat drawn in the air above her',
  words: [
    'At bedtime Rosa heard a rhyme. The cat sat on the hat. She giggled. Cat and hat sounded like twins.',
    'Why did they sound alike? The starts were different. Cuh. Huh. Not the same at all.',
    'The ends were the same. At. At. Then the bat came in. At again. Three words, one ending.',
    'That was what made them rhyme. Same ending sound. Rosa listened for it.',
    'Mom read on. The dog on a log. Og, og! A frog on the log. Og! Rosa clapped every time.',
    'She made up her own. Cat, hat, bat, mat, sat, rat. She was still going when the light went out.',
    'Rhyming words end with the same sound.',
  ],
};
STORIES['tracing-letters'] = {
  about: 'a wet window, a finger, and the first T a boy ever made',
  more: [{ serial: 'S294', after: 0, alt: 'A foggy window, a finger pressed to it' }, { serial: 'S1553', after: 2, alt: 'Mom drawing a dot at the top' }, { serial: 'S1554', after: 3, alt: 'A finger pulling straight down from the dot' }, { serial: 'S1555', after: 5, alt: 'A foggy window full of traced letters, the morning sun starting to melt them away' }],
  ...
  words: [
    ...
    'He drew a line across. Then another line across. It looked like an equals sign. Not a T.',
    'His mom put a dot at the top of the glass. Start here, she said. Down. Lift. Now across the top.',
    'Diego put his finger on the dot. Down. Lift. Across the top. A T! Dripping a little.',
    'He made another next to it. Then an L. Down, then across the bottom. Then an I. Just down.',
    'By the time the fog cleared, the window was full of letters. Then the sun came out and they melted.',
...
STORIES['tracing-small-letters'] = {
  ...
  more: [{ serial: 'S297', after: 0, alt: 'A girl tracing a tall capital letter, then a small letter drawn much too tall beside it' }, { serial: 'S298', after: 1, alt: 'A small letter drawn too tall, tipping over like a bent stick' }, { serial: 'S1557', after: 4, alt: 'A finger going round in a circle, then down' }, { serial: 'S1558', after: 5, alt: 'A big A and a small a on the line, one tall and one low' }],
  title: 'The small a sits low', art: 'S296', cast: [],
  alt: 'A small girl tracing a small letter a on lined paper, a big A standing tall beside it',
  words: [
    'Lena traced a big A. It stood tall. Then came the small a. She made it tall too. It looked wrong.',
    'The small a did not want to be tall. It kept falling over. It looked like a bent stick.',
    'Start at the dot, her teacher said. Round, then down. Do not go up high. Stay low.',
    'Lena tried. Round. Down. The small a sat low on the line, like a curled-up cat. That was right.',
    'She traced the small c. Round, and stop. Low. The small o. Round and round. Low.',
    'Big letters stand tall. Small letters sit low. Lena traced a whole line of them, all sitting.',
...
STORIES['tracing-more-letters'] = {
  ...
  more: [{ serial: 'S300', after: 0, alt: 'A wiggly snake with teeth, the first try at an E' }, { serial: 'S1559', after: 2, alt: 'The chalk lifting off the board between two lines' }, { serial: 'S1560', after: 4, alt: 'One line down, then three across' }, { serial: 'S1561', after: 5, alt: 'A finished E with four clean lines' }],
  title: 'The E, one line at a time', art: 'S299', cast: [],
  alt: 'A small boy at a chalkboard drawing the letter E with a big piece of chalk, one line at a time',
  words: [
    'Kai tried to draw an E without lifting his chalk. He got a wiggly snake with teeth. It did not look like an E.',
    'His teacher laughed, kindly. An E is not one line, she said. It is four.',
    'Down. Lift. Across the top. Lift. Across the middle. Lift. Across the bottom. Four lines, three lifts.',
    'Kai tried it. Down. Lift. Across. Lift. Across. Lift. Across. An E! Clean and straight.',
    'Then an F. Down, across the top, across the middle. Three lines, two lifts. Then an H. Two downs and a bridge.',
    'Lift, lift, lift. The chalk squeaked every time. Kai filled the board with letters made of lines.',
    'One line at a time. Lift your finger between lines.',
  ],
};
STORIES['syllables'] = {
  about: 'the beats hiding in every name, found by clapping',
  more: [{ serial: 'S303', after: 0, alt: 'Ben clapping once, hands together' }, { serial: 'S1562', after: 1, alt: 'Elijah looking unsure, hands still' }, { serial: 'S1563', after: 3, alt: 'The teacher saying it slowly, three fingers up' }, { serial: 'S1564', after: 5, alt: 'Elijah clapping three times, grinning' }],
  title: 'Clap your name', art: 'S302', cast: [],
  alt: 'Children in a circle on a rug clapping, a girl in the middle clapping her own name',
  words: [
    'Ben clapped his name. Ben. One clap. Maya clapped hers. Ma, ya. Two claps. Then it was Elijah\'s turn. He was not sure.',
    'He said his name fast. Elijah. It came out as one blur. How many claps was a blur?',
    'Say it slowly, said the teacher. E. Li. Jah. Clap, clap, clap. Three beats were hiding in there the whole time.',
    'Elijah clapped it. E, li, jah. Three! He grinned. He clapped it again, louder.',
    'They went round the circle. Sam. One. Rosa. Ro, sa. Two. Ma, ri, an, na. Four claps!',
    'Then they clapped other words. Apple. Ap, ple. Banana. Ba, na, na. Every word had beats.',
...
STORIES['sounding-out'] = {
  ...
  more: [{ serial: 'S306', after: 0, alt: 'Three letters on a door, C A T' }, { serial: 'S1565', after: 2, alt: 'Her brother beside her, pointing at the first letter' }, { serial: 'S1566', after: 4, alt: 'A girl opening a little door to find a cat sitting on a mat, looking up at her' }, { serial: 'S1567', after: 5, alt: 'The door open, a cat sitting in the doorway' }],
  title: 'The word on the door', art: 'S305', cast: [],
  alt: 'A small girl standing at a door with three letters on it, sounding them out with her finger under each',
  words: [
    'There were three letters on the door. C. A. T. Ana knew each one. She did not know the word.',
    'She said the letter names. See, ay, tee. That was not a word. That was just three names in a row.',
    'Say the sounds, said her brother. Not the names. Cuh. A. Tuh. Slowly. Then faster.',
    'Cuh. A. Tuh. Cuh-a-tuh. Cuh-a-tuh. Cat! Ana said it. Cat!',
    'She opened the door. And there was the cat, sitting on the mat. It looked up at her.',
    'Ana found more doors. D-O-G. Duh-o-guh. Dog! A dog was not behind that one. But she read it anyway.',
...
STORIES['which-way-we-read'] = {
  ...
  more: [{ serial: 'S309', after: 0, alt: 'The finger going right to left, words coming out backward' }, { serial: 'S1568', after: 2, alt: 'The teacher tapping the top left corner' }, { serial: 'S1569', after: 4, alt: 'The finger at the end of a line, hopping down' }, { serial: 'S1570', after: 5, alt: 'The finger back at the left, starting the next line' }],
  title: 'Which way the finger goes', art: 'S308', cast: [],
  alt: 'A small boy on a reading rug with a book, his finger moving along a line of words',
  words: [
    'Theo put his finger on a page and went right to left. The words came out backward. Tac. Gid. It sounded like a robot.',
    'He tried starting in the middle. That was worse. Half a word, then nothing.',
    'Start on the left, said his teacher. She tapped the corner. Go right. At the end of the line, hop down.',
    'Theo started on the left. Cat. Dig. Now the words made sense. At the end, he hopped down.',
    'Back to the left. Go right again. Line after line. The page had a road, and he was on it.',
    'He read the whole page. Then the next. His finger knew the way now, even with his eyes closed.',
...
STORIES['word-meanings'] = {
  ...
  more: [{ serial: 'S312', after: 0, alt: 'Three pictures laid out on the table' }, { serial: 'S313', after: 1, alt: 'The card placed on the sun, the teacher shaking her head' }, { serial: 'S1571', after: 2, alt: 'The girl saying the word out loud' }, { serial: 'S1573', after: 4, alt: 'Three cards on three pictures, all matched' }],
  title: 'The card and the picture', art: 'S311', cast: [],
  alt: 'A small girl holding a word card, pictures of a dog, a sun and a fish on the table in front of her',
  words: [
    'Rosa had a card that said dog. On the table were pictures. A dog. A sun. A fish. Where did the card go?',
    'She put it on the sun. Her teacher smiled and shook her head. Not that one.',
    'Rosa said the word. Dog. She looked for the dog. There. Ears and a tail. The card went on the dog.',
    'Then sun. She said it. Sun. Round and yellow. There. The card went on the sun.',
    'Then fish. Fins and scales. There. Three cards. Three pictures. All matched.',
    'Her teacher gave her more cards. Cat. Hat. Cup. Rosa said each one, found each one. She did not miss again.',
...
STORIES['trace-slant-letters'] = {
  ...
  more: [{ serial: 'S315', after: 0, alt: 'A line straight down and a line across in the sand' }, { serial: 'S1574', after: 2, alt: 'Down a slant, up a slant, a V' }, { serial: 'S1575', after: 3, alt: 'Up, down, and across the middle, an A' }, { serial: 'S1576', after: 4, alt: 'A boy drawing slanted lines in the wet sand with a stick' }],
  title: 'Slants in the sand', art: 'S314', cast: [],
  alt: 'A small boy drawing a big letter V in wet sand with a stick, waves behind him',
  words: [
    ...
    'His sister asked for a V. Jamal tried. Straight down. Straight across. That was not a V. That was an L.',
    'Slant, she said. Down a slant. Up a slant. Jamal tried. A point at the bottom. A V!',
    'Then an A. Up a slant. Down a slant. Across the middle. Like a tent with a bar.',
    'Then an N. Down. Slant. Up. Three lines. An N. Slanted lines made all three.',
    'V, A, N. Then a wave came and washed them away. Jamal drew them again, bigger, further up the beach.',
...
STORIES['teen-numbers'] = {
  ...
  more: [{ serial: 'S318', after: 0, alt: 'The full carton of ten eggs, lid open' }, { serial: 'S1622', after: 2, alt: 'A hand tapping the closed carton, ten' }, { serial: 'S1623', after: 3, alt: 'Three loose eggs counted on, eleven twelve thirteen' }, { serial: 'S1624', after: 5, alt: 'Two cartons and four eggs, twenty-four' }],
  title: 'Ten and three', art: 'S317', cast: [],
  alt: 'A small girl at a kitchen counter with a full egg carton and three eggs sitting beside it',
  words: [
    'Ten eggs filled the carton. Two rows of five. Three more eggs sat beside it, brown and speckled. Mia had to say how many.',
    'She started counting from one. One, two, three, four. By eight she lost her place. The eggs all looked the same.',
    'Mom tapped the carton. This is ten, she said. You do not need to count those again. Ten is done.',
    'Ten. Then the three more. Eleven, twelve, thirteen. Ten and three is thirteen.',
    'Mia tried more. Ten and five. Eleven, twelve, thirteen, fourteen, fifteen. Ten and seven. Seventeen.',
    'Every teen number is ten and some more. The carton is the ten. The loose eggs are the some.',
    'A teen number is ten and some more. Start at ten and count on.',
  ],
};
STORIES['adding-to-20'] = {
  about: 'marbles in two pockets, and the jar that held them all',
  more: [{ serial: 'S321', after: 0, alt: 'The boy with both hands in his pockets, feeling for marbles' }, { serial: 'S322', after: 1, alt: 'Eight marbles from one pocket on the rug' }, { serial: 'S1626', after: 3, alt: 'The boy counting on from eight, fingers up' }, { serial: 'S1627', after: 4, alt: 'The jar with fourteen marbles inside' }],
  title: 'Two pockets', art: 'S320', cast: [],
  alt: 'A small boy emptying two pockets of marbles into a glass jar on his bedroom floor',
  words: [
    'Leo had marbles in both pockets. Eight in one. Six in the other. How many in all? He tried to count them inside his pockets. Pockets are dark.',
    'He tipped them out. Eight on the rug in one pile. Six in another pile. Blue ones. Green ones. One with a swirl.',
    'He could count them all from one. Fourteen marbles, one at a time. But that was slow.',
    'His sister showed him a faster way. Start with the bigger number. Eight. Then count on. Nine, ten, eleven, twelve, thirteen, fourteen.',
    'Fourteen! The same answer, in six counts instead of fourteen. Leo put them all in the jar.',
    'He tried it with pennies. Nine and four. Nine, ten, eleven, twelve, thirteen. It worked every time.',
...
STORIES['subtracting-to-20'] = {
  ...
  more: [{ serial: 'S324', after: 0, alt: 'Fifteen birds in a neat row on the wire' }, { serial: 'S1628', after: 2, alt: 'The girl starting to count from one again, frowning' }, { serial: 'S1629', after: 3, alt: 'Fingers counting back from fifteen' }, { serial: 'S1630', after: 4, alt: 'Nine birds left on the wire, the girl pointing' }],
  title: 'Birds on the wire', art: 'S323', cast: [],
  alt: 'A small girl in a backyard looking up at a row of birds on a wire, a few flying off',
  words: [
    'Fifteen birds sat on the wire. Small brown ones. Ana counted them twice to be sure. Fifteen.',
    'Then six flew away at once. Flap, flap. Off over the roof. How many were left?',
    'Ana started to count all over again. But the birds kept hopping and moving. Counting from one was slow.',
    'Grandpa said, count back. You had fifteen. Six left. Fourteen, thirteen, twelve, eleven, ten, nine. Six steps back.',
    'Nine! Nine birds left on the wire. Ana counted them the slow way to check. Nine. Same answer.',
    'Then two more flew off. Nine. Eight, seven. Seven birds. Then all of them left at once. Zero.',
...
STORIES['tens-and-ones'] = {
  ...
  more: [{ serial: 'S327', after: 0, alt: 'A big pile of craft sticks' }, { serial: 'S1631', after: 2, alt: 'Three bundles standing in a row' }, { serial: 'S1632', after: 4, alt: 'Four loose sticks beside the bundles' }, { serial: 'S1633', after: 5, alt: 'Bundles of ten sticks tied with rubber bands beside a few loose sticks on the table' }],
  title: 'Bundles of ten', art: 'S326', cast: [],
  alt: 'A small boy at a craft table with bundles of sticks held by rubber bands and a few loose sticks',
  words: [
    'Sam had a pile of sticks. Craft sticks, flat and smooth. His teacher asked how many. He started counting one at a time. The pile did not seem to get smaller.',
    'Then she handed him rubber bands. Ten sticks, one band. A bundle. Sam counted ten and snapped a band on.',
    'He made three bundles. Four sticks were left over. Not enough for another bundle.',
    'Three tens and four ones. Three, four. Thirty-four! He read the number right off the bundles.',
    'His friend had five bundles and two loose. Fifty-two. Sam could read it without counting a single stick.',
    'Tens come in bundles. Ones are the loose ones. Every number is bundles and loose sticks.',
...
STORIES['comparing-to-100'] = {
  ...
  more: [{ serial: 'S330', after: 0, alt: 'Two jars of buttons, both nearly full' }, { serial: 'S331', after: 2, alt: 'Buttons from one jar in stacks of ten' }, { serial: 'S1635', after: 3, alt: 'Four stacks and eight loose' }, { serial: 'S1636', after: 4, alt: 'The girl pointing at the jar with six stacks' }],
  title: 'Two jars of buttons', art: 'S329', cast: [],
  alt: 'A small girl comparing two big jars of buttons on a sewing table',
  words: [
    'This jar had 62 buttons. That jar had 48. Rosa wanted the bigger one for her sewing. The jars looked the same size. The numbers looked close.',
    'She did not want to count a hundred buttons twice. There had to be a faster way.',
    'Grandma said, look at the tens first. Rosa made stacks of ten. This jar: six stacks and two loose. Sixty-two.',
    'That jar: four stacks and eight loose. Forty-eight. Six tens. Four tens. Six is more.',
    'Six tens is more than four tens. The ones do not matter. Sixty-two is bigger than forty-eight.',
    'Rosa took the big jar. She sewed six buttons on her coat. Fifty-six left. Still more than forty-eight.',
    'Look at the tens first. If the tens match, the ones decide.',
  ],
};
STORIES['writing-numbers'] = {
  about: 'a five that kept coming out backward, until Lena found its dot',
  more: [{ serial: 'S333', after: 0, alt: 'A five that looks like an S' }, { serial: 'S1637', after: 2, alt: 'A finger on the dot at the top' }, { serial: 'S1638', after: 3, alt: 'Down, round the belly, the five taking shape' }, { serial: 'S1639', after: 5, alt: 'A row of numbers each with its own dot' }],
  title: 'The five', art: 'S332', cast: [],
  alt: 'A small girl frowning at her wobbly five on lined paper while her little brother wiggles his arm like a snake',
  words: [
    'Lena wrote a five. It looked like an S. She wrote it again. An S with a hat. Her brother said it was a snake.',
    'A five has a place to start. Lena kept starting in the wrong spot. In the middle. At the bottom.',
    'Her teacher drew a dot at the top. Start here. Down. Round the belly. Lift. Across the top.',
    'Lena tried. Down. Round. Lift. Across. A five! Not a snake. A real five, standing up straight.',
    'Every number had its own dot. Two started at the top and curved. Seven started at the top and went across, then down.',
    'Lena wrote a row of fives. Then a row of sevens. All from their dots. No snakes.',
...
STORIES['read-the-word'] = {
  ...
  alt: 'A small boy looking at a cardboard box with three letters on it, his finger under the first letter',
  words: [
    'Three letters on the box. M. A. P. Kai knew them all. Em, ay, pee. He said the names. That was not a word.',
    'Letter names do not make words. Sounds do. Dad tapped the M. What sound does it make?',
    'Mmm. Then the A. Aaa. Then the P. Puh. Kai said them one at a time. Mmm. Aaa. Puh.',
    'Now push them together, said Dad. Kai slid his finger under the letters. Mmm-aaa-puh. Mmm-aaa-puh. Map!',
    'He opened the box. Inside was a map. A big folded one. The word had told him what was inside.',
    'Kai looked for more boxes. C-U-P. Cuh-uh-puh. Cup! And there was a cup inside. He read every box in the garage.',
    'Say each sound. Push them together. Read the word.',
  ],
};
STORIES['sh-ch-th'] = {
  about: 'two letters that make one sound, and the shell that said shh',
  more: [{ serial: 'S339', after: 0, alt: 'A sign on the beach with the word shell' }, { serial: 'S1643', after: 2, alt: 'S and H drawn together with a finger to the lips, shh' }, { serial: 'S1644', after: 4, alt: 'A girl on the beach holding up her thumb and grinning' }, { serial: 'S1645', after: 5, alt: 'T and H with a thumb' }],
  title: 'Shell, chair, thumb', art: 'S338', cast: [],
  alt: 'A small girl holding a shell to her ear on a beach, a folding chair beside her',
  words: [
    'Ana found a shell. Pink and curly. She held it to her ear. Then she tried to read the word on the sign. S, h, e, l, l. Sss-huh. That was not shell.',
    'Two of the letters were working as a team. She was reading them one by one. That was the problem.',
    'S and H together say shh, said Mom. Like when you want quiet. Shh. Shell.',
    'Ana looked around. C and H together say ch. Chair. She sat in the beach chair. Ch.',
    'T and H together say th. Thumb. She held up her thumb. Th. Two letters, one sound.',
    'Shell, chair, thumb. Ana found all three on the beach. She said them with the sea.',
    'Sh, ch and th are two letters that say one sound.',
  ],
};
STORIES['silent-e'] = {
  about: 'a cap that became a cape when one letter joined and said nothing',
  more: [{ serial: 'S342', after: 0, alt: 'The word cap on a tag, a baseball cap' }, { serial: 'S1646', after: 2, alt: 'An e sliding onto the end of cap' }, { serial: 'S1647', after: 3, alt: 'A shy little letter e staying silent with a finger to its lips, reaching back to change the letter beside it' }, { serial: 'S1648', after: 5, alt: 'The boy in the cape, flying around the room' }],
  title: 'The quiet e', art: 'S341', cast: [],
  alt: 'A small boy holding a cap in one hand and a superhero cape in the other',
  words: [
    'Leo read cap. A hat. He put it on. Then he saw cape. He read it cap-eh. His sister laughed. There was no eh.',
    'The e at the end made no sound at all. So what was it for? Just sitting there?',
    'It was there to change the a. In cap, the a says aa. In cape, the a says its name. Ay. Cape.',
    'The e was silent. It worked by staying quiet. It reached back and changed the a.',
    'Leo tried more. Kit. Kite! The i said its name. Tub. Tube! The u said its name. The quiet e did it every time.',
    'Leo put on the cape. He flew around the room. Cape, not cap. He knew the difference now.',
...
STORIES['read-the-sentence'] = {
  ...
  more: [{ serial: 'S345', after: 0, alt: 'Four words on a page, read one at a time' }, { serial: 'S346', after: 1, alt: 'A girl looking at a long line of words in her book, one finger at the start and one at the end' }, { serial: 'S1649', after: 2, alt: 'A big capital T at the start, glowing' }, { serial: 'S1651', after: 4, alt: 'The girl reading a whole page, finger sliding' }],
  title: 'From the capital to the period', art: 'S344', cast: [],
  alt: 'A small girl on a rug reading a sentence in a book, her finger at the first capital letter',
  words: [
    'Rosa read the words one at a time. The. Dog. Is. Out. Four words. She said them like a list. She did not know when to stop.',
    'A sentence is not a pile of words. It has a start. It has an end. Rosa had to find both.',
    'Start at the capital letter, said her teacher. The big T. Read across. Stop at the period. The little dot.',
    'The dog is out. Rosa read it smooth. Now it was a sentence. It said something. A dog was out!',
    'The next line. Capital letter. Read across. Period. He ran to the park. Another sentence.',
    'Rosa read the whole page that way. Capital, across, period. Capital, across, period. The story came alive.',
...
STORIES['what-happened'] = {
  ...
  more: [{ serial: 'S348', after: 0, alt: 'The kite flying high on a windy day' }, { serial: 'S1652', after: 1, alt: 'Picture cards of a kite story laid out in the wrong order, the ending card first' }, { serial: 'S1653', after: 3, alt: 'Dad on tiptoe pulling the kite loose' }, { serial: 'S1654', after: 5, alt: 'The boy telling the story in order, three fingers up' }],
  title: 'First, then, last', art: 'S347', cast: [],
  alt: 'A small boy and his dad at a park with a kite stuck high in a tree',
  words: [
    'Sam told the story of his kite. Dad got it down. It went up. It got stuck. His mom looked confused. What happened first?',
    'All of it was true. But it was in the wrong order. The end was at the start.',
    'Sam tried again. First, the kite went up. High, in the wind. Then, it caught in a tree. Stuck.',
    'Last, Dad climbed and got it down. Three little words. First, then, last. Now the day made sense.',
    'Mom nodded. She could see it now. Up, stuck, down. In that order.',
    'Sam told the story again at dinner. First, then, last. Everyone understood the first time.',
...
STORIES['tracing-more-small-letters'] = {
  ...
  more: [{ serial: 'S351', after: 0, alt: 'A g with its tail on the line, looking like a q' }, { serial: 'S352', after: 2, alt: 'The g with its tail hanging below the line' }, { serial: 'S1656', after: 3, alt: 'The z zigzagging across' }, { serial: 'S1657', after: 4, alt: 'A whole row of tails, bumps and zigzags' }],
  title: 'Tails, bumps and zigzags', art: 'S350', cast: [],
  alt: 'A small girl tracing small letters g, m and z on lined paper',
  words: [
    'Mia traced a g. She kept its tail on the line. It looked like a q with a hat. Her teacher smiled.',
    'Some small letters go below the line. Some have bumps. Some zigzag. Mia did not know which was which.',
    'A g has a tail, said her teacher. It hangs below the line. Let it drop. Mia traced it. The tail hung down. A real g.',
    'An m has two bumps. Up, over, up, over. Mia traced it. Two round hills. A z zigzags. Across, down, across.',
    'Tails, bumps, zigzags. Mia found more. A y had a tail. An n had one bump. A w zigzagged too.',
    'She traced a whole row. Every letter its own way. Her teacher put a star on the page.',
...
STORIES['trace-small-letters-3'] = {
  ...
  more: [{ serial: 'S354', after: 0, alt: 'An i and a t that both look like an l' }, { serial: 'S1658', after: 2, alt: 'A dot added on top, an i' }, { serial: 'S1659', after: 4, alt: 'A bar across, a t' }, { serial: 'S1660', after: 5, alt: 'A boy tracing a whole row of small letters with a fat crayon, smiling at the finished row' }],
  title: 'One line, then the rest', art: 'S353', cast: [],
  alt: 'A small boy tracing i, t and k on lined paper, one line down first each time',
  words: [
    'Kai traced an i and forgot the dot. He traced a t and forgot the bar. Both looked like the letter l. Three l\'s in a row.',
    'Each one started the same way, said his teacher. One line down. Then something else. The something else was the part he kept forgetting.',
    'One line down, then a dot on top. An i. Kai traced it. Dot! Not an l anymore.',
    'One line down, then a bar across. A t. Kai traced it. Bar! One line down, then a kick out. A k.',
    'Start the same. Finish your own way. Kai said it as he traced. Line, dot. Line, bar. Line, kick.',
    'He traced a whole row of i, t, k. No more l\'s. Every letter had its finish.',
...
STORIES['trace-small-letters-4'] = {
  ...
  more: [{ serial: 'S357', after: 0, alt: 'A c drawn as a full circle by mistake' }, { serial: 'S1661', after: 2, alt: 'A c like a cup on its side' }, { serial: 'S1662', after: 3, alt: 'A v going down to a sharp point' }, { serial: 'S1663', after: 4, alt: 'An x, two lines crossing' }],
  title: 'Curve, point, cross', art: 'S356', cast: [],
  alt: 'A small girl tracing c, v and x on paper, her finger curving, pointing and crossing',
  words: [
    'Ana traced a c. It came out as a circle. She traced a v. It came out round, like a u. All she drew was round.',
    'Not every letter is round, said her teacher. Some have points. Some cross. Ana looked at the letters again.',
    'A c is a curve. Like a cup on its side. Open on the right. Ana traced it and stopped. Not a circle. A c.',
    'A v goes down to a point and up. Sharp at the bottom. Ana made the point. Sharp!',
    'An x is two lines that cross. One slant. Then the other slant over it. An x. Nothing round at all.',
    'Curve, point, cross. Ana traced them in a row. c, v, x. Each one different. Each one right.',
...
STORIES['trace-small-letters-5'] = {
  ...
  more: [{ serial: 'S360', after: 0, alt: 'A boy tracing three small letters in a row while his teacher leans in with a question' }, { serial: 'S1664', after: 2, alt: 'A line down, then up and over, an n' }, { serial: 'S1665', after: 3, alt: 'Down, round the bottom, and up, a u' }, { serial: 'S1666', after: 5, alt: 'A line down and a small arch that stops, an r' }],
  title: 'Line and arch', art: 'S359', cast: [],
  alt: 'A small boy tracing n, u and r on lined paper, an arch drawn beside them',
  words: [
    'Sam traced an n. Then a u. Then an r. His teacher asked what they had in common. Sam said nothing. They looked different.',
    'He looked again. Each one had a line. Each one had a little arch. The arch went one way or another.',
    'A line down, then up and over. An arch. That is an n. Sam traced it. Down, up, over.',
    'Down, round the bottom, and up. A u. The arch turned upside down. Sam traced it. Down, round, up.',
    'A line down, then a small arch that stops. An r. Just the start of an n. Sam traced it. Down, little arch, stop.',
    'Line and arch. Three letters from one move. Sam wrote run. r, u, n. All three in one word!',
...
STORIES['sun-moon-patterns'] = {
  ...
  more: [{ serial: 'S363', after: 0, alt: 'The sun coming up over the fence' }, { serial: 'S364', after: 2, alt: 'The girl marking a chart with a sun each morning' }, { serial: 'S1668', after: 4, alt: 'The moon a thin curve one night' }, { serial: 'S1669', after: 5, alt: 'The moon round and full a week later' }],
  title: 'The same place every day', art: 'S362', cast: [],
  alt: 'A small girl at a window at dawn, the sun rising over the same fence as yesterday',
  words: [
    ...
    'She decided to check. Every morning for a week. She made a chart. A sun for each day.',
    'Every morning, the east. Over the fence. Every evening, the west. Behind the far hill. Never once did it change.',
    'Then she watched the moon. One night it was a thin curve. A few nights later, half. A week later, round and full.',
    'The moon changed shape too. A little each night. Round, then thin, then round again. Slow, but the same each month.',
    'Rosa showed her chart to the class. Sun in the east. Sun in the west. Moon getting round. Patterns that repeat.',
...
STORIES['water-changes'] = {
  ...
  more: [{ serial: 'S366', after: 0, alt: 'A hard ice cube on a sunny step' }, { serial: 'S1670', after: 2, alt: 'The boy pouring the puddle into a tray' }, { serial: 'S1671', after: 4, alt: 'Ice melting into water in a warm hand and water freezing into ice in a tray, arrows going round' }, { serial: 'S1672', after: 5, alt: 'A hard ice cube again in the morning' }],
  title: 'Ice, water, ice', art: 'S365', cast: [],
  alt: 'A small boy watching an ice cube melt into a puddle on a sunny step',
  words: [
    'Leo left an ice cube on the step. It was hard and cold. Slippery. When he came back, it was a puddle. Where did the ice go?',
    'Nowhere, said Mom. It is right there. The sun warmed it. Heat melts ice into water.',
    'Leo scooped the puddle into a tray. He put the tray in the freezer. Cold. Very cold.',
    'In the morning it was hard again. An ice cube. The same water, frozen back.',
    'Cold makes ice. Heat melts it back. Round and round. The water never left. It just changed.',
    'Leo tried a snowball. Warm hands melted it. Water. The freezer froze it. Ice. He did it three times.',
...
STORIES['animal-needs'] = {
  ...
  more: [{ serial: 'S369', after: 0, alt: 'The puppy whining, the girl puzzled' }, { serial: 'S370', after: 2, alt: 'The puppy eating from its bowl' }, { serial: 'S1674', after: 3, alt: 'The puppy asleep in a soft bed' }, { serial: 'S1675', after: 5, alt: 'The girl checking the bowl, the dish and the bed each morning' }],
  title: 'What the puppy needed', art: 'S368', cast: [],
  alt: 'A small girl kneeling beside a small puppy with a bowl, a water dish and a soft bed',
  words: [
    'The puppy whined. Ana did not know why. It had a collar. It had a name. It had a squeaky toy. It still whined.',
    'A puppy needs more than a name, said Dad. Think about what you need every day.',
    'Food! Ana filled the bowl. The puppy ate. Crunch, crunch. Then it whined again. Water! Ana filled the dish. The puppy lapped and lapped.',
    'It was still tired. Ana made a soft bed in the corner. A blanket. A pillow. A home. The puppy curled up and slept.',
    'Fed. Watered. Rested. The puppy stopped whining. It had what it needed.',
    'Every morning Ana checked three things. Bowl. Dish. Bed. Food, water, a home. The puppy grew big and happy.',
...
STORIES['leaders-near-and-far'] = {
  ...
  more: [{ serial: 'S372', after: 0, alt: 'A mayor at the town hall steps' }, { serial: 'S373', after: 2, alt: 'A mayor cutting a ribbon at a new city park while children watch' }, { serial: 'S1677', after: 4, alt: 'Three circles, small, medium and large, one inside the next' }, { serial: 'S1678', after: 5, alt: 'The boy pointing at each circle in turn' }],
  title: 'Near and far', art: 'S371', cast: [],
  alt: 'A small boy in a town square with three drawn circles behind him: a town, a state, a country',
  words: [
    'Kai heard about a mayor, a governor and a president. All in one day. Three leaders. He thought they all did the same job.',
    'They do the same kind of job, said his teacher. For places of different sizes. Small, medium, big.',
    'The mayor leads the city. That is near. Kai could walk to the town hall. The mayor had cut the ribbon at his park.',
    'The governor leads the whole state. Bigger. Texas is huge. That is farther. The president leads the whole country. That is far.',
    'Kai drew three circles. A small one for the city. A bigger one around it for the state. The biggest for the country.',
    'Mayor in the small circle. Governor in the middle. President in the big one. Near, farther, far.',
...
STORIES['goods-and-services'] = {
  ...
  more: [{ serial: 'S375', after: 0, alt: 'The girl buying a hat, coins on the counter' }, { serial: 'S1679', after: 2, alt: 'The hat in a paper bag' }, { serial: 'S1680', after: 4, alt: 'The girl touching her new haircut, nothing to hold' }, { serial: 'S1681', after: 5, alt: 'A street with a toy shop on one side and a car wash on the other, a girl looking from one to the other' }],
  title: 'The hat and the haircut', art: 'S374', cast: [],
  alt: 'A small girl outside a shop holding a new hat, a barber pole next door',
  words: [
    'Mia bought a hat and got a haircut on the same street. Both cost money. Both came from a shop. Only one of them went home in a bag.',
    'The haircut was not a thing. She could not hold it. So what had she paid for?',
    'The hat was a good. A thing you can hold. Put on. Take off. Keep. Goods go in bags.',
    'The haircut was a service. Work someone did for her. Snip, snip. She could not put it in a bag. But she had it.',
    'Both were paid for with money. And money comes from work. Mom worked at the bakery. That paid for the hat and the haircut.',
    'Mia looked down the street. The toy shop sold goods. The car wash sold a service. She could tell them apart now.',
...
STORIES['maps-of-my-world'] = {
  ...
  more: [{ serial: 'S378', after: 0, alt: 'The boy turning the map every way, puzzled' }, { serial: 'S379', after: 2, alt: 'The sun rising over the fence' }, { serial: 'S1682', after: 3, alt: 'The four directions drawn as a cross on the map' }, { serial: 'S1684', after: 5, alt: 'The boy walking the yard with the map held right' }],
  title: 'Where the sun comes up', art: 'S377', cast: [],
  alt: 'A small boy in a backyard at sunrise pointing east over a fence, a paper map in his other hand',
  words: [
    'Sam had a map of his yard. It said north at the top. He turned it every way. He still could not tell which way was which.',
    'The map needed one true direction to start from. Dad said, wait for the sun.',
    'The sun rose over the fence. That way was east. Sam held the map so east was on the right.',
    'Now north was at the top of the map. To the left of the sun. The tree was to the north. West was behind him. South was to the right.',
    'North, south, east, west. Four directions. Sam drew them on the map as a cross.',
    'He walked the yard. North to the tree. East to the fence. South to the door. The map matched the world.',
...
STORIES['signs-around-town'] = {
  ...
  more: [{ serial: 'S381', after: 0, alt: 'The red eight-sided sign up close' }, { serial: 'S1685', after: 2, alt: 'A green sign with a street name and an arrow' }, { serial: 'S1686', after: 4, alt: 'A yellow sign with a picture of children walking' }, { serial: 'S1687', after: 5, alt: 'The girl pointing at each sign in turn' }],
  title: 'The sign that stopped everyone', art: 'S380', cast: [],
  alt: 'A small girl at a street corner watching every car stop at a red eight-sided sign',
  words: [
    ...
    'The sign told them. All of them, at once. That is what signs do.',
    'A stop sign says stop. Red, eight sides. A green sign says the street\'s name. Oak Street. That way.',
    'A yellow sign says slow down, something is ahead. This one had children on it. A school.',
    'Rosa read the signs on the way home. Stop. Oak Street. School. She knew what each one meant.',
    'She made a sign for her room. Red, eight sides. Stop. Her brother stopped at the door. It worked.',
...
STORIES['symbols-of-our-country'] = {
  ...
  more: [{ serial: 'S384', after: 0, alt: 'The Liberty Bell with its crack' }, { serial: 'S385', after: 2, alt: 'The Statue of Liberty holding her torch' }, { serial: 'S1689', after: 4, alt: 'The flag waving' }, { serial: 'S1690', after: 5, alt: 'The boy drawing all four on one page' }],
  title: 'The bell and the torch', art: 'S383', cast: [],
  alt: 'A small boy looking at four pictures on a classroom wall: a cracked bell, a green statue, an old mission and a flag',
  words: [
    'Leo saw a picture of a bell. It had a big crack in it. Why keep a broken bell? His teacher said it was famous.',
    'Famous for what? A crack is a crack. Leo did not get it.',
    'The Liberty Bell rang for freedom, long ago. People came to hear it. The crack came later. They kept it anyway.',
    'The Statue of Liberty holds a torch to welcome people. She stands in the harbor. Green and tall.',
    'The Alamo is an old fort in Texas. People remember what happened there. The flag stands for the whole country.',
    'Each one stands for something bigger than itself. Leo drew all four. The bell, the torch, the fort, the flag.',
...
STORIES['hundreds-tens-ones'] = {
  ...
  more: [{ serial: 'S387', after: 0, alt: 'Pennies rolling all over the table' }, { serial: 'S388', after: 1, alt: 'The girl losing count at fifty, hands in her hair' }, { serial: 'S1700', after: 3, alt: 'Ten pennies stacked, then ten stacks pushed together' }, { serial: 'S1701', after: 4, alt: 'Three hundreds, four stacks and two loose in a row' }],
  ...
  words: [
    'Mia tipped her penny jar onto the table. Pennies rolled all over, cold and coppery. Some fell on the floor. She started counting. One, two, three.',
    'By forty she lost her place. Her brother walked past and said something. She started again. By fifty she lost it again. The pile was too big for counting one at a time.',
    'Dad sat down beside her. Stack them, he said. Ten in a stack. Mia made a stack. Then another. The pile of loose pennies got smaller.',
    'Ten stacks pushed together made a hundred. Mia slid ten stacks into a block. A hundred. Then another block. Two hundred. Then a third.',
    'Three hundreds. Then four stacks that did not make a hundred. Then two loose pennies. Three, four, two. Three hundred forty-two.',
    'Mia said it out loud. Three hundred forty-two pennies. She had counted them all without counting them all. Dad said that was the trick.',
    'Big numbers are hundreds, tens and ones. Stack them and the counting does itself.',
  ],
};
STORIES['adding-with-regrouping'] = {
  ...
  more: [{ serial: 'S390', after: 0, alt: 'Two strips of ten and seven loose stickers' }, { serial: 'S391', after: 1, alt: 'Loose stickers sliding off the desk' }, { serial: 'S1702', after: 2, alt: 'Seven loose and five loose slid into one row of twelve' }, { serial: 'S1703', after: 4, alt: 'A new strip of ten with two left over, four strips in all' }],
  ...
  words: [
    'Sam had 27 stickers. Two strips of ten and seven loose ones. Stars and rockets. His aunt gave him 15 more. One strip and five loose. He wanted one number for all of them.',
    'He tried counting every sticker. The loose ones kept sliding off the desk. He got to twenty and a rocket fell on the floor. He started over.',
    'Add the loose ones first, said his aunt. Seven and five. Sam pushed them into one row. Twelve loose stickers.',
    'Twelve was more than ten. Ten of them made a whole new strip. Two were left over. Sam lined the new strip up with the others.',
    'Now he had two strips, one strip, and the new strip. Four strips. And two loose. Four tens and two ones. Forty-two.',
    'Sam counted the strips again to be sure. Four. Forty-two stickers. He stuck the two loose ones on his notebook. No more sliding.',
    'Ones first, then tens. When ten ones pile up, they become a new ten.',
  ],
};
STORIES['subtracting-with-regrouping'] = {
  ...
  more: [{ serial: 'S393', after: 0, alt: 'Four strings of ten beads and two loose ones' }, { serial: 'S394', after: 1, alt: 'The girl reaching for eight loose beads and finding two' }, { serial: 'S1704', after: 3, alt: 'One string snipped open, ten beads spilling loose' }, { serial: 'S1705', after: 5, alt: 'The finished necklace beside two strings and four loose beads' }],
  ...
  words: [
    'Rosa had 42 beads. Four strings of ten and two loose. Blue and silver. Her necklace needed 18. She reached for eight loose beads.',
    'She found only two. Two beads cannot give you eight. Rosa sat back. She was stuck. Eighteen beads and only two to start with.',
    'Grandma looked over. Open a string, she said. Rosa snipped one string of ten. Ten beads spilled into the loose pile.',
    'Now she had three strings and twelve loose beads. Twelve take away eight. Four loose beads left.',
    'Three strings take away one string. Two strings left. Two strings and four loose. Twenty-four beads left over.',
    'She checked by adding back. Twenty-four and eighteen. Forty-two. It matched. The necklace went on, and it fit.',
    'Ones first, then tens. When the ones are not enough, borrow a ten. Open it up.',
  ],
};
STORIES['money'] = {
  about: 'a pocket of coins counted the way the cashier counts, biggest first',
  more: [{ serial: 'S396', after: 0, alt: 'Coins in a jumble on the counter' }, { serial: 'S397', after: 2, alt: 'The boy starting with a penny, unsure' }, { serial: 'S1708', after: 3, alt: 'A quarter, two dimes and a nickel lined up' }, { serial: 'S1709', after: 5, alt: 'Three pennies at the end of the row, the gum in his hand' }],
  ...
  words: [
    'Leo emptied his pocket onto the counter. A quarter, two dimes, a nickel and three pennies. He wanted gum. The cashier waited.',
    'Leo started with a penny. One. Then a dime. Eleven? He was not sure. The coins were all mixed up. So was he.',
    'The cashier slid the biggest coin to the front. Start big, she said. Count on from there.',
    'A quarter. Twenty-five. A dime. Thirty-five. Another dime. Forty-five. A nickel. Fifty.',
    'Then the pennies, one at a time. Fifty-one. Fifty-two. Fifty-three. Fifty-three cents. Enough for the gum, with three cents left.',
    'Leo counted it again on the way home, biggest first. It came out the same. He bought a sticker with the three cents next time.',
    'Start with the biggest coin and count on. Count dimes by tens and nickels by fives.',
  ],
};
STORIES['rows-and-columns'] = {
  about: 'a carton of eggs that a girl counted without touching a single egg',
  more: [{ serial: 'S399', after: 0, alt: 'An egg slipping as she counts one by one' }, { serial: 'S400', after: 2, alt: 'The girl looking at the shape of the carton' }, { serial: 'S1710', after: 3, alt: 'One row of six eggs' }, { serial: 'S1711', after: 5, alt: 'A tray with three rows of four' }],
  ...
  words: [
    'Dad asked Ana how many eggs were in the carton. She started to count them one by one. On the fourth egg it slipped. She caught it just in time.',
    'Counting every egg was slow. And a little dangerous. Eggs do not like being picked up.',
    'So she looked at the shape instead. Two rows. Six in each row. She did not touch a single egg.',
    'Six and six. Twelve. Twelve eggs. Dad nodded. Then he brought out a bigger tray.',
    'Three rows. Four in each. Four, and four, and four. Twelve again. Ana counted it two ways. Same answer.',
    'Rows and columns. Count the rows. Count one row. Add that number once for every row. Ana never picked up an egg again.',
    'Count the rows, count how many in each row. Add that number once for every row.',
  ],
};
STORIES['vowel-teams'] = {
  about: 'a boat with two vowels, and the one that did the talking',
  more: [{ serial: 'S402', after: 0, alt: 'The word boat with the o and a side by side' }, { serial: 'S403', after: 1, alt: 'The girl sounding out a word stiffly like a robot, her dad trying not to laugh' }, { serial: 'S1714', after: 3, alt: 'The o glowing and the a quiet' }, { serial: 'S1715', after: 4, alt: 'A rain cloud and a train, more vowel teams' }],
  ...
  words: [
    'Lena read the sign by the pond. B, o, a, t. Bo-at. Two sounds in the middle. That was not a word she knew.',
    'The o and the a were next to each other. Two vowels in a row. She said them both. It sounded like a robot.',
    'Dad said, they are a team. When two vowels sit together, only one of them talks. The first one.',
    'The o said its name. Oh. The a stayed quiet. Boat. One long sound from two vowels. Lena looked up. There was the boat.',
    'She tried more. Rain. The a talked, the i stayed quiet. Rain. Train. Coat. Goat. Every team worked the same way.',
    'On the way home she read every sign. Road. Meat. Seed. The first vowel talked every time.',
...
STORIES['two-syllable-words'] = {
  ...
  more: [{ serial: 'S405', after: 0, alt: 'The long word on the sign, the boy frozen' }, { serial: 'S406', after: 1, alt: 'His teacher clapping twice' }, { serial: 'S1716', after: 2, alt: 'The word rabbit split in the middle with a small gap' }, { serial: 'S1717', after: 4, alt: 'The two halves pushed back together, the rabbit hopping past' }],
  title: 'Rab, bit', art: 'S404', cast: [],
  alt: 'A boy reading a sign that says rabbit by a garden, a rabbit peeking from the lettuce',
  words: [
    'Rabbit. Six letters. Kai looked at the word on the garden sign and froze. It was too long to read all at once.',
    'His teacher said, clap it. Kai clapped. Rab, bit. Two claps. Two parts. The long word had a middle.',
    'He split the word in the middle. Rab. Bit. He read the first part. Rab. He read the second. Bit.',
    'Then he pushed them back together. Rab-bit. Rabbit! The long word was two short ones holding hands.',
    'A rabbit hopped out of the lettuce. Kai read the sign again. Rabbit. Then the next sign. Car-rot. Carrot.',
    'Every long word in the garden came apart in the middle. Let-tuce. Pep-per. Kai read them all.',
...
STORIES['reading-for-meaning'] = {
  ...
  more: [{ serial: 'S408', after: 0, alt: 'The girl closing the book, saying only a dog' }, { serial: 'S409', after: 2, alt: 'Dad holding up four fingers' }, { serial: 'S1718', after: 3, alt: 'The girl and her dog on the page at the beach' }, { serial: 'S1719', after: 5, alt: 'The dog digging up a bone, the girl laughing' }],
  ...
  words: [
    ...
    'She had read every word. She had not held on to any of them. The story had gone in one ear and out the other.',
    'Dad held up four fingers. Who? Where? What happened? Why? Read it again and catch those four.',
    'Ana read it again. Who? A girl and her dog. Where? At the beach. What happened? The dog dug up a bone.',
    'Why? The dog smelled it under the sand. Now Ana could tell the whole story. Beginning to end.',
    'She told it to her brother. Girl, dog, beach, bone, smell. He said it sounded like a good book. It was.',
...
STORIES['word-meaning-from-context'] = {
  ...
  more: [{ serial: 'S411', after: 0, alt: 'The boy stopped at a hard word, frowning' }, { serial: 'S412', after: 1, alt: 'Mom pointing at the words around it' }, { serial: 'S1720', after: 2, alt: 'The enormous dog not fitting through the door' }, { serial: 'S1721', after: 4, alt: 'The boy finding another new word and reading on' }],
  ...
  words: [
    'Leo hit a new word. Enormous. He stopped. He did not know it. He wanted to give up and close the book.',
    'His mom said, do not stop. Read the words around it. They will tell you.',
    'The enormous dog could not fit through the door. Could not fit through the door. Leo thought about that.',
    'A dog that could not fit through a door. That was a very big dog. Enormous had to mean very big.',
    'He read on. Another new word. Gobbled. The dog gobbled the whole bowl in one second. Gobbled meant ate fast.',
    'Leo did not stop again. Every new word had friends around it. The friends told him what it meant.',
...
STORIES['complete-sentences'] = {
  ...
  more: [{ serial: 'S414', after: 0, alt: 'The words ran fast alone on a line' }, { serial: 'S415', after: 1, alt: 'The teacher asking who ran' }, { serial: 'S1722', after: 3, alt: 'The dog ran fast, with a capital and a period' }, { serial: 'S1723', after: 5, alt: 'A teacher reading a page of sentences and smiling while the girl waits proudly' }],
  ...
  words: [
    ...
    'Ran fast told what happened. It did not tell who. A sentence needs both. Someone has to do the thing.',
    'Rosa wrote it again. The dog ran fast. Now there was a who. The dog. And a what. Ran fast.',
    'A capital letter at the start. The. A period at the end. Fast. A whole sentence.',
    'She wrote more. The cat sat. The bird sang. The boy laughed. Each one had a who and a what.',
    'Her teacher read them all. Every one was complete. Rosa never left out the who again.',
...
STORIES['describing-sentences'] = {
  ...
  more: [{ serial: 'S417', after: 0, alt: 'The words the cat sat on a page, plain' }, { serial: 'S418', after: 2, alt: 'A fluffy cat sitting very still on a warm sunny step, a girl studying it closely' }, { serial: 'S1724', after: 3, alt: 'The same sentence with fluffy, quietly and warm added' }, { serial: 'S1725', after: 5, alt: 'The brother reading the new sentence and nodding' }],
  title: 'The fluffy cat', art: 'S416', cast: [],
  alt: 'A girl on a porch step writing while a fluffy cat sits beside her in the sun',
  words: [
    'Mia wrote: the cat sat. It was true. The cat was right there, sitting. Her brother read it and shrugged. So what?',
    'The sentence did not show anything. Which cat? How did it sit? Where? Her brother could not see it.',
    'Mia looked at the cat. Fluffy. Sitting very still. On the warm step. She added those words.',
    'The fluffy cat sat quietly on the warm step. Now her brother could see it. Fluffy said what the cat was like.',
    'Quietly said how it sat. Warm said what the step was like. Three words, and the sentence had a picture in it.',
    'Her brother read it again. He said, oh, that cat. He could see it now. Mia wrote three more sentences with pictures in them.',
...
STORIES['tell-a-story-2'] = {
  ...
  more: [{ serial: 'S420', after: 0, alt: 'The boy telling the story out of order, his friend confused' }, { serial: 'S421', after: 2, alt: 'The tooth wobbling at breakfast' }, { serial: 'S1726', after: 3, alt: 'The tooth falling out at the lunch table' }, { serial: 'S1727', after: 5, alt: 'The tooth going under the pillow' }],
  title: 'The wobbly tooth', art: 'S419', cast: [],
  alt: 'A boy holding a tiny tooth in his palm, a pillow behind him',
  words: [
    'Sam told the story of his tooth. He said the pillow part first. Then the wobble. Then the lunch part. His friend was lost.',
    'It was all true. But it was mixed up. The end was at the start. The start was at the end.',
    'First, my tooth wobbled. At breakfast. It wiggled when I chewed.',
    'Next, it fell out at lunch. Right into my sandwich. Last, I put it under my pillow. And in the morning, a coin!',
    'First, next, last. Three words, and the day lined up. His friend nodded. Now it made sense.',
    'Sam told it again to his grandma. First, next, last. She said it was the best tooth story she had heard.',
...
STORIES['then-and-now'] = {
  ...
  more: [{ serial: 'S423', after: 0, alt: 'The old classroom, one room, wooden desks' }, { serial: 'S424', after: 1, alt: 'Grandma as a girl, drawn in the old room' }, { serial: 'S1728', after: 3, alt: 'A modern classroom with a screen and many rooms' }, { serial: 'S1729', after: 4, alt: 'A timeline with then on the left and now on the right' }],
  title: 'Then and now', art: 'S422', cast: [],
  alt: 'A girl standing in an old one-room schoolhouse with a chalkboard and a bell rope',
  words: [
    'Lena visited the school her grandmother went to. One room. A chalkboard. A bell on a rope. Wooden desks in rows. Lena thought it was a museum.',
    'It was a school, said Grandma. My school. She pointed at a desk by the window. That one was mine.',
    'Then: a chalkboard. A bell on a rope. One room for every grade. Lena tried to picture it. All the kids together.',
    'Now: a screen. A buzzer. Many rooms. A gym. Lena\'s school had all of that.',
    'Grandma was a girl then. Lena is a girl now. A timeline puts them in order. Then on the left. Now on the right.',
    'Lena drew the timeline. Grandma\'s desk. Her own desk. Sixty years between them, on one line.',
...
STORIES['good-citizens'] = {
  ...
  more: [{ serial: 'S426', after: 0, alt: 'The wallet on the sidewalk, money showing' }, { serial: 'S427', after: 1, alt: 'The boy looking around, nobody watching' }, { serial: 'S1730', after: 3, alt: 'A boy holding out a lost wallet to a worried man checking his pockets at the corner' }, { serial: 'S1731', after: 4, alt: 'The boy handing the wallet to a grateful man' }],
  ...
  words: [
    ...
    'Then he thought about the person who lost it. Someone was looking for this. Someone was worried right now.',
    'Honesty: give it back. Doing your part: pick up your own mess. Respect: listen when others talk. Kai knew the three.',
    'He found the man at the corner, checking his pockets. Kai held out the wallet. The man\'s face changed.',
    'Thank you, the man said. He shook Kai\'s hand. Kai felt taller than before.',
    'At school, the class voted on the reading corner rug. More votes won. Kai voted blue. Green won. He was fine with green.',
...
STORIES['producers-and-consumers'] = {
  ...
  more: [{ serial: 'S429', after: 0, alt: 'Lemons, sugar and a pitcher on the table' }, { serial: 'S430', after: 2, alt: 'Neighbors lining up with coins' }, { serial: 'S1732', after: 3, alt: 'Ten dollars counted into a jar' }, { serial: 'S1733', after: 5, alt: 'Six dollars of costs set aside, four left' }],
  title: 'The lemonade stand', art: 'S428', cast: [],
  alt: 'Two children at a lemonade stand in a front yard, a neighbor holding out coins',
  words: [
    'Ana and her brother made lemonade and sold it. A pitcher. Paper cups. A sign. Neighbors came and paid. At the end, Ana wanted to know if they had made money.',
    'They had spent some first. Lemons. Sugar. Cups. Six dollars, from the grocery store.',
    'They were the producers. They made the lemonade. The neighbors were consumers. They bought it and drank it.',
    'Ana counted the jar. Ten dollars. Ten dollars in. But six dollars had gone out first.',
    'Ten minus six. Four dollars left. That was what they had really made.',
    'Next time, they used lemons from the tree. No cost. Ten dollars in, and ten dollars left. Ana liked that math better.',
...
STORIES['maps-of-our-town'] = {
  ...
  more: [{ serial: 'S432', after: 0, alt: 'The tiny book drawn on the map' }, { serial: 'S433', after: 1, alt: 'The key in the corner with a book, a tree and a cross' }, { serial: 'S1734', after: 3, alt: 'A finger counting three blocks north' }, { serial: 'S1735', after: 4, alt: 'The boy on the library steps, map folded' }],
  title: 'The key on the map', art: 'S431', cast: [],
  alt: 'A boy on library steps holding a town map, a small book symbol on it',
  words: [
    'Sam looked at the town map. There was a tiny book drawn on it. Why a book? He had no idea. There was a tree too. And a cross.',
    'In the corner was a box with pictures and words. The key. A book means library. A tree means park. A cross means hospital.',
    'Sam found his house on the map. Then the book. Three blocks north. He counted the blocks with his finger. One, two, three.',
    'North is at the top. Sam turned the map so north was up. Then he walked. Three blocks. And there it was. The library.',
    'He looked at the map again. The park was two blocks east. The hospital was far, on the other side.',
    'The key told him what every picture meant. The blocks told him how far. Sam could find anything in town now.',
...
STORIES['services-in-our-town'] = {
  ...
  more: [{ serial: 'S435', after: 0, alt: 'The fire truck at a smoky corner' }, { serial: 'S436', after: 2, alt: 'A fire truck, a library and a park on one busy town street' }, { serial: 'S1736', after: 4, alt: 'The library, the school and the park in a row' }, { serial: 'S1737', after: 6, alt: 'A police officer helping at a crossing' }],
  title: 'Who sent the truck', art: 'S434', cast: [],
  alt: 'A girl watching a fire truck pass a library and a park on a town street',
  words: [
    'A fire started on the corner. Small, in a trash can. A fire truck came fast. Rosa asked who had sent it. Nobody had called it, she thought.',
    'Someone had paid for that truck long before the fire. Someone had trained the crew. Someone kept the truck ready.',
    'The town did, said Dad. The town sends the fire truck. The town lends the library book. The town keeps the park and the school.',
    'And the police. The officer at the crossing. The town pays for that too. Services, for everyone.',
    'Rosa counted the services on her street. Fire. Police. Library. School. Park. Five, on one street.',
    'She had thought they just were there. Now she knew someone made them be there. The town.',
...
STORIES['saving-for-a-goal'] = {
  ...
  more: [{ serial: 'S438', after: 0, alt: 'The kite in the shop window with its price' }, { serial: 'S439', after: 1, alt: 'The empty jar with the kite picture taped on' }, { serial: 'S1738', after: 2, alt: 'Two dollars going in, week one' }, { serial: 'S1739', after: 4, alt: 'The jar full and the kite in the sky' }],
  title: 'The kite jar', art: 'S437', cast: [],
  alt: 'A boy holding a jar with a few dollars inside, a picture of a kite taped to it',
  words: [
    'The kite cost twelve dollars. Red, with a long tail. Leo\'s jar had nothing in it. He wanted the kite now. Now was not going to work.',
    'He got two dollars a week for feeding the cat. How many weeks? Leo taped a picture of the kite to the jar.',
    'Week one. Two dollars in the jar. Week two. Four. Week three. Six. Halfway.',
    'Leo counted ahead. Twelve divided by two. Six weeks. Three more to go.',
    'Week four, eight. Week five, ten. Week six, twelve! The jar was full. Leo carried it to the shop.',
    'The kite flew higher than the roof. It had taken six weeks. It felt like it was worth six weeks.',
...
STORIES['hard-or-soft'] = {
  ...
  more: [{ serial: 'S441', after: 0, alt: 'Four things on a mat, the girl looking at them' }, { serial: 'S442', after: 2, alt: 'A hand pressing a hard rock and a soft pillow' }, { serial: 'S1740', after: 3, alt: 'A wet sponge dripping next to a dry towel' }, { serial: 'S1741', after: 4, alt: 'The four things sorted into pairs' }],
...
STORIES['equivalent-fractions'] = {
  about: 'two pizzas, an argument over who got more, and slices that matched crust to crust',
  more: [{ serial: 'S444', after: 1, alt: 'A dad with his arms folded, smiling, while a boy and a girl argue over a pizza box' }, { serial: 'S445', after: 2, alt: 'One big half slice and two quarter slices lined up crust to crust, matching exactly' }, { serial: 'S1749', after: 4, alt: 'A pizza cut into eight thin slices, the girl holding up two skinny ones' }, { serial: 'S1750', after: 5, alt: 'Four thin slices lined up beside one big half slice, covering the same space' }, { serial: 'S1751', after: 6, alt: 'Three same-size pizzas cut in two, four and eight, the same amount of each shaded' }],
  ...
  words: [
    'Leo and his sister Ava ordered two pizzas the same size. One came cut into two big pieces, the other into four smaller ones. Leo took one big piece. Ava took two small ones and said she had more, because two is more than one.',
    'Leo was sure she was wrong, but he could not say why. Two pieces did look like more. The box smelled of oregano, and the cheese was going cold. Prove it, their dad said. Do not shout it.',
    'So they laid Ava\'s two pieces beside Leo\'s one and lined up the crusts. The edges matched exactly. Two quarters covered the very same pizza as one half.',
    'The pizza had not changed. Only the cuts had. Cutting each half in two doubled the bottom number, from two to four. Taking twice as many pieces doubled the top, from one to two. Double both and nothing changes.',
    'The next Friday, a pizza came cut into eight thin slices. Ava grabbed two. Same as last week, she said. Leo laughed, because two eighths was a skinny strip. She had changed the bottom number and not the top.',
    'To match one half, she needed four of the eight slices, because one times four is four and two times four is eight. She took two more, and the crusts lined up again.',
    'That is an equivalent fraction. Multiply the top and the bottom by the same number, and the amount stays put. Change only one, and the amount changes.',
  ],
};
STORIES['comparing-fractions'] = {
  about: 'a birthday choice between one third and one eighth, and the big number that fooled a girl',
  more: [{ serial: 'S447', after: 0, alt: 'The girl choosing the eighth, her hand shooting up while her uncle holds the knife over the chocolate cake' }, { serial: 'S448', after: 1, alt: 'A thick third slice next to a thin eighth slice on two plates' }, { serial: 'S1752', after: 2, alt: 'Two same-size circles on a napkin, one cut into three big wedges and one into eight thin ones' }, { serial: 'S1753', after: 4, alt: 'Five thin cake slices on one plate and three on another, every slice the same size' }, { serial: 'S1754', after: 3, alt: 'A cake cut into many thin slices beside the same cake cut into a few thick ones' }],
  title: 'Which slice is bigger?', art: 'S446', cast: [],
  alt: 'A girl at her birthday party eyeing a big chocolate cake while her uncle holds the cake knife',
  words: [
    'At Maya\'s birthday party, her uncle held a knife over the chocolate cake and offered her a choice. One third of the cake, or one eighth. Maya loved big numbers, and eight is much bigger than three. She chose the eighth.',
    'Then her cousin Ben got one third. His slice was a thick wedge with frosting piled on the edge. Hers was a thin sliver she could almost see through. She had picked the bigger number and gotten the smaller cake. How?',
    'Her uncle drew two circles on a napkin, both the same size. He cut one into three pieces and the other into eight. Cut a cake into three and each piece is big. Cut the same cake into eight and each piece is small.',
    'The bottom number counts how many pieces the whole was cut into. More pieces means thinner slices. So when the top numbers match, one and one, the smaller bottom wins. One third beats one eighth.',
    'Later he cut a second cake into eight equal slices for the guests to take home. Ben took three. Maya took five. This time there was no trick. Every slice was an eighth, the same size, so more slices meant more cake. Five eighths beat three eighths.',
    'That is how to compare fractions. Same bottom, the bigger top wins. Same top, the smaller bottom wins. When neither matches, rename them so the bottoms match, then look again. And never trust a big number until you know what it counts.',
  ],
};
STORIES['fractions-on-a-line'] = {
  about: 'a model grasshopper, a ruler with unmarked steps and the walk from zero to three quarters',
  more: [{ serial: 'S450', after: 0, alt: 'A close look at one inch of a wooden ruler with three small unmarked lines, a boy squinting at it' }, { serial: 'S451', after: 1, alt: 'A pile of straw bits cut too short and too long, a glue bottle drying in its cap' }, { serial: 'S1755', after: 2, alt: 'A green bead sliding along the ruler in four equal steps' }, { serial: 'S1756', after: 4, alt: 'Six straw legs cut to the same length, laid in a row beside the ruler' }, { serial: 'S1757', after: 5, alt: 'A winding road with signposts at equal steps, a straw grasshopper hopping from one to the next' }],
  title: 'Marks on the ruler', art: 'S449', cast: [],
  alt: 'A boy at a desk building a model grasshopper out of drinking straws, a wooden ruler beside him',
  words: [
    'Sam was building a model grasshopper for the science fair. Its legs were bits of drinking straw, and each one had to be three quarters of an inch long. His ruler showed 0 and 1. Between them sat three little marks with no numbers at all. Where was three quarters?',
    'He guessed and cut. Too short. He guessed again. Too long. The pile of straw bits grew, and the glue was drying in its cap. Six legs to make, and not one was right. Those little marks had to mean something. But what?',
    'His teacher put a green bead at 0 and slid it along. The three marks cut the space from 0 to 1 into four equal steps. Four steps made one whole inch, so each step was one quarter.',
    'Step: one quarter. Step: two quarters. Step: three quarters. The bead stopped on the third mark. The bottom number, four, told Sam how many steps make a whole. The top number, three, told him how many steps to walk.',
    'Sam cut all six legs at the third mark, and every one matched. Then he noticed the middle mark. Two steps out of four, exactly halfway. Two quarters and one half were the same spot on the road.',
    'A number line is a road with signposts. Cut 0 to 1 into equal steps, and every fraction is a place on that road. The bottom number sets the size of each step. The top number says how far to walk.',
  ],
};
STORIES['building-fractions'] = {
  about: 'five wooden blocks, three fifths built by hand and two granola bars shared by three',
  more: [{ serial: 'S453', after: 1, alt: 'The girl pushing wooden blocks around on the rug, a pencil and paper set aside' }, { serial: 'S454', after: 2, alt: 'Three blocks pulled forward from the row of five, each block the same size' }, { serial: 'S1758', after: 3, alt: 'The three blocks split into a pile of two and a pile of one' }, { serial: 'S1759', after: 4, alt: 'Two granola bars each cut into three equal pieces on a plate, three children reaching in' }, { serial: 'S1760', after: 5, alt: 'Unit pieces, fifths and thirds, stacking up into whole bars' }],
  title: 'Blocks of a fifth', art: 'S452', cast: [],
  alt: 'A girl and her little brother kneeling on a rug beside five wooden blocks joined into one long bar',
  words: [
    'Nadia had five wooden blocks that fit together into one long bar. The bar was one whole. Her little brother Omar asked her to show him three fifths. She stared at the blocks. A fraction was a thing you wrote, not a thing you built. Or was it?',
    'She wrote it on paper. Three over five. Omar shrugged. He wanted to see it, not read it. The blocks smelled of pine and clicked as she pushed them around, and then she saw it.',
    'Each block was one fifth of the bar. She pulled three forward. One fifth, one fifth, one fifth. Three fifths, sitting on the table where anyone could count them.',
    'Omar pushed two of the three blocks together and left one apart. Was that still three fifths? It was: two fifths and one fifth, the same three blocks in two piles. Push all five together and it was five fifths, the whole bar again.',
    'At snack time their mom brought two granola bars for three kids: Nadia, Omar and a friend. Nadia cut each bar into three equal pieces, thirds, just like her blocks. Each kid took one piece from each bar. Two bars shared by three people is two thirds apiece.',
    'A fraction is built from unit pieces, one fifth or one third at a time. It can be taken apart in more than one way. It is also a sharing that has not been finished yet. Once you can build it, you can see it.',
  ],
};
STORIES['prefixes-and-suffixes'] = {
  about: 'a boy with a long spelling list and the short words hiding inside it',
  more: [{ serial: 'S456', after: 1, alt: 'A big sister covering the front of a word card with one finger while her little brother leans in, surprised' }, { serial: 'S457', after: 2, alt: 'A plain little word creature trying on a hat for its front and a cape for its back in a dress-up closet' }, { serial: 'S1764', after: 3, alt: 'The little word creature taking off its hat and cape, standing plain and proud' }, { serial: 'S1765', after: 4, alt: 'The boy crossing long words off his list, a small word peeking out of each one' }, { serial: 'S1766', after: 5, alt: 'The next morning, a teacher handing the boy his spelling paper with every word right and a gold star' }],
  title: 'Happy, unhappy, happily', art: 'S455', cast: [],
  alt: 'A boy slumped at a kitchen table over a long spelling list, his big sister leaning in to help',
  words: [
    'Diego had a spelling list with happy, unhappy and happily on it. Three long words to learn, he thought, and there were fifteen more below them. He groaned and put his head on the table. The paper smelled like fresh printer ink.',
    ...
    'They were one word wearing costumes. Un goes on the front and means not, so unhappy means not happy. A piece on the front is a prefix. Ly goes on the end and turns happy into a way of doing something. A piece on the end is a suffix.',
    'Take the costume off, his sister said, and the small word is still standing there.',
    'Diego went down the list hunting for costumes. Hopeful: hope, plus ful, which means full of. Full of hope. Hopeless: hope, plus less, which means without. Without hope. Reread: re, which means again, plus read. Read it again. The long list was shrinking into short words he already knew.',
    'He finished in ten minutes and spelled every word right the next morning.',
    'Half the long words you will ever meet are short words in costume. Find the front piece, find the end piece, and read the middle. Once you can see the seams, long words stop being scary.',
  ],
};
STORIES['fact-or-opinion'] = {
  about: 'a dog show, a scale and the sentence nobody could check',
  more: [{ serial: 'S459', after: 0, alt: 'A man proudly lifting a fluffy brown dog while the girl writes in her notebook' }, { serial: 'S460', after: 2, alt: 'A boy with a beagle and a woman with a poodle arguing by the dog pens' }, { serial: 'S1767', after: 3, alt: 'The fluffy brown dog sitting on a big scale, the needle steady' }, { serial: 'S1768', after: 4, alt: 'A teacher and the girl looking at a notebook together at a classroom desk' }, { serial: 'S1769', after: 5, alt: 'The girl handing her finished story to her teacher, both smiling' }],
  title: 'Check it or argue it', art: 'S458', cast: [],
  alt: 'A busy county dog show, a girl reporter with a notebook among dogs and their owners',
  words: [
    'At the county dog show, Priya was writing for the school paper. Her neighbor lifted his fluffy dog, Biscuit, and told her two things. Biscuit weighs thirty pounds. Biscuit is the best dog here. Priya wrote both down.',
    'The next morning her teacher circled the second sentence in red. Priya had heard it with her own ears. Wasn\'t that enough to make it true?',
    'She went back to prove it and could not. A boy by the next pen was sure his beagle was the best. A woman with a poodle was sure hers was. Nobody changed anybody\'s mind.',
    'The first sentence was different. Priya put Biscuit on the scale, and the needle stopped at thirty. Anyone could check it and get the same answer. That is a fact. The second sentence could only be argued, because it was what her neighbor felt. That is an opinion.',
    'Her teacher showed her the clue words: best, worst, beautiful, boring. They tell you how somebody feels, not what is true. Opinions are fine to print, she said, as long as you say whose they are.',
    'Priya fixed her story. Biscuit weighs thirty pounds. His owner thinks he is the best dog at the show. Both sentences were true now.',
    'Every sentence you read is one or the other. Ask, could I check this with a scale, a map or a clock? If yes, it is a fact. If all you can do is argue, it is an opinion, and it belongs to the person who said it.',
  ],
};
STORIES['sequence-and-cause'] = {
  about: 'a muddy kitchen floor and the little words that turned a tangle into a story',
  more: [{ serial: 'S462', after: 1, alt: 'A guilty wet dog sitting by the back door beside a dripping mop' }, { serial: 'S463', after: 2, alt: 'A dog rolling happily in a muddy yard in the rain' }, { serial: 'S1770', after: 3, alt: 'The boy pointing from the muddy floor back toward the rainy window, explaining' }, { serial: 'S1771', after: 4, alt: 'The wet dog shaking water off just inside the door, drops flying' }, { serial: 'S1772', after: 5, alt: 'The boy mopping the kitchen floor while the dog watches and his mom smiles' }],
  title: 'Because and so', art: 'S461', cast: [],
  alt: 'A boy and his mom in the kitchen doorway staring at a trail of muddy paw prints across the floor',
  words: [
    'Sam came home to a trail of muddy paw prints across the kitchen floor. His mom stood in the doorway, keys still in her hand. What happened here? she asked. Sam knew. He had seen all of it. But when he tried to say it, the words came out in a tangle.',
    'The dog. The rain. The door. The mud. His mom shook her head. That told her what, but not in what order, and not why. The dog looked guilty, and the mop was dripping.',
    'So Sam tried the order words. First, it started to rain. Next, the dog rolled in the yard. Then I opened the door. Finally, the dog ran across the floor. Now his mom could see it happen, one step at a time.',
    'But she still wanted to know why. Sam tried a small word. The floor is muddy because the dog came in from the rain. Because pointed backward, at the reason.',
    'Or the other way around. The dog was soaked, so the floor got muddy. So pointed forward, at what happened next. The rain was the cause. The muddy floor was the effect.',
    'His mom handed him the mop. And the effect of that, she said, is that you are cleaning it.',
    'A cause is why. An effect is what happened. Because looks back at the cause, so looks ahead to the effect, and first and then tell the order. Pick the right little word, and a tangle turns into a story.',
  ],
};
STORIES['states-of-matter'] = {
  about: 'an ice cube, a glass and a kettle, and the morning they turned out to be the same water',
  more: [{ serial: 'S465', after: 1, alt: 'A puddle spreading across a plate where the ice cube used to be, a kettle whistling behind' }, { serial: 'S466', after: 2, alt: 'Water being poured into a tall glass, taking its shape' }, { serial: 'S1779', after: 3, alt: 'Steam rising from a kettle spout and spreading through the kitchen air' }, { serial: 'S1780', after: 4, alt: 'A boy touching a foggy kitchen window, tiny water drops on the glass, an ice tray going into the freezer behind him' }, { serial: 'S1781', after: 5, alt: 'An ice cube, a glass of water and a cloud of steam side by side, the same water in three states' }],
  ...
  words: [
    'On Saturday morning, Theo dropped an ice cube on a plate and left it on the counter. He poured water into a glass. His mother put the kettle on the stove. Three different things, he thought. Ice, water and steam.',
    'When he came back, the ice cube was gone. In its place was a puddle, spreading across the plate. The kettle was whistling, and the kitchen window had gone foggy. Where did the ice go? And where did that fog come from?',
    'His mother tapped the plate. The ice cube kept its square shape until it warmed. That is a solid. Then it melted and spread out flat, taking the shape of the plate. That is a liquid. Pour it into a glass and it becomes glass-shaped.',
    'The kettle was the next step. Heat the water enough and it boils. It turns into steam, a gas that spreads to fill the whole kitchen. You cannot hold a gas or pour it. It goes wherever there is room.',
    'Theo touched the foggy window. It was cold and wet. The steam had cooled on the glass and turned back into tiny drops of water. He filled the ice tray and put it in the freezer. By lunch the water was solid again.',
    'Everything around you is a solid, a liquid or a gas. A solid keeps its shape. A liquid takes the shape of its container. A gas fills whatever holds it. Heat moves matter up that list, and cooling brings it back down. Same water, the whole way through.',
  ],
};
STORIES['forces-and-motion'] = {
  about: 'a wagon of pumpkins, a grassy hill and the three forces that moved it',
  more: [{ serial: 'S468', after: 1, alt: 'The wagon slowing to a stop in thick grass while the boy pulls hard on the handle' }, { serial: 'S469', after: 2, alt: 'A dad kneeling by the wagon wheels, pointing at the grass' }, { serial: 'S1782', after: 3, alt: 'The boy pulling and the girl pushing the pumpkin wagon up the grassy hill together' }, { serial: 'S1783', after: 4, alt: 'The empty wagon rolling back down the hill on its own, the children watching' }, { serial: 'S1784', after: 5, alt: 'Three arrows around a rolling ball: a push, the rub of friction and the pull of gravity' }],
  title: 'Pushes and pulls', art: 'S467', cast: [],
  alt: 'A red wagon loaded with three pumpkins at the bottom of a grassy hill, a boy standing beside it',
  words: [
    'The red wagon sat at the bottom of the hill, loaded with three pumpkins for the fall sale at the top. Jamal stood beside it and waited. Nothing happened. Wagons, it turns out, do not move by themselves.',
    'He grabbed the handle and pulled, and the wagon rolled, squeaking, up the sidewalk. Then his sister steered it onto the grass to take a shortcut. The wagon slowed and stopped, even though Jamal was still pulling hard. The grass was fighting him. Why?',
    'His dad knelt by the wheels. A force is a push or a pull, he said, and nothing starts or stops without one. Jamal\'s pull was one force. The grass was another. It rubbed against the wheels and slowed them. That rubbing is called friction.',
    'So Jamal pulled and his sister pushed from behind. Two forces in the same direction. The wagon crawled up the grass and reached the top, and the pumpkins sold in an hour.',
    'At the top, Jamal let go of the empty wagon for one second. It rolled straight back down the hill without anyone touching it. Gravity had pulled it, the same pull that makes a dropped ball fall. At the bottom, the grass rubbed it slower and slower until it stopped.',
    'Nothing moves without a force. A push or a pull gets things going, friction slows moving things down, and gravity pulls everything toward the ground. Watch anything roll, slide or fall, and ask which force did that.',
  ],
};
STORIES['life-cycles'] = {
  about: 'a jar of pond water and the eggs that turned into something new every few weeks',
  more: [{ serial: 'S471', after: 1, alt: 'Tadpoles with long tails swimming in quick circles in a jar' }, { serial: 'S472', after: 2, alt: 'A tadpole with tiny back legs and a shrinking tail, seen up close' }, { serial: 'S1785', after: 3, alt: 'An egg, a tadpole, a tadpole with legs and a frog arranged in a circle' }, { serial: 'S1786', after: 4, alt: 'A bean seed, a sprout and a flowering bean plant in a row of pots on a sunny sill' }, { serial: 'S1787', after: 5, alt: 'A girl letting little frogs go at the muddy edge of a pond' }],
  ...
  words: [
    'Rosa scooped a clump of clear jelly from the pond into a jar on the classroom windowsill. Inside the jelly were hundreds of little black dots. Her brother said they were dirt. She said they were eggs. Nobody could tell.',
    'About a week later the dots had wriggled free. They had tails and swam in quick, jerky circles. They were tadpoles. Rosa fed them boiled lettuce and drew them every Friday.',
    'After about six weeks, two tiny back legs appeared. A few weeks after that came front legs, and the tails began to shrink. Every time Rosa looked, the thing in the jar was different. Was it even the same animal?',
    'It was. Her teacher drew a circle on the board: egg, tadpole, tadpole with legs, frog. Each stage leads to the next. And a grown frog lays eggs, which starts the circle again. That circle is called a life cycle.',
    'A bean does it too, her teacher said. Seed, sprout, plant, flower, and the flower makes new seeds. A butterfly goes egg, caterpillar, chrysalis, butterfly. The stages look nothing alike, but each one makes the next.',
    'In June, Rosa carried the little frogs back to the pond and let them go at the muddy edge. The next spring she went back to look. Floating by the reeds was a fresh clump of clear jelly, full of black dots.',
    'Every living thing goes around its own circle of stages. A frog, a bean, a butterfly and you. The shapes change, but the circle keeps turning.',
  ],
};
STORIES['paragraph-shape'] = {
  about: 'a paragraph about a dog that a girl built one sentence at a time',
  more: [{ serial: 'S474', after: 0, alt: 'A long messy heap of scribbled sentences on a notebook page beside a sleeping dog' }, { serial: 'S475', after: 2, alt: 'The scruffy dog trotting in with a pair of lost shoes in its mouth' }, { serial: 'S1800', after: 3, alt: 'The girl reading her sentences one at a time, pointing at each with her pencil' }, { serial: 'S1801', after: 4, alt: 'The dog sneaking a slice of birthday cake off the kitchen counter' }, { serial: 'S1802', after: 5, alt: 'A wooden table with a wide top resting on four sturdy legs' }],
  ...
  words: [
    'Lily had to write a paragraph about her dog, Pepper, and she had a hundred things to say. He brings in the newspaper. He finds her lost shoes. He once ate a whole birthday cake. She wrote it all in one heap, and it sounded like a shopping list.',
    'Her teacher asked one question. What is this paragraph about? My dog, said Lily. Yes, said the teacher, but what about him? Every sentence in the heap was true. Not one of them said the big thing.',
    'So she wrote the big thing first. Pepper is the best helper in our house. That was the idea, and it went in the first sentence. Then the heap became proof. He brings in the newspaper. He finds my lost shoes.',
    'Then she read each sentence and asked the test question: is this about the same idea? The newspaper, yes. The shoes, yes. The birthday cake? That was not helping. That was stealing.',
    'The cake did not get thrown away. It got a paragraph of its own, with its own first sentence. Pepper is also a thief. Now Lily had two paragraphs, two ideas, and nothing in the wrong place.',
    'Her teacher drew it as a table. The first sentence is the tabletop, the idea everything rests on. The details are the legs, and a leg from a different table makes it wobble.',
    'That is the shape of a paragraph. One idea in the first sentence, details after it holding it up, and a new paragraph for every new idea.',
  ],
};
STORIES['explain-how'] = {
  about: 'a paper boat, a card of steps and the two folds that went missing',
  more: [{ serial: 'S477', after: 1, alt: 'A boy holding a torn paper hat, stuck and puzzled' }, { serial: 'S478', after: 2, alt: 'Hands opening a folded paper hat at the bottom and flattening it into a diamond' }, { serial: 'S1803', after: 3, alt: 'The boy folding paper slowly and writing a line on a card after each fold' }, { serial: 'S1804', after: 4, alt: 'A little paper boat floating in a sink full of water' }, { serial: 'S1805', after: 5, alt: 'A stranger\'s hands following a card of steps, a paper boat taking shape' }],
  title: 'The paper boat', art: 'S476', cast: [],
  alt: 'Two boys at a kitchen table with sheets of paper, one writing folding steps on a card for the other',
  words: [
    'Marcus could fold a paper boat with his eyes closed. His friend Eli could not, so Marcus wrote the steps on a card for him. Fold the paper in half. Fold the top corners down. Fold the bottom strips up. Pull it open. Easy.',
    'Eli tried it at the kitchen table. He got a paper hat, and then he got stuck. Pull what open? Every way he pulled, the hat tore. He brought Marcus the ripped hat and the card.',
    'Marcus read his card and frowned. Every step on it was right, but his hands did more than it said. After the hat, you open it at the bottom and flatten it into a diamond. Then you fold the bottom corners up and flatten it again. He had skipped what he no longer noticed doing.',
    'So he folded one slowly and wrote down every move as his hands made it. What you need: one sheet of paper. Then seven steps, in the order they really happen. Seven, not four.',
    'Eli followed the new card without asking a single question. Hat. Diamond. Smaller diamond. Pull the top corners apart. The boat popped open, and it floated in the sink.',
    'Explaining how to do something has two parts: say what is needed, then give every step in order. The test is to picture a stranger following your words. A missing step leaves them stuck, and steps out of order leave them with a mess.',
  ],
};
STORIES['give-a-reason'] = {
  about: 'a class that wanted a pet, and the girl who said why properly',
  more: [{ serial: 'S480', after: 0, alt: 'A classroom of children shouting with their hands in the air while the teacher waits calmly' }, { serial: 'S481', after: 2, alt: 'A boy standing at his desk with his mouth open, stuck on his second reason' }, { serial: 'S1806', after: 4, alt: 'A teacher writing four lines on the board while the girl watches' }, { serial: 'S1807', after: 5, alt: 'A little orange fish swimming in its new tank on the classroom windowsill' }, { serial: 'S1808', after: 6, alt: 'The class cheering around the new fish tank' }],
  ...
  words: [
    'Mia\'s class wanted a pet. When the teacher asked why, twelve kids shouted at once. Because pets are cool! Because! Just because! The teacher waited for the noise to stop. That is not a reason, she said. That is a wish.',
    ...
    'Then Leo stood up for a hamster. I think we should get a hamster, because hamsters are fun. The class clapped. The teacher nodded and asked him for a second reason. Leo opened his mouth, closed it and sat down.',
    'Mia put up her hand and said it in order. I think our class should get a fish. Because a fish would teach us to take care of something every day. Because a fish is quiet and will not bother the class next door.',
    'Then she said it again, in new words. A fish would be the perfect classmate. The teacher wrote it on the board in four lines: what I think, a reason, a reason, and what I think again.',
    'They voted, and the fish won. It got a name, Captain Bubbles, and a job chart.',
    'That is how to give a reason. Say what you think. Say because, with two real reasons. Then say it again at the end in fresh words. A wish only gets clapped for. A reason gets a fish.',
  ],
};
STORIES['equal-groups'] = {
  about: 'three bags of apples and the boy who was too slow counting them',
  more: [{ serial: 'S483', after: 1, alt: 'The aunt answering with a smile while her nephew is still counting, the line of customers growing' }, { serial: 'S484', after: 2, alt: 'Apples tipped out onto the table in three neat rows of five' }, { serial: 'S1809', after: 3, alt: 'A tray of apples in rows and columns, a finger counting down one column' }, { serial: 'S1810', after: 4, alt: 'The boy turning a tray of twelve apples sideways, four rows becoming three' }, { serial: 'S1811', after: 5, alt: 'Equal groups all over the market: egg cartons, bundles of carrots and baskets of peaches' }],
  ...
  words: [
    'Ben was helping at his aunt\'s apple stall at the farmers market. A customer pointed at three paper bags, five apples in each, and asked how many apples that was. Ben counted every apple with his finger. One, two, three. The customer sighed. Ben lost his place and started over.',
    'His aunt could say the answer before he opened the second bag. Fifteen. Every time. Was she guessing? The apples smelled sweet, and the line was getting longer.',
    'She tipped the apples onto the table in three rows of five. Five, ten, fifteen, she said, tapping one row at a time. Three groups of five is three fives added together: five plus five plus five. That is all multiplying is. Three times five is fifteen.',
    'Rows and columns like that have a name, she said. An array. Count the rows, count how many are in each row, and multiply.',
    'The next customer wanted four bags with three apples in each. Ben made four rows of three. Twelve. Then he turned the tray sideways, and the rows became three rows of four. Still twelve. Four groups of three and three groups of four were the same apples, seen from a new side.',
    'The first number says how many groups. The second says how many are in each one. Whenever things come in equal groups, you do not have to count them one by one. Groups times how many in each group, and the counting is already done.',
  ],
};
STORIES['times-tables'] = {
  about: 'the fact that would not stick, and the rectangle that made it stay',
  more: [{ serial: 'S486', after: 1, alt: 'A grandfather and his granddaughter at a kitchen table, a paper napkin and a pen between them' }, { serial: 'S487', after: 2, alt: 'A napkin covered in dots in a rectangle, turned sideways on the table' }, { serial: 'S1812', after: 3, alt: 'The girl counting by fives on her fingers while her grandfather smiles' }, { serial: 'S1813', after: 4, alt: 'The rectangle of dots split down the middle, five columns on one side and two on the other' }, { serial: 'S1814', after: 5, alt: 'The girl marching to school in the morning, saying numbers in time with her steps' }],
  ...
  words: [
    'Every fact in the times table stuck for Lena except one. Seven times eight. She learned it every night and lost it every morning, like a sock that kept vanishing in the wash.',
    'Her grandfather asked what seven times eight even meant. Fifty-six, she said. No, he said, what does it mean? Lena did not know. She had been memorizing a sound, not a thing.',
    'He drew a rectangle of dots on a napkin, seven across and eight down. Then he turned the napkin sideways. Eight across and seven down. Seven eights and eight sevens were one rectangle, looked at two ways. Every fact works both ways, so learning half the table gets you the whole thing.',
    'Then he showed her how to build the hard fact from easy ones. She already knew her fives: every fact ends in five or zero. Five eights are forty. She knew her twos, because twos just double. Two eights are sixteen. Forty and sixteen make fifty-six.',
    'The rectangle split right down the middle to prove it: five columns on one side, two on the other, seven columns in all.',
    'He had one more trick. Say five, six, seven, eight. Fifty-six is seven times eight. The numbers march in order. Lena said it all the way to school.',
    'The facts up to ten times ten are the tools every bigger problem uses. Practice a few at a time, a little each day. A fact you can picture, and build from facts you know, is a fact you keep.',
  ],
};
STORIES['sharing-equally'] = {
  about: 'twelve cookies, four friends and a fight that ended with a deal',
  more: [{ serial: 'S489', after: 0, alt: 'Four children grabbing cookies from one plate and arguing' }, { serial: 'S490', after: 2, alt: 'Four plates with three cookies on each, all matching' }, { serial: 'S1815', after: 3, alt: 'The girl holding up three fingers and then four, checking her work' }, { serial: 'S1816', after: 4, alt: 'Two more friends coming through the door, everyone turning to the girl with the plate' }, { serial: 'S1817', after: 5, alt: 'Six children at the table, two cookies on every plate' }],
  ...
  words: [
    'Twelve cookies, four friends, and nobody wanted to be the one who got fewer. Everyone grabbed. Somebody got five, somebody got just two, and the arguing started before anyone took a bite.',
    'Grace took the plate back. There had to be a fair way. Twelve was too many to split by just looking. She could feel the warm cookies through the plate, and everyone was staring at her.',
    'She dealt them out like cards. One for each friend, around the table. Then another round. Then another. No favorites, no grabbing, no arguing. The plate was empty, and every plate had three. Twelve divided by four is three.',
    'She could check it backward, too. Three cookies on each of four plates is three times four, and three times four is twelve. Dividing undoes multiplying. The same three numbers make both facts.',
    'Then the doorbell rang. Two more friends, and now there were six. Nobody grabbed this time. Everyone looked at Grace. She asked herself the backward question: what times six makes twelve? Two. So each of the first four gave one cookie back, and all six had two.',
    'Dividing is sharing out equally, one round at a time, like dealing cards. When a division looks hard, flip it around and ask the multiplying question: what times the divisor makes the total? The answer to that is the answer to this. Twelve divided by six is two, because six times two is twelve.',
  ],
};
STORIES['add-subtract-1000'] = {
  about: 'two jars of marbles and the column that overflowed',
  more: [{ serial: 'S492', after: 0, alt: 'A boy with his eyes squeezed shut, trying to add two jars of marbles in his head' }, { serial: 'S493', after: 1, alt: 'A crowded sum on paper with one column squeezed too full, the boy scratching his head' }, { serial: 'S1818', after: 2, alt: 'A teacher pointing at the ones column while the boy carries a small one to the next column' }, { serial: 'S1819', after: 3, alt: 'Marbles sorted into bags of a hundred, cups of ten and loose ones' }, { serial: 'S1820', after: 4, alt: 'The boy counting marbles into a bag for his cousin' }],
  title: 'Column by column', art: 'S491', cast: [],
  alt: 'Two big jars of marbles on a desk, a boy writing a sum in neat columns on paper',
  words: [
    'Hugo had 256 marbles in one jar and 378 in another, and he wanted one number for the whole collection. He added them in his head and got a different answer every time.',
    'The trouble was the ones. Six and eight make fourteen, and fourteen will not fit in one column. He wrote the whole 14 there anyway, and the answer came out enormous and wrong. Where was the extra ten supposed to go?',
    'His teacher showed him to go column by column, ones first. Six and eight is fourteen. Write the 4, and carry the ten to the tens column. Tens: five and seven and the carried one make thirteen. Write the 3, and carry the hundred. Hundreds: two and three and one make six. 634 marbles.',
    'Every number up to a thousand is built the same way, from hundreds, tens and ones. 634 is six hundreds, three tens and four ones. Each column holds one kind, and a ten that spills over belongs next door.',
    'Then his cousin asked for 125 marbles. Two steps: put the jars together, then give some away. Ones first again. Four ones are not enough to take away five, so Hugo borrowed a ten, and fourteen take away five is nine. Two tens take away two is zero. Six hundreds take away one is five. 509 left.',
    'Adding and subtracting big numbers is small columns, in order. Carry when a column makes ten or more. Borrow when a column runs short. And read a two-step problem all the way through before you start.',
  ],
};
STORIES['elements-of-art'] = {
  about: 'one cup drawn seven ways, once for each element',
  more: [{ serial: 'S495', after: 0, alt: 'A girl drawing a cup again and again, a pile of cup drawings growing beside her' }, { serial: 'S496', after: 2, alt: 'A cup drawn three ways: as an outline, as a flat cutout shape and shaded round' }, { serial: 'S1827', after: 3, alt: 'The cup drawn three more ways: bright red, rough with a dry brush, and tiny on a wide empty table' }, { serial: 'S1828', after: 4, alt: 'The same cup drawn with a thick bold line beside one drawn with a thin wobbly line' }, { serial: 'S1829', after: 5, alt: 'Seven cup drawings pinned in a row on a classroom wall' }],
  title: 'A cup, seven ways', art: 'S494', cast: [],
  alt: 'A girl at an art table with seven small drawings of the same cup in a row, each done differently',
  words: [
    'Ines drew a cup, and her art teacher said, again. Ines drew it again. Again, said the teacher, but this time only lines. Then only a flat shape. By the fourth cup, Ines was sure she was being punished.',
    'She was not. Each cup was built from just one of the seven elements of art, the pieces every picture is made of. The teacher lined them up across the table so Ines could see them side by side.',
    'Line was just the edges, a mark traveling around the cup. Shape was the outline filled in flat, like a paper cutout. Form was shaded on one side, so the cup looked round enough to pick up.',
    'Color turned it red. Texture made it rough, dragged on with a dry brush. Space put the cup small and far away, with a whole empty table around it. Value used no color at all, only light, dark and every gray between.',
    'Then the teacher took the line cup and drew it twice more. Once with a thick, heavy line, and the cup looked loud and sure of itself. Once with a thin, wobbly line, and the same cup looked nervous. Ines laughed. One element had changed the mood.',
    'Seven cups, and none looked like the others. Ines had thought art was talent. It turned out to be ingredients.',
    'The elements of art are line, shape, form, color, texture, space and value. Look for them in any picture, from a scribble to a masterpiece, and you will see how it was built.',
  ],
};
STORIES['the-color-wheel'] = {
  about: 'three jars of paint and every color that came out of them',
  more: [{ serial: 'S498', after: 1, alt: 'Red and yellow paint puddles meeting and swirling into orange' }, { serial: 'S499', after: 2, alt: 'A brush mixing blue and green paint into a blue-green swirl' }, { serial: 'S1830', after: 3, alt: 'A painted color wheel with the warm half glowing and the cool half in shade' }, { serial: 'S1831', after: 4, alt: 'A painting of a warm sunset over a calm blue sea with a small orange boat' }, { serial: 'S1832', after: 5, alt: 'A pink sky fading into deep blue night at the edges of the painting' }],
  title: 'Three jars', art: 'S497', cast: [],
  alt: 'A boy at an art table with three jars of red, yellow and blue paint, mixed puddles between them',
  words: [
    'Ravi had three jars of paint, red, yellow and blue, and a picture in his head that needed orange, green and purple. He asked for more jars. His art teacher said the three jars already held everything.',
    'He did not believe her until he mixed. Red and yellow made orange. Yellow and blue made green. Blue and red made purple. Three primary colors had made three secondary colors, and he had not opened a new jar.',
    'Then he mixed blue with a little green and got blue-green, a color between the two. That kind is called tertiary: a primary mixed with the secondary beside it.',
    'The teacher had him set the colors in a circle. One half glowed: red, orange and yellow, the warm colors, like fire and sun. The other half sat back: green, blue and purple, the cool colors, like water and shade.',
    'Ravi painted a sunset with the warm half and a calm sea with the cool half. Then he put a small orange boat on the blue water, and it jumped off the page. Orange and blue sit across the wheel from each other. Complementary colors make each other look brighter.',
    'For the sky he added white to red and got pink, a tint. For the night coming in at the edges he added black to blue, a shade.',
    'Red, yellow and blue are the primaries, and every other color on the wheel can be mixed from them. Three jars hold the whole wheel.',
  ],
};
STORIES['looking-at-a-picture'] = {
  about: 'a painting looked at four times, in the order most people get backward',
  more: [{ serial: 'S501', after: 0, alt: 'The girl frowning and turning away from the painting after a quick glance' }, { serial: 'S502', after: 1, alt: 'A painting of a woman at a window holding a letter, gray light and one red chair' }, { serial: 'S1833', after: 2, alt: 'Light pouring in from the left of the painting and landing brightest on the letter' }, { serial: 'S1834', after: 4, alt: 'The girl pointing at the red chair in the painting while explaining to her teacher' }, { serial: 'S1835', after: 5, alt: 'The girl and her teacher standing back from the painting, the girl nodding thoughtfully' }],
  title: 'Four looks', art: 'S500', cast: [],
  alt: 'A girl standing in front of a large painting in a museum, her teacher beside her, four footprints on the floor leading up to it',
  words: [
    'Zoe looked at the painting for three seconds and said she did not like it. Her teacher said that was step four, and asked her to go back to step one.',
    'Step one: describe. Say only what is there. A woman at a window. A letter in her hands. Gray light. A red chair. Zoe was not allowed to say whether any of it was good. Just what was there.',
    'Step two: analyze. How is it made? The light comes in from the left and lands brightest on the letter. The chair is the only warm color in a room full of gray and blue.',
    'Where did your eye go first, the teacher asked. To the letter. That is the focus, she said, and the painter put it there on purpose, with the brightest light in the whole picture.',
    'Step three: interpret. What does it mean, and why do you think so? The letter matters to her. The red chair says the room is not as cold as it looks. Zoe had to point at the painting to prove each idea.',
    'Step four: judge. Now the judging had something under it. Zoe still did not love the painting. But she could say what it was doing and how, and that the red chair was a small, smart choice.',
    'Describe, analyze, interpret, then judge. Most people start at judging, the least interesting step, and stop there. Three looks before the verdict, and the verdict gets better.',
  ],
};
STORIES['three-levels-of-government'] = {
  ...
  more: [{ serial: 'S504', after: 0, alt: 'A crew in orange vests working on a highway overpass as a boy rides by' }, { serial: 'S505', after: 2, alt: 'A city hall with a library, a fire truck and a street crew in front of it' }, { serial: 'S1845', after: 3, alt: 'The pink granite capitol in Austin and, far behind it, the white Capitol dome in Washington' }, { serial: 'S1846', after: 4, alt: 'A boy standing at a microphone at a city council meeting, council members listening' }, { serial: 'S1847', after: 5, alt: 'A three-story building with local, state and national governments on its floors, a small boy at the front door' }],
  title: 'Three levels', art: 'S503', cast: [],
  alt: 'A boy on a bike beside a pothole on a city street, a highway overpass in the distance, a letter with a stamp in his basket',
  words: [
    'On Saturday, Tomas hit a pothole on his bike, rode past a crew fixing the highway overpass and mailed a birthday card to his grandmother. Three ordinary things. Then his uncle asked him who fixes the pothole, who fixes the highway and who delivers the card.',
    'The government, Tomas said. His uncle asked, which one? Tomas did not know there was more than one. It felt like a trick question, and the pothole was still there.',
    'There are three, his uncle said, stacked like floors in a building. The ground floor is local: your city, led by a mayor and a city council. It fixes streets, runs the library and sends the fire truck. The pothole belongs to them.',
    'The middle floor is the state: Texas, led by a governor and a legislature in Austin. It builds the highways, runs the state parks and gives out driver\'s licenses. The top floor is national: the United States, led by a president and Congress in Washington, D.C. It prints the money and delivers the mail.',
    'Tomas wanted the pothole gone, so his uncle took him to a city council meeting. Tomas stood up and described the hole, how deep it was and where. A council member wrote it down. Two weeks later, a city truck filled it.',
    'Local, state and national. Three levels, three leaders, three sets of jobs. The closer the level, the easier it is to walk in and be heard, even when you are nine.',
  ],
};
STORIES['how-we-decide'] = {
  about: 'a school rule, a walk signal and a class vote, and who each one covers',
  more: [{ serial: 'S507', after: 0, alt: 'A dad holding his son back at a crosswalk, the pedestrian signal showing a red hand' }, { serial: 'S508', after: 2, alt: 'A family, a class and a team, each gathered in its own small circle' }, { serial: 'S1848', after: 3, alt: 'Lawmakers in a grand chamber at the Texas Capitol in Austin raising their hands to vote' }, { serial: 'S1849', after: 4, alt: 'A class of children raising their hands in a field trip vote, the zoo side a little bigger' }, { serial: 'S1850', after: 5, alt: 'The whole class at the zoo, the museum fans grinning at a giraffe' }],
  title: 'Rule or law?', art: 'S506', cast: [],
  alt: 'A boy slowing to a walk in a school hallway, a crosswalk signal glowing red through the window',
  words: [
    'Noah got told off twice in one day. Once at school for running in the hall, and once on the way home for stepping into the street before the walk signal came on. His dad said one of those was a rule and one was a law. Noah said they felt exactly the same.',
    'They both told him what to do. They both had someone watching. But would a police officer ever stop a kid for running down a school hallway? Noah laughed. Of course not. So what made them different?',
    'Who they cover, his dad said. A rule is for one group: a family, a class, a team. The school made the hall rule, and it stops at the school door. A law is for everyone in a city, a state or the whole country, and breaking it has a set punishment.',
    'The walk signal law covers everyone in Texas. The state legislature in Austin made it. Laws for the whole country come from Congress. The President carries them out, and the courts decide what they mean when people disagree.',
    'The next day, Noah\'s class voted on a field trip. Fourteen kids chose the zoo and ten chose the museum. More than half picked the zoo, so the zoo won by four. That is majority rule.',
    'The museum kids groaned, but they still got to go, and they still get a vote next time. That is the deal that makes voting work.',
    'Rule or law, ask who it covers.',
  ],
};
STORIES['earning-and-choosing'] = {
  about: 'eleven dollars, a book and a ball, and the thing that got left on the shelf',
  more: [{ serial: 'S510', after: 0, alt: 'Six dollars from chores and five from a birthday card laid out on a bed and counted' }, { serial: 'S511', after: 1, alt: 'A kind cashier shaking her head at the counter while the girl holds up her money' }, { serial: 'S1851', after: 2, alt: 'The girl walking out of the store with the book, glancing back at the ball on the shelf' }, { serial: 'S1852', after: 3, alt: 'A lemonade stand at the end of a driveway on a sunny Saturday' }, { serial: 'S1853', after: 4, alt: 'The girl dropping a dollar into a glass savings jar, a new ball under her arm' }],
  ...
  words: [
    'Hana had eleven dollars. Six came from chores and five from a birthday card. At the store she found the book she wanted for eight dollars and the ball she wanted for seven. She counted her money twice. It did not get any bigger.',
    'She tried every trick. Maybe the ball was on sale. It was not. Maybe she could pay the rest next week. The cashier smiled and shook her head. Eight and seven make fifteen, and eleven is not fifteen.',
    'That is scarcity. There is never enough for everything, so every choice gives something up. Hana chose the book. The ball stayed on the shelf, and the ball was the real cost of the book. The thing you give up has a name: the opportunity cost.',
    'She still had three dollars, and she still wanted that ball. So on Saturday she set up a lemonade stand at the end of the driveway. Anyone in the country is free to start a business like that. It is called free enterprise.',
    'She sold twelve cups at fifty cents each, six dollars in all, and paid her mom back one dollar for the sugar and cups. Now she had eight. She bought the ball for seven and dropped the last dollar into her savings jar.',
    'Every time you spend money, time or attention, you are not spending it on something else. The trick is not to avoid that. It is to know what you are giving up, and to choose on purpose.',
  ],
};
...
STORIES['summarizing'] = {
  ...
  more: [{ serial: 'S513', after: 1, alt: 'A movie scene with a dog, a pair of silly boots and a busy market' }, { serial: 'S514', after: 2, alt: 'A school bus squealing to a stop, the boy counting on three fingers' }, { serial: 'S1854', after: 3, alt: 'A girl crossing a moonlit desert, following the stars toward a hidden city' }, { serial: 'S1855', after: 4, alt: 'The boy walking home, a lost map drifting away on the wind' }, { serial: 'S1856', after: 6, alt: 'The friend on the bus smiling out the window, the whole story in his head' }],
  ...
  words: [
    ...
    'The bus squealed to a stop, and he had thirty seconds. He grabbed the three questions his teacher always asked. Who was it about? What happened? How did it end?',
    'A girl lost her map, crossed a desert without it, and found the hidden city by following the stars. No breakfast, no dog, no song. Eli said, oh, that sounds good, and got on the bus knowing exactly what the movie was about.',
    'Noah tested the rest. Could he cut the joke about the boots and still have the story? Yes, so it was a detail. Could he cut the lost map? No. Without it, there was no desert and no story.',
    'He had almost added, and it was the best movie ever. He was glad he had not. That was his opinion, not the story.',
    'A summary keeps the big events and drops the small details. It stays in order and leaves your opinion out. The test is the bus stop: if a friend hears it in a minute and knows the story, you summarized it.',
  ],
};
STORIES['making-inferences'] = {
  about: 'muddy boots, a sigh, and the thing nobody said out loud',
  more: [{ serial: 'S516', after: 1, alt: 'A boy jumping into a big puddle on the way home from school, mud flying' }, { serial: 'S517', after: 3, alt: 'A little girl pointing at a car in the driveway while her big sister shakes her head' }, { serial: 'S1857', after: 4, alt: 'A girl reading a storybook in bed, the page showing a girl with an umbrella sighing at a rainy window' }, { serial: 'S1858', after: 5, alt: 'An umbrella and a sigh drawn side by side, both pointing to a rain cloud' }, { serial: 'S1859', after: 6, alt: 'A magnifying glass held over a pair of muddy boots' }],
  ...
  words: [
    ...
    'Because she had two things. A clue in front of her, the mud on the boots. And something she already knew, that her brother could not pass a puddle without jumping in it. A clue plus what you know makes an inference.',
    'Her little sister had a different idea. Mom sighed because the car is broken, she said. Tessa looked around. No clue anywhere said anything about a car. That was not an inference. It was just a guess.',
    'That night, Tessa read a story that began: Maya grabbed her umbrella and sighed at the window. It never said rain. It never said Maya was unhappy. Tessa knew both before she reached the next line.',
    'The umbrella was the clue for rain. The sigh was the clue for unhappy. Tessa knew what umbrellas and sighs mean, and the writer had trusted her to know.',
    'Writers do not say everything. They show muddy boots and a sigh, and they trust you to work out the rest. An inference is a clue in the text plus what you already know. No clue, no inference.',
  ],
};
STORIES['similes-and-metaphors'] = {
  about: 'a brave friend, and the two ways a girl found to say how brave',
  more: [{ serial: 'S519', after: 0, alt: 'The biggest kid in school looming over a small boy while a girl steps in front of him without blinking' }, { serial: 'S520', after: 1, alt: 'A girl frowning at a growing pile of dull, crossed-out words on her notebook page' }, { serial: 'S1860', after: 3, alt: 'A girl standing tall, a lion\'s shadow stretching behind her' }, { serial: 'S1861', after: 4, alt: 'The girl drawn as a lion outright, mane and tail and all, still in her school clothes' }, { serial: 'S1862', after: 5, alt: 'A noisy school cafeteria like a zoo, and beyond it a hallway as quiet as a library' }],
  ...
  words: [
    ...
    'Then she stopped describing Maya and compared her to something else. Maya is as brave as a lion. The little word as made it a simile, a comparison that uses like or as.',
    'Then she went further. Maya is a lion. No like, no as. Maya simply was one, for the length of the sentence. That is a metaphor: saying one thing is another thing it plainly is not.',
    'Neither sentence is meant to be taken literally. Maya has no mane and no tail. But both put a lion in the reader\'s head, fast, and a lion says more than a page of very brave ever could.',
    'Once she knew the trick, Rosa heard it everywhere. At lunch her brother said the cafeteria was a zoo. A metaphor. Her teacher said the hallway was as quiet as a library. A simile. Neither was meant literally, and both were perfectly clear.',
    'Like or as makes a simile. Saying one thing is another makes a metaphor. Both compare, and both let a reader feel what plain words only describe.',
  ],
};
STORIES['text-structure'] = {
  about: 'a chapter that made no sense until a boy read its road signs',
  more: [{ serial: 'S522', after: 0, alt: 'A boy lost on a road with no signs, a thick book under his arm' }, { serial: 'S523', after: 1, alt: 'A teacher pointing at the small words between sentences, lit up like stepping stones' }, { serial: 'S1863', after: 2, alt: 'A volcano erupting in steps: rumbling, then smoking, then lava spilling over' }, { serial: 'S1864', after: 4, alt: 'Two kinds of volcanoes side by side, a wide gentle one and a tall steep one' }, { serial: 'S1865', after: 6, alt: 'A winding road with blank signs at every turn, a boy walking it with confidence' }],
  title: 'Road signs', art: 'S521', cast: [],
  alt: 'A boy reading a thick science book while a winding road with blank road signs rises out of its pages',
  words: [
    ...
    'His teacher told him to stop reading the sentences and read the little words between them instead. First. Then. Because. As a result. However. Jamal thought she was joking. Those were the words you skipped.',
    'They were the signs. First, then and finally meant a sequence, one step after another, like the steps of a volcano erupting. Because and as a result meant cause and effect: this happened, so that happened.',
    'Both, unlike and however meant comparing, two things set side by side. And the words problem and solved meant a problem and its solution. Four shapes, and the little words told him which one he was on.',
    'Jamal went back to the chapter. The first section said first, then, finally: a sequence. The next said because three times in one paragraph: causes and effects. The last said unlike and however: a comparison of two kinds of volcanoes. He knew what was coming before it came.',
    'When he saw because, he knew an effect was on its way. When he saw however, he knew a difference was coming. The chapter made sense on the first try.',
    'Every text is built one of a few ways, and signal words tell you which. Read the signs, and you will know the shape of the road before you walk it.',
  ],
};
STORIES['forms-of-energy'] = {
  about: 'one kitchen before breakfast, and the five kinds of energy a boy counted in it',
  more: [{ serial: 'S525', after: 1, alt: 'The boy standing in the kitchen with a pencil and an empty page, looking around' }, { serial: 'S526', after: 2, alt: 'A toaster glowing orange inside with bread in it' }, { serial: 'S1875', after: 3, alt: 'Every machine in the kitchen with little arrows going in and out of it' }, { serial: 'S1876', after: 4, alt: 'A glowing lamp with warm light and a little heat shimmering above the bulb' }, { serial: 'S1877', after: 5, alt: 'The boy rubbing his cold hands together, then tapping a spoon on his bowl' }],
  ...
  words: [
    ...
    'He stood in the kitchen with a pencil and nothing on the page. The lamp was on. The toaster was ticking. His dad was listening to the radio, and the fan was turning. He had been in this room a thousand times and never seen energy in it.',
    'Then he looked again. The lamp gave off light. The toaster glowed with heat, and he could smell the bread starting to brown. The radio made sound. The outlet fed the fan electrical energy, and the fan turned it into spinning blades: mechanical energy, the energy of moving things.',
    'Five kinds, one kitchen, before he had even eaten. But the best part was what came next. Every machine in the room took in one form and gave out another.',
    'The lamp took in electrical energy and gave out light, plus a little heat, which is why the bulb was warm. The toaster turned electrical energy into heat. The radio turned it into sound. The fan turned it into motion.',
    'Amir rubbed his cold hands together and felt them warm up. Motion into heat. He tapped a spoon on his bowl. Motion into sound. He was a machine too.',
    'Energy comes in forms you can name, and machines change one form into another. Ask of anything: what form goes in, and what comes out?',
  ],
};
STORIES['circuits'] = {
  about: 'a bulb that would not light until the last wire closed the loop',
  more: [{ serial: 'S528', after: 0, alt: 'A dark little bulb on a table, one wire hooked from the battery to it' }, { serial: 'S529', after: 2, alt: 'The bulb lit, the wire touching the battery, the girl grinning' }, { serial: 'S1878', after: 3, alt: 'A boy holding a plastic straw and then a metal paper clip between the wire and the battery' }, { serial: 'S1879', after: 4, alt: 'A cut wire showing shiny copper inside and plastic coating outside' }, { serial: 'S1880', after: 5, alt: 'A paper clip switch taped to a board, swung open and then closed' }],
  title: 'The loop', art: 'S527', cast: [],
  alt: 'A girl at a table with a battery, a bulb and two wires, the second wire stopping just short of the battery',
  words: [
    'Jade had a battery, a bulb and two wires. The instructions said the bulb would light. She hooked one wire from the battery to the bulb and waited. Nothing. She wiggled it. Still nothing. The bulb sat there like a glass egg.',
    'She checked the battery. It was new. She checked the bulb. It was fine. Everything worked, and nothing worked. Her brother said the electricity was stuck in the battery, which did not help.',
    'Then she noticed the second wire. It ran from the bulb back toward the battery and stopped an inch short. She touched it to the battery. Light! She lifted it. Dark. Electricity did not want a road. It wanted a loop, from the battery, through the bulb and back home.',
    'Her brother wanted a turn, so she let him close the gap. He tried a plastic straw between the wire and the battery first. Dark. Then a metal paper clip. Light. The metal let electricity through. The plastic stopped it.',
    'Metals like copper, iron and aluminum are conductors: they carry electricity. Rubber, plastic, wood and glass are insulators: they block it. That is why a wire is metal inside and plastic outside. The metal carries the flow, and the plastic keeps it away from your hand.',
    'Jade taped a paper clip to the board so she could swing it on and off the wire. Now she had a switch. Open, dark. Closed, light.',
    'Every circuit is a loop, and electricity flows only when the loop is complete. Break it anywhere, and the light goes out.',
  ],
};
STORIES['changing-land'] = {
  about: 'a sandcastle, a cliff and the week of weather that broke, moved and rebuilt the beach',
  more: [{ serial: 'S531', after: 1, alt: 'Waves crashing against a rocky cliff at the end of a beach, sand piled in its cracks' }, { serial: 'S532', after: 2, alt: 'A grandpa crouching beside a cracked rock with a plant root growing through it' }, { serial: 'S1881', after: 3, alt: 'Waves washing the last of a sandcastle out to sea' }, { serial: 'S1882', after: 4, alt: 'A new bank of sand piled up farther down the beach, the girl pointing at it' }, { serial: 'S1883', after: 5, alt: 'The girl pressing a shell into the new sand bank, smiling' }],
  ...
  words: [
    'Sofia built the best sandcastle of her life on the first day of vacation. Three towers, a moat, and a wall you could stand a shell on. She came back every morning to check on it, and every morning it was a little less castle.',
    'At the end of the beach stood a rocky cliff. Waves slammed into it, and in its cracks lay sand and broken shell. Sofia asked her grandpa a question she had never thought to ask. Where does sand even come from?',
    'From rock, he said. Water, ice, wind and plant roots crack rock into smaller and smaller pieces over many years. That breaking is called weathering. Most beach sand is bits of rock and shell broken down that way.',
    'By the fourth day, the waves had carried half of her castle out to sea. By the last day there was nothing left at her spot at all. Carrying pieces away is called erosion, and water does most of it.',
    'And yet, farther down the beach, a fresh bank of sand had piled up where none had been. Where the water slowed down, it dropped what it was carrying. Dropping the pieces somewhere new is called deposition.',
    'Sofia pressed a shell into the new sand bank. Her castle had not vanished. It had moved.',
    'Break, carry, drop. Weathering, erosion and deposition shape every hill, canyon and beach on Earth. A sandcastle shows in one week what a mountain shows in a million years.',
  ],
};
STORIES['adaptations'] = {
  about: 'a duck, a cactus and a desert fox, and why each one looked so strange',
  more: [{ serial: 'S534', after: 1, alt: 'A zookeeper talking with a boy beside the duck pond' }, { serial: 'S535', after: 2, alt: 'A close look at a webbed foot pushing water like an oar, beside a thick cactus stem' }, { serial: 'S1884', after: 3, alt: 'A small desert fox with enormous ears curled up asleep in the sand' }, { serial: 'S1885', after: 4, alt: 'The desert fox hunting under a starry night sky' }, { serial: 'S1886', after: 5, alt: 'A polar bear standing out among green forest trees, looking puzzled' }],
  ...
  words: [
    ...
    'He asked the keeper whether the duck minded its silly feet. She asked him a question back. What would happen to a duck with feet like a chicken? He pictured it paddling hard and going nowhere.',
    'Every strange part, she said, is a tool for a problem. Webbed feet push against the water like oars. The cactus has a thick stem that stores water for the dry months, and its spines keep thirsty animals from biting in.',
    'In the next room, a small desert fox with enormous ears was curled up asleep. Ravi guessed the ears were for hearing. They do help, the keeper said, but they also let heat escape, and that keeps the fox cool in the desert sun.',
    'An adaptation is a part or a habit that helps a living thing survive where it lives. The fox has a habit too. It sleeps through the hot day and hunts in the cooler night.',
    'Then she asked one more question. What if you moved a polar bear to a forest? Its white fur hides it on snow. Among green trees, it would stand out.',
    'When something looks odd, ask two questions: what problem does this place give it, and how does this part solve it? The answers turn the strangest creatures into the smartest.',
  ],
};
STORIES['topic-sentences'] = {
  about: 'a paragraph about dogs that a boy wrote backward, and then the right way round',
  more: [{ serial: 'S537', after: 0, alt: 'A cat asleep on a windowsill while a dog trots in with a newspaper' }, { serial: 'S538', after: 2, alt: 'The boy writing one big sentence at the top of his page, the dog watching' }, { serial: 'S1896', after: 3, alt: 'A dog fetching a stick, a dog guarding a gate and a guide dog in a harness walking beside its owner' }, { serial: 'S1897', after: 4, alt: 'The boy lifting a sleeping cat out of a picture full of busy dogs' }, { serial: 'S1898', after: 5, alt: 'An open door with a blank sign above it and a tidy room inside where everything belongs' }],
  title: 'The big thing first', art: 'S536', cast: [],
  alt: 'A boy writing a paragraph about dogs at a kitchen table, a golden retriever resting its head on his knee',
  words: [
    'Sam wrote a paragraph about dogs. They fetch. They guard the house. They guide people who cannot see. My cat sleeps all day. It was all true, and his teacher wrote one question in the margin: what is this paragraph about?',
    ...
    'So he wrote the big thing first. Dogs make good helpers. That is a topic sentence, and it makes a promise: the rest of the paragraph will show how.',
    'Then the facts followed, and suddenly they were not loose facts. They were three ways of proving one idea. Fetching helps. Guarding helps. Guiding helps most of all.',
    'Then Sam asked the test question of every sentence: does this back up the first one? My cat sleeps all day. No. It was true, and funny, but it was about a cat, not dogs helping. It moved to a paragraph of its own.',
    'His teacher called the topic sentence the sign on the door. It tells you what is inside the room. Every sentence after it has to belong in that room.',
    'Write the big thing first. Then make every sentence after it back the big thing up. A reader will know where they are going from the very first line, and so will you.',
  ],
};
STORIES['opinion-paragraph'] = {
  about: 'a longer recess, and the girl who turned wanting it into a case for it',
  more: [{ serial: 'S540', after: 0, alt: 'A class shouting at a smiling principal, who holds up one hand for quiet' }, { serial: 'S541', after: 1, alt: 'The girl at her desk at home, face red, crumpling her first draft' }, { serial: 'S1899', after: 2, alt: 'Children running at recess, then sitting alert at their desks, in two panels' }, { serial: 'S1900', after: 4, alt: 'A dad reading a page at the kitchen table, eyebrows raised, impressed' }, { serial: 'S1901', after: 5, alt: 'Children pouring out onto a sunny playground for a longer recess' }],
  ...
  words: [
    ...
    'The second draft had a shape. Her opinion came first: I think recess should be longer. Then reason one, with a helper word: first, we think better after we have run around.',
    'Then reason two: also, friends who play together get along better in class. The little words first and also held the reader by the hand, one step at a time.',
    'Then a closing sentence that said the opinion again in new words: give us twenty more minutes outside, and you will get better students back. Her dad read it and said it sounded like a lawyer wrote it.',
    'The principal read it twice, then read it to the teachers. Recess grew by ten minutes the very next week, and nobody had to shout.',
    'An opinion paragraph is an opinion, two reasons and a closing sentence. Say what you think at the start, prove it in the middle, and say it again at the end. That is how a wish becomes an argument.',
  ],
};
STORIES['narrative-paragraph'] = {
  about: 'the day a bird got into the house, and the girl who wrote it so a reader could see it',
  more: [{ serial: 'S543', after: 0, alt: 'A sparrow shooting in through an open front door on a hot afternoon' }, { serial: 'S544', after: 1, alt: 'A girl frowning at her one short sentence, trying to picture the bird' }, { serial: 'S1902', after: 3, alt: 'The bird perched on a curtain rod, everyone in the room frozen with their hands up, a cat under the couch' }, { serial: 'S1903', after: 4, alt: 'Dad sliding the window open and the bird flying out into the light' }, { serial: 'S1904', after: 5, alt: 'A teacher circling one line on a page and smiling' }],
  ...
  words: [
    'A sparrow flew in through the open door, and the whole afternoon turned upside down. That night Ava had to write about something that happened. She wrote: a bird got in and then it got out. Her teacher wrote back: I was not there. Let me see it.',
    ...
    'So she wrote it again in three parts. The beginning said who and where: our living room, a hot afternoon, the door propped open. Then a sparrow shot in like a thrown ball.',
    'The middle said what happened. It circled the lamp twice, landed on the curtain rod, and everyone in the room froze with their hands up. The cat crouched under the couch, tail twitching.',
    'The end said how it turned out. Dad slid the window open, and after one more circle the bird found the light and was gone. Nobody breathed until it was over the fence.',
    'Her teacher circled one line: everyone froze with their hands up. Ava had not written that they were scared. She had shown it, and the reader felt it anyway.',
    'A small story has a beginning, a middle and an end. Show what happened with words a reader can see: not a bird got in, but a sparrow like a thrown ball. Your reader was not there. Your words take them.',
  ],
};
STORIES['first-texans'] = {
  about: 'three peoples of early Texas, and the three kitchens the land gave them',
  more: [{ serial: 'S546', after: 0, alt: 'A boy waving his hand over a big map of Texas pinned to a classroom wall' }, { serial: 'S547', after: 2, alt: 'A Caddo village of tall round grass houses beside rows of corn in the wet east' }, { serial: 'S1905', after: 3, alt: 'A Comanche rider following a buffalo herd across a dry plain, a folded tipi on a pole drag behind' }, { serial: 'S1906', after: 4, alt: 'Karankawa fishers paddling a dugout canoe across a calm coastal bay' }, { serial: 'S1907', after: 5, alt: 'People of several nations meeting to trade under a big tree' }],
  ...
  words: [
    'When Diego\'s class was asked what the first Texans ate, he said buffalo, because that was the picture in every book. His teacher put a map of Texas on the wall and asked where. Diego waved his hand over the whole state.',
    ...
    'In the wet east, rain fell often and the soil was rich. The Caddo farmed corn, beans and squash, and they lived in villages of tall, round houses made of grass. People who farm can stay put.',
    'On the dry plains, the Comanche followed the buffalo on horseback. They rode into Texas in the 1700s, on horses whose ancestors had come over with the Spanish. The herds kept moving, so the people carried tipis they could pack.',
    'Along the coast, the Karankawa fished the bays from dugout canoes and gathered shellfish. They moved with the seasons, camping wherever the food was best that season.',
    'Many nations lived in Texas, and they traded, fought and made peace with one another for centuries. When Spain, Mexico and the United States arrived, each found peoples already at home.',
    'Land decides a way of life. Look at where a people lived, and you can guess what they ate, what they built and how far they moved. The map was the first cookbook.',
  ],
};
STORIES['spanish-and-mexican-texas'] = {
  about: 'a mission bell that rang under two flags, and the door that let the settlers in',
  more: [{ serial: 'S549', after: 1, alt: 'Spanish soldiers and priests building the stone walls of a mission beside a river' }, { serial: 'S550', after: 2, alt: 'The same mission with the flag of Mexico now flying over it' }, { serial: 'S1908', after: 3, alt: 'A line of covered wagons of American settlers arriving on a Texas road' }, { serial: 'S1909', after: 4, alt: 'A crowded town square with Tejano families and newly arrived settlers arguing' }, { serial: 'S1910', after: 6, alt: 'An old stone mission church standing today, its bell tower against a blue sky' }],
  ...
  words: [
    'The bell in the old mission near San Antonio had rung every morning for about a hundred years, since Spain built the mission, its walls and the little farm around it. Lucia\'s great-great-grandmother had heard it as a girl. The bell never changed.',
    'Spain had claimed Texas in the 1500s. From the 1690s on, it built missions and forts to spread its faith and hold the land, and San Antonio grew up around them. Lucia had never known any flag on the pole but Spain\'s.',
    'Then, in 1821, Mexico won its independence from Spain. One morning the bell rang under a new flag on the same pole. Texas was part of Mexico now. Lucia wondered how a place could belong to one country at breakfast and another by lunch.',
    'Mexico had a problem. Texas was huge and had few settlers, and an empty land is hard to hold. So Mexico opened the door to American settlers. Stephen F. Austin brought the first three hundred families in the 1820s.',
    'They came, and kept coming. Within about ten years, Americans outnumbered the Tejanos, the Texans of Mexican descent like Lucia\'s family. The newcomers disagreed with Mexico City about laws, language and slavery.',
    'The bell rang over more and more faces that had never seen Spain or Mexico. One of the old missions had another name by then: the Alamo.',
    'Two flags in a row, Spain and then Mexico, and the roots of a third growing under the same bell. The missions are still standing, and some still ring their bells.',
  ],
};
STORIES['texas-joins-the-union'] = {
  about: 'a flag with twenty-eight stars, a reading in Galveston, and the day freedom arrived late',
  more: [{ serial: 'S552', after: 0, alt: 'A grandfather pointing at one star on an old flag' }, { serial: 'S553', after: 1, alt: 'The wide Rio Grande winding between two countries under a big sky' }, { serial: 'S1913', after: 2, alt: 'The flag of the United States in the 1860s flying over a quiet town, every star still on it' }, { serial: 'S1914', after: 4, alt: 'A crowd gathered in Galveston hearing the news of freedom read aloud, faces lifting with joy' }, { serial: 'S1915', after: 5, alt: 'A wooden derrick at Spindletop spraying oil high into the air' }],
  title: 'The 28th star', art: 'S551', cast: [],
  alt: 'A girl in a dusty attic unfolding an old flag with her grandfather',
  words: [
    'Mia found an old flag in her grandfather\'s attic with twenty-eight stars on it, not fifty. He told her the twenty-eighth star was Texas. For nine years Texas had been a country of its own. Then, in 1845, it joined the United States as the twenty-eighth state.',
    'Mexico had never accepted that Texas was free, and a fight over the border helped start a war between the United States and Mexico in 1846. When it ended, the border was the Rio Grande.',
    'But the story was not a straight line. In 1861 Texas left the Union to join the Confederacy in the war over slavery. Mia asked whether the star came off the flag. It did not. The United States never removed the stars of the states that left.',
    'When that war ended, freedom did not reach Texas the day it was declared. Mia asked how freedom could be late. The news traveled slowly, and some people did not want it heard.',
    'On June 19, 1865, Union soldiers arrived in Galveston with the order that every enslaved person in Texas was free. That day became Juneteenth, a holiday that began in Texas and now belongs to the whole country.',
    'Then, in 1901, at Spindletop near Beaumont, oil roared out of the ground, and Texas changed again. Six flags had flown over Texas by then: Spain, France, Mexico, the Republic of Texas, the Confederacy and the United States.',
    'Statehood in 1845, the Confederacy in 1861, Juneteenth in 1865 and oil in 1901. History is a line with bends in it.',
  ],
};
STORIES['multi-digit-multiplication'] = {
  about: 'twenty-three boxes of crayons and the boy who counted them in two pieces',
  more: [{ serial: 'S555', after: 1, alt: 'The boy counting crayons one at a time, a small pile growing while the clock ticks' }, { serial: 'S556', after: 2, alt: 'Crayon boxes sorted into one big pile and a small pile of three' }, { serial: 'S1916', after: 3, alt: 'A teacher handing the boy a bin full of marker bags, both grinning' }, { serial: 'S1917', after: 4, alt: 'The boy multiplying on a notepad, arrows linking each piece to every other piece' }, { serial: 'S1918', after: 5, alt: 'A rectangle split into four smaller rectangles, one for each piece of the multiplication' }],
  title: 'Twenty-three boxes', art: 'S554', cast: [],
  alt: 'A boy in an art supply room with a tall stack of small crayon boxes, counting them into two piles',
  words: [
    'The art teacher asked Leo to count the crayons in the supply room. There were 23 boxes with 4 crayons in each. Leo started multiplying in his head, lost the number and started again. Twenty-three fours is a lot to hold at once.',
    'He tried counting the crayons one at a time and got to thirty before the teacher came back. This was going to take all afternoon. The boxes smelled like wax, and he was tired of them already.',
    'Then he broke the 23 into pieces he could handle: twenty boxes and three boxes. Twenty boxes of four is 80 crayons. Three boxes of four is 12. And 80 plus 12 is 92. Two easy multiplications and one addition, instead of one hard one.',
    'The teacher was impressed, so she gave him a harder one. The markers came in 14 bags of 23. Now both numbers were big. Leo broke both of them. Twenty and three. Ten and four.',
    'He multiplied every piece by every piece. Twenty times ten is 200. Twenty times four is 80. Three times ten is 30. Three times four is 12. Then he added them: 200, 80, 30 and 12 make 322 markers.',
    'He checked with a picture: a rectangle 23 wide and 14 tall, cut into four smaller rectangles, one for each piece. The four areas added up to the whole.',
    'Every big multiplication is a set of small ones in disguise. Break the numbers into tens and ones, multiply each piece, then add the pieces together.',
  ],
};
STORIES['long-division'] = {
  about: 'ninety-six stickers, four friends and the sharing that went round in rounds',
  more: [{ serial: 'S558', after: 0, alt: 'Four friends waiting at a table, chins in their hands, bored' }, { serial: 'S559', after: 1, alt: 'Four equal piles of stickers, a smaller bunch left in the girl\'s hand' }, { serial: 'S1919', after: 3, alt: 'A teacher writing a neat long division tower on a small whiteboard' }, { serial: 'S1920', after: 4, alt: 'A little brother dropping one more sticker onto the sheet, one sticker left over at the end' }, { serial: 'S1921', after: 5, alt: 'The girl multiplying back on paper and nodding, the check exact' }],
  ...
  words: [
    'Grace had a sheet of 96 stickers and four friends waiting. She did not want to hand them out one at a time. That was 96 moves, and her friends were already bored.',
    'So she tried a bigger step. Could everyone get twenty? Four twenties is 80. Yes. She peeled off twenty for each friend and had 16 left. Sixteen was a much smaller problem than 96.',
    'Second round. Four more each used up all 16. Twenty and four: every friend had 24, and the sheet was empty. Share the big part first, see what is left, then share that.',
    'Her teacher showed her the written way, one digit at a time. How many fours fit in 9, the first digit? Two, with 1 left over. Bring down the 6 to make 16. How many fours fit in 16? Four, exactly. The digits made 24. The same answer, in a tidier tower.',
    'The next day her little brother added one more sticker to the sheet, 97 in all. Everyone got 24 again, and one sticker was left in her hand. That leftover is the remainder: 97 divided by 4 is 24, remainder 1.',
    'To check it, Grace multiplied back. Four times 24 is 96. Add the remainder, 1, and you get 97. The check came out exactly.',
    'Long division shares a big number in steps. Share what you can, bring down what is left, and always check by multiplying back and adding the remainder.',
  ],
};
STORIES['factors-and-multiples'] = {
  about: 'twelve chairs and every way a boy could arrange them in equal rows',
  more: [{ serial: 'S561', after: 0, alt: 'Chairs in one long row stretching across a classroom like a bus' }, { serial: 'S562', after: 1, alt: 'The boy dragging chairs into new rows again and again, tired' }, { serial: 'S1922', after: 2, alt: 'Chairs arranged in two neat rows, then three, then four' }, { serial: 'S1923', after: 4, alt: 'A class counting by fours as they set chairs in rows of four' }, { serial: 'S1924', after: 5, alt: 'A thirteenth chair arriving, and one long line the only way to fit them all' }],
  title: 'Twelve chairs', art: 'S560', cast: [],
  alt: 'A boy in an empty classroom arranging chairs into rows, arrangements chalked on the floor',
  words: [
    'Dev had to set out twelve chairs for the school play, in equal rows. He put them in one long row of twelve and stepped back. It looked like a bus. He tried five rows and had two chairs left over with nowhere to go.',
    'Some numbers of rows worked, and some did not, and he could not tell which until he had dragged every chair. There had to be a way to know first.',
    'He wrote down the ones that worked. One row of twelve. Two rows of six. Three rows of four. Four rows of three. Six rows of two. Twelve rows of one. The numbers that worked were 1, 2, 3, 4, 6 and 12.',
    'Those are the factors of twelve, his teacher said: the numbers that go into it exactly, with nothing left over. Five was not a factor. That was why two chairs had nowhere to go.',
    'For the next show, the class wanted chairs in rows of four. Four, eight, twelve, sixteen, twenty: any of those numbers of chairs would fill the rows exactly. Those are the multiples of four, what four makes when you count by it.',
    'Then a latecomer brought a thirteenth chair. Dev tried every row he could think of. Only one long line worked. Thirteen has exactly two factors, itself and one, so it is prime.',
    'A factor goes into a number exactly. A multiple is what a number makes. A prime has exactly two factors. And a prime number of chairs only ever makes one long line.',
  ],
};
STORIES['equivalent-and-decimals'] = {
  about: 'a coin called a quarter, and the girl who found three names for it',
  more: [{ serial: 'S564', after: 1, alt: 'Four quarters arranged in a circle to make one dollar' }, { serial: 'S565', after: 2, alt: 'A square of pennies on a table, one corner of it covered by a single quarter' }, { serial: 'S1925', after: 3, alt: 'A decimal point drawn as a tiny doorway between whole dollars and cents' }, { serial: 'S1926', after: 4, alt: 'Three dimes beside thirty pennies on a table, the same amount' }, { serial: 'S1927', after: 5, alt: 'Seven dimes in one row and six dimes and a nickel in another, a girl comparing them' }],
  ...
  words: [
    'June found a quarter on the sidewalk and asked her dad why it was called that. Because it is a quarter of a dollar, he said. But he also called it twenty-five cents, and the price tag at the store said 0.25. Three names, one small coin.',
    'She lined up four quarters, and they made a dollar. So one quarter was one fourth of the whole. But twenty-five? And that dot in 0.25? None of it looked like a fourth.',
    'Her dad drew a dollar as a hundred pennies in a square, ten rows of ten. A quarter covered twenty-five of them. Twenty-five out of a hundred can be written as a fraction, 25/100, or as a decimal, 0.25. One fourth, twenty-five hundredths and 0.25 are the same money.',
    'A decimal is a fraction with 10 or 100 on the bottom, he said, written with a point instead of a line. The first place after the point is tenths. The second is hundredths.',
    'So a dime is one tenth of a dollar, 0.1. Three dimes are 0.3, and so are thirty pennies, 0.30. The zero at the end changes nothing, because three tenths and thirty hundredths are the same amount.',
    'Then he gave her a puzzle. Which is more, 0.7 or 0.65? June said 0.65, because 65 looks bigger than 7. Her dad lined up the points. Seven tenths against six tenths. Seven dimes beat six dimes and a nickel. The tenths decide first.',
    'Fractions and decimals are two names for one amount. Read decimals place by place, tenths first.',
  ],
};
STORIES['add-fractions'] = {
  about: 'half a pizza, a quarter of a pizza and a boy who could not add them until he cut',
  more: [{ serial: 'S567', after: 1, alt: 'The boy frowning at his paper beside a cold pizza, the answer looking wrong' }, { serial: 'S568', after: 2, alt: 'The half pizza cut into two quarters with a pizza wheel' }, { serial: 'S1928', after: 3, alt: 'Seven quarter slices laid out: four making one whole pizza and three more beside it' }, { serial: 'S1929', after: 4, alt: 'A sister walking off with three pizza slices, one whole pizza left in the box' }, { serial: 'S1930', after: 5, alt: 'A pizza cut into eighths with half of its slices left' }],
  ...
  words: [
    'Two boxes came back from the party. Half a pizza in one, a quarter of a pizza in the other. Mateo wanted to know how much pizza that was altogether. He wrote one half plus one fourth, then stopped. Halves and fourths were different sizes.',
    ...
    'The next weekend there were leftovers from two parties: seven quarter slices in all. Seven fourths. Mateo laid them out. Four quarters made one whole pizza, and three quarters were left over. Seven fourths is one and three fourths.',
    'His sister ate three of the slices. Seven fourths take away three fourths is four fourths. Same bottoms, so he subtracted the tops. Four fourths was exactly one whole pizza.',
    'At the end, he looked at a pizza cut into eighths with four slices left. Four eighths. Both numbers could be divided by four, so four eighths was the same as one half. Simplify at the end, and the answer gets easier to read.',
    'Fractions add and subtract when their pieces are the same size. Same bottoms: work with the tops, keep the bottom.',
  ],
};
STORIES['balance-and-pattern'] = {
  about: 'a face, a flower and a fence, and the three kinds of balance in them',
  more: [{ serial: 'S570', after: 0, alt: 'A drawing of a face folded down the middle, both halves matching' }, { serial: 'S571', after: 1, alt: 'A flower seen from above, its petals spreading evenly from the center' }, { serial: 'S1937', after: 2, alt: 'A big quiet tree on one side of a page balanced by a small bright red bird on the other' }, { serial: 'S1938', after: 3, alt: 'A garden fence with pickets repeating, every fourth one painted red' }, { serial: 'S1939', after: 4, alt: 'The same fence with one bright yellow picket in the middle catching the eye' }],
  title: 'A face, a flower, a fence', art: 'S569', cast: [],
  alt: 'A boy sketching in a garden with a face, a flower and a fence drawn on one page',
  words: [
    'Felix drew a face and folded the paper down the middle. The two halves matched. Then he drew a flower from above, and no fold worked. It matched all the way around its center instead. His teacher said he had found two of the three kinds of balance by accident.',
    'A face is symmetrical: the same on both sides of a line. It feels calm, like the front of a cathedral. A flower seen from above is radial: everything spreads from a center, like a wheel.',
    'The third kind took a tree. Felix drew a big, quiet tree on the left side of a page and a small, bright red bird on the right. Different things, but the page felt even. That is asymmetrical balance, and it feels alive.',
    'Then he drew the garden fence. Picket, picket, picket: a shape repeated with a rule, which is pattern. He painted every fourth picket red, and the fence had a beat. Pattern with a beat is rhythm, the same word musicians use.',
    'Last, he painted one picket bright yellow in the middle of the fence. Everyone who looked at the drawing looked there first. Change one thing in a pattern and the eye goes straight to it. That is emphasis, made out of almost nothing.',
    'Balance is how a picture stands still. Rhythm is how it moves.',
    'Balance can be symmetrical, radial or asymmetrical. Pattern is repetition with a rule, and rhythm is pattern with a beat. A face, a flower and a fence hold it all.',
  ],
};
STORIES['making-space-on-paper'] = {
  about: 'a road that ran into the distance on a flat sheet of paper',
  more: [{ serial: 'S573', after: 0, alt: 'A flat road drawn like a ribbon straight across a page' }, { serial: 'S574', after: 1, alt: 'Two trees drawn so the near one covers part of the far one' }, { serial: 'S1940', after: 2, alt: 'A big detailed tree low on the page and a small pale tree high up behind it' }, { serial: 'S1941', after: 3, alt: 'A horizon line with a road, fence posts and rooftops all running to one vanishing point' }, { serial: 'S1942', after: 5, alt: 'Trees with the gaps between them shaded, showing the shapes of the empty space' }],
  title: 'The road into the distance', art: 'S572', cast: [],
  alt: 'A girl drawing a road that narrows to a point on the horizon, trees shrinking along it',
  words: [
    'Clara drew a road, and it lay flat on the page like a ribbon. She wanted it to go somewhere. Her teacher said a page has no depth, so depth has to be faked, and there were four fakes and one ruler.',
    'Overlap: the near tree covers part of the far one, so the far one must be behind. It is the simplest trick, and the strongest. Clara tried it with two trees.',
    'Size: the near tree is drawn bigger, and the far tree smaller. Placement: the far tree sits higher on the page. Detail: the near tree has every leaf, and the far one is a pale green smudge.',
    'Then the ruler. Clara drew a horizon line where the sky met the ground. She picked one point on it, the vanishing point. The road\'s two edges ran toward that point until they met, and every fence post and rooftop leaned toward it too.',
    'The road left the page. It went somewhere now, over a hill and out of sight, and Clara wanted to walk it.',
    'Her teacher pointed at the gaps between the trees. The trees were positive space, the shapes of the things. The gaps were negative space, the shapes around them. Artists plan the empty parts as carefully as the full ones.',
    'Overlap, size, placement and detail make a flat page look deep. Perspective lines everything up to a vanishing point on the horizon. Depth is a trick, and the trick has rules.',
  ],
};
STORIES['art-tells-a-story'] = {
  about: 'a hand outlined on a cave wall, and the thousands of years of reasons since',
  more: [{ serial: 'S576', after: 0, alt: 'Someone long ago blowing red paint around a hand pressed to a cave wall' }, { serial: 'S577', after: 1, alt: 'A cave guide with a flashlight talking to a small tour group' }, { serial: 'S1943', after: 2, alt: 'Painted animals running along a cave ceiling' }, { serial: 'S1944', after: 3, alt: 'A carved stone queen beside a tall church window of colored glass stories' }, { serial: 'S1945', after: 5, alt: 'Three masks side by side: a festival mask, an ancestor mask and a portrait mask on a wall' }],
  title: 'The handprint', art: 'S575', cast: [],
  alt: 'A boy on a cave tour looking at a red hand outline on the rock wall, his own hand raised beside it',
  words: [
    'On the cave tour, Theo saw a red hand on the wall, outlined in paint that someone had blown around their fingers more than twenty-five thousand years ago. Before writing. Before farms. Theo asked why anyone would do that.',
    'Nobody knows for certain, the guide said, and that was the beginning of a long answer. People made art before they wrote a single word, and every culture since has made it, never for only one reason.',
    'Some art records. Painted animals running across a cave ceiling may show the animals people knew and hunted.',
    'Some art honors: a carving of a queen, a statue of a leader, a painting for someone who died. Some art teaches: a church window full of stories for people who could not read.',
    'Some art decorates: a pot with a pattern, because plain was not enough. And some art questions: a painting that made a whole city argue about what was fair.',
    'Theo asked about masks. The guide said one mask might hide a face at a festival, another might hold an ancestor\'s spirit, and another might hang on a wall as a portrait. Same object, three meanings. So always ask who made a thing, when and for whom.',
    'Art records, honors, teaches, decorates and questions. The hand on the wall might have been any of those. It might have simply meant, I was here. It is one of the oldest messages we have, and it still reads.',
  ],
};
STORIES['adding-decimals'] = {
  about: 'two prices at a bake sale, and the boy who added them the wrong way first',
  more: [{ serial: 'S579', after: 1, alt: 'A long line of kids waiting behind the boy at the bake sale table' }, { serial: 'S580', after: 2, alt: 'Two prices written one above the other with the decimal points lined up' }, { serial: 'S1967', after: 3, alt: 'A five-dollar bill beside 5.00 written on a napkin, with 3.85 lined up under it' }, { serial: 'S1968', after: 4, alt: 'The boy estimating on his fingers: about two and a half plus about one and a half makes about four' }, { serial: 'S1969', after: 5, alt: 'Coins and dollar bills lined up in columns under their decimal points' }],
  ...
  words: [
    ...
    'Marcus paid with a five-dollar bill, and now the change was his problem. He wrote 5 as 5.00, because a whole number has a hidden decimal point at its end, and zeros can fill the empty places without changing anything. Five dollars minus three eighty-five, cents under cents: one dollar fifteen.',
    'He checked it the fast way before he walked off. Two fifty is about two and a half, one thirty-five is about one and a half, and together they make about four. Three eighty-five is close to four, so the answer made sense. An estimate cannot give the exact answer, but it catches a silly one.',
...
STORIES['multiplying-fractions'] = {
  ...
  more: [{ serial: 'S582', after: 0, alt: 'A girl looking at one small slice on her plate beside an open pizza box' }, { serial: 'S583', after: 1, alt: 'The half pizza cut into two quarters, one lifted out' }, { serial: 'S1970', after: 2, alt: 'A notebook with one half times one half written and a quarter drawn beside it' }, { serial: 'S1971', after: 3, alt: 'A measuring cup filled to one half beside a recipe card that asks for three quarters of a cup of flour' }, { serial: 'S1972', after: 4, alt: 'Three plates, each holding one quarter of a pizza' }],
  ...
  words: [
    ...
    'Her mother was baking and wanted two thirds of a recipe that called for three quarters of a cup of flour. Priya tried the rule. Two times three is six, three times four is twelve: six twelfths. Simplified, that is one half. Half a cup, less than the recipe asked, which made sense, because she was making less.',
    'Then she tried a whole number. Three friends each ate a quarter of a pizza. A whole number is itself over one, so three over one times one over four is three over four. Three quarters of a pizza, gone.',
...
STORIES['dividing-by-two-digits'] = {
  ...
  more: [{ serial: 'S585', after: 0, alt: 'A boy filling one egg carton by hand, trays of eggs all around him' }, { serial: 'S586', after: 2, alt: 'Ten full cartons stacked, a smaller pile of eggs left over' }, { serial: 'S1973', after: 3, alt: 'A pile of twelve eggs left over beside twelve full cartons' }, { serial: 'S1974', after: 4, alt: 'Thirteen cartons in a stack, the last one half full' }, { serial: 'S1975', after: 5, alt: 'A notebook page showing 288 divided by 24, an estimate above and the check 12 × 24 = 288 below' }],
  ...
  words: [
    ...
    'Dividing by a number like 4 was easy. Dividing by 24 felt impossible. Twenty-four was too big to see how many times it fit into anything, and there were far too many eggs to count one by one.',
    ...
    'The next week there were 300 eggs. Owen guessed with rounder numbers: 24 is close to 25, and four 25s make 100, so 300 would need about twelve cartons. Twelve cartons held 288, and 12 eggs were left over. A remainder.',
    'The remainder changed the answer. Twelve eggs would not fit in twelve full cartons, so his aunt needed thirteen, and the last one was half full. Division gives a number, and the question decides what to do with what is left. His aunt said that was the most useful thing he had learned all week.',
...
STORIES['volume'] = {
  ...
  more: [{ serial: 'S588', after: 0, alt: 'A girl losing count of sticky sugar cubes spilled across a table' }, { serial: 'S589', after: 1, alt: 'One layer of cubes, four across and three deep' }, { serial: 'S1976', after: 2, alt: 'The box seen from the side, two layers high' }, { serial: 'S1977', after: 3, alt: 'A bigger box of sugar cubes, five across, four deep and three layers high' }, { serial: 'S1978', after: 4, alt: 'A single tiny cube one centimeter on each side beside a ruler' }],
  ...
  words: [
    ...
    'At the party her grandmother brought out a bigger box. Five across, four deep, three layers. Lena did not lift a single cube. Five times four is twenty in a layer, and three layers of twenty is sixty.',
    'Her grandmother said scientists count the same way, with tiny cubes one centimeter on each side. A box that holds sixty of them has a volume of sixty cubic centimeters. The cube is the unit, and the answer counts how many would fit.',
...
STORIES['order-of-operations'] = {
  ...
  more: [{ serial: 'S591', after: 0, alt: 'Two friends arguing over a card that says 3 + 4 × 2' }, { serial: 'S592', after: 1, alt: 'A boy reading the card left to right with his finger under each number' }, { serial: 'S1982', after: 2, alt: 'The 4 × 2 wrapped like a parcel with an 8 on its label' }, { serial: 'S1983', after: 3, alt: 'A card showing (3 + 4) × 2 = 14 with the brackets drawn in red' }, { serial: 'S1984', after: 4, alt: '12 ÷ 3 × 2 on a whiteboard with arrows running left to right' }],
  ...
  words: [
    ...
    'Sam got his fourteen back, with brackets. (3 + 4) × 2 means add first, because the brackets say so: seven, then fourteen. Both boys had been right about something. Sam had been right about the answer to a different question.',
    'The teacher wrote one more: 12 ÷ 3 × 2. Division and multiplication are equal partners, she said, so go left to right. Twelve divided by three is four, and four times two is eight. Doing the multiplying first would give two, and two is wrong.',
...
STORIES['theme'] = {
  ...
  more: [{ serial: 'S594', after: 1, alt: 'A reading test with two friends written as the answer and half right marked beside it' }, { serial: 'S595', after: 2, alt: 'The same two friends laughing together at the end of the day' }, { serial: 'S2018', after: 3, alt: 'A girl on a winners stand holding a medal and looking unhappy' }, { serial: 'S2019', after: 4, alt: 'A book about a soldier and a book about a dog side by side, one sentence written between them' }, { serial: 'S2020', after: 5, alt: 'A notebook with the word topic on one line and theme on the line below it' }],
  title: 'What it was really about', art: 'S593', cast: [],
  alt: 'Two friends, both girls, sitting apart on a school bench after an argument, a book open between them',
  words: [
    ...
    'Kai tried again with the next story, about a girl who lied to win a race and then could not enjoy the medal. He wrote honesty. His teacher said honesty was still only a topic, one word. A theme is a whole sentence: winning by cheating takes the joy out of winning.',
    'Later Kai noticed that two very different books, one about a soldier and one about a dog, said the same thing: loyalty costs something. Different topics, one theme. The theme was the part that could travel from book to book.',
...
STORIES['point-of-view'] = {
  ...
  more: [{ serial: 'S597', after: 0, alt: 'Two drafts on a desk, one starting with I saw and one with she saw' }, { serial: 'S598', after: 1, alt: 'A girl reading two drafts aloud with a puzzled face' }, { serial: 'S2021', after: 2, alt: 'The view from a camera on the girl\'s head: the storm through her own window, as first person sees it' }, { serial: 'S2022', after: 3, alt: 'A page of directions written with you, a small map beside it' }, { serial: 'S2023', after: 4, alt: 'The same room from the corner, the girl small at the window and her little brother hiding under a blanket' }],
  title: 'Two cameras', art: 'S596', cast: [],
  alt: 'A girl writing at a window as storm clouds gather, a small drawn camera on her head and another on a tripod in the corner',
  words: [
    ...
    'Then her teacher showed a third camera, a rare one. You see the storm coming. That is second person, and it puts the reader inside the story as the one doing things. Directions and some games use it, but most stories do not.',
    'Third person has two kinds of tripod too. One can only see inside one character\'s head. The other can see inside everyone, knowing what each person thinks. Ana rewrote the storm from that all-knowing corner and found out her little brother had been scared the whole time.',
...
STORIES['idioms'] = {
  ...
  more: [{ serial: 'S600', after: 0, alt: 'A girl backstage whispering to a boy in costume before the curtain rises' }, { serial: 'S601', after: 1, alt: 'The boy checking his own legs in alarm behind the curtain' }, { serial: 'S2024', after: 2, alt: 'The boy bowing on stage to applause, both legs fine' }, { serial: 'S2025', after: 3, alt: 'A boy with a cloud drawn around his head, forgetting his lunch at the door' }, { serial: 'S2026', after: 4, alt: 'A notebook titled idioms with phrases written in English and Spanish' }],
  ...
  words: [
    ...
    'Theo started collecting them. His grandmother said he had his head in the clouds when he forgot his lunch. His coach said the test would be a piece of cake. His dad told him to hold his horses when he rushed. None of it was about clouds, cake or horses.',
    'Maya said other languages have their own. In Spanish, estar en las nubes, to be in the clouds, also means daydreaming. But many idioms do not travel. Translate break a leg word for word into another language and the actor might really worry.',
...
STORIES['text-evidence'] = {
  ...
  more: [{ serial: 'S603', after: 0, alt: 'Two classmates arguing across a book club table' }, { serial: 'S604', after: 1, alt: 'A teacher waiting while two students search their books' }, { serial: 'S2027', after: 2, alt: 'The page with a single line of text glowing, his hands shook' }, { serial: 'S2028', after: 3, alt: 'A boy pointing to a line on page fifteen about yawning at dinner' }, { serial: 'S2029', after: 4, alt: 'A notebook with a claim written and a page number beside it' }],
  ...
  words: [
    ...
    'Then Marcus found his own line on page fifteen: he yawned twice at dinner. Tired had evidence too. The teacher smiled. A story can hold more than one truth. The boy was scared at the door and tired by dinner, and both claims now stood on something.',
    'The last step was to explain. Priya wrote her claim and the line in quotation marks with its page number. Then she added one sentence saying how the line proved it: shaking hands are what fear does to a body. Claim, evidence, explanation.',
...
STORIES['mixtures-and-solutions'] = {
  ...
  more: [{ serial: 'S606', after: 0, alt: 'A boy stirring sand into one glass and salt into another at a kitchen table' }, { serial: 'S607', after: 1, alt: 'The boy tasting the clear water and making a salty face' }, { serial: 'S2000', after: 2, alt: 'The sandy water poured off, sand left in the bottom of the glass' }, { serial: 'S2001', after: 3, alt: 'A shallow dish of white salt crystals on a sunny windowsill' }, { serial: 'S2002', after: 4, alt: 'A glass of water with a small pile of salt resting on the bottom, no longer dissolving' }],
  ...
  words: [
    ...
    'His sister showed him how to get the salt back. She poured some of the salty water into a shallow dish and set it on a sunny windowsill. Three days later the water was gone and a crust of white crystals was left. Evaporation had pulled the solution apart.',
    'Theo kept adding salt to a fresh glass to see how much would vanish. Spoon after spoon disappeared, until one spoonful sat on the bottom and stayed. The water could hold no more. Warm water, his sister said, would have held a little more before it stopped.',
...
STORIES['earth-sun-moon'] = {
  ...
  more: [{ serial: 'S609', after: 0, alt: 'A dark kitchen table with one lamp glowing, a top and a marble beside it' }, { serial: 'S610', after: 1, alt: 'The top circling the lamp, half of it lit, half in shadow' }, { serial: 'S2003', after: 2, alt: 'The marble circling the top in a small ring' }, { serial: 'S2004', after: 3, alt: 'Four views of the marble around the top: full, half, a thin sliver and dark' }, { serial: 'S2005', after: 4, alt: 'A marble with a painted dot always facing the spinning top as it circles' }],
  ...
  words: [
    ...
    'Then her dad crouched to the height of the top and asked her to watch the marble. As it went around, Ava saw its lit side full, then half, then a thin sliver, then dark. The marble never changed shape. She was seeing different amounts of its sunny half. Those are the phases of the moon.',
    'There was one more trick. As the marble circled, her dad turned it slowly so the same painted dot always faced the top. The real moon does that too, spinning once for every trip around Earth, which is why we always see the same face.',
...
STORIES['inherited-and-learned'] = {
  ...
  more: [{ serial: 'S612', after: 0, alt: 'A boy and his father side by side at a mirror, both with brown eyes' }, { serial: 'S613', after: 1, alt: 'The boy falling off a bike on a lawn, his father laughing kindly' }, { serial: 'S2009', after: 2, alt: 'Two columns on a page: from my parents, and from practice' }, { serial: 'S2010', after: 3, alt: 'A spider spinning a web beside a dog sitting for a treat' }, { serial: 'S2011', after: 4, alt: 'A long-legged boy running on a school track while a coach holds a stopwatch' }],
  ...
  words: [
    ...
    'Diego tried the question on animals. A spider spins its first web without ever seeing one, so that behavior is inherited; scientists call it instinct. His neighbor\'s dog sits when told, but only because someone taught it with a hundred treats. That is learned.',
    'Some things mix both. Height is mostly inherited, but good food helps a body reach it. Diego inherited long legs from his mom, but how fast he runs also depends on how much he practices. The legs came first. The speed came from the track.',
...
STORIES['informational-piece'] = {
  ...
  more: [{ serial: 'S615', after: 0, alt: 'A boy writing one very long paragraph in a notebook' }, { serial: 'S616', after: 1, alt: 'A boy searching a crowded page for the word library' }, { serial: 'S2057', after: 2, alt: 'Three doors in a hallway: the gym, the library and the garden' }, { serial: 'S2058', after: 3, alt: 'A school guide with a heading over each paragraph, a small map and a captioned photo' }, { serial: 'S2059', after: 5, alt: 'A finished guide with an introduction, three headed paragraphs and a conclusion' }],
  ...
  words: [
    ...
    'Then he added signs. A heading over each paragraph, like the names over real doors: The Gym, The Library, The Garden. A small map with the rooms labeled. A caption under his photo of the garden. Readers who skimmed could still find their way.',
    'His teacher crossed out one sentence: the library is the best room. Informational writing gives facts, she said, and best is an opinion. He changed it to something a reader could check: the library has four thousand books and a reading corner by the window.',
...
STORIES['opinion-essay-5'] = {
  ...
  more: [{ serial: 'S618', after: 0, alt: 'A girl rereading two paragraphs that say the same thing, looking puzzled' }, { serial: 'S619', after: 2, alt: 'Three cards in the middle of the row, each with a different reason drawn on it' }, { serial: 'S2060', after: 3, alt: 'A fish tank in a calm classroom next door' }, { serial: 'S2061', after: 4, alt: 'A sign-up sheet for taking the class pet home on weekends' }, { serial: 'S2062', after: 5, alt: 'The conclusion card, the opinion card\'s picture repeated with a bigger smile' }],
  ...
  words: [
    ...
    'Her teacher said each reason needed something to stand on. It calms the room became: when the class next door got a fish tank, their teacher said the loudest part of the day got quieter. A reason with an example is harder to wave away.',
    'Rosa also thought about who would read it. The principal would decide, and the principal would worry about weekends. So Rosa added a sentence to her conclusion: families could sign up to take the pet home, one weekend each.',
...
STORIES['personal-narrative-5'] = {
  ...
  more: [{ serial: 'S621', after: 0, alt: 'A short three-sentence story on a page beside a clock showing eight seconds' }, { serial: 'S622', after: 1, alt: 'A teacher holding up two fingers beside a drawing of a bike' }, { serial: 'S2063', after: 2, alt: 'The training wheels lying in the grass beside a wrench' }, { serial: 'S2064', after: 3, alt: 'A boy on a bike with wind in his hair, laughing' }, { serial: 'S2065', after: 4, alt: 'The boy riding away by himself down the sidewalk, his dad watching' }],
  ...
  words: [
    ...
    'His teacher pointed at one word: fun. Fun tells, she said. Show it instead. Sam crossed it out and wrote what his body did: the wind in his ears, his mouth open, a laugh that came out before he could stop it. The reader could feel the fun without being told.',
    'Then he added the one thing his dad said, in quotation marks: You are doing it by yourself. Real words from a real person made the moment sound true. Sam kept the whole story on one page, and it took a full minute to read.',
...
STORIES['thirteen-colonies'] = {
  ...
  more: [{ serial: 'S624', after: 0, alt: 'A girl frowning at thirteen flashcards spread across her bed' }, { serial: 'S625', after: 1, alt: 'A grandfather pointing at a coastal map while a girl looks at where the colonies sit' }, { serial: 'S2036', after: 2, alt: 'The northern band: rocky shore, fishing boats and small farms under a cold sky' }, { serial: 'S2037', after: 3, alt: 'Colonists at a New England town meeting raising hands to vote' }, { serial: 'S2038', after: 4, alt: 'The southern band: big farms of wide green fields along a warm river' }],
  ...
  words: [
    ...
    'Her grandfather added one more pattern. The colonists were far from the king, so they learned to govern themselves. Virginia had an elected assembly, the House of Burgesses, from 1619. New England towns held meetings where settlers argued and voted on local matters. That habit of deciding for themselves would matter later.',
    'And not everyone came by choice. In the South especially, the big farms depended on enslaved Africans, brought by force and denied every choice the colonists prized. The three rows were shaped by weather and soil, and also by who was made to do the work.',
...
STORIES['road-to-revolution'] = {
  ...
  more: [{ serial: 'S627', after: 0, alt: 'A very old teapot on a high shelf in a family kitchen' }, { serial: 'S628', after: 1, alt: 'Colonists reading a tax notice nailed to a wall, frowning' }, { serial: 'S2039', after: 2, alt: 'Crates of tea splashing into a dark harbor at night, seen from the shore' }, { serial: 'S2040', after: 3, alt: 'Delegates arriving at a brick hall in Philadelphia in 1774' }, { serial: 'S2041', after: 5, alt: 'A crowd in a town square listening as a declaration is read aloud' }],
  ...
  words: [
    ...
    'Eli found more steps in between. In 1770, British soldiers fired into a crowd in Boston and five colonists died, and the colonists called it a massacre. In 1774, Britain closed Boston Harbor to punish the tea party, and delegates from twelve colonies met in Philadelphia as the First Continental Congress.',
    'The colonists had a slogan for all of it: no taxation without representation. They were not against every tax. They were against taxes voted by a Parliament across the ocean, where they had no members at all.',
...
STORIES['the-constitution'] = {
  ...
  more: [{ serial: 'S630', after: 0, alt: 'A worn set of papers marked as failed, an empty money chest beside them' }, { serial: 'S631', after: 1, alt: 'One state saying no while delegates from every other state wait around a table' }, { serial: 'S2042', after: 2, alt: 'Three drawn figures side by side, Congress, the President and the Courts, linked by arrows' }, { serial: 'S2043', after: 3, alt: 'Two houses of Congress drawn side by side: a big House by population and a Senate with two seats for every state' }, { serial: 'S2044', after: 4, alt: 'A newspaper announcing that the ninth state has approved the Constitution' }],
  title: 'The second plan', art: 'S629', cast: [],
  alt: 'Delegates around a long table in a candlelit hall, the old Articles of Confederation beside an empty money chest, one man standing to speak',
  words: [
    ...
    'The big states and the small states nearly broke the meeting apart. Big states wanted votes by population. Small states wanted one vote each. The answer was a compromise: two houses of Congress, the House of Representatives by population and the Senate with two senators from every state.',
    'The plan still had to be approved. Nine of the thirteen states had to say yes, and in 1788 the ninth one did. Some states agreed only after a promise that a list of rights would be added. In 1791 the first ten amendments, the Bill of Rights, kept that promise.',
...
STORIES['growing-west'] = {
  ...
  more: [{ serial: 'S633', after: 0, alt: 'A girl unfolding a map where a huge middle piece has just been added' }, { serial: 'S634', after: 1, alt: 'The peoples who had always lived on the plains, a village beside a river on land that was new only to the map' }, { serial: 'S2045', after: 2, alt: 'A wagon train on a long trail across the plains toward mountains' }, { serial: 'S2046', after: 3, alt: 'Explorers in a canoe on a wide river, a guide pointing west' }, { serial: 'S2047', after: 4, alt: 'A steam train crossing the same plains on new rails, gold pans by the track' }],
  ...
  words: [
    ...
    'Then the blank half filled. Trails carried wagons west through the plains. In 1848 gold turned up in California, and tens of thousands rushed to it. A war with Mexico added the southwest, and railroads would later follow the trails. By 1850 the country reached the Pacific Ocean, and the map that had doubled was full to the far edge.',
    'First came the explorers. In 1804 Lewis and Clark set out up the Missouri River with a small crew, helped along the way by guides like Sacagawea, and reached the Pacific in 1805. Their maps and notes filled in some of the blank half.',
    'The filling had a cost. The land was never empty to the nations who lived there. As settlers moved west, the government forced many Native peoples off their homelands, including the Cherokee on the Trail of Tears in 1838. The railroad that crossed the continent in 1869 carried more settlers still.',
...
STORIES['civil-war'] = {
  ...
  more: [{ serial: 'S636', after: 0, alt: 'A boy on an attic floor reading an old letter pulled from a shoebox' }, { serial: 'S637', after: 1, alt: 'A map of the United States torn down the middle, two colors, 1861' }, { serial: 'S2048', after: 3, alt: 'A field at Gettysburg with a small crowd listening to a speaker on a wooden platform' }, { serial: 'S2049', after: 4, alt: 'A quiet theater balcony draped in black cloth in April 1865' }, { serial: 'S2050', after: 5, alt: 'A stitched map, whole again, with a new amendment pinned beside it' }],
  ...
  words: [
    ...
    'It can. Between December 1860 and June 1861, eleven southern states left the Union over slavery, which they wanted to keep and expand. The rest of the country said no. Neither side would give in, and the argument became a war.',
    'The war lasted four years. In 1863 President Lincoln declared the enslaved people in the rebelling states free. In 1865 the South surrendered, more than six hundred thousand soldiers had died, and the 13th Amendment ended slavery everywhere in the country. The soldier\'s sister got her letter. The country got itself back, changed.',
    'Marcus looked up the soldier\'s years. The war had begun at Fort Sumter in April 1861. In July 1863 the Union won at Gettysburg, in Pennsylvania, and that November Lincoln gave a two-minute speech there about a nation that should not perish.',
    'Five days after the main Southern army surrendered in April 1865, Lincoln was shot at a theater in Washington, and he died the next morning. He did not live to see the 13th Amendment ratified that December, or the long work of rebuilding the South that came after.',
...
STORIES['dividing-fractions'] = {
  ...
  more: [{ serial: 'S639', after: 0, alt: 'A boy staring at three whole pizzas while a crowd of hungry kids waits' }, { serial: 'S640', after: 1, alt: 'A notebook with a crossed-out answer of one and a half kids' }, { serial: 'S2069', after: 2, alt: 'The three pizzas cut into six halves, six children reaching for them' }, { serial: 'S2070', after: 3, alt: 'Three quarters of a pizza cut into six equal slices' }, { serial: 'S2071', after: 5, alt: 'A notebook page with 3 ÷ 1/2 = 6 and a flipped fraction beside it' }],
  ...
  words: [
    ...
    'At the end of the party three quarters of a pizza was left, and his mother wanted to know how many eighth-size slices it made. Three quarters divided by one eighth. Flip the eighth and multiply: three quarters times eight is six. Six slices. He checked it backward: six eighths is three quarters.',
    'Jamal liked the checking best. Division asks how many of one thing fit inside another, and multiplication puts them back together. If the answer multiplies back to where you started, it is right.',
...
STORIES['area-of-triangles'] = {
  ...
  more: [{ serial: 'S642', after: 0, alt: 'A girl kneeling by a triangular garden bed with a soil catalog, Tuesday circled on a calendar' }, { serial: 'S643', after: 1, alt: 'The rectangle of string with the triangle inside, the leftover corners shaded' }, { serial: 'S2075', after: 3, alt: 'A boy stretching a tape along the slanted side of the triangle while a plumb line hangs straight down beside it' }, { serial: 'S2076', after: 4, alt: 'A paper parallelogram with a triangle cut from one end and slid to the other to make a rectangle' }, { serial: 'S2077', after: 5, alt: 'A notebook with a rectangle, a diagonal, and one half written under it' }],
  ...
  words: [
    ...
    'Her brother wanted to measure the slanted side instead. It was five feet. Six times five, halved, is fifteen, three square feet too many. The height has to be the straight-up distance from the base to the top corner, the way a plumb line would hang.',
    'The next bed was a slanted four-sided shape, a parallelogram. Priya cut a paper copy, sliced the triangle off one end and slid it to the other. It became a rectangle with the same base and height, and the same area. Base times height, no halving, because nothing had been cut away.',
...
STORIES['one-step-equations'] = {
  ...
  more: [{ serial: 'S645', after: 0, alt: 'A boy staring at a sealed box on a balance scale, weights on both pans' }, { serial: 'S646', after: 1, alt: 'A boy scribbling guesses of ten and six beside a scale that tips one way and then the other' }, { serial: 'S2078', after: 2, alt: 'Five weights lifted off each pan at the same time, the box left alone against seven weights' }, { serial: 'S2079', after: 3, alt: 'Three identical boxes on one pan balancing twelve weights split into three groups of four' }, { serial: 'S2080', after: 4, alt: 'A notebook with 7 + 5 = 12 and 3 × 4 = 12, each checked' }],
  ...
  words: [
    ...
    'The next setup had three identical boxes on one side and twelve weights on the other. Owen split each side into three equal groups: one box against four weights. He had undone multiplying by dividing both sides by three. Three x equals twelve, so x equals four.',
    'Then he checked both answers by putting them back. Seven plus five is twelve. Three times four is twelve. Both scales would stay level, so both answers were right. Checking takes ten seconds and catches most mistakes.',
...
STORIES['word-roots'] = {
  ...
  more: [{ serial: 'S654', after: 2, alt: 'A porter carrying bags, with the word port drawn on his cap' }, { serial: 'S655', after: 3, alt: 'Arrows drawn across a map: import in, export out, transport across' }],
...
STORIES['central-idea'] = {
  ...
  more: [{ serial: 'S657', after: 2, alt: 'Three workers pulling one rope, each paragraph drawn as a worker' }, { serial: 'S658', after: 3, alt: 'The article with one sentence written above it in bold: we need bees' }],
...
STORIES['heat-transfer'] = {
  ...
  more: [{ serial: 'S663', after: 1, alt: 'A close look at a metal pan handle glowing with heat along its length' }, { serial: 'S664', after: 2, alt: 'Soup swirling in a pot, hot broth rising in the middle and sinking at the sides' }],
...
STORIES['ecosystems'] = {
  ...
  more: [{ serial: 'S669', after: 1, alt: 'Sunlight falling on grass, the grass glowing faintly green' }, { serial: 'S670', after: 2, alt: 'Mushrooms and fungi on a fallen log at the edge of the meadow' }],
...
STORIES['argument-with-evidence'] = {
  ...
  more: [{ serial: 'S675', after: 2, alt: 'A nurse\'s log book open on a desk, a column of tally marks' }, { serial: 'S676', after: 3, alt: 'The boy presenting a chart to a principal who is nodding' }],
...
STORIES['compare-and-contrast'] = {
  ...
  more: [{ serial: 'S678', after: 1, alt: 'A market square in the first town, busy with stalls' }, { serial: 'S679', after: 2, alt: 'A ferry crossing the river toward the second town' }],
...
STORIES['narrative-with-dialogue'] = {
  ...
  more: [{ serial: 'S681', after: 2, alt: 'A page of description crossed out, two short lines of dialogue written beneath it' }, { serial: 'S682', after: 3, alt: 'The two characters seen close up, one annoyed, one sheepish' }],
...
STORIES['maps-and-hemispheres'] = {
  ...
  more: [{ serial: 'S684', after: 1, alt: 'The orange with rings drawn around it from the middle, like belts' }, { serial: 'S685', after: 2, alt: 'The orange with lines from top to bottom, like segments of a peel' }],
...
STORIES['kinds-of-economies'] = {
  ...
  more: [{ serial: 'S693', after: 0, alt: 'A grandmother weaving at a loom in a village, the same cloth her mother wove' }, { serial: 'S694', after: 3, alt: 'A busy market where buyers and sellers bargain over prices' }],
...
STORIES['people-on-the-move'] = {
  ...
  more: [{ serial: 'S696', after: 1, alt: 'A closed factory gate in a quiet town, a sign hanging crooked' }, { serial: 'S697', after: 2, alt: 'A crowded city street with lit shop windows and people everywhere' }],
...
STORIES['world-regions-today'] = {
  ...
  more: [{ serial: 'S699', after: 2, alt: 'A coastline with several countries along it, all colored the same blue' }, { serial: 'S700', after: 3, alt: 'A mountain range crossing several borders, drawn as one shaded band' }],
...
STORIES['proportions'] = {
  ...
  more: [{ serial: 'S702', after: 2, alt: 'One pen alone on the counter with two dimes beside it' }, { serial: 'S703', after: 3, alt: 'Five pens lined up with a dollar bill under them' }],
...
STORIES['two-step-equations'] = {
  ...
  more: [{ serial: 'S708', after: 2, alt: 'The equation 2x + 3 = 11 with the plus 3 circled as the last thing done' }, { serial: 'S709', after: 3, alt: 'The steps peeled back: 2x = 8, then x = 4' }],
...
STORIES['authors-purpose'] = {
  ...
  more: [{ serial: 'S714', after: 1, alt: 'A weather report page, all numbers and dates, next to an advertisement with bold words' }, { serial: 'S715', after: 2, alt: 'A comic strip panel with a small plot, the girl laughing' }],
...
STORIES['evidence-quality'] = {
  ...
  more: [{ serial: 'S717', after: 1, alt: 'The friend, hand on heart, telling his one story' }, { serial: 'S718', after: 2, alt: 'A page of a study with a bar chart of ten thousand people' }],
...
STORIES['character-motive'] = {
  ...
  more: [{ serial: 'S723', after: 2, alt: 'The girl in the story turning away from her brother with a folded paper behind her back' }, { serial: 'S724', after: 3, alt: 'A notebook page with two headings: wants and fears' }],
...
STORIES['body-systems'] = {
  ...
  more: [{ serial: 'S726', after: 1, alt: 'The city map: roads for blood vessels, a kitchen for the stomach, a power plant for the lungs' }, { serial: 'S727', after: 2, alt: 'Trucks on the roads carrying supplies from the kitchen to every building' }],
...
STORIES['summary-and-response'] = {
  ...
  more: [{ serial: 'S738', after: 2, alt: 'A page split by a line: a calm summary above, an opinionated response below' }, { serial: 'S739', after: 3, alt: 'A reader nodding at the summary with no idea what the writer thinks' }],
...
STORIES['explanatory-essay'] = {
  ...
  more: [{ serial: 'S744', after: 2, alt: 'A single die and a single piece on the board, the first rule' }, { serial: 'S745', after: 3, alt: 'A finished page with each new word underlined and an example beside it' }],
...
STORIES['revolution-and-republic'] = {
  ...
  more: [{ serial: 'S753', after: 2, alt: 'The walls of the Alamo at dawn, quiet, no fighting shown' }, { serial: 'S754', after: 3, alt: 'A watch showing eighteen minutes past the hour on the field at San Jacinto' }],
...
STORIES['cattle-cotton-and-oil'] = {
  ...
  more: [{ serial: 'S759', after: 2, alt: 'A cattle drive heading north toward a railroad, dust rising' }, { serial: 'S760', after: 3, alt: 'The Spindletop gusher of 1901 spraying oil high over a wooden derrick' }],
...
STORIES['modern-texas'] = {
  ...
  more: [{ serial: 'S762', after: 2, alt: 'A rocket lifting off with Mission Control drawn in the foreground' }, { serial: 'S763', after: 3, alt: 'A quiet farm road giving way to a highway and glass towers' }],
...
STORIES['flawed-reasoning'] = {
  ...
  more: [{ serial: 'S777', after: 2, alt: 'Four cards laid out, each showing a broken chain link with a different name' }, { serial: 'S778', after: 3, alt: 'The boy pointing at a card labeled in his own handwriting, grinning' }],
...
STORIES['irony'] = {
  ...
  more: [{ serial: 'S780', after: 2, alt: 'A woman in a storm saying great weather, umbrella inside out' }, { serial: 'S781', after: 3, alt: 'A stage with the audience seeing a shadow the hero cannot see' }],
...
STORIES['scale-of-the-universe'] = {
  ...
  more: [{ serial: 'S792', after: 1, alt: 'The boxes lined up from smallest to largest, each labeled by a drawn planet, sun, galaxy' }, { serial: 'S793', after: 2, alt: 'A night sky with a faint band of stars, the girl pointing up' }],
...
STORIES['thesis-and-outline'] = {
  ...
  more: [{ serial: 'S801', after: 0, alt: 'The sentence dogs are pets crossed out, nobody arguing' }, { serial: 'S802', after: 3, alt: 'An outline: one thesis at the top, three reasons beneath' }],
...
STORIES['evidence-paragraph'] = {
  ...
  more: [{ serial: 'S804', after: 2, alt: 'A paragraph with claim and evidence, a blank line between them' }, { serial: 'S805', after: 3, alt: 'The blank line filled in, the paragraph whole' }],
...
STORIES['full-essay'] = {
  ...
  more: [{ serial: 'S807', after: 2, alt: 'A skeleton drawn beside the cards: one head, three ribs, one base' }, { serial: 'S808', after: 3, alt: 'The first card being written last, a thesis in bold' }],
...
STORIES['founding-documents'] = {
  ...
  more: [{ serial: 'S810', after: 2, alt: 'The Declaration with the word why drawn above it' }, { serial: 'S811', after: 3, alt: 'The Bill of Rights with a drawn locked gate beside it' }],
...
STORIES['early-republic'] = {
  ...
  more: [{ serial: 'S813', after: 2, alt: 'A drawn map doubling in size as a hand unfolds it' }, { serial: 'S814', after: 3, alt: 'A crowd at a polling place, many more men voting than before' }],
...
STORIES['reconstruction'] = {
  ...
  more: [{ serial: 'S819', after: 2, alt: 'The 13th, 14th and 15th written on three doors, one after another' }, { serial: 'S820', after: 3, alt: 'A crowd at a march in the 1960s holding the same three numbers' }],
...
STORIES['multi-step-equations'] = {
  ...
  more: [{ serial: 'S822', after: 2, alt: 'The socks gathered into one basket on one side' }, { serial: 'S823', after: 3, alt: 'The equation 5x + 3 = 2x + 15 reduced line by line to x = 4' }],
...
STORIES['functions'] = {
  ...
  more: [{ serial: 'S825', after: 2, alt: 'The button 3 pressed and one pretzel dropping' }, { serial: 'S826', after: 3, alt: 'A table of inputs and outputs: 1 to 3, 2 to 5, 3 to 7' }],
...
STORIES['systems-of-equations'] = {
  ...
  more: [{ serial: 'S828', after: 1, alt: 'The first clue: two numbers that add to 5' }, { serial: 'S829', after: 2, alt: 'The lock opening on 3 and 2' }],
...
STORIES['exponential-growth'] = {
  ...
  more: [{ serial: 'S834', after: 1, alt: 'A tree diagram: one, two, four, eight' }, { serial: 'S835', after: 2, alt: 'Two lines on a graph, one climbing gently, one shooting up' }],
...
STORIES['rhetorical-appeals'] = {
  ...
  more: [{ serial: 'S837', after: 0, alt: 'The girl pointing at her own scuffed knees, years of riding' }, { serial: 'S838', after: 3, alt: 'A small chart of the bike\'s price against new ones' }],
...
STORIES['credible-sources'] = {
  ...
  more: [{ serial: 'S846', after: 2, alt: 'The page with an author, a date and a list of sources' }, { serial: 'S847', after: 3, alt: 'A shop button hiding at the bottom of the nameless page' }],
...
STORIES['respiration-and-photosynthesis'] = {
  ...
  more: [{ serial: 'S852', after: 1, alt: 'A leaf with arrows: carbon dioxide and water in, sugar and oxygen out' }, { serial: 'S853', after: 2, alt: 'A lung with the arrows reversed' }],
...
STORIES['evidence-for-evolution'] = {
  ...
  more: [{ serial: 'S855', after: 2, alt: 'A fossil of an ancient whale with small hind legs' }, { serial: 'S856', after: 3, alt: 'An arm, a flipper and a wing side by side, the same bones shaded' }],
...
STORIES['homeostasis'] = {
  ...
  more: [{ serial: 'S867', after: 1, alt: 'Sweat on a hot day, cooling the skin' }, { serial: 'S868', after: 2, alt: 'Shivering on a cold day, warming up' }],
...
STORIES['analysis-paragraph'] = {
  ...
  more: [{ serial: 'S870', after: 2, alt: 'The claim and the quotation with nothing after them' }, { serial: 'S871', after: 3, alt: 'The added sentence, glowing, connecting the two' }],
...
STORIES['narrative-with-a-turn'] = {
  ...
  more: [{ serial: 'S873', after: 2, alt: 'Dinner dishes and a math book, everything ordinary' }, { serial: 'S874', after: 3, alt: 'A hand reaching for the ringing phone, the clock stopped' }],
...
STORIES['rhetorical-analysis'] = {
  ...
  more: [{ serial: 'S876', after: 2, alt: 'The transcript marked: a librarian\'s twenty years, a child\'s story, a chart' }, { serial: 'S877', after: 3, alt: 'A notebook with three questions and three answers' }],
...
STORIES['the-shape-of-the-earth'] = {
  ...
  more: [{ serial: 'S879', after: 2, alt: 'Two shell pieces pushed together, one riding up over the other' }, { serial: 'S880', after: 3, alt: 'A world map with mountain ranges and ocean ridges drawn along the cracks' }],
...
STORIES['climate-and-biomes'] = {
  ...
  more: [{ serial: 'S882', after: 1, alt: 'The car climbing from green valley to snow' }, { serial: 'S883', after: 2, alt: 'A coast town under mild skies next to a desert inland' }],
...
STORIES['regions-of-the-world'] = {
  ...
  more: [{ serial: 'S894', after: 2, alt: 'A blank outline of the world with a few capitals pinned' }, { serial: 'S895', after: 3, alt: 'The same map filling in: Cairo, Paris, Brasília, Ottawa, Mexico City' }],
...
STORIES['similar-triangles'] = {
  ...
  more: [{ serial: 'S900', after: 1, alt: 'A 3-4-5 triangle beside a 6-8-10 triangle, the same angles marked' }, { serial: 'S901', after: 2, alt: 'A ruler on both photos, one side four inches, the other twelve' }],
...
STORIES['transformations'] = {
  ...
  more: [{ serial: 'S903', after: 2, alt: 'The picture slid right, every point shifted the same amount' }, { serial: 'S904', after: 3, alt: 'The picture turned a quarter turn, its corners swapped' }],
...
STORIES['right-triangle-trig'] = {
  ...
  more: [{ serial: 'S906', after: 1, alt: 'The three sides labeled from his corner: opposite, adjacent, hypotenuse' }, { serial: 'S907', after: 2, alt: 'SOH CAH TOA written on the ground in chalk' }],
...
STORIES['spotting-bias'] = {
  ...
  more: [{ serial: 'S912', after: 1, alt: 'Charged words in the article circled: slammed, admitted, so-called' }, { serial: 'S913', after: 2, alt: 'A list of people quoted, with an empty line where the other side should be' }],
...
STORIES['balancing-equations'] = {
  ...
  more: [{ serial: 'S927', after: 2, alt: 'Two red pairs and one blue pair before rebuilding' }, { serial: 'S928', after: 3, alt: 'Two new pieces, each made of two red and one blue' }],
...
STORIES['concentration'] = {
  ...
  more: [{ serial: 'S942', after: 1, alt: 'Four spoons of sugar going into two glasses' }, { serial: 'S943', after: 2, alt: 'Water poured in, the same sugar spread through more liquid' }],
...
STORIES['sourced-argument'] = {
  ...
  more: [{ serial: 'S948', after: 2, alt: 'Two cards side by side, one with a source and one blank at the bottom' }, { serial: 'S949', after: 3, alt: 'The boy pointing to the source line as a classmate asks a question' }],
...
STORIES['ancient-civilizations'] = {
  ...
  more: [{ serial: 'S954', after: 2, alt: 'Granaries full of grain, a scribe counting jars with marks on clay' }, { serial: 'S955', after: 3, alt: 'A city wall rising beside the fields, workers who are not farming' }],
...
STORIES['logarithms'] = {
  ...
  more: [{ serial: 'S978', after: 2, alt: 'Eight becoming 16, 32, 64, with the doublings counted' }, { serial: 'S979', after: 3, alt: '2 to the x equals 64 written above log base 2 of 64 equals 6' }],
...
STORIES['absolute-value'] = {
  ...
  more: [{ serial: 'S981', after: 1, alt: 'A number line with 3 marked and two spots four away' }, { serial: 'S982', after: 2, alt: 'The two cases written out: x minus 3 equals 4, and equals minus 4' }],
...
STORIES['waves'] = {
  ...
  more: [{ serial: 'S999', after: 0, alt: 'A slow shake: a few long waves on the rope' }, { serial: 'S1000', after: 3, alt: 'A fast shake: many short waves, the same speed down the rope' }],
...
STORIES['momentum'] = {
  ...
  more: [{ serial: 'S1005', after: 0, alt: 'A hand stopping the bike easily' }, { serial: 'S1006', after: 3, alt: 'Two carts colliding on a track, their totals written before and after' }],
...
STORIES['synthesis-essay'] = {
  ...
  more: [{ serial: 'S1014', after: 0, alt: 'An outline with one paragraph per source, crossed out' }, { serial: 'S1015', after: 3, alt: 'A new outline with one paragraph per reason, sources mixed under each' }],
...
STORIES['america-in-world-war-two'] = {
  ...
  more: [{ serial: 'S1029', after: 2, alt: 'Landing craft at dawn on a beach, June 6, 1944' }, { serial: 'S1030', after: 3, alt: 'Women on a factory line building aircraft' }],
...
STORIES['cold-war'] = {
  ...
  more: [{ serial: 'S1032', after: 2, alt: 'A missile on a truck under palm trees, ships in a ring around an island' }, { serial: 'S1033', after: 3, alt: 'A wall coming down in 1989, people on top of it' }],
...
STORIES['civil-rights-movement'] = {
  ...
  more: [{ serial: 'S1035', after: 2, alt: 'An empty bus seat, 1955' }, { serial: 'S1036', after: 3, alt: 'A president signing with many pens, 1964' }],
...
STORIES['assumptions'] = {
  ...
  more: [{ serial: 'S1059', after: 1, alt: 'The claim at the top, the reason below, a gap between' }, { serial: 'S1060', after: 2, alt: 'The missing stair drawn in dotted lines, labeled' }],
...
STORIES['human-impact'] = {
  ...
  more: [{ serial: 'S1077', after: 1, alt: 'A river measured year by year, a line rising' }, { serial: 'S1078', after: 2, alt: 'A factory outflow, then a filter, then the line falling' }],
...
STORIES['research-paper'] = {
  ...
  more: [{ serial: 'S1092', after: 2, alt: 'Each source with a job written beside it: background, data, counterpoint' }, { serial: 'S1093', after: 3, alt: 'The final answer paragraph, built on the sources but in her own voice' }],
...
STORIES['personal-essay'] = {
  ...
  more: [{ serial: 'S1095', after: 1, alt: 'A trophy shelf, faded, with one small photo in focus' }, { serial: 'S1096', after: 2, alt: 'A boy and his grandfather at a workbench, fixing a radio' }],
...
STORIES['three-branches'] = {
  ...
  more: [{ serial: 'S1104', after: 2, alt: 'A veto stamped on a bill, then a two-thirds vote overriding it' }, { serial: 'S1105', after: 3, alt: 'A court striking a law, and a Senate confirming a judge' }],
...
STORIES['scarcity-and-opportunity-cost'] = {
  ...
  more: [{ serial: 'S1119', after: 2, alt: 'The shoes bought, the concert poster fading behind' }, { serial: 'S1120', after: 3, alt: 'A price tag that reads: the concert' }],
...
STORIES['mean-median-mode'] = {
  ...
  more: [{ serial: 'S1131', after: 0, alt: 'Six monthly budgets in a row, one far taller' }, { serial: 'S1132', after: 3, alt: 'The same six sorted, a finger on the middle two' }],
...
STORIES['correlation-causation'] = {
  ...
  more: [{ serial: 'S1143', after: 2, alt: 'Four small diagrams: A to B, B to A, a third thing to both, and a shrug' }, { serial: 'S1144', after: 3, alt: 'A sun drawn above both the ice cream cart and the crowded pool' }],
...
STORIES['academic-structure'] = {
  ...
  more: [{ serial: 'S1149', after: 2, alt: 'Claim, evidence, and an empty slot labeled warrant' }, { serial: 'S1150', after: 3, alt: 'The slot filled, the paragraph now standing' }],
...
STORIES['ending-sounds'] = {
  ...
  more: [{ serial: 'S1173', after: 0, alt: 'The boy saying cat fast, the end sound blurred' }, { serial: 'S1547', after: 2, alt: 'The boy with his tongue tapping behind his teeth' }, { serial: 'S1548', after: 4, alt: 'A boy saying the end of a word with his lips popping, a toy dog and a cup on the kitchen table' }, { serial: 'S1549', after: 5, alt: 'A bus drawn with a hissing sss at its end' }],
  title: 'The sound at the end', art: 'S1172', cast: [],
  alt: 'A small boy saying a word slowly with a cat on his lap, three letters floating from his mouth',
  words: [
    'Sam could hear the start of cat. Cuh. He could not hear the end. It went by too fast. Cat. Gone.',
    'His dad said, say it slowly. Sam said cat. His dad said, slower. Like a snail.',
    'C. A. T. There it was. A little tuh at the end. His tongue tapped behind his teeth. Tuh.',
    'Then bus. B, u, sss. The last sound was sss. A hiss, like a snake.',
    'Then dog. D, o, guh. Guh at the end. Then cup. C, u, puh. Puh! His lips popped.',
    'Sam said every word in the kitchen slowly. Pan. Nnn. Spoon. Nnn. Fork. Kuh. He found every ending.',
...
STORIES['dictionary-skills'] = {
  ...
  more: [{ serial: 'S1176', after: 0, alt: 'A girl paging through the wrong part of a huge dictionary, a picture of a giraffe on the page' }, { serial: 'S1177', after: 1, alt: 'A dad and his daughter at a kitchen table, the dad spelling a word out on his fingers' }, { serial: 'S1866', after: 2, alt: 'Dictionary pages fanned out like a deck of cards, the girl flipping toward the back' }, { serial: 'S1867', after: 3, alt: 'The girl pointing at the two top corners of a dictionary page' }, { serial: 'S1868', after: 4, alt: 'The girl with her finger on the right entry halfway down a dictionary page, smiling' }],
  ...
  words: [
    'Priya needed the word jungle for her report and opened the dictionary to G, because the word starts with the same sound as giraffe. Nothing. She flipped forward and back until the pages blurred. The dictionary was enormous, and the word was hiding.',
    'Her dad asked how jungle was spelled. J, U, N, G, L, E, she said. Then why look in G? Because jungle and giraffe start with the same sound, she said. But not the same letter. A dictionary does not care how a word sounds. It only cares how it is spelled.',
    'So she went to J. But J still had pages and pages. Her dad showed her the second letter trick. Words that start with the same letter are sorted by the next one: bat, bed, bin. JA came first, then JE, JI, JO, and last, JU.',
    'Then she noticed two words printed in bold at the top of every page. She had never once looked at them. They were guide words: the first and last words on that page.',
    'One page said jumpy at the top left and junk at the top right. Jungle comes after jumpy, because N comes after M. It comes before junk, because G comes before K. So it had to be on that page, and there it was.',
    'A dictionary is sorted by the first letter, then the second, then the third. Guide words name a page\'s first and last entries, so you never have to read a page to know if your word is on it.',
  ],
};
STORIES['simple-machines'] = {
  about: 'a piano too heavy to lift, and the ramp that did not make it any lighter',
  more: [{ serial: 'S1179', after: 0, alt: 'Two movers straining to lift the piano straight up, unable to' }, { serial: 'S1180', after: 2, alt: 'The long ramp beside the tall truck bed, the piano halfway up' }, { serial: 'S1887', after: 3, alt: 'A dolly stacked with boxes, a crowbar prying open a crate and a flag rising up a pole next door' }, { serial: 'S1888', after: 4, alt: 'A long lever handle pushed down far to lift a heavy crate a little' }, { serial: 'S1889', after: 5, alt: 'The six simple machines in a row: a ramp, a wedge, a screw, a lever, a wheel and axle, and a pulley' }],
  ...
  words: [
    ...
    'Nowhere, the mover said. The ramp made a trade. Instead of lifting the piano straight up four feet, they pushed it along twelve feet of ramp. Less force, more distance. The work, the push times the distance, stayed about the same.',
    'That ramp is a simple machine, an inclined plane. Nina counted the others that day. The dolly under the boxes rolled on wheels and axles. The crowbar that opened a crate was a lever. Next door, a flag went up its pole on a pulley.',
    'Every one made a job easier without an engine, and every one made the same trade. A long lever handle moves far so the other end can move a little and push hard.',
    'There are six simple machines: the inclined plane, the wedge, the screw, the lever, the wheel and axle, and the pulley. None of them gives you something for nothing.',
    'Machines do not make jobs smaller. They make them possible, by stretching a hard push into a long, easy one.',
  ],
};
STORIES['coordinate-plane'] = {
  about: 'a treasure map, two numbers, and the boy who walked them in the wrong order',
  more: [{ serial: 'S1182', after: 0, alt: 'A treasure map with 3, 2 written on it beside a small X' }, { serial: 'S1183', after: 1, alt: 'The same boy at a different corner after walking north first' }, { serial: 'S1979', after: 2, alt: 'The boy walking three paths east, then two north, to a marked corner' }, { serial: 'S1980', after: 3, alt: 'A boy beside a flag on a lamppost four blocks north of the park gate' }, { serial: 'S1981', after: 4, alt: 'A grid with an x-axis along the bottom and a y-axis up the side, two points marked' }],
  ...
  words: [
    ...
    'The map had a second clue: 0, 4. Jamal laughed. Zero across meant no walking east at all. He walked four blocks straight north from the start and found a flag on a lamppost. The start of the park, where both numbers are zero, is called the origin.',
    'His sister wrote the pairs the way mathematicians do, in parentheses with a comma: (3, 2) and (0, 4). The first number goes along the x-axis, across the bottom. The second goes up the y-axis. Every point on the plane has exactly one address.',
...
STORIES['quarter-hours'] = {
  ...
  more: [{ serial: 'S1188', after: 0, alt: 'The clock with the long hand on the 3' }, { serial: 'S1189', after: 1, alt: 'A boy running for the school bus with one shoe untied, the bus pulling away' }, { serial: 'S1712', after: 3, alt: 'The long hand on the 6, half past' }, { serial: 'S1713', after: 4, alt: 'The long hand on the 9, the boy grabbing his bag' }],
  ...
  words: [
    ...
    'He did not want to miss the bus again. Last time he had run the whole way with one shoe untied.',
    'His mom showed him. The clock is a pie. Cut it in four. The long hand on the 3 has gone a quarter round. Quarter past.',
    'On the 6, halfway round. Half past. On the 9, three quarters. Only a quarter left to go. Quarter to.',
    'Sam looked again. Long hand on the 3. Quarter past eight. Time to go. He grabbed his bag and both shoes were tied.',
    'At school the clock said quarter to nine when the bell rang. Sam knew it before the bell did.',
    'The long hand on the 3 says quarter past. On the 6, half past. On the 9, quarter to.',
  ],
};
STORIES['sound'] = {
  about: 'a rubber band, a paper cup and the buzz a boy could feel with his finger',
  more: [{ serial: 'S1191', after: 0, alt: 'The rubber band a blur as it shakes after a pluck, a fingertip about to touch it' }, { serial: 'S1192', after: 2, alt: 'Ripples of air spreading from a shaking rubber band toward a child\'s ear' }, { serial: 'S1791', after: 3, alt: 'The boy stretching the band tighter across the cup, listening closely' }, { serial: 'S1792', after: 4, alt: 'The boy with his ear flat on a wooden desk, tapping the far end with a pencil' }, { serial: 'S1793', after: 5, alt: 'A girl with her hand on her throat, humming, eyes closed' }],
  ...
  words: [
    'Owen was building a guitar for music class out of a paper cup and a rubber band. He stretched the band over the cup and plucked it. Twang. He plucked it again and, while it was still buzzing, touched it with one finger. It tickled. The sound stopped the moment he touched it.',
    'That was strange. Why would a finger stop a sound? He tried again and again. Every time the band shook, there was a sound. Every time he held it still, silence. The sound and the shaking seemed to be the same thing.',
    'They were. Sound is a vibration: something shaking fast enough to shake the air. The shaking air travels to your ear, and your ear feels it as sound.',
    'Owen plucked harder, and the band shook wider. The sound got louder. He stretched the band tighter, and it shook faster. The sound went higher. He loosened it, and the note dropped low. Bigger shake, louder. Faster shake, higher. Slower shake, lower.',
    'Then he put his ear flat on his desk and tapped the far end with a pencil. The tap came through the wood, louder than it came through the air. Sound can travel through air, water or wood. With nothing at all to travel through, like in outer space, there is no sound.',
    'Every sound you have ever heard is something vibrating, from a guitar string to a drum skin to your own voice. Put a hand on your throat and hum. That buzz is you, shaking the air.',
  ],
};
STORIES['microscopes'] = {
  about: 'a slice of cork under a lens, and the tiny rooms a girl found inside it',
  more: [{ serial: 'S1194', after: 2, alt: 'The view through the lens: rows of tiny box-shaped rooms in the cork' }, { serial: 'S1195', after: 3, alt: 'An old engraving-style drawing of the same cork cells from 1665' }],
...
export const COURSE_STORIES = {
  'fractions-intro': { title: 'The pizza that fed the whole street', about: 'a block party, three pizzas, and every fraction on the block', art: 'CS1', alt: 'A street block party with three pizzas on a folding table, children with paper plates, chalk marks on the sidewalk', cast: [], words: ['The pizzas arrived at noon: three of them, all the same size, for a street with more mouths than slices. The air smelled of cut grass and charcoal. Mrs. Okafor from number twelve picked up the knife. Somebody had to cut them, she said, and cutting is where fractions live.', 'The first pizza went into two equal pieces, halves, and Malik\'s sister took one. The second went into four equal pieces, fourths, and Malik took two. Equal pieces are the whole rule. Cut a pizza into four lopsided chunks, and the word fourth stops meaning anything.', 'Then the arguments started. Malik said his two fourths were less than his sister\'s one half, because a half was one big slice and he had two little ones. Mrs. Okafor laid the slices on one plate, crust to crust. Two fourths covered exactly the same space as one half. Same pizza, different cuts.', 'The third pizza had to reach everyone else, so it went into eighths. Wren got one and was sure it beat one of Malik\'s fourths, because eight is bigger than four. They held the slices side by side. Her eighth was half the size of his fourth. The bottom number counts the cuts, and more cuts make smaller pieces.', 'Wren\'s little brother took his eighths one at a time, grinning with sauce on his chin. One eighth, two eighths, three eighths. A fraction is built from unit pieces like that, and three eighths is simply three of them.', 'Then three latecomers ran up, and only two fourths were left. Mrs. Okafor did not flip a coin. She cut each slice into three equal pieces and gave every latecomer one piece of each. Two slices shared by three people is two thirds of a slice apiece. Nobody argued, which was a first for the afternoon.', 'When the pizzas were gone, Wren drew a chalk line on the sidewalk from 0 to 1 and cut it into eight equal steps. Her friends hopped behind her as she walked it: one eighth, two eighths, three eighths, four eighths. Four eighths landed exactly halfway, right where one half would be.', 'A fraction is a share of one whole, cut into equal parts. The bottom number says how many parts, the top says how many you have, and every fraction has its own spot on the line from 0 to 1. The street had eaten the lesson.'], more: [{ serial: 'CS63', after: 1, alt: 'A woman cutting one pizza into two halves and another into four fourths on a folding table' }, { serial: 'CS64', after: 2, alt: 'Two fourth slices and one half slice laid crust to crust on one plate, covering the same space' }, { serial: 'CS65', after: 3, alt: 'A girl holding up a thin eighth slice beside a boy with a wider fourth slice' }, { serial: 'CS66', after: 5, alt: 'One slice cut into three equal pieces as three latecomers run up the sidewalk' }, { serial: 'CS67', after: 6, alt: 'A girl hopping along a chalk number line on the sidewalk, eight equal steps from end to end' }] },
  'reading-3': { title: 'The day the newspaper came to school', about: 'a class that wrote its own newspaper and learned to read like editors', art: 'CS2', alt: 'A classroom holding up a freshly printed one-page newspaper, children at desks with red pens', cast: [], words: ['The class was going to make a newspaper. One page, real stories, printed for the whole school, with real bylines. Ms. Reyes handed out red pens and made one rule: every reader must understand every story on the first try.', 'The first job was headlines. A headline is the main idea in a few words. The story about the leaky gym roof had twelve facts in it, from the drip on the free-throw line to the bucket everyone called Gerald. The headline was four words long. Gym Roof Leaks Again.', 'The second job was hard words. The sports report called the fifth grade team unbeatable, and half the class stopped reading. So they took the word apart. Un means not. Able means can be. Unbeatable: cannot be beaten. Once you can see the pieces, a long word opens like a door.', 'Another story said the rain had been torrential. Nobody knew that word either, but the next sentence helped: the gutters overflowed, and the parking lot turned into a lake. Torrential rain is very heavy rain. The words around a stranger usually give it away, so the class left it in.', 'The lunch review was the trickiest. It said the Friday pizza was the best in the world. Fact or opinion? Nobody could check every pizza in the world, so it was an opinion. It stayed in the paper, but now it said whose opinion it was: the writer\'s.', 'The field trip story had its events in a jumble, like a puzzle dumped on a table. So the writers put them in order and showed the causes. The bus was late because of the rain, so lunch moved indoors, and then the sun came out just in time for the walk home.', 'The best story of all was a profile of Mr. Bell, the custodian. The writer never called him kind. She wrote what he did: he dried the gym floor with his own towels before the big game, and he knew every kid\'s name by October. Readers could see who he was from what he did.', 'When the page was printed, every reader in the school found the main ideas and opened the long words. They knew what was checked and what was only felt, followed each story in order and met Mr. Bell. That is reading to understand, and the class had learned it by working from the other side of the page.'], more: [{ serial: 'CS68', after: 1, alt: 'A bucket catching a drip on the free-throw line of a school gym' }, { serial: 'CS69', after: 2, alt: 'Children pulling a long word apart like puzzle pieces on a classroom table' }, { serial: 'CS70', after: 3, alt: 'Heavy rain overflowing the gutters and turning a school parking lot into a lake' }, { serial: 'CS71', after: 5, alt: 'A school bus in the rain, children eating lunch indoors, then sunshine on the walk home' }, { serial: 'CS72', after: 6, alt: 'A school custodian drying a gym floor with his own towels while children wave hello' }] },
  'reading-4': { title: 'The letter with the missing lines', about: 'a letter from a grandmother, and everything it said without saying', art: 'CS3', alt: 'A child at a kitchen table reading a two-page handwritten letter, a dictionary open beside it, a garden photo tucked in the envelope', cast: [], words: ['The letter was two pages long and said almost nothing directly. That was the point. It began with the weather, which is how you know someone has something else to say. It came from a grandmother who had just moved three hundred miles away.', 'The grandchild who read it had learned to summarize: keep the big events, drop the details. A summary is short on purpose. The big events were three: a move, a new garden and a question about visiting. Everything else, the rain, the neighbor and the price of tomatoes, was detail.', 'Then came the reading between the lines. The letter never said she was lonely. It said the house was quiet at night and that the garden was slow to grow when there was nobody to show it to. That is an inference: a guess with a clue behind it.', 'She wrote that the new town was as strange as a shoe on the wrong foot, a simile, because it compares with as. Later she wrote that the days were a long gray hallway, a metaphor, because it says the days were one. Both told the truth better than plain words would have.', 'The letter had a shape too. First the move, then the garden, then the question, with signal words holding it together: first, after that, finally. Structure is a map. A reader who knows the shape can find the question without reading every line twice. Hers was on the last page.', 'One word the reader did not know, disconsolate, sent them to the dictionary. The guide words at the top of each page, the first and last words on it, walked them there: past dirt, past disagree, to a page that began with disco and ended with discord. Disconsolate: unable to be comforted.', 'The words the grandmother chose did something the facts alone could not. A reader who only summarized would know she moved and planted a garden. A reader who inferred would know she missed them, and that the question at the end was not really about June. It was about whether anyone would come.', 'The reply went out that afternoon, in the same shape: first the news, then the feelings, finally the answer. It said yes. The visit was arranged for June, and the next letter from the grandmother began with the weather again, and then said, plainly, that the garden was finally growing. It had someone to show it to.'], more: [{ serial: 'CS108', after: 0, alt: 'An envelope with a pressed flower and two handwritten pages on a sunny kitchen table' }, { serial: 'CS109', after: 2, alt: 'A quiet house at night with one lamp on and a small garden outside the dark window' }, { serial: 'CS110', after: 3, alt: 'A left shoe on a right foot on one side and a long gray hallway on the other, like two pictures in a book' }, { serial: 'CS111', after: 5, alt: 'A child running a finger down a dictionary page, the guide words at the top of the page highlighted' }, { serial: 'CS112', after: 7, alt: 'A grandmother in a sun hat kneeling in a garden of tall green plants while a child waves from the gate' }] },
  'science-3': { title: 'The storm that came to the science fair', about: 'a science fair afternoon when the weather did the demonstrating', art: 'CS4', alt: 'A school science fair on a sunny lawn with folding tables and ribbons, dark clouds rolling in at the edge of the sky', cast: [], words: ['The science fair was set up outside on the lawn, which everyone later agreed was a mistake. Table one had an ice cube melting on a plate, a glass of water and a thermos of hot water puffing steam: solid, liquid, gas. Table two had a wagon on a wooden ramp for pushes and pulls.', 'Table three had a jar of tadpoles with tiny back legs, halfway to being frogs. Table four had a rain gauge that had never seen rain. Table five had a jar of garden dirt settled into layers, sand at the bottom, and table six had a poster of a food chain: grass, grasshopper, bird, hawk.', 'Then the sky went dark, and thunder rumbled far off. The principal did not wait. When thunder roars, she called, go indoors! Everyone grabbed a poster and ran for the gym, because thunder means lightning is close enough to be dangerous.', 'They watched the rest through the gym windows. The wind shoved the wagon down its ramp with nobody touching it, and gravity pulled it faster down the slope. It was the best demonstration of a force anyone gave all day. Out on the grass, the rubbing of friction slowed it until it stopped by the flagpole.', 'The rain came down so hard that the gauge filled past its first line in ten minutes. Nobody had ever seen the gauge move that fast. On table one, the ice cube had melted into a puddle, and the thermos had stopped steaming. Rain on the windows ran together into little streams.', 'When the thunder cracked close, the gym windows buzzed under a boy\'s hand. He felt it and heard it at the same moment. Sound is a vibration, and a big one can shake the glass it passes through.', 'The storm moved on in half an hour. The posters were soaked, but the tadpoles did not mind at all. A tadpole lives in water and was on its way to becoming a frog either way. A robin hopped onto the wet grass to hunt for insects, the food chain from the poster back at work.', 'The judges gave every table a ribbon. In one afternoon they had seen matter change state, forces move things, a life cycle turning, weather arriving and sound shaking a window. The weather had done the demonstrating, and the judges had the good sense to watch it from indoors.'], more: [{ serial: 'CS73', after: 0, alt: 'Science fair tables on a school lawn: a melting ice cube, a glass of water and a steaming thermos beside a wagon on a ramp' }, { serial: 'CS74', after: 1, alt: 'A jar of tadpoles with tiny back legs, a rain gauge, a jar of layered dirt and a food chain poster on folding tables' }, { serial: 'CS75', after: 2, alt: 'Children running into the school gym with their posters as dark clouds roll in, the principal holding the door' }, { serial: 'CS76', after: 3, alt: 'The wagon rolling down its ramp in the wind and across the grass toward the flagpole' }, { serial: 'CS77', after: 5, alt: 'A boy with his hand on a rain-streaked gym window as thunder cracks outside' }] },
  'science-4': { title: 'The night the lights went out', about: 'a family evening in a blackout, and everything that still worked', art: 'CS5', alt: 'A family in a dark kitchen with a flashlight beam, a candle, rain on the window, a hand pump in the corner', cast: [], words: ['At seven the lights went out on the whole street. The first thing anyone learned was which energy was which: the lamp had been light, the heater heat, the radio sound, the fridge motion, and all of it had been electrical until the line went down.', 'The second thing was a circuit. The flashlight only lit when the switch closed the loop, and when the batteries went in the wrong way round, nothing. Electricity needs a complete path from the battery, through the bulb and back. Open the switch and the path is broken.', 'The youngest child wanted to use a metal spoon to fix a loose wire. The oldest said no. Metal is a conductor, which is why the wires inside a cord are copper, and rubber and plastic are insulators, which is why the cord is wrapped in them. Nobody touched the wire.', 'Outside, the storm that had cut the line was doing other work. Rain was carrying the garden soil down the path: erosion, said the oldest child, who had done it in a tray at school. At the bottom, by the gate, it was piling into a small bank: deposition.', 'Water had done the first part too, long before the storm. The rock by the gate was cracked where ice had frozen in it winter after winter and pushed it apart. Breaking rock down is weathering. Carrying the pieces away is erosion. Dropping them somewhere else is deposition. The path had all three.', 'The moths on the porch had gone quiet, and the owl in the pine did not care about the dark at all. Its large eyes gather what little light there is, and its soft-edged feathers make almost no sound. An adaptation is a body part or behavior that helps a living thing survive where it lives.', 'The last thing was the pump. The basement was taking on water, and the hand pump worked with a lever, a bar with a long handle that turns on a fixed point. It took a lot of pulling to lift a little water, but it lifted it. A lever trades distance for force.', 'When the lights came back at midnight nobody was scared of the dark anymore. They had seen energy in five forms and a loop that must be closed. They had met a conductor and an insulator, land broken and carried and dropped, animals fitted to the night, and a machine that makes a hard job possible.'], more: [{ serial: 'CS113', after: 1, alt: 'A flashlight taken apart on a kitchen table, batteries in a line and the bulb glowing when the loop is closed' }, { serial: 'CS114', after: 2, alt: 'A copper wire with its rubber coating peeled back, next to a metal spoon and a plastic cup' }, { serial: 'CS115', after: 3, alt: 'Rainwater carrying brown soil down a garden path to a small pile of mud by a gate' }, { serial: 'CS116', after: 5, alt: 'A barn owl with large dark eyes perched in a pine tree at night, its soft feathers edged in moonlight' }, { serial: 'CS117', after: 6, alt: 'A child pulling the long handle of a hand pump in a flooded basement, water spilling into a bucket' }] },
  'science-5': { title: 'The trip to the lake', about: 'a weekend at the lake and the science that came along', art: 'CS6', alt: 'A family campsite by a lake at dusk, a tent, a campfire, a full moon rising over the water', cast: [], words: ['The lake trip started with lemonade. Sugar in water: it vanished, but the drink was sweet. Sand from the shore in the bucket: it sank and could be poured off. A solution and a mixture, before the tent was even up. A cup left in the sun dried to a sticky ring, the sugar staying behind when the water left.', 'That night the moon came up over the water, and the youngest wanted to know why it changed shape. A ball, a flashlight, a slow walk around the campfire: the moon circles the Earth, and we see its lit side from different angles. It was full that night, the oldest said, because the moon sat on the far side of Earth from the sun.', 'In the morning the tent was wet on the inside. Nobody had spilled anything. The night air had cooled, and the water in it had turned to drops: condensation. By noon the drops were gone again, up into the air, and the clouds building over the far hills were the same water on its way back. The lake was one stop on a loop that never ends.', 'After lunch they took the canoe out. Paddling on one side only sent the canoe in a slow circle, and paddling on both sides together sent it straight. Every stroke pushed water back, and the water pushed the canoe forward. When everyone stopped, the canoe slowed and drifted still, the water dragging against the hull until the push was used up.', 'On the far shore the rocks lay in flat layers, like a stack of books on its side. In one of them the youngest found a tiny shell pressed into the stone. A fossil, which meant this ground had once been under water. The layers below it were older still.', 'That evening the cousins skipped stones. The trick was a flat stone thrown low and fast with a spin, so it bounced instead of sinking. Nobody was born knowing it. Every cousin learned it that afternoon, one sunk stone at a time.', 'On the last day the cousins compared: two had brown eyes like their fathers, inherited; all of them could now skip a stone, learned. The drive home passed a field of sunflowers turned toward the sun, and the youngest, who had been paying attention, said that was inherited too. Nobody argued.', 'Back home, the youngest made a list of everything the lake had taught. A solution and a mixture. The moon. The loop of water. A push and a drag. A shell in stone. And the difference between what you are born with and what you practice. It was a longer list than the one for school, and nobody had assigned it.'], more: [{ serial: 'CS143', after: 0, alt: 'A cup of lemonade dried to a sticky ring on a sunny picnic table' }, { serial: 'CS144', after: 1, alt: 'A child walking a ball around a flashlight by a campfire, the ball half lit' }, { serial: 'CS145', after: 3, alt: 'A family paddling a canoe on both sides across a calm lake' }, { serial: 'CS146', after: 4, alt: 'A tiny fossil shell in a layer of flat rock on a lake shore' }, { serial: 'CS147', after: 6, alt: 'A field of sunflowers facing the sun beside a country road' }] },
  ...
  'history-4': { title: 'Six flags over one town', about: 'one Texas town, the six flags that flew over it, and the people who were there before any of them', art: 'CS9', alt: 'A Texas town square with six flags on poles in front of a courthouse, children walking past', cast: [], words: ['The town had been a town for a very long time. Before the roads, the Caddo farmed corn, beans and squash on the river flats to the east, and the Comanche rode the plains beyond. People had lived on this ground for thousands of years before anyone raised a flag over it.', 'Then a mission bell rang, and Spain called the place its own for more than a hundred years, though the priests were few and the settlers fewer. For a few years a French explorer named La Salle kept a fort on the coast, and France claimed the land too. His fort did not last, but his flag is still counted.', 'In 1821 a new flag went up: Mexico, newly free of Spain. Mexico opened the door to families from the north, and Stephen F. Austin led the first of them to farms along the Brazos. More came than anyone planned, and they brought their own ideas about how they wanted to be governed.', 'The arguments turned into a war. In October 1835 a cannon at Gonzales fired under a flag that said come and take it. In March 1836 the Alamo fell. In April, at San Jacinto, the fight took eighteen minutes, and the town belonged to a new country, the Republic of Texas, with a single star on its flag.', 'The Republic had to do everything a country does, with very little money. It printed its own paper money, which soon lost most of its value. It moved its capital more than once and chose Austin in 1839. Sam Houston led it twice, and people argued about joining the United States the whole time.', 'Nine years after San Jacinto the star joined twenty-seven others. Texas was the 28th state. Sixteen years after that, in 1861, Texas left the Union and joined the Confederacy, and the town sent its young men to the Civil War. After the war, on June 19, 1865, a Union general announced in Galveston that the enslaved people of Texas were free, and Juneteenth began.', 'The flags in the town square today tell the whole story in cloth: Spain, France, Mexico, the Republic, the Confederacy and the United States. Six flags, but more than six peoples, because the Caddo and the Comanche were here before any cloth went up a pole.', 'The children who walk past them on the way to school are walking the same ground the Caddo farmed. One of them stopped to count the stars on the last flag. Fifty. The single star is still there too, on the Texas flag beside it.'], more: [{ serial: 'CS103', after: 1, alt: 'A small log fort on a flat Texas coast with tall grass and a gray sea behind it' }, { serial: 'CS104', after: 2, alt: 'Settler families with wagons crossing the Brazos River toward new farms at sunrise' }, { serial: 'CS105', after: 3, alt: 'A small brass cannon under a white banner showing a cannon and a lone star, in an autumn field' }, { serial: 'CS106', after: 5, alt: 'A crowd gathered on a Galveston street in 1865 listening to an announcement, the harbor bright behind them' }, { serial: 'CS107', after: 7, alt: 'A child pointing up at six flags on tall poles in a town square, counting the stars on one of them' }] },
  'history-5': { title: 'The road from the coast', about: 'a family who arrived in 1620 and the country that grew around their descendants', art: 'CS10', alt: 'An old wooden house on a rocky New England coast, a road running inland, a family group in period clothes on the step', cast: [], words: ['The first of them came off a ship in 1620 and built a house on the coast, in the New England row of what became thirteen colonies. The winters were long, and half of the first settlers did not live to see spring. Their grandchildren farmed rocky fields and fished the cold water, and voted in town meetings on everything from roads to the minister\'s pay.', 'Their great-grandchildren paid a tax on tea they had no vote about, and in 1773 one of them was on a dark harbor tipping crates into the water. In 1775 the fighting started at Lexington and Concord, a day\'s ride away, and two of the family\'s sons marched.', 'In 1776 the family signed nothing but heard the Declaration read aloud in a market square. In 1787 they argued about the Constitution at the dinner table: a stronger plan than the first one, three branches, each able to stop the others.', 'In 1803 a cousin went west into the Louisiana Purchase, fifteen million dollars for land that doubled the country, and did not come back. His letters, when they came, told of rivers wider than the town and of the nations who had lived there long before him. His grandson crossed the plains in a wagon in 1849, headed for California gold.', 'In 1861 two brothers of the family fought on opposite sides. In 1865 the one who lived came home to a country that had ended slavery at the cost of more than six hundred thousand lives. His brother never came home; his name is carved on a stone in the town square with forty others.', 'The next generation went to work in the mills. A daughter ran a loom in a factory town where the machines never stopped and a whistle told everyone when to eat. Her husband laid track for the railroad that, by 1869, crossed the whole continent.', 'Around 1900 the family changed again. A young man from Italy came through Ellis Island with one bag, found work in the city, and married the loom worker\'s granddaughter. He brought a recipe and a language, and the family took both. From then on, holiday dinners were louder and better.', 'The house on the coast is a museum now. Visitors can walk from its door down the old road inland, the same road the family took west, to war, to the mills and back again. It runs all the way to Texas, and every mile of it is someone\'s story.'], more: [{ serial: 'CS148', after: 1, alt: 'Minutemen marching down a country road toward Lexington at dawn in 1775' }, { serial: 'CS149', after: 3, alt: 'A covered wagon crossing the plains toward the mountains in 1849' }, { serial: 'CS150', after: 4, alt: 'A tired soldier walking home down a country road in 1865' }, { serial: 'CS151', after: 5, alt: 'A young woman running a loom in a busy mill full of machines' }, { serial: 'CS152', after: 6, alt: 'A young man with one bag on a steamship arriving at Ellis Island' }] },
  ...
  'tech-3': { title: 'The robot birthday', about: 'a birthday party run by a robot that did exactly what it was told', art: 'CS13', alt: 'A birthday table with a small white robot carrying a slice of cake on a plate, children laughing', cast: [], words: ['The robot came in a box on the morning of June\'s birthday party. It was small and white, with two blue lights for eyes, and her aunt had built it. The first thing it did was nothing at all. Nobody had told it anything. It sat on the table like a guest who had forgotten why it came.', 'June\'s aunt, who built robots for a living, showed her the three parts. The buttons on its back were inputs: you press them to tell the robot something. The little screen and the beep were outputs: that is how it shows you something. In between, a program waits for steps. No steps, no robot.', 'June wrote her first program on an index card and typed it in with the buttons. Forward two. Turn left. Beep. The robot rolled two squares across the checkered tablecloth, turned, beeped and stopped dead, because that was the end of the card. It did exactly what it was told, and not one thing more.', 'Serving the cake needed more steps than anyone expected. Pick up a plate. Put a slice on it. Drive to the next guest. Hand it over. Four steps, in order, once for every guest, and there were ten guests. Written out, that was forty lines, and June\'s hand hurt by line twelve.', 'Then her cousin noticed that the same four steps kept repeating. So June wrote them once, inside a loop: repeat ten times. Forty lines became five. The robot served ten plates without a single mistake, and the whole program fit on a card small enough for a pocket.', 'The only disaster was the juice. The card said pour the juice, and nobody had said take the cap off first. The robot tipped the bottle over every cup, very politely, and not a drop came out. Everyone laughed so hard that June\'s grandpa had to sit down.', 'June added one line above the pour: take off the cap. The juice poured, and the robot beeped once, which was the closest it could get to singing. Her aunt said June had just debugged her first program: she found the missing step and fixed it.', 'Every computer works like that robot. Inputs tell it, outputs show you, and a program is the steps in between. The order matters, every step must be there, and a loop lets a few lines do a lot of work.'], more: [{ serial: 'CS93', after: 1, alt: 'A small white robot on a party table, an aunt pointing to its buttons, its screen and its speaker' }, { serial: 'CS94', after: 2, alt: 'The robot rolling two squares across a checkered tablecloth, turning left and beeping' }, { serial: 'CS95', after: 3, alt: 'A girl writing a long list of steps on index cards, her hand tired, the birthday cake waiting' }, { serial: 'CS96', after: 5, alt: 'The robot politely tipping a capped juice bottle over a cup while everyone laughs' }, { serial: 'CS97', after: 6, alt: 'Juice pouring into cups as the girl adds one line to her card and the robot beeps' }] },
  'tech-5': { title: 'The game that kept score', about: 'a class that built a game and learned what a program remembers and decides', art: 'CS14', alt: 'A classroom with a projected simple game, a paddle and ball, a scoreboard, students pointing at one line of code on a whiteboard', cast: [], words: ['The class built a game in a week. On Monday it had a ball and a paddle and no memory: every point was forgotten the moment it was scored. The ball bounced, the paddle moved, and nothing that happened mattered to anything that happened next.', 'Tuesday brought variables: a box named score, a box named lives, and the game began to remember. Score went from 0 to 5 to 8, and lives went down from 3 to 2 when the ball got past. The names stayed the same all game long; only the numbers inside them changed.', 'Wednesday was for deciding. IF the ball touches the paddle THEN bounce, ELSE lose a life. IF lives is 0 THEN show the end. The game did not decide anything by itself; it asked yes-or-no questions the class had written and took whichever road the answer pointed down.', 'The questions had to be asked again and again, many times every second, or the ball would slip past the paddle between two checks. So the whole program sat inside a loop: move the ball, check the paddle, check the lives, draw the screen, and start again. A loop is a set of steps a program repeats.', 'Thursday, the game was wrong. It ended after two lost balls, not three. Nobody deleted anything. They read the steps one at a time, and found the line that checked lives before taking one away instead of after. One line moved, and the game was fixed.', 'Then they tested it the way players would try to break it. One student held the paddle at the very edge. Another pressed two keys at once. A third just let the ball go by, to see whether the end screen appeared. Every test that passed was one less surprise on Friday.', 'Friday was for playing, and for one last box. A variable named best kept the highest score anyone had reached, and IF a new score beat it, THEN best took the new number. By lunch the best score was 41, and a quiet student who had written the loop held it.', 'The game was simple, but it held the whole of programming: boxes that remember, questions that decide, a loop that keeps asking, and a careful reading when something goes wrong. Everything bigger is built from the same four parts. The class kept the game on the classroom computer, and the best score has changed hands eleven times since.'], more: [{ serial: 'CS153', after: 1, alt: 'A whiteboard with two boxes labeled score and lives, numbers crossed out and rewritten' }, { serial: 'CS154', after: 2, alt: 'A ball meeting a paddle beside a fork in the road: bounce, or lose a life' }, { serial: 'CS155', after: 3, alt: 'A circle of arrows around four steps: move the ball, check the paddle, check the lives, draw the screen' }, { serial: 'CS156', after: 5, alt: 'Three students testing a game, one holding the paddle at the very edge of the screen' }, { serial: 'CS157', after: 6, alt: 'A game screen showing best score 41, a proud student at the keyboard' }] },
  ...
  'math-5': { title: 'The bake sale', about: 'a bake sale where every decimal, fraction and box counted', art: 'CS16', alt: 'A school bake sale table with brownies, lemonade, boxes of cookies, a handwritten price list and a cash box', cast: [], words: ['The bake sale needed a table, a cash box and a price list, and the price list was where the decimals lived. Brownies were 1.25, lemonade 0.75. A brownie and a lemonade: line up the points, add the cents, add the dollars, 2.00. The first customer paid with a five, and the change was decimals in reverse: 5.00 minus 2.00, three dollars back.', 'Six lemonades for one family meant multiplying a decimal: six times 75 cents. Six times 75 is 450, and the price had two decimal places, so the answer did too: 4.50. Four dollars fifty, which the family\'s youngest checked by counting out eighteen quarters.', 'The brownies came from a recipe that made a tray, and half the tray had been eaten by breakfast. Half of what was left went to the sale: half of a half, a quarter of the tray. Multiplying by a fraction had made the brownies fewer, which is exactly what fractions do.', 'The cookies came in boxes of 24, and 288 cookies had been baked: how many boxes? Ten boxes used 240, two more used the 48, twelve boxes on the table. Checked backward, twelve times twenty-four was 288, and nobody had to count a single cookie twice.', 'The table sat on a grid painted on the gym floor, and the lemonade stand was three across and two up from the corner, the point (3, 2). The cash box was a box: four cookies long, three wide, two layers high, room for twenty-four cookies.', 'Every hour someone made dots on a line plot for the brownies sold: eight, ten, eleven, nine. The tallest stack showed the busiest hour was the third, just after lunch, and next year the brownies would be ready for it. A line plot does not tell you why. It tells you where to look.', 'Thirty-eight brownies sold at 1.25 each came to 47.50. At the end, the total came from a long sum with brackets in it, and the brackets went first: 38 times 1.25, then the lemonade, then the cookies. The sale had made 143 dollars and 50 cents.', 'Decimals, fractions, division, a grid, a box, a line plot and brackets. Nobody at the table would have called it a math test, but every number on it was one. The class counted the money twice anyway, on two sheets of paper side by side, and both said the same thing. That was the best part.'], more: [{ serial: 'CS158', after: 0, alt: 'A customer handing a five-dollar bill across a bake sale table, three dollars in change coming back' }, { serial: 'CS159', after: 1, alt: 'Eighteen quarters counted out beside six cups of lemonade' }, { serial: 'CS160', after: 3, alt: 'Twelve boxes of cookies stacked on a table beside an empty tray' }, { serial: 'CS161', after: 4, alt: 'A gym floor grid with a lemonade stand at three across and two up from the corner' }, { serial: 'CS162', after: 5, alt: 'A line plot with four stacks of dots, the tallest over the third hour' }] },
  'reading-5': { title: 'The play', about: 'a class play, and everything the script did not say out loud', art: 'CS17', alt: 'A school stage with two children and a bicycle prop, a narrator at the side, an audience of families', cast: [], words: ['The class was putting on a play about two friends who fight over a bicycle and make up. The topic was two friends. The theme, which took a week of rehearsal to find, was that friendship survives a fight. The topic was two words; the theme was a sentence.', 'The play had come from a short book, and the class read both. The book spent three pages inside the younger friend\'s head. The play had no room for that, so it showed her feelings in what she did: she walked past the bicycle twice without looking at it. Same story, two different jobs.', 'The script was in first person for one scene, the narrator saying I, and the audience only knew what she knew. Then the camera moved to the corner: third person, she and he, and suddenly the audience could see the bicycle hidden behind the shed that neither friend could. That was the whole trick of the play.', 'One line said the older friend had cold feet. A first grader in the front row asked why nobody brought him socks. An idiom, said the narrator, not skipping a beat. It means he was nervous. The audience laughed, and the first grader learned a new phrase.', 'When a parent asked afterward how they knew the ending was happy, the cast pointed to the last line. The two friends ride off on the bicycle together, one pedaling and one on the handlebars. A claim about a story needs a line behind it, and that line was the evidence.', 'The week before, someone had written to the principal asking to cancel the play because it took time from math. The class read the letter the way they had learned. The claim was clear. The reason was time. The evidence was missing: no numbers, no schedule, nothing anyone could check.', 'So the class wrote back, and this time the evidence was there: rehearsals had happened at lunch, and not a minute of math had been lost. The principal read both letters and let the play go on. An argument with evidence beat one without. The class pinned both letters to the bulletin board, side by side.', 'After the last bow, the teacher said the play had used every skill of the year: theme, point of view, idioms, evidence, comparing two versions and weighing an argument. The first grader in the front row said it was a good play. That was also true.'], more: [{ serial: 'CS163', after: 1, alt: 'A short book and a play script side by side, the book open to three pages of thoughts' }, { serial: 'CS164', after: 2, alt: 'A stage seen from the corner, a bicycle hidden behind a painted shed' }, { serial: 'CS165', after: 3, alt: 'A first grader in the front row holding up a pair of socks, puzzled' }, { serial: 'CS166', after: 4, alt: 'Two friends riding one bicycle across the stage, one pedaling and one on the handlebars' }, { serial: 'CS167', after: 6, alt: 'A principal at a desk reading two letters side by side' }] },
  ...
  'health-4': { title: 'The week the phone charged and I did not', about: 'one student\'s week of sleep, labels, stairs and screens, kept in a notebook', art: 'CS24', alt: 'A child at a desk with an open notebook showing a week of checkmarks, a cereal box, a stopwatch and a phone charging on the side', cast: [], words: ['The notebook started as a dare from a teacher: one week, write down when you sleep, what you eat, when you move and when you look at a screen. No rules, no grades, just the truth on paper. The notebook was small enough for a pocket. Monday was honest and a little embarrassing.', 'Nine hours of sleep, but the last hour before sleep had been a screen, and the morning felt like wading. Children need about nine to twelve hours of sleep. The brain, the teacher had said, files the day at night, and Monday\'s files were still on the desk.', 'Tuesday was the cereal. Twelve grams of sugar per serving, and the serving was half of what went in the bowl, so the bowl held twenty-four. Sugar was the second ingredient on the list, and ingredients are listed from most to least, so there was a lot of it. Reading a label is reading the truth about food.', 'Wednesday was the stairs. Sitting still, the heart beat twelve times in ten seconds, seventy-two a minute. At the top of the stairs it was twenty-five in ten seconds. A minute later, eighteen. After two minutes, thirteen. The heart came back fast, and that, it turned out, was the whole point.', 'A heart that recovers quickly is a heart that is getting stronger. Kids need about an hour of moving every day, and it does not have to happen all at once. Recess counted. So did the walk to the bus and the stairs, twice.', 'Thursday was the screens. The tablet had been on for two hours straight, and the eyes felt dry and tired. The teacher\'s rule: every twenty minutes, look at something twenty feet away for twenty seconds. The eyes need to change focus, the way legs need to change position.', 'Thursday dinner was a plate the notebook could be proud of: half of it fruits and vegetables, green and orange, a quarter grain, a quarter protein, and water instead of soda. Nobody had planned it that way. The notebook had just made the plate easier to see.', 'By Friday the notebook had a rule in it that nobody had assigned: the phone charges overnight, and so do I. Screens off an hour before bed, eyes up every twenty minutes, half the plate green and orange, an hour of moving in whatever pieces the day allowed. Nothing in the week had been hard. It had only needed to be written down.'], more: [{ serial: 'CS138', after: 1, alt: 'A child asleep in a dark bedroom while a phone charges on a desk across the room' }, { serial: 'CS139', after: 2, alt: 'A cereal box turned around to show its nutrition label, a measuring cup beside a full bowl' }, { serial: 'CS140', after: 3, alt: 'A child at the top of a staircase with two fingers on the side of the neck, a stopwatch in the other hand' }, { serial: 'CS141', after: 5, alt: 'A child at a desk looking out the window at a far tree, a tablet set down beside the notebook' }, { serial: 'CS142', after: 6, alt: 'A dinner plate with half vegetables and fruit, a quarter rice and a quarter chicken, beside a glass of water' }] },
  ...
  'music-4': { title: 'The school concert', about: 'one spring concert, from the first tick of the beat to the last soft note', art: 'CS36', alt: 'A school stage with a small band of children in rows, a conductor with a raised pencil, music stands, parents in the dark', cast: [], words: ['The concert began the way every rehearsal had, with the teacher tapping a pencil on the stand: tick, tick, tick, tick. The beat came first, before any note, and the twenty-two players found it the way you find a heartbeat, without looking. Every piece they would play that night rested on it.', 'The first piece was all quarter notes, one beat each, four to a measure. The time signature at the start said so: a 4 over a 4, four beats in every measure, and a quarter note gets one. Nobody rushed. Rushing is what happens when players stop listening to the beat.', 'The second piece had a solo, and the soloist read it off the staff the way she had learned in September. Every Good Boy Does Fine named the lines from the bottom up, and FACE spelled the spaces. Reading music is reading a map of sound: higher on the staff means higher in pitch.', 'The half notes held for two beats, and the eighth notes came in pairs, two to a beat, quick as footsteps. The rests were the hardest part. A rest is a beat of silence that still counts, and the whole band had to keep counting through it and come back in together.', 'At the end of the solo a whole note sat for four full beats while the room held still. Four beats is a long time to hold one sound, long enough to hear your own breathing. The soloist let it ring, then lowered her flute. Nobody clapped yet, because the page had one more piece on it.', 'The last piece was marked forte and allegro, loud and fast, and the drums took it at a run. In the middle the music swelled, a crescendo, each measure louder than the one before, until the trumpets were shining.', 'Then, on the final page, a word nobody had noticed in rehearsal: piano. It means soft. The whole band dropped to a whisper, and the piece ended slow, adagio, on one long note that faded until nobody could tell when it stopped. Loud is easy. Soft, played together, takes a whole band listening.', 'The applause was forte. Nobody had told it to be. Afterward the teacher said the band had played the notes right all year, but tonight they had played the music: the loud and the soft, the fast and the slow, and the silence in between.'], more: [{ serial: 'CS133', after: 0, alt: 'A conductor\'s hand tapping a pencil on a music stand while children in rows watch' }, { serial: 'CS134', after: 2, alt: 'A music staff with five lines and notes climbing like a ladder, a flute resting beside it' }, { serial: 'CS135', after: 3, alt: 'Children in a school band counting silently during a rest, instruments raised and waiting' }, { serial: 'CS136', after: 5, alt: 'Drummers and trumpet players in a school band playing loud and fast under bright stage lights' }, { serial: 'CS137', after: 7, alt: 'Parents standing and clapping in a dim school auditorium as the band takes a bow' }] },
  'multiplication-3': { title: 'Frederick and the ants', about: 'eight-year-old Frederick, an ant farm, and the day counting stopped being enough', art: 'CS37', alt: 'A boy of eight at a windowsill with a glass ant farm, a digital microscope in its box beside him', cast: [], words: ['Frederick was eight and had an ant farm on his windowsill, a birthday present from his dad, along with a digital microscope he was not allowed to touch without help. Twenty-four harvester ants came in a tube. His dad said they had come without a queen, so the farm would not grow, but it would be busy.', 'On the third morning the ants had dug four tunnels, and they would not hold still to be counted. So Frederick stopped counting ants and counted groups. Four tunnels, six ants resting in each. Four groups of six. Twenty-four, without touching a single ant.', 'By the second week he had the times tables to ten taped above the farm, and he used them the way other kids used a calculator. Six groups of four was the same twenty-four ants seen sideways, because every fact works both ways. His sister asked what seven eights were. Fifty-six, he said, before she finished asking.', 'When his dad brought home a second, bigger farm, Frederick split the colony fairly. Twenty-four ants, two farms, twelve in each. Dividing was sharing out equally, and it undid the multiplying exactly: two groups of twelve made twenty-four again.', 'Every morning he held a ruler against the glass and measured the longest tunnel in inches. One morning the bigger farm\'s longest tunnel reached seven inches. He kept a tally chart of which farm dug farther each day, in bundles of five, and turned it into a bar graph. The bigger farm won by a lot. More room, more digging.', 'Then he read that a wild harvester ant colony can hold thousands of ants, and he wanted real numbers. He and his sister sat a careful step back from two anthills in the backyard, because harvester ants sting, and tallied every ant that went in for ten minutes at each hill. The first hill got 256. The second got 378.', 'He added them in columns, ones first. Six and eight is fourteen, so write the 4 and carry the ten. Five and seven and the carried one is thirteen, so write the 3 and carry the hundred. Two and three and one is six. 634 trips into the two hills in twenty minutes.', 'His dad found the sums penciled on the side of the farm and did not erase them. Frederick would be a biology professor one day. It started with a windowsill and a tally chart.'], more: [{ serial: 'CS83', after: 1, alt: 'A boy peering at ants resting in four tunnels behind the glass of his ant farm' }, { serial: 'CS84', after: 2, alt: 'A sister asking a question while her brother answers fast, an ant farm on the sill between them' }, { serial: 'CS85', after: 3, alt: 'The boy gently tipping half the ants into a second, bigger ant farm' }, { serial: 'CS86', after: 5, alt: 'A brother and sister sitting a careful step back from a red anthill in the backyard, tallying on a clipboard' }, { serial: 'CS87', after: 7, alt: 'A dad smiling at sums penciled on the side of an ant farm' }] },
  'math-4': { title: 'Chloe and the mural', about: 'nine-year-old Chloe, a wall to paint, and every number a mural needs', art: 'CS38', alt: 'A girl of nine on a stepladder at a long community-center wall, graph paper in hand, ninety-two small birds sketched in rows across the wall', cast: [], words: ['Chloe was nine and had been given a wall. The community center wanted a mural, her art teacher had said she could plan it, and planning turned out to be arithmetic. The wall was 23 feet wide and 4 feet high, and she wanted a row of 4 birds for every foot of it.', 'That was 23 times 4. She broke it into 20 times 4 and 3 times 4, eighty plus twelve, ninety-two birds. Breaking a number apart by place value turns a hard multiplication into two easy ones. She drew ninety-two birds on graph paper and lost count twice.', 'The paint came in cans that each covered 96 square feet. Area counts the squares that would cover a flat shape, and a rectangle takes length times height: 23 times 4, which she already knew was 92 square feet. One can would cover the wall once, with 4 square feet to spare. Two coats meant two cans.', 'The birds needed to be arranged in equal rows. Factors are numbers that multiply together to make another number. Twelve chairs can go one by twelve, two by six or three by four. Ninety-two birds could go one by ninety-two, two by forty-six or four by twenty-three.', 'Not three by anything, she found, because 92 is not a multiple of 3. She tried dividing and got 30 with 2 left over. A remainder, her teacher said, is what is left when things will not share out evenly. Chloe chose four rows of twenty-three.', 'The sky took a quarter of the wall and the grass a fourth. She wrote each as 0.25, a decimal, and added them: 0.50, the same as a half. Chloe had never cared about fractions and decimals until they told her where the horizon went. The birds would fly across the half in between.', 'On painting day, twelve volunteers came. Chloe split the ninety-two birds among them: 92 divided by 12 is 7 with 8 left over, so eight people painted eight birds and four painted seven. Nobody had to paint a fraction of a bird. Division, she decided, was fair sharing with a pencil.', 'The mural is still on the wall of the center. The birds are a little uneven, and she likes that now. Every time she walks past, she counts them, and every time there are ninety-two. She thinks of the numbers underneath the paint: the product, the area, the factors, the remainder and the decimals that put the sky in its place.'], more: [{ serial: 'CS123', after: 1, alt: 'A girl of nine at a table covered in graph paper, rows of tiny birds drawn in pencil' }, { serial: 'CS124', after: 2, alt: 'Two paint cans beside a long white wall, a tape measure stretched along its bottom edge' }, { serial: 'CS125', after: 4, alt: 'Ninety-two paper birds laid out in four neat rows on a gym floor' }, { serial: 'CS126', after: 5, alt: 'A long wall painted with a blue sky band on top and a green grass band below, the middle waiting for birds' }, { serial: 'CS127', after: 6, alt: 'Twelve volunteers of all ages painting small birds along a long community wall' }] },
  'civics-3': { title: 'Mike and the crosswalk', about: 'eight-year-old Mike, a dangerous corner, and three governments in a row', art: 'CS39', alt: 'A boy of eight in an ironed shirt standing at a microphone at a city council meeting, a hand-drawn map of a street corner held up', cast: [], words: ['Mike was eight and walked to school past a corner where cars did not stop. There were no stripes and no light, just a sign nobody seemed to see. His big brother had been clipped there by a car\'s side mirror, and his arm was bruised for a week.', 'Mike did what nobody in his house had ever done. He went to a city council meeting in a shirt his mom ironed, stood at the microphone and held up a map he had drawn of the corner. His voice shook on the first sentence and steadied by the third. The corner needs a crosswalk, he said. The mayor listened from the long table.', 'The street belonged to the city, so the city could paint the stripes. The council talked it over for an hour and took a vote. Five hands went up for the crosswalk and two against. Five is more than half of seven, so the crosswalk won. That is majority rule, and the two who voted no still had to help make it happen.', 'The light was harder. The corner sat on a state highway, and a traffic light there needed the state\'s permission. That meant Texas, with its governor and its legislature in Austin. The city wrote to the state highway office, and then everyone waited.', 'When the answer came, Mike noticed the stamp on the envelope. The mail is run by the national government, the United States, led by a president and Congress in Washington, D.C. Three levels of government, three sets of jobs, and it took all three to fix one corner.', 'While he waited, Mike did chores and saved eleven dollars. At the store he wanted a book for eight dollars and a ball for seven. Eleven was not fifteen. He chose the book, and the ball was its real cost, the thing he gave up. That is called the opportunity cost.', 'He was learning early that there is never enough for everything. His teacher called that scarcity. Even eleven dollars had to choose. He was also learning that things get fixed by the people who show up, and that one did not have a fancy name.', 'The crosswalk went in the next spring, stripes first and the light a few months after. Mike watched the painters from the sidewalk. His brother crossed it first. Mike crossed it second, holding the new book. Nobody had to run.'], more: [{ serial: 'CS98', after: 0, alt: 'A busy street corner with no crosswalk stripes, cars rushing past a boy waiting with his backpack' }, { serial: 'CS99', after: 2, alt: 'Council members raising their hands in a vote, most of the hands up' }, { serial: 'CS100', after: 3, alt: 'A letter traveling from a city hall to the pink granite Texas Capitol in Austin' }, { serial: 'CS101', after: 5, alt: 'The boy at a store counter choosing a book, a ball left on the shelf behind him' }, { serial: 'CS102', after: 7, alt: 'Two brothers crossing a freshly painted crosswalk under a new traffic light' }] },
  'art-3': { title: 'Chloe looks at a picture', about: 'eight-year-old Chloe at a museum, and the four looks she learned to take', art: 'CS40', alt: 'A girl of eight in a bright yellow raincoat standing before a large painting of a boat in a storm, her grandmother beside her, a museum bench behind', cast: [], words: ['Chloe was eight and already wore the brightest thing in any room, that day a yellow raincoat on a dry afternoon. Her grandmother had brought her to the museum for her birthday. In front of a big painting of a boat in a storm, Chloe said, before anyone asked, that she liked it.', 'Her grandmother, who was not Georgette but might as well have been, smiled and said that liking it was the last thing to say, not the first. Then she made Chloe look four times, one look at a time.', 'First look: what is in it? Chloe was only allowed to name what was there, like a detective taking notes. A small boat. Two people. A tall mast. Dark waves, a gray-green sea, a black sky and one bright red sail. No opinions yet. Just the list.', 'Second look: how is it built? The mast made a diagonal line, and diagonal lines feel like motion, which is why the boat seemed to tip. The waves were thick paint you could almost feel, which is texture. The red sail was the brightest color in the painting, the only warm one against all that cool gray-green. That was why her eye had gone there first. The painter had made it the focus on purpose.', 'Third look: what might it mean? Chloe thought about the two tiny people and the one bright sail. Hope in a storm, she said. Her grandmother asked why, and Chloe pointed. Because the only warm color in the painting is the thing that keeps them going. Her grandmother nodded slowly.', 'Fourth look: do I like it? Yes, still. But now she could say why, and the why was better than the yes. Her grandmother said most grown-ups never get past the yes.', 'At home Chloe tried to paint the storm from memory with three jars of paint. Blue and yellow made the green sea. Red, straight across the color wheel from green, made the sail burn, because complementary colors make each other look brighter. For the sky she added black to blue, a shade. Her painting was smaller and messier than the museum\'s, but it was hers.', 'Line, shape, form, color, texture, space and value: every picture is built from those seven. Chloe has looked four times ever since, and she still wears the brightest thing in the room, now that she knows how a bright spot pulls the eye.'], more: [{ serial: 'CS88', after: 1, alt: 'A grandmother smiling and holding up four fingers beside the girl in the museum' }, { serial: 'CS89', after: 2, alt: 'A painting of a small boat with two people and a red sail on dark waves under a black sky' }, { serial: 'CS90', after: 3, alt: 'The same painting with its diagonal mast and thick textured waves, the red sail glowing' }, { serial: 'CS91', after: 4, alt: 'The girl pointing at the tiny people in the boat while explaining to her grandmother' }, { serial: 'CS92', after: 6, alt: 'The girl at home painting a stormy sea from three jars of paint, a red sail on green waves' }] },
  'art-4': { title: 'Chloe draws the road home', about: 'nine-year-old Chloe, a flat page, and the tricks that made it deep', art: 'CS41', alt: 'A girl of nine at a desk drawing a road that narrows to a vanishing point, a near tree large and a far tree small, her traced handprint in the corner', cast: [], words: ['Chloe was nine and could not make the road home look like a road. It sat on the page like a ribbon, flat and the same width all the way up. She had drawn it five times, and five times it looked like something lying on the paper instead of going into it.', 'Her teacher drew a dot on the horizon and said everything runs to it. The road wide at the bottom, thin at the top. The near tree big and detailed, the far tree small and plain. Overlap, size, placement, detail. The page was suddenly deep enough to walk into.', 'That dot is called a vanishing point, her teacher said, and painters in Italy worked out its rules about six hundred years ago. Before that, many pictures stacked things up the page to show distance. After it, a flat wall could look like a window. It was one of the biggest ideas in the history of art, and it fit on a single dot.', 'The next lesson was balance. Her own face was symmetrical, nearly the same on both sides. A flower spread from the middle: radial balance. The fence along the road was a pattern, a post, a post, a post. She had been drawing all three for years without knowing they had names.', 'Knowing the names made her choose them on purpose. She gave the farmhouse at the end of the road two matching windows, symmetry, and a round flower bed by the door, radial. The fence posts marched toward the vanishing point, each one a little smaller than the last.', 'Color came next. Her teacher showed her that far-off hills look paler and bluer than near ones, because there is more air between you and them. Artists call it atmospheric perspective. Chloe painted the near field a strong green and the far hills a soft blue-gray, and the distance deepened again.', 'The last lesson was the oldest pictures in the world: hands on cave walls. At a cave in France, people painted spotted horses and outlined their own hands beside them more than twenty thousand years ago, a story told with no words long before writing.', 'Chloe put her own hand on the road drawing and traced it. Art tells a story, her teacher had said. Hers was about the way home, the near tree and the far hill and the point where the road disappeared, and the hand said who had walked it. She signed it small in the corner, the way the painters did.'], more: [{ serial: 'CS128', after: 1, alt: 'A drawing of a road narrowing to a single dot on the horizon, trees shrinking along both sides' }, { serial: 'CS129', after: 2, alt: 'A painting in an old Italian style of a tiled courtyard whose lines all meet at one point' }, { serial: 'CS130', after: 4, alt: 'A farmhouse with two matching windows and a round flower bed, a fence leading away from it' }, { serial: 'CS131', after: 5, alt: 'Green fields in front and pale blue-gray hills far behind under a soft sky' }, { serial: 'CS132', after: 6, alt: 'Painted spotted horses and outlined handprints on a cave wall lit by a lantern' }] },
  'writing-3': { title: 'Georgette and the letter', about: 'eight-year-old Georgette, a grandmother far away, and her first real paragraph', art: 'CS42', alt: 'A girl of eight at a kitchen table writing a letter in careful print, a paper boat and a stamped envelope beside her', cast: [], words: ['Georgette was eight, read everything, and had never written a real letter. Her grandmother lived a day\'s drive away and wrote every week in handwriting like lace. Georgette wanted to answer with something worth reading. Her first try was a page of loose facts that wandered like a lost cat. She had a lot to say and no idea where to put it.', 'Her teacher showed her the shape of a paragraph. Say the big idea in the first sentence. Then give details that hold it up. Georgette started over. Our new house is small, but it is perfect. My room has a window seat. The kitchen smells like toast. The yard has a tree made for climbing.', 'Then she read each sentence and asked the test question: is this about the same idea? The neighbor\'s dog barks at the mailman. That one was about the dog, not the house. It moved to a paragraph of its own, with its own first sentence.', 'Her second letter explained how to fold a paper boat. Fold in half, corners down, strips up, pull it open. Two weeks later her grandmother wrote back that she had made a very nice paper hat and worn it to the grocery store. Georgette laughed until her stomach hurt. She had skipped the steps her hands did without thinking.', 'So she folded a boat slowly and wrote down every move. What you need: one sheet of paper. Then all seven steps, in order, from the first fold to pulling the top corners apart. The next letter from her grandmother had a photo inside: a paper boat floating in her kitchen sink.', 'The third letter was a case. Georgette thought the family should visit at Christmas instead of summer. I think we should come at Christmas, she wrote, because the whole family is off school and work at once, and because you have never seen me in the Christmas play.', 'Then she said it again in new words, the way her teacher had shown her. Christmas is the one time we can all be at your table. Her grandmother read it twice and said yes the same afternoon.', 'Georgette kept every letter her grandmother sent in a shoebox under her bed. Some of them had paper boats tucked inside. Years later, when she was the grandmother people wrote to, she still had them, and she still answered every one in paragraphs.'], more: [{ serial: 'CS78', after: 0, alt: 'A girl of eight reading a letter in lacy handwriting, a stack of envelopes beside her' }, { serial: 'CS79', after: 1, alt: 'A small cozy house with a window seat and a big climbing tree in the yard' }, { serial: 'CS80', after: 3, alt: 'A grandmother wearing a folded paper hat at the grocery store, smiling' }, { serial: 'CS81', after: 4, alt: 'An old photograph of a paper boat floating in a kitchen sink' }, { serial: 'CS82', after: 6, alt: 'A grandmother reading a letter at her table by a snowy window, smiling' }] },
  'writing-4': { title: 'Mike writes it down', about: 'nine-year-old Mike, a summer of hard work, and the paragraphs that came out of it', art: 'CS43', alt: 'A boy of nine at a school desk writing, a scrap truck visible through the window behind him, calloused hands on the paper', cast: [], words: ['Mike was nine and spent the summer hauling scrap with his uncle for money the house needed. The truck was old, the metal was heavy, and by July his hands had stopped hurting. He did not think of any of it as something to write about.', 'When school started, the first assignment was a paragraph with a topic sentence. A topic sentence tells the reader what the whole paragraph is about. Mike wrote the only big thing he knew: hard work is not the same as hard. Then the details: the truck, the weight, his hands.', 'His teacher showed him how the details held the topic sentence up, the way posts hold up a fence. Take one away and the paragraph leans. Put in a detail that does not belong, like the sandwich he ate in June, and the reader stops trusting the fence. A good paragraph stays on its topic from the first sentence to the last.', 'The opinion paragraph was harder, because Mike had opinions and no practice saying them nicely. Recess should be longer. Reason one: kids think better after running. Reason two: kids get along better after playing. Then say the opinion again, a new way, at the end.', 'His teacher wrote good in the margin, and underneath, one question: how do you know? Mike added a fact. After recess, his class had finished a math page faster than before it. An opinion with a reason is stronger. An opinion with a reason and a fact is harder to argue with.', 'The small story was about the bird that got into the house that August. Every story needs a problem, and a bird in the living room is a good one. Beginning: the door left open in the heat. Middle: the bird on the curtain rod and everyone frozen. End: his uncle opening the window, and the bird finding its way out into the yard.', 'Revising was the part Mike liked least and learned most from. He read the story out loud and heard where it dragged. He cut two sentences about the curtain, added the sound of the wings, and changed went to flew. The story got shorter and better at the same time.', 'Mike had not known a summer of scrap could be a story. It turned out everything could, if you gave it a beginning, a middle and an end, and then read it out loud and fixed what you heard. He kept every page in a folder with the truck drawn on the front.'], more: [{ serial: 'CS118', after: 0, alt: 'An old scrap truck piled with metal pipes and wheels in a summer yard, a boy lifting a pipe beside his uncle' }, { serial: 'CS119', after: 2, alt: 'A wooden fence held straight by strong posts, with one post missing and that part of the fence leaning' }, { serial: 'CS120', after: 3, alt: 'Children running across a school playground at recess while a teacher checks a watch' }, { serial: 'CS121', after: 5, alt: 'A small brown bird perched on a curtain rod in a living room, a family frozen below it' }, { serial: 'CS122', after: 7, alt: 'A boy\'s folder of writing with a hand-drawn truck on the cover, pages peeking out' }] },
  'writing-5': { title: 'Georgette and the class pet', about: 'ten-year-old Georgette, a five-paragraph case, and a hamster named after a poet', art: 'CS44', alt: 'A girl of ten at the front of a classroom holding a five-page essay, a hamster in a cage on the shelf behind her', cast: [], words: ['Georgette was ten and had decided the class needed a pet. She could not just ask. Her teacher said a good case is built, not wished for, so Georgette started building. She began with a question she could not answer yet: what does a class pet really need?', 'She wrote an informational piece first, three paragraphs on how hamsters live, with an introduction that walked the reader in and a conclusion that walked them out. Her teacher said it read like a tour of a house. That was the idea. Informational writing gives facts, not feelings.', 'The facts had to come from somewhere. Georgette used two sources, a library book and a page from an animal shelter, and wrote down which fact came from which. When they disagreed about how long hamsters live, she wrote down both: two to three years, said one, and up to four, said the other.', 'Then the opinion essay. Paragraph one: our class should have a pet. Paragraphs two, three and four: one reason each, it teaches care, it calms us, it is fun. Paragraph five: all of it again, with the reasons behind it.', 'Her first draft had a hamster that was very, very, very cute. Revising, she cut two of the verys and added a reason instead. Editing, she found three missing capitals and a their that should have been there. Revising changes what you say. Editing fixes how it is written.', 'The class voted. The hamster arrived in October and was named after a poet Georgette liked, which nobody else in the room had heard of. She wrote a care schedule for the wall: who feeds it, who cleans the cage, which family takes it home each weekend. It hung by the door all year.', 'The personal narrative came last, and it was about the moment the hamster escaped and she found it in her coat pocket after an hour of everyone searching. Set the scene, build to the moment, say what changed. She slowed the moment down the way her teacher showed her: the empty cage, the whole class on hands and knees, then a small warm weight moving in her pocket.', 'What changed was that Georgette learned she could make a room of people do something with five paragraphs. She kept every draft in a folder, the messy ones too, because the messy ones showed how the good ones were made. She never forgot it.'], more: [{ serial: 'CS168', after: 0, alt: 'A girl of ten writing a question at the top of a blank page' }, { serial: 'CS169', after: 2, alt: 'A library book and a printed shelter page side by side, sticky notes marking the facts' }, { serial: 'CS170', after: 4, alt: 'A draft with two verys crossed out and a capital letter fixed in red' }, { serial: 'CS171', after: 5, alt: 'A hamster cage beside a care schedule taped to a classroom wall by the door' }, { serial: 'CS172', after: 6, alt: 'A girl finding a hamster peeking out of her coat pocket while classmates search' }] },
...
STORIES['inputs-and-outputs'] = {
  about: 'a talking toaster that only knew three things, and what happened in between',
  more: [{ serial: 'S1200', after: 0, alt: 'A shiny toaster popping up two slices of toast, a little speaker glowing on its side' }, { serial: 'S1201', after: 1, alt: 'A hand pushing down a toaster lever beside a dial and a small bagel button' }, { serial: 'S1836', after: 2, alt: 'Golden toast popping up out of the toaster, warm air rising' }, { serial: 'S1837', after: 4, alt: 'A slice of black, burnt toast held up by a surprised boy' }, { serial: 'S1838', after: 5, alt: 'A boy touching a tablet screen, music and pictures coming out of it' }],
  title: 'The talking toaster', art: 'S1199', cast: [],
  alt: 'A boy pressing the lever on a toaster with a cartoon face, arrows in and out of it',
  words: [
    'Arjun\'s uncle had a toaster that talked. When the toast was ready, it said, done, and the bread popped up. Arjun wanted to know how it decided what to say. His uncle said the toaster only knew three things, and those three explained every computer in the world.',
    'The first thing was inputs. The lever going down, the dial set to four, the little button for bagels. Each one tells the toaster something. You do the telling.',
    'The second thing was outputs. The heat, the ding, the toast popping up, the voice saying done. Each one shows you something. The toaster does the showing.',
    'In between was a program, a list of steps the toaster follows exactly, in order. Dial at four means this much heat for this long. Then pop. Then ding. Then done.',
    'Arjun turned the dial all the way to nine to see what would happen. The toaster did exactly what it was told, and the bread came out black. It never wondered whether he meant it. A program cannot guess. It follows the steps it is given, with the inputs it is given.',
    'Then Arjun looked at his tablet. Touching the screen was an input. The picture on the screen and the sound from the speaker were outputs. The games were programs. It was the same toaster with more buttons.',
    'Inputs tell a computer. Outputs show you. A program is the steps in between. Watch, car or toaster, every computer runs on those three.',
  ],
};
STORIES['steps-in-order'] = {
  about: 'a sandwich made by someone who did exactly what she was told, and nothing more',
  more: [{ serial: 'S1203', after: 1, alt: 'The younger sister shrieking and pointing at a jam-covered bread bag' }, { serial: 'S1204', after: 2, alt: 'A closed, empty sandwich with jam spread across its top slice' }, { serial: 'S1839', after: 3, alt: 'The girl swapping two steps on her page with a pencil arrow' }, { serial: 'S1840', after: 4, alt: 'A perfect jam sandwich cut in half on a plate, the big sister bowing' }, { serial: 'S1841', after: 5, alt: 'A friendly robot carefully following a list of steps, one arm holding a butter knife' }],
  title: 'Exactly what she was told', art: 'S1202', cast: [],
  alt: 'A girl following written sandwich instructions with a straight face, jam on the outside of the bread bag',
  words: [
    'Nina wrote instructions for a jam sandwich and handed them to her big sister, who promised to follow them exactly and add nothing. Step one: put jam on the bread. Her sister picked up the whole loaf, still in its bag, and smeared jam on the outside.',
    'Nina shrieked. That was not what she meant! Her sister shrugged. It was what she wrote. Nina had never said to open the bag, or take out a slice, or open the jar. Every step she skipped, her sister skipped too.',
    'The second try was longer. Open the bag. Take out two slices. Lay them flat. Open the jar. Spread jam on one slice. But Nina put the slices together before the jam step, and her sister spread jam on the top of a closed, empty sandwich.',
    'Two steps in the wrong order, and the whole sandwich went wrong. Nina swapped them back.',
    'The third try had eleven steps, every one in its place. Her sister followed them without making a single decision, and out came a perfect sandwich. Nina had written an algorithm: a list of steps, in order, that gets something done.',
    'A computer follows an algorithm the way her sister did. It never guesses what you meant. If a step is missing, it skips it. If two steps are swapped, it swaps them.',
    'An algorithm is steps in order. The order matters, and every small step must be there, because whoever follows it will do exactly what it says and nothing else.',
  ],
};
STORIES['patterns-and-loops'] = {
  about: 'a necklace of beads that only needed one instruction, repeated',
  more: [{ serial: 'S1206', after: 0, alt: 'A long page of instructions running off the edge of the desk, the boy shaking his tired hand' }, { serial: 'S1207', after: 1, alt: 'Red and blue beads laid out in matching pairs across the table' }, { serial: 'S1842', after: 3, alt: 'A little girl holding up a bracelet of red, red and yellow beads repeating' }, { serial: 'S1843', after: 4, alt: 'A longer bracelet stretched between two small hands' }, { serial: 'S1844', after: 5, alt: 'A staircase of identical steps curling upward, music notes floating along the rail' }],
  title: 'One instruction, repeated', art: 'S1205', cast: [],
  alt: 'A boy threading a long necklace of red and blue beads, a card beside him with one short rule',
  words: [
    'Felix wrote instructions for a bead necklace: red bead, blue bead, red bead, blue bead. Eighty lines for eighty beads. His hand ached, and somewhere in the middle he had written blue twice in a row.',
    'His teacher asked what all those lines had in common. Felix looked. Every pair was the same, red then blue, over and over. Eighty lines were really one pair of lines, forty times.',
    'So he rewrote the whole thing in two lines. Repeat forty times: red bead, blue bead. That is a loop, a set of steps that runs again and again. Two lines instead of eighty, and no place for a mistake to hide.',
    'Then his little sister wanted a bracelet: red, red, yellow, red, red, yellow. Felix hunted for the part that repeats. Not red, red. Not red, yellow. The part was three beads long: red, red, yellow. Repeat it six times, and she had eighteen beads.',
    'A loop is also easy to change. When his sister wanted a longer bracelet, Felix did not rewrite anything. He changed six to eight, and the bracelet grew to twenty-four beads.',
    'Loops are everywhere once you look. A song writes its chorus once and marks it to repeat. A staircase is one step, repeated. Even a clap, stomp, clap, stomp dance is a loop of two moves. Programs use loops to do a lot with very little.',
    'Find the part that repeats. Write it once. Say how many times. That is a loop.',
  ],
};
STORIES['variables'] = {
  about: 'a scoreboard at the park, and the named box that kept changing',
  more: [{ serial: 'S1209', after: 0, alt: 'A box labeled home with a 3 in it' }, { serial: 'S1210', after: 1, alt: 'The same box with a 4, the label unchanged' }, { serial: 'S1991', after: 2, alt: 'A blank scoreboard before a game, the names home and visitors ready' }, { serial: 'S1992', after: 3, alt: 'Three labeled boxes: home 4, visitors 2, total 6' }, { serial: 'S1993', after: 4, alt: 'A box labeled x with a question mark beside a box labeled home' }],
  title: 'The scoreboard', art: 'S1208', cast: [],
  alt: 'A girl at a park scoreboard flipping the number for the home team from 3 to 4',
  words: [
    'Ana kept score at the park with a flip board. HOME on one side, VISITORS on the other, and numbers she changed every time someone scored. Her brother said the board was a computer program with two variables.',
    'A variable is a named box that holds a value and can change. The box called HOME held 3. When the home team scored, the box still said HOME and the value became 4. The name stayed; the number moved.',
    'Ana saw why the name mattered. The program did not need to know the score ahead of time. It needed to know where to look. Add one to HOME, whatever HOME holds. The board could keep score for a game that had not been played yet.',
    'Her brother showed her a second trick. TOTAL could be HOME plus VISITORS, worked out fresh every time either one changed. At 4 to 2 the total was 6. At 5 to 2 it was 7, and nobody had to count again.',
    'He also said the names should tell you what the boxes hold. A box called X could be anything. A box called HOME could only be one thing. Math uses letters the same way: n plus 3 works for any n, the way the scoreboard works for any game.',
    'A variable is a named box that holds a value and can change. The name stays, the value moves, and a program that uses the name works for a score it has never seen.',
  ],
};
STORIES['if-then'] = {
  about: 'a thermostat that never sleeps, and the two roads it chooses between all night',
  more: [{ serial: 'S1212', after: 1, alt: 'IF too cold THEN heat on, drawn as one road' }, { serial: 'S1213', after: 2, alt: 'ELSE heat off, the other road' }, { serial: 'S1994', after: 3, alt: 'A sprinkler timer on a garage wall beside a dry lawn at dawn' }, { serial: 'S1995', after: 4, alt: 'A video game screen with a star, a timer and a score' }, { serial: 'S1996', after: 5, alt: 'A loop of arrows around a thermostat: check, pick, check again' }],
  title: 'The thermostat that never sleeps', art: 'S1211', cast: [],
  alt: 'A boy looking at a hallway thermostat at night, a fork in the road drawn beside it',
  words: [
    'Owen asked who turned the heat on at night when everyone was asleep. His father pointed at the thermostat and said it had been making the same decision every few seconds since they moved in. Nobody had touched it in weeks.',
    'The decision was one sentence. IF the room is colder than the setting, THEN turn the heat on. ELSE, turn it off. A condition, and two roads.',
    'That is all the thermostat knows, and it is enough. It checks, picks a road, checks again. Owen wrote the same sentence for his game: IF the player touches the star, THEN add a point, ELSE keep going. The thermostat had taught him the shape of every choice a computer makes.',
    'His father showed him a harder choice on the sprinkler timer. IF it is six in the morning AND the ground is dry, THEN water the lawn. Both parts must be true. At six on a rainy morning, the sprinklers stay off.',
    'Owen added one to his game. IF the player touches the star AND the timer is still running, THEN add a point. Late stars no longer counted. Before that, a player could grab a star after the clock ran out and still score. One small word, AND, had made the rule fair.',
    'IF a condition is true THEN a step runs. ELSE is the other road. AND means both parts must be true. A program chooses the way a thermostat does: check, pick, check again.',
  ],
};
STORIES['finding-the-bug'] = {
  about: 'a robot that ended up facing the wall, and the one step that sent it there',
  more: [{ serial: 'S1215', after: 0, alt: 'A small robot stopped nose-first against a classroom wall' }, { serial: 'S1216', after: 1, alt: 'The list of steps with a finger on the third one' }, { serial: 'S1997', after: 2, alt: 'The corrected step and the robot reaching the flag' }, { serial: 'S1998', after: 3, alt: 'Two robots on a floor grid, one turning the wrong way at a corner' }, { serial: 'S1999', after: 4, alt: 'A girl watching her robot run the whole course again, a checklist in hand' }],
  title: 'Facing the wall', art: 'S1214', cast: [],
  alt: 'A girl kneeling beside a small classroom robot that has stopped nose-first against a wall, a list of steps in her hand',
  words: [
    'Lena\'s robot was supposed to reach the flag in the corner. It drove forward, turned, drove, and stopped with its nose against the wall. Lena rewrote the whole program from scratch. It hit the wall again.',
    'Her teacher told her to stop rewriting and start reading. One step at a time, out loud, with her finger on the line and her eye on the robot. Forward two. Good. Turn right. Good. Forward four.',
    'Forward four was the bug. The room was three squares wide. One number, one wrong step, and everything after it had been right and useless. She changed the four to a three and the robot found the flag. Debugging was not rewriting. It was reading.',
    'The next day a friend\'s robot had a different problem. It reached the corner and then turned the wrong way. Every number was right, but two steps were in the wrong order: turn, then forward, instead of forward, then turn. A bug can be a wrong value or a wrong order.',
    'After each fix, Lena ran the whole program again, start to finish, not just the step she changed. A fix can break something that used to work. Testing again is the only way to know. Her teacher called it checking your work, the same as in math.',
    'Debugging is reading the steps one at a time and checking each. The bug is usually one small wrong thing, and rewriting everything hides it instead of finding it.',
  ],
};
STORIES['binary'] = {
  about: 'a girl who had to send the number 10 across a field with nothing but four flashlights',
  more: [{ serial: 'S1218', after: 0, alt: 'Four flashlights in a row on a fence post at dusk, the first and third lit' }, { serial: 'S1219', after: 2, alt: 'The friend across the field holding up ten fingers' }],
...
STORIES['how-the-internet-works'] = {
  about: 'a puzzle mailed one piece at a time, with the address on every piece',
  more: [{ serial: 'S1221', after: 1, alt: 'Envelopes taking different routes and arriving out of order' }, { serial: 'S1222', after: 3, alt: 'A phone book turning a name into a number address' }],
  title: 'One piece at a time', art: 'S1220', cast: [],
  alt: 'A boy at a post office counter with a stack of envelopes, each holding one puzzle piece',
  words: [
    'Kai sent his cousin a photo and it arrived in a second, and he pictured the whole picture flying across the country in one piece. His aunt, who worked at the post office, said it had gone as a thousand envelopes.',
    'The internet cuts a message into packets, small pieces, each with the destination address on it and a number saying which piece it is. The packets take whatever routes are open, arrive in any order, and get put back together by the number.',
    'And the address is a number, not a name. When Kai typed his cousin\'s site, a directory called DNS turned the name into the number address, the way a phone book turns a name into a phone number. Then the envelopes went out.',
    'Messages travel as addressed packets that can take different routes and arrive out of order. DNS turns names into number addresses. A photo is a thousand envelopes that know how to line up.',
  ],
};
STORIES['passwords-and-privacy'] = {
  about: 'the message that said now, and the three habits that made it harmless',
  more: [{ serial: 'S1224', after: 2, alt: 'A long passphrase written as four random words' }, { serial: 'S1225', after: 3, alt: 'A second proof: a code arriving on a different device' }],
  title: 'The message that said now', art: 'S1223', cast: [],
  alt: 'A girl looking at a phone message with an urgent warning, a locked padlock drawn beside her',
  words: [
    'The message said her account would be closed unless she clicked the link now. Rosa\'s thumb was already moving. Her father asked one question: who wants you to hurry?',
    'Hurry is the tell. Someone who wants you not to think will tell you there is no time to. Rosa put the phone down and went to the real site herself, typing the address, and her account was fine.',
    'Three habits, her father said. Long passwords, four random words beat one clever one. A second proof, so a stolen password alone opens nothing. And never through the link: go to the site yourself. The message that says now is the one that can wait.',
    'Long passwords, a second proof, and never through the link. The message that says now is the one to slow down for.',
  ],
};
// Health, added on 2026-09-23.
STORIES['washing-hands'] = {
  about: 'glitter that would not come off with water alone',
  more: [{ serial: 'S1227', after: 0, alt: 'Hands covered in gold glitter' }, { serial: 'S1610', after: 1, alt: 'Glitter hiding between the fingers' }, { serial: 'S1611', after: 4, alt: 'A girl washing her soapy hands at the sink before lunch' }, { serial: 'S1612', after: 5, alt: 'Clean hands held up, no glitter left' }],
  title: 'The glitter', art: 'S1226', cast: [],
  alt: 'A small girl at a bathroom sink with glitter on both hands, soap bubbles starting to form',
  words: [
    'Mia had glitter on both hands. Gold glitter. From art class. She rinsed them. Water only. Some glitter stayed.',
    'Rinsing was not enough. The glitter hid between her fingers. It hid around her thumbs.',
    'Soap, and count to twenty. Between the fingers. Around the thumbs. Under the nails. Gone.',
    'Germs are like glitter, said the nurse. You cannot see them. But they hide in the same places.',
    'Mia washed before lunch. She washed after the bathroom. Soap, twenty, rinse.',
    'She sang a song while she counted. By twenty, the song was done and her hands were clean.',
    'Wash with soap before eating and after the bathroom. Count to twenty.',
  ],
};
STORIES['brushing-teeth'] = {
  about: 'a fence of teeth, and the pickets that got missed',
  more: [{ serial: 'S1230', after: 0, alt: 'The boy brushing fast, front teeth only' }, { serial: 'S1231', after: 1, alt: 'The dentist pointing at the back teeth' }, { serial: 'S1614', after: 4, alt: 'A timer showing two minutes' }, { serial: 'S1615', after: 5, alt: 'All four corners brushed, the fence painted' }],
  title: 'The fence of teeth', art: 'S1229', cast: [],
  alt: 'A small boy brushing his teeth in a mirror, a fence drawn faintly over his smile',
  words: [
    'Leo brushed fast. Front teeth only. Done in ten seconds. He ran off to play.',
    'His dentist looked in his mouth. The back pickets are unpainted, she said. Both sides.',
    'A fence of teeth. Every picket needs paint, both sides. Front and back. Top and bottom.',
    'Two minutes. Top right. Top left. Bottom left. Bottom right. Thirty seconds each corner.',
    'Leo set a timer. Two minutes felt long. He brushed every corner. Front and back.',
    'Morning and night. Two times a day. His dentist looked again. Every picket painted.',
    'Brush two times a day for two minutes. Every tooth, both sides.',
  ],
};
STORIES['sleep-k'] = {
  about: 'a phone that charged all night, and a boy who did not',
  more: [{ serial: 'S1233', after: 0, alt: 'The phone plugged in, charging' }, { serial: 'S1616', after: 1, alt: 'The phone at one hundred, the boy at fifty and grumpy' }, { serial: 'S1617', after: 3, alt: 'That night, a boy tucked into bed early after his bath and a book, the lights going out' }, { serial: 'S1618', after: 4, alt: 'The boy bouncing out of bed in the morning' }],
  title: 'The phone and the boy', art: 'S1232', cast: [],
  alt: 'A small boy yawning in bed while his phone on the dresser shows a full battery',
  words: [
    'The phone charged all night. Plugged in. Sam stayed up. Playing. Then reading. Then looking at the ceiling.',
    'In the morning the phone was at a hundred. Sam was at fifty, and grumpy. He yawned all through breakfast.',
    'Kids need ten to twelve hours to fill up. Sam had six. His battery was low.',
    'That night, Sam went to bed earlier. Same quiet steps. Bath. Book. Lights out.',
    'He slept ten hours. In the morning he bounced out of bed. A hundred percent!',
    'The phone charges every night. So does a boy. Sam plugged himself in on time after that.',
    'Ten to twelve hours of sleep. The same quiet routine each night.',
  ],
};
STORIES['my-plate'] = {
  about: 'a plate that was all one color, and the rainbow that fixed it',
  more: [{ serial: 'S1236', after: 0, alt: 'A plate with only beige food on it' }, { serial: 'S1619', after: 2, alt: 'Red tomatoes and orange carrots on the plate' }, { serial: 'S1620', after: 4, alt: 'A girl crunching a rainbow of fruits and vegetables, then running off full of energy' }, { serial: 'S1621', after: 5, alt: 'A glass of water beside a colorful plate' }],
  title: 'The rainbow plate', art: 'S1235', cast: [],
  alt: 'A small girl at a table with a plate half full of colorful fruits and greens, a glass of water beside it',
  words: [
    'Ana\'s plate was all one color. Beige. Bread. Crackers. More bread. She ate it all.',
    'Her tummy was full. But her body was not happy. She felt slow. She felt tired.',
    'Mom made a new plate. Red tomatoes. Orange carrots. Green peas. Purple grapes. A rainbow.',
    'Half the plate, all colors. The other half, bread and chicken. A glass of water beside it.',
    'Ana ate the rainbow. Crunch. Pop. Sweet. Her body felt better. She had energy to run.',
    'Every day after that, Ana looked at her plate. Was there a rainbow? If not, she asked for one.',
    'Half the plate fruits and greens. Water to drink.',
  ],
};
STORIES['sleep-and-the-brain'] = {
  about: 'a librarian who only worked nights, and the shelves that stayed messy when she was skipped',
  more: [{ serial: 'S1239', after: 0, alt: 'A boy yawning at his desk in the morning, trying to remember' }, { serial: 'S1240', after: 1, alt: 'A tiny librarian pushing a cart piled with memories through a dark library' }, { serial: 'S1955', after: 3, alt: 'A clock beside a sleeping boy, the night stretching long outside the window' }, { serial: 'S1956', after: 4, alt: 'A bright screen glowing in a dark bedroom at night like a small sun' }, { serial: 'S1957', after: 5, alt: 'A tablet charging in the kitchen while the boy sleeps upstairs' }],
  title: 'The night librarian', art: 'S1238', cast: [],
  alt: 'A boy asleep in bed, a small drawn librarian above him filing the day\'s pictures onto shelves',
  words: [
    'Ezra stayed up late finishing a game, and the next morning he could not remember what his teacher had said the day before. He had listened. It had gone in. It just was not there anymore.',
    'His mom said the brain has a librarian who only works nights. All day long, new memories pile up on her cart: a spelling word, a math trick, a friend\'s joke. At night, while you sleep, she files them onto shelves where you can find them later.',
    'Skip the night, and the cart stays full. Some things slide off before they are ever filed. That is why a tired morning feels like a cart with a wobbly wheel.',
    'Ezra asked how long her shift was. For a kid his age, nine to eleven hours of sleep a night. Growing bodies and busy brains need all of it, every night.',
    'And screens off an hour before bed, his mom said. The light from a screen tells the brain it is still daytime, and the librarian does not clock in.',
    'That week Ezra went to bed on time and left his tablet in the kitchen. On Friday, he remembered every word on the spelling test, even the ones he had studied the night before, and it felt easy.',
    'Sleep is when the brain sorts and stores what you learned. Study, then sleep, and more of it stays. Nine to eleven hours, and the screen goes off first.',
  ],
};
STORIES['reading-a-food-label'] = {
  about: 'a cereal box that won a race it should not have, until someone read the first line',
  more: [{ serial: 'S1242', after: 0, alt: 'Two cereal boxes side by side, a dad pointing at the top of one label' }, { serial: 'S1243', after: 1, alt: 'A half cup and a full cup of cereal side by side' }, { serial: 'S1958', after: 2, alt: 'A dad and daughter squinting at a long ingredients list on a cereal box' }, { serial: 'S1959', after: 4, alt: 'A breakfast table with eggs, beans, fruit and vegetables around a bowl of cereal' }, { serial: 'S1960', after: 5, alt: 'A girl slicing a banana onto a bowl of oats, a glass of milk beside it' }],
  title: 'The serving size', art: 'S1241', cast: [],
  alt: 'A girl at a kitchen table with two cereal boxes, reading the small print on one',
  words: [
    'Isla compared two cereal boxes and picked the one with less sugar on the label: nine grams against fourteen. Easy choice. Her dad asked her to read the very first line before she decided. Serving size: half a cup on hers, one cup on the other.',
    'Every number on a label is per serving. Nine grams in half a cup was eighteen grams in a whole cup. Her cereal had won a race it should not have, because it had run only half the distance.',
    'Then her dad showed her the ingredients list. Ingredients are listed from most to least, so the first word is what the food is mostly made of. Her box began with sugar. The other began with whole grain oats.',
    'Isla felt a little tricked. The label had told the truth twice, in small print. She had just read the big number first, like almost everyone does.',
    'Her dad turned the box over. Protein, he said, from beans, eggs, fish or meat, builds and repairs muscle. Fruits and vegetables bring vitamins. A good breakfast has more than cereal in the bowl.',
    'Isla chose the oats, sliced a banana on top and poured herself a glass of milk. She read the serving size on every box in the pantry that weekend, just to catch them.',
    'Check the serving size first, because every number is per serving. Then the sugar, then the first three ingredients. The small print tells the real story.',
  ],
};
STORIES['the-heart-at-work'] = {
  about: 'a pulse counted at the top of the stairs, and what it did one minute later',
  more: [{ serial: 'S1245', after: 0, alt: 'A nurse showing a boy where to press two fingers on the inside of his wrist' }, { serial: 'S1246', after: 2, alt: 'A heart pumping hard, blood carrying oxygen down to running legs' }, { serial: 'S1961', after: 3, alt: 'The boy resting on the top step, counting his pulse again while his aunt watches the clock' }, { serial: 'S1962', after: 4, alt: 'Children playing soccer, biking and chasing each other in a game of tag' }, { serial: 'S1963', after: 5, alt: 'The boy racing up the stairs again a month later, grinning at the top' }],
  title: 'The top of the stairs', art: 'S1244', cast: [],
  alt: 'A boy at the top of a stairwell with two fingers on his wrist, watching a clock',
  words: [
    'Andre raced up four flights of stairs at the library and wanted to know what his heart had done about it. He pressed two fingers on the inside of his wrist, below his thumb, and felt his pulse thumping. His aunt, a nurse, showed him how to count.',
    'Count the beats for fifteen seconds, she said, then multiply by four. At the top of the stairs, Andre counted 36 beats in fifteen seconds. Thirty-six times four: 144 beats a minute.',
    'Why so fast? Working muscles need more oxygen, and blood carries it to them, so his heart pumped faster to send more blood.',
    'Then his aunt had him rest and count again one minute later: 28 beats, or 112 a minute. His heart was already settling. How quickly a heart slows back down after hard work is called recovery, and it is one of the best signs of fitness.',
    'Andre decided to try an experiment. For a month he played hard for about an hour every day: soccer, biking, tag with his cousins. It all counted, even in pieces.',
    'Then he raced the same stairs and counted again. Nearly as fast at the top. But one minute later, his pulse had dropped much further than before. Training makes the heart stronger, so it pumps more blood with every beat, and the body learns to calm it down faster after hard work.',
    'Muscles at work need more blood, so the heart speeds up. An hour of active play a day trains it, and a fit heart settles fast.',
  ],
};
STORIES['screens-and-you'] = {
  about: 'twenty minutes, twenty feet, twenty seconds, and the rules that fit on a sticky note',
  more: [{ serial: 'S1248', after: 0, alt: 'A girl rubbing her tired eyes after homework on a laptop' }, { serial: 'S1249', after: 1, alt: 'The girl looking out a window at a tree far away, giving her eyes a rest' }, { serial: 'S1964', after: 2, alt: 'A phone charging on a kitchen counter at night, the bedroom dark upstairs' }, { serial: 'S1965', after: 3, alt: 'The girl showing her mom a photo on her phone before sharing it' }, { serial: 'S1966', after: 4, alt: 'A photo being copied again and again, spreading across many screens' }],
  title: 'Twenty, twenty, twenty', art: 'S1247', cast: [],
  alt: 'A girl at a desk looking up from a screen toward a far window, a sticky note on the monitor',
  words: [
    'Zara\'s eyes ached after homework, and she could not fall asleep after watching videos in bed. She figured that was just how screens were. Everybody she knew had tired eyes.',
    'Her school nurse gave her three rules that fit on one sticky note. The first was for her eyes. Every twenty minutes, look at something twenty feet away for twenty seconds. Staring at something close keeps the focusing muscles in your eyes working hard, and looking far away lets them relax.',
    'The second rule was for sleep. Screens off an hour before bed, because the light from a screen tells the brain it is still daytime. Zara moved her phone charger to the kitchen.',
    'The third rule was not about her body at all. Anything she shared online, a photo, a message, where she was, went past a trusted adult first. And never her address or her school.',
    'Zara asked why. What goes online stays online, the nurse said. A photo can be copied and passed around long after you delete it, by people you will never meet.',
    'A week later, Zara\'s eyes felt better by the end of homework, and she fell asleep faster. She stuck the note on her desk where she could see it, and one on her little brother\'s tablet too.',
    'Screens are useful and fun, and they have costs. A break every twenty minutes, off an hour before bed, and nothing shared without a trusted adult.',
  ],
};
// Music, added on 2026-09-23.
STORIES['the-steady-beat'] = {
  about: 'a clock that kept time, and the song that had a clock inside it',
  more: [{ serial: 'S1251', after: 0, alt: 'The clock on the wall, tick tick' }, { serial: 'S1691', after: 1, alt: 'Music notes swirling fast and slow around a puzzled girl, her finger ready to tap' }, { serial: 'S1692', after: 2, alt: 'The girl listening for the pulse under the notes' }, { serial: 'S1693', after: 4, alt: 'The girl tapping a steady beat on her knee while music notes dance above her' }],
  title: 'The clock in the song', art: 'S1250', cast: [],
  alt: 'A small girl tapping a steady beat on her knees while a clock ticks on the wall',
  words: [
    'Tick, tick, tick. The clock on the wall kept time. Mia tapped along on her knees. Then the music teacher played a song. Keep tapping, she said.',
    'The song had lots of notes. Fast ones. Slow ones. Mia did not know where to tap.',
    'Listen under the notes, said the teacher. There is a pulse. Even, like the clock.',
    'Mia listened. There it was. Tap. Tap. Tap. Steady. Under it all. The beat.',
    'She found it and tapped it. The notes danced on top. The beat stayed steady underneath.',
    'Every song had a clock inside it. Mia tapped the beat to the radio all the way home.',
...
STORIES['high-and-low'] = {
  ...
  more: [{ serial: 'S1254', after: 0, alt: 'The bird on a branch, its song drawn high' }, { serial: 'S1694', after: 1, alt: 'The boy puzzled, high and low for a sound?' }, { serial: 'S1695', after: 3, alt: 'Fingers walking to the right on the piano keys' }, { serial: 'S1696', after: 5, alt: 'Fingers walking to the left, down toward the cow' }],
  title: 'Bird high, cow low', art: 'S1253', cast: [],
  alt: 'A small boy on a farm hearing a bird sing high and a cow moo low, a small piano drawn beside him',
  words: [
    'The bird sang. Tweet! The cow mooed. Moo. Kai said they were the same sound. His sister said one was high and one was low.',
    'What did high and low mean for a sound? A sound was not up or down. Kai did not get it.',
    'Inside, on the piano, Kai walked his fingers to the right. The notes climbed. Higher and higher. Toward the bird.',
    'He walked his fingers to the left. The notes sank. Lower and lower. Toward the cow.',
    'High and low is pitch. The bird was high. The cow was low. Kai could hear it now.',
    'He played a bird. Way up on the right. He played a cow. Way down on the left. His sister laughed.',
...
STORIES['loud-and-soft'] = {
  ...
  more: [{ serial: 'S1257', after: 0, alt: 'The big drum booming in the parade' }, { serial: 'S1697', after: 1, alt: 'Mom singing softly by a crib at night' }, { serial: 'S1698', after: 2, alt: 'The drum reaching the whole street, sound waves drawn' }, { serial: 'S1699', after: 4, alt: 'The girl singing to her doll, soft as a whisper' }],
  title: 'The drum and the lullaby', art: 'S1256', cast: [],
  alt: 'A small girl covering her ears at a loud parade drum, a baby asleep in a stroller nearby',
  words: [
    'The parade drum was so loud that Ana covered her ears. Boom! Boom! That night her mom sang a lullaby. It was so soft Ana could barely hear it.',
    'Why not sing loud too? Ana asked. Mom smiled. Loud and soft are for different jobs.',
    'The drum had to reach the whole street. Everyone, all at once. Loud.',
    'The lullaby had to reach one sleepy girl. Just Ana. Soft.',
    'A song can grow louder. It can fade away. That is dynamics. Loud, soft, and all the steps between.',
    'Ana sang to her doll. Soft as a whisper. Then she marched with a pot lid. Loud as a drum. Both were right.',
    'Loud and soft is dynamics. A song can grow louder or fade.',
  ],
};
STORIES['note-lengths'] = {
  about: 'a pizza cut into notes, and why they added up like fractions',
  more: [{ serial: 'S1260', after: 0, alt: 'A girl frowning at a line of music, counting the notes on her fingers' }, { serial: 'S1261', after: 1, alt: 'A whole pizza, a half, a single slice and half a slice lined up in a row' }, { serial: 'S1946', after: 2, alt: 'One slice and six half slices filling a plate' }, { serial: 'S1947', after: 4, alt: 'A paper plate of pizza pieces with one gap, the girl pointing at the empty space' }, { serial: 'S1948', after: 5, alt: 'Four slices, two halves, one whole pizza and eight small pieces, each filling a plate of its own' }],
  title: 'The pizza of notes', art: 'S1259', cast: [],
  alt: 'A girl at a music stand with a paper pizza cut into halves, quarters and eighths, notes drawn on the slices',
  words: [
    'Bea counted the notes in one measure and got seven. The measure was only supposed to hold four beats, so she decided the music was broken. Her teacher asked her to add the notes up instead of counting them.',
    'A whole note is the whole pizza: four beats. A half note is half the pizza: two beats. A quarter note is one slice: one beat. An eighth note is half a slice: half a beat. Each note lasts half as long as the one before it.',
    'Bea\'s seven notes were one quarter note and six eighth notes. The quarter was one beat. The six eighths were half a beat each, and six halves make three. One beat plus three beats. Four beats. Not broken at all.',
    'The number of notes did not matter at all. What mattered was how long each one lasted, and how they added up.',
    'She drew the measure as a pizza and every note as a piece, and the pieces always filled the plate. When they did not fill it, she had miscounted, and the empty space on the plate showed her where.',
    'Four quarter notes fill a measure of four beats. So do two half notes, or one whole note, or eight eighth notes. Notes are fractions of a measure, and they add up the same way fractions do.',
    'Whole, half, quarter, eighth: four beats, two, one and a half. A measure is a plate that has to be full.',
  ],
};
STORIES['the-staff'] = {
  about: 'a ladder of letters, and the boy who learned to climb it',
  more: [{ serial: 'S1263', after: 0, alt: 'Five lines of music with one note on them, like a fence with a bird perched on it' }, { serial: 'S1264', after: 1, alt: 'A music staff drawn as a ladder with five rungs, a boy climbing it with his eyes' }, { serial: 'S1949', after: 2, alt: 'A smiling boy walking home, saying something over and over to himself' }, { serial: 'S1950', after: 3, alt: 'A cheerful face drawn in the four spaces of a music staff' }, { serial: 'S1951', after: 4, alt: 'Notes climbing a staff from the bottom line up, getting higher like birds on a staircase' }],
  title: 'The ladder of letters', art: 'S1262', cast: [],
  alt: 'A boy at a music stand tracing the five lines of a staff with his finger',
  words: [
    'Luis could play any note if you told him its name, but he could not find the name on the page. Five lines, four spaces, and a dot somewhere on them. It looked like a fence with a bird on it.',
    'His teacher called the staff a ladder. Some ladders you climb with your feet. This one you climb with your eyes. Every rung and every gap between the rungs has a letter, and every note sits either on a line or in a space.',
    'The lines of the treble staff, from the bottom up, are E, G, B, D and F. To remember them, she said: Every Good Boy Does Fine. Luis said it three times on the walk home.',
    'The spaces, from the bottom up, are F, A, C and E. They spell a word you already know: face. Four letters, four spaces, one face.',
    'And the ladder went up in pitch. A dot higher on the staff was a higher note. Luis put his finger on the bottom line, E, and climbed, naming each rung and gap as he went: E, F, G, A, B, C, D, E, F.',
    'By the end of the week, the bird on the fence had turned into a note he could name and play without stopping to count.',
    'Five lines and four spaces; lines E, G, B, D, F; spaces F, A, C, E. Higher on the staff is higher in pitch. Learn two sayings, and you can name any note on the staff.',
  ],
};
STORIES['tempo-and-dynamics'] = {
  about: 'four Italian words on a music stand, and the whole feel of a piece in them',
  more: [{ serial: 'S1266', after: 0, alt: 'A teacher pointing at small words on a music page while a girl looks puzzled' }, { serial: 'S1267', after: 1, alt: 'A piano with soft notes floating gently from one end and loud notes bursting from the other' }, { serial: 'S1952', after: 3, alt: 'A girl tiptoeing into a quiet room, then the same room full of people and noise' }, { serial: 'S1953', after: 4, alt: 'A little brother leaning in the doorway, listening to his sister play' }, { serial: 'S1954', after: 5, alt: 'A baby asleep to a soft lullaby while a marching band parades loudly past the window' }],
  title: 'Four Italian words', art: 'S1265', cast: [],
  alt: 'A girl at a piano with a page of music, circling marks on it with a pencil',
  words: [
    'Nora played the piece exactly as written, every note right, and her teacher said it sounded like a grocery list. Nora asked what was missing. Her teacher pointed at four words she had skipped because they were not notes.',
    'Forte means loud. Piano means soft. Those two are dynamics: how loud or soft to play. The piano got its name from them, her teacher said. Its full name, pianoforte, means soft-loud, because it could play both.',
    'Allegro means fast. Adagio means slow. Those two are tempo: how fast the music goes. A composer writes the words right on the page so every player in the orchestra plays it the same way.',
    'Nora played it again with the words. The opening was piano and adagio, soft and slow, like someone tiptoeing into a room. The middle was forte and allegro, and the room filled with people and noise.',
    'Same notes, same order. But now it sounded like a piece of music instead of a list. Her little brother, who never listened to her practice, came to the door to hear the ending.',
    'Her teacher played two examples. A lullaby, piano and adagio, soft and slow. A march, forte and allegro, loud and fast. Nora could have guessed the words just from hearing them.',
    'Forte is loud, piano is soft; tempo is speed, allegro fast and adagio slow. The notes say what to play. The Italian words say how, and how is most of the music.',
  ],
};
...
STORIES['area-and-perimeter'] = {
  ...
  more: [{ serial: 'S1269', after: 0, alt: 'A girl walking the edge of a garden bed with a tape measure' }, { serial: 'S1270', after: 1, alt: 'A mom at a garden store holding a bag of soil, tilting her head at her daughter' }, { serial: 'S1931', after: 3, alt: 'A garden bed drawn on grid paper, four rows of three squares' }, { serial: 'S1932', after: 4, alt: 'A little boy planting one sunflower by the back steps with leftover soil' }, { serial: 'S1933', after: 5, alt: 'A square sandbox in a backyard, a girl measuring one side' }],
  ...
  words: [
    'Hannah\'s mom asked her to measure the new garden bed so they could buy fence wire and soil. Hannah walked around the edge with a tape measure: four feet, three feet, four feet, three feet. Fourteen feet. She wrote down fourteen and thought she was done.',
    'At the store, fourteen feet of wire was exactly right. Then her mom picked up the soil bags and asked how many square feet the bed was. Hannah said fourteen. Her mom tilted her head. Was it, though?',
    'The wire went around the edge. The soil filled the inside. Those were two different questions, and one number could not answer both.',
    'At home, Hannah drew the bed on grid paper, one square for every square foot. Four rows of three squares. Twelve squares. The bed covered twelve square feet, not fourteen. That was the area. The fourteen feet around the edge was the perimeter.',
    'They had bought soil for fourteen square feet, so two square feet of soil were left in the bag. Her little brother used them to plant a single sunflower by the back steps.',
    'Then her mom gave her a harder one: a square sandbox, five feet on every side. Around the edge: five, five, five and five, twenty feet. Inside: five rows of five, twenty-five square feet. Hannah did not mix them up this time.',
    'Perimeter is the walk around the edge, measured in feet. Area is the surface covered, measured in square feet. Before you measure, ask which one the question wants.',
  ],
};
STORIES['angles-and-lines'] = {
  about: 'a bedroom door and the angles it made between closed and flat against the wall',
  more: [{ serial: 'S1272', after: 1, alt: 'A little sister peeking through a door opened just a crack' }, { serial: 'S1273', after: 2, alt: 'The door barely open, making a thin wedge like the tip of a pizza slice' }, { serial: 'S1934', after: 3, alt: 'The door straight out from the wall, making a square corner' }, { serial: 'S1935', after: 4, alt: 'The door swung all the way back, flat against the wall' }, { serial: 'S1936', after: 5, alt: 'Railroad tracks running side by side into the distance beside a doorway' }],
  title: 'The door', art: 'S1271', cast: [],
  alt: 'A boy slowly swinging a bedroom door open, its angle to the wall growing wider',
  words: [
    'Kai\'s homework asked for an acute angle, a right angle and an obtuse angle from around the house. He looked at the clock, the table and the roof and could not find any. He even checked under the bed. Angles seemed to live only on worksheets.',
    'Then his little sister opened his door a crack to spy on him. The door and the wall made a thin wedge. Kai pushed it a bit wider. A bigger wedge. He pushed it straight out. A square corner.',
    'The door had been drawing angles the whole time. Barely open, a small wedge: acute, less than a right angle, like the tip of a pizza slice. Kai drew it in his notebook.',
    'Straight out from the wall: a right angle, 90 degrees, the corner of a square. Pushed farther: obtuse, wider than a right angle but not yet flat, like a chair tipped back.',
    'Then he swung it all the way back until it lay flat against the wall beside it. A straight angle: 180 degrees, two right angles side by side.',
    'His sister pointed at the top and bottom edges of the door. They ran side by side and never met, like railroad tracks. Parallel. The edge of the door met the floor in a square corner. Perpendicular. Kai wrote both words down before he forgot them.',
    'Angles are everywhere two lines meet. A right angle is 90 degrees, acute is smaller and obtuse is wider. Open any door, and you can see all of it.',
  ],
};
STORIES['mean-median-mode-6'] = {
  ...
  more: [{ serial: 'S1275', after: 0, alt: 'Six small stacks of dollar bills: two, three, three, four, five and nine' }, { serial: 'S1276', after: 1, alt: 'The two-dollar friend frowning while the nine-dollar friend grins' }, { serial: 'S2081', after: 2, alt: 'The six stacks lined up from smallest to tallest, a finger on the middle two' }, { serial: 'S2082', after: 3, alt: 'Five stacks of dollars shared out evenly after the tallest stack is set aside' }, { serial: 'S2083', after: 4, alt: 'A note to the teacher with the word median circled' }],
  ...
  words: [
    'Six friends compared allowances at lunch: two, three, three, four, five and nine dollars. Nadia said the average was about four dollars and thirty-three cents. Marcus said most people got three. Lena said the middle was three and a half. All three were right, which made no sense.',
    'They argued about which number was the real one. The nine-dollar friend, Sam, said the average was more than four dollars and that proved everyone was doing fine. The two-dollar friend did not feel fine.',
    'There were four honest numbers, and each told something different. The mean added it all and shared it out: twenty-six dollars among six, about 4.33, pulled upward by Sam. The median was the middle after sorting, three and a half, and Sam could not move it. The mode was the most common, three. The range was highest minus lowest, seven, and it measured the gap between Sam and everyone else.',
    'Then Lena asked what would happen without Sam. The other five allowances added to seventeen dollars, and seventeen shared by five is 3.40. The mean dropped by almost a dollar. The median only slipped from 3.50 to 3. One big number had moved the mean a long way and the median hardly at all.',
    'So which average should they give a teacher who asked what a typical kid got? The median, they decided, because it was where most of them actually were. The mean was not wrong. It answered a different question: how much each would have if everyone shared.',
...
STORIES['four-quadrants'] = {
  ...
  more: [{ serial: 'S1278', after: 0, alt: 'A girl reading an address of minus three, minus two on a note, puzzled' }, { serial: 'S1279', after: 1, alt: 'A girl stuck on a street corner, unsure which way a negative step goes' }, { serial: 'S2084', after: 2, alt: 'Two pins on the map, one at three east and two north, one at three west and two south' }, { serial: 'S2085', after: 3, alt: 'A school and a house mirrored across the main east-west street on a city map' }, { serial: 'S2086', after: 5, alt: 'A map with four colored quarters around the center point, numbered counterclockwise' }],
  ...
  words: [
    ...
    'Another friend lived at 3, minus 2: three blocks east, two south, a mirror image of the school across the main east-west street. Change one sign and you flip across one axis. Change both and you land on the opposite corner.',
    'The library sat at minus 3, 2, three blocks west on the same street as the school. Walking from the school took six blocks: three to the center line and three more, the two distances from zero added together.',
...
STORIES['context-clues'] = {
  about: 'a girl reading about a mountain climb, three strange words and the friends each one came with',
  more: [{ serial: 'S1287', after: 0, alt: 'The girl frowning at one hard word in her book, the dictionary far across the room' }, { serial: 'S1288', after: 2, alt: 'Mountain climbers shivering in a frigid wind, pulling their hoods tight' }, { serial: 'S1773', after: 3, alt: 'Climbers standing on the snowy top of a mountain, arms raised' }, { serial: 'S1774', after: 4, alt: 'A white bird sitting on a snowy mountain ridge, watching climbers pass' }, { serial: 'S1775', after: 5, alt: 'The girl closing a big dictionary with a satisfied smile beside the window' }],
  title: 'The friends it came with', art: 'S1286', cast: [],
  alt: 'A girl curled on a couch under a blanket, reading a book about mountain climbers, one page glowing softly',
  words: [
    'Ava was reading a story about a mountain climb when she hit a word she had never seen. Frigid. She stopped. The whole page seemed to lock behind that one word, the way a door locks when you do not know the code.',
    'She could have skipped it. She could have asked her dad. The dictionary was across the room, and the couch was warm under the blanket. So she read the sentence again, slowly, and something caught her eye.',
    'The frigid wind made the climbers shiver and pull their hoods tight. Shiver. Hoods. The new word had come to the party with friends, and the friends gave it away. Frigid meant very cold.',
    'Two pages later came another stranger. The climbers reached the summit, or the very top of the mountain. This time the clue came right after the word, holding the door open. The little word or was saying: here is what it means.',
    'Then came a word with no friends at all. On the ridge, a ptarmigan watched them pass. Nothing around it helped. Was it a rock? A person? Ava finally got off the couch and opened the dictionary. A ptarmigan is a bird whose feathers turn white in winter.',
    'Most new words arrive with clues: the words beside them, the sentence before, the picture on the page. Read around the stranger first, and you will guess right more often than not. When the friends stay quiet, the dictionary does the introducing.',
  ],
};
STORIES['character-and-setting'] = {
  about: 'a new girl who said she was shy, and what she did at recess',
  more: [{ serial: 'S1290', after: 1, alt: 'A teacher smiling at the board while children think about what to write' }, { serial: 'S1291', after: 2, alt: 'The new girl climbing off her swing to give it to a crying little boy' }, { serial: 'S1776', after: 3, alt: 'A playground at recess under a hot sun, the swing chains glinting' }, { serial: 'S1777', after: 4, alt: 'The girl reading a poem aloud to her class, her paper shaking a little' }, { serial: 'S1778', after: 5, alt: 'An open storybook with its setting and characters rising out of the pages: a sunny playground, a swing and a kind girl' }],
  title: 'What she did at recess', art: 'S1289', cast: [],
  alt: 'A new girl with a backpack standing quietly by the classroom door on her first morning',
  words: [
    'Jonah\'s teacher asked the class to describe the new girl, Lina, after her first day. Almost everybody wrote the same thing. She is shy. That was what Lina had said about herself that morning, in a voice so small the back row missed it.',
    'One boy wrote that she was tall. The teacher shook her head. Tall is how someone looks, she said. I asked what she is like. A trait is a way of being: brave, honest, kind, shy.',
    'Jonah started to write shy, then stopped. At recess he had seen something. A first grader was crying because every swing was taken. Lina got off her swing without a word and gave it to him. Shy people did not do that. Or did they?',
    'He wrote it carefully. The where was the playground. The when was recess, under a hot sun with the swing chains creaking. Those two were the setting. And who Lina was did not come from what she said about herself. It came from what she did. She was kind.',
    'On Friday, Lina raised her hand and read her poem out loud to the whole class. Her voice shook a little, but she finished. The girl who called herself shy had just been brave. Jonah wrote that down too. Characters can change.',
    'That is how characters work in every story. Setting is the where and the when. Characters show who they are by what they say and do, and when the two disagree, believe what they do.',
  ],
};
...
STORIES['soil-and-rocks'] = {
  about: 'a jar of muddy water that sorted itself overnight into the things soil is made of',
  more: [{ serial: 'S1299', after: 1, alt: 'The jar the next morning settled into layers: sand at the bottom, silt, cloudy water and dark bits near the top' }, { serial: 'S1300', after: 2, alt: 'A big rock cracked by ice and tree roots on a hillside, crumbs of sand below it' }, { serial: 'S1794', after: 3, alt: 'A grandpa holding a sticky ball of wet clay in one hand and crumbling sand in the other' }, { serial: 'S1795', after: 4, alt: 'A girl and her grandpa digging rotted leaves into a garden bed of tomato plants' }, { serial: 'S1796', after: 5, alt: 'A slice of ground cut away like a cake, rock at the bottom and rotted leaves on top, a jar of water beside it' }],
  title: 'The jar', art: 'S1298', cast: [],
  alt: 'A tall glass jar of muddy water on a table, a girl shaking it hard, dirt swirling inside',
  words: [
    'Priya\'s tomato plants were drooping, and her grandpa said the trouble was in the dirt. Dirt was just dirt, she thought. She scooped some into a jar of water and shook it until the whole thing turned brown. Then she went to bed.',
    'In the morning the jar had sorted itself into stripes. Gritty sand lay at the bottom, fine silt above it. The water was still cloudy with clay, and dark bits of old leaves floated near the top. One scoop of dirt had become four things. How?',
    'Because soil was never one thing. Most of it is rock, cracked apart over thousands of years by rain, ice and roots, then ground smaller and smaller. The rest is rotted leaves and roots of things that once lived. Heavy sand sank first. Tiny clay took longest to settle.',
    'Her grandpa showed her the squeeze test. He wet a handful of each. Clay made a sticky ball that held its shape. Sand fell apart in his fingers. The good garden soil held together a little and crumbled a little. That mix is called loam.',
    'Priya\'s garden bed was mostly clay. Clay packs tight and holds water, so her tomato roots were sitting in a puddle. They dug in rotted leaves from the compost pile, and by summer the plants stood tall.',
    'The ground under your feet is a slow recipe of rock and rotted life. Clay holds water, sand drains fast, and loam is the mix that gardens love. A jar of water reads the recipe out.',
  ],
};
STORIES['food-chains-3'] = {
  about: 'a bucket of water passed up a hill at camp, and how little of the sun reaches a hawk',
  more: [{ serial: 'S1302', after: 0, alt: 'A boy filling a bucket to the brim at a creek at the bottom of a grassy hill' }, { serial: 'S1303', after: 1, alt: 'A camp counselor by a campfire at night, children listening with their chins in their hands' }, { serial: 'S1797', after: 2, alt: 'A grasshopper on a blade of grass, a small bird watching from a branch' }, { serial: 'S1798', after: 4, alt: 'A rotting log covered in mushrooms in a shady forest' }, { serial: 'S1799', after: 5, alt: 'A hawk flying away over a dry brown meadow' }],
  ...
  words: [
    'At summer camp, Kenji stood at the bottom of a line of kids passing a bucket of water up the hill. He filled it to the brim at the creek. Every hand spilled a little. By the time it reached the top, only a splash sloshed at the bottom.',
    'That night the counselor asked a strange question. Why are there so many blades of grass in the meadow and so few hawks above it? The kids guessed hawks were shy, or fast, or hiding. Nobody guessed the bucket.',
    'Every food chain starts with the sun. Grass catches sunlight and makes its own food, so grass is a producer. A grasshopper eats the grass, a bird eats the grasshopper, and a hawk eats the bird. Each eater is a consumer, and each one uses up most of the energy it gets, like a spill.',
    'By the hawk, only a splash is left. It takes a whole meadow of grass to feed one hawk, which is why the hawk sits at the top of this chain.',
    'The next morning Kenji found a rotting log covered in mushrooms. The counselor said those were decomposers. They break down dead things and turn them back into soil, and the soil feeds the grass. The chain was really a circle.',
    'Late that summer the creek ran low and the meadow went brown. The grasshoppers thinned out, then the birds, and the hawk flew off to hunt somewhere else.',
    'Every link depends on the one below it. Take away the grass, and the whole line goes dry.',
  ],
};
STORIES['forces-and-motion-5'] = {
  about: 'a tug of war that nobody won, until one small girl walked over',
  more: [{ serial: 'S1305', after: 0, alt: 'Red-faced children pulling hard, their shoes digging into the grass' }, { serial: 'S1306', after: 1, alt: 'A small girl stepping in to join one end of the rope' }, { serial: 'S2012', after: 2, alt: 'The flag sliding across the line, one team stumbling forward' }, { serial: 'S2013', after: 3, alt: 'Sneakers gripping grass beside socks slipping on a wet floor' }, { serial: 'S2014', after: 4, alt: 'An empty cart racing ahead of a cart full of water jugs after the same push' }],
  ...
  words: [
    ...
    'The coach added one more idea. Why did both teams dig their shoes into the grass? Friction, the force that grips where two surfaces rub. On a wet floor in socks, both teams would have slid, pulled along by the rope instead of holding against it.',
    'Then he rolled two carts across the field, one empty and one full of water jugs, and pushed each just as hard. The empty cart shot away. The full one crept. The same push moves a lighter thing more. Gravity was pulling on both the whole time, holding them to the ground.',
...
STORIES['fossils-and-earth-5'] = {
  ...
  more: [{ serial: 'S1308', after: 0, alt: 'A hiker studying a trail map that shows the ocean far away' }, { serial: 'S1309', after: 1, alt: 'The same place drawn as a shallow sea floor long ago, shells settling in sand' }, { serial: 'S2015', after: 2, alt: 'Layers of rock on a cliff face, the shell in one of the middle layers' }, { serial: 'S2016', after: 3, alt: 'A leaf print, a stone shell and dinosaur footprints side by side in rock' }, { serial: 'S2017', after: 4, alt: 'Ancient swamp plants buried under layers of mud that slowly turn to coal' }],
  ...
  words: [
    ...
    'Her uncle said fossils come in more than one kind. Some are the hard part itself, turned to stone. Some are only a print, like a leaf pressed into mud that hardened. Some are tracks, the footprints of an animal that walked across soft ground and left.',
    'Coal was made in a similar way, he said, from swamp plants buried in layers and squeezed for millions of years. The energy in it first came from sunlight those plants caught long ago. That is why coal is called a fossil fuel.',
...
STORIES['immigration-and-cities'] = {
  ...
  more: [{ serial: 'S1311', after: 0, alt: 'An old bag opened to show folded clothes, a photograph and a handwritten recipe' }, { serial: 'S1312', after: 1, alt: 'Inspectors checking eyes and papers in a great hall at Ellis Island' }, { serial: 'S2051', after: 2, alt: 'A crowded tenement room with six people, a stove and one window' }, { serial: 'S2052', after: 4, alt: 'Children and adults in an English class at a city settlement house around 1900' }, { serial: 'S2053', after: 5, alt: 'A grandmother and granddaughter baking the same bread on a Sunday in a modern kitchen' }],
  ...
  words: [
    ...
    'Rosa looked it up. Ellis Island opened in 1892, and about twelve million people passed through it before it closed. On the other coast, many who crossed the Pacific came through Angel Island in San Francisco Bay, where some were held for weeks or months.',
    'The cities strained to hold everyone. Some neighbors helped. In Chicago in 1889, Jane Addams opened Hull House, where new arrivals could learn English, leave their children in a nursery and find help getting work. The newcomers built the cities that had not been ready for them.',
...
STORIES['industry-and-invention'] = {
  about: 'a shirt that took fourteen hours to sew, then a hundred in a day, and everything that sped up with it',
  more: [{ serial: 'S1314', after: 1, alt: 'A woman sewing one shirt by hand at a window, a clock behind her showing the long hours' }, { serial: 'S1315', after: 2, alt: 'Rows of sewing machines in a bright factory turned by a steam engine, shirts moving along a line' }, { serial: 'S2054', after: 3, alt: 'Children working beside large machines in a factory around 1900' }, { serial: 'S2055', after: 4, alt: 'Car frames moving along a line past workers in a 1913 factory' }, { serial: 'S2056', after: 5, alt: 'A light bulb glowing over a factory at night beside a telegraph pole and railroad tracks' }],
  title: 'Fourteen hours', art: 'S1313', cast: [],
  ...
  words: [
    'Lena\'s history project was a shirt. Before machines, a skilled seamstress needed about fourteen hours of hand sewing for one fine shirt, more than a full day of work. After machines, a factory could turn out a hundred in a day. She wrote the two numbers down and did not believe them.',
    'Fourteen hours for one, and a hundred in a day. How could anything speed up that much? And if shirts changed that fast, what else did? She started a list and it would not stop growing.',
    ...
    'Machines also changed who worked, and for how long. Many factories hired children, some younger than ten, for twelve-hour days, because they were paid little and their small hands fit between the machines. It took decades of protest before laws kept young children out of factories.',
    'The speeding up kept going. In 1913 Henry Ford set car parts moving past his workers on a line. Building one Model T dropped from about twelve hours to about an hour and a half. Every worker did one job, over and over, and the car came to them.',
...
STORIES['measuring-things'] = {
  ...
  more: [{ serial: 'S1317', after: 1, alt: 'The girl holding the ruler against the puppy again and stopping, puzzled' }, { serial: 'S1318', after: 2, alt: 'A mom standing on a bathroom scale holding a small puppy' }, { serial: 'S1821', after: 3, alt: 'Water poured from a puppy bowl back into a measuring cup at bedtime' }, { serial: 'S1822', after: 4, alt: 'A dad pointing at a big gallon jug of water on a garage shelf' }, { serial: 'S1823', after: 5, alt: 'A ruler, a scale and a measuring cup lined up beside a sleepy puppy' }],
  title: 'Three ways to measure a puppy', art: 'S1316', cast: [],
  alt: 'A wriggling puppy on a rug with a girl holding a ruler along its back',
  words: [
    'The shelter sent Ellie home with a new puppy named Noodle and a chart to fill in. How long is she? How heavy is she? How much water does she drink in a day? Ellie grabbed a ruler and started with the puppy, who did not want to be measured at all.',
    'Fourteen inches, nose to tail, after four tries. Twelve inches make a foot, so Noodle was one foot and two inches long. Then Ellie held the ruler against the puppy again for the second question and stopped. A ruler cannot tell you how heavy something is.',
    'She needed a different tool. The kitchen scale was too small, so her mom stood on the bathroom scale holding Noodle, then without her. The difference was six pounds. Pounds answer how heavy.',
    'For the water, Ellie poured two cups into the bowl with a measuring cup in the morning. At bedtime she poured what was left back into the cup. One cup. So Noodle drank one cup that day. Cups answer how much liquid.',
    'Her dad pointed at the gallon jug in the garage. Sixteen cups fill a gallon, he said, so that jug holds sixteen days of Noodle\'s water.',
    'Three questions, three tools. A ruler for how long, a scale for how heavy, a measuring cup for how much. Every measurement starts with the question. Pick the unit that answers it, and the tool comes with it. A ruler on a puppy only ever answers one of the three.',
  ],
};
STORIES['graphs-and-tallies'] = {
  about: 'ten minutes of cars, counted twice, and the picture that ended an argument',
  more: [{ serial: 'S1320', after: 0, alt: 'A blue car and a red car passing a house while two children point and argue on the porch' }, { serial: 'S1321', after: 1, alt: 'Tally marks on a clipboard in bundles of five, one line slanting across four' }, { serial: 'S1824', after: 3, alt: 'A hand-drawn bar graph with three bars, the blue one standing tallest' }, { serial: 'S1825', after: 4, alt: 'A mom holding the graph and looking puzzled, a bird and a bike in a thought bubble' }, { serial: 'S1826', after: 5, alt: 'A pictograph of little car drawings in rows, one row ending with half a car' }],
  ...
  words: [
    'Kai said most cars on their street were red. His sister Ana said blue. They sat on the porch for ten minutes to settle it and called out colors as cars went by. Red, blue, blue, white, red, blue. By the end, neither could remember the count.',
    'So they tried again. Ana drew a line for every car under its color, and when a color reached five, she drew the fifth line across the other four. Bundles of five. Counting a bundle takes one look.',
    'This time the tallies said red four, blue six and white three. Blue had one bundle and one more line. Red had four lines and no bundle at all.',
    'Then Ana turned the tallies into a bar graph. One bar for each color, as tall as its count. The blue bar stood tallest, taller than red by two, and nobody had to count anything again. The picture said it.',
    'They showed their mom, and she asked what the bars were counting. Birds? Bikes? A graph with no labels is a riddle. So Ana wrote a title across the top and a color under each bar.',
    'Kai made a pictograph too, with one little car standing for two real ones. Blue got three little cars. Red got two. White got one and a half.',
    'Tallies count in fives so a long count stays easy. Bar graphs and pictographs turn counts into pictures, and a title and labels say what the pictures mean.',
  ],
};
STORIES['multiplying-decimals'] = {
  about: 'five dollars, a tenth, and a girl who was sure the answer had to be bigger',
  more: [{ serial: 'S1323', after: 1, alt: 'A calculator showing 0.5 beside a five-dollar bill' }, { serial: 'S1324', after: 2, alt: 'One dime beside a dollar, the dime a tenth of it' }, { serial: 'S1985', after: 3, alt: 'A notebook with 0.5 × 0.4 = 0.20 and two decimal places counted' }, { serial: 'S1986', after: 4, alt: 'Three friends each holding two dollars fifty at a snack stand' }, { serial: 'S1987', after: 5, alt: 'Five dimes stacked beside a five-dollar bill, one small pile beside one big bill' }],
  ...
  words: [
    ...
    'Her teacher gave her a harder one: 0.5 times 0.4. Five times four is twenty, and the question had two decimal places, one in each number, so the answer needs two: 0.20. Half of four tenths is two tenths, the same thing.',
    'Then one that grew: 2.5 times 3. Twenty-five times three is seventy-five, one decimal place, 7.5. Maya checked it with money: three people each paying two dollars fifty spend seven dollars fifty. Times a number bigger than one, the answer grows. Times a number smaller than one, it shrinks.',
...
STORIES['data-and-line-plots'] = {
  ...
  more: [{ serial: 'S1326', after: 0, alt: 'Ten numbers written in a row on a notebook page, a pencil beside them' }, { serial: 'S1327', after: 2, alt: 'A line plot with a tall stack of dots above 4 and one dot alone above 7' }, { serial: 'S1988', after: 3, alt: 'A line plot with the tallest stack, the range and the middle marked by arrows' }, { serial: 'S1989', after: 4, alt: 'One bean sprout taller than the rest in the cup nearest the sunny window' }, { serial: 'S1990', after: 5, alt: 'A line graph of one bean\'s height rising day by day' }],
  ...
  words: [
    ...
    'So she drew a line, numbered it, and put one dot above each measurement. The dots stacked. The pile at four was tallest by far, five dots high. And one lonely dot sat above seven, the surprise sprout that had beaten everyone. She could see the whole experiment in one look.',
    'Her teacher showed her what else the dots could say. The most common height, the mode, was four. The range, tallest minus shortest, was seven minus three: four centimeters. Lined up from shortest to tallest, the middle fell between the fifth and sixth sprouts, and both were four.',
    'The seven made her curious. That cup sat closest to the window and got the most sun. A line plot cannot say why a dot is alone. It shows you where to look, and then you go and look.',
...
STORIES['probability-7'] = {
  ...
  more: [{ serial: 'S1329', after: 1, alt: 'The tally sheet showing fifty-three heads and forty-seven tails' }, { serial: 'S1330', after: 2, alt: 'A second sheet, forty-eight heads, and both sheets side by side' }],
...
STORIES['scale-drawings'] = {
  ...
  more: [{ serial: 'S1332', after: 0, alt: 'A drawing of the room with a scale bar: one inch to two feet' }, { serial: 'S1333', after: 3, alt: 'The real window and the drawn window side by side, the same shape' }],
...
STORIES['cause-and-effect-4'] = {
  ...
  more: [{ serial: 'S1335', after: 0, alt: 'A boy with frozen toes writing two lines in his journal at the bus stop' }, { serial: 'S1336', after: 2, alt: 'A close look at the icy road with tire tracks sliding' }, { serial: 'S1869', after: 4, alt: 'A row of falling dominoes, each one showing a closed bridge, a canceled soccer game or a school bus heading home' }, { serial: 'S1870', after: 5, alt: 'A journal page with arrows all pointing back to a drawing of ice' }, { serial: 'S1871', after: 6, alt: 'The boy reading his journal story aloud while his teacher smiles' }],
  ...
  words: [
    ...
    'So points forward, from the cause to the effect. Because points back, from the effect to the cause. Ask why, and you find the cause. Ask what happened, and you find the effect.',
    'That afternoon the storm got worse, and one cause started knocking over effects like dominoes. The ice closed the bridge. It canceled soccer practice. It sent Owen home early, and school was called off the next day.',
    'Owen added them all to his journal, each with an arrow pointing back to the ice. One cause, five effects, counting the late bus.',
    'A cause makes something happen, and an effect is what happened. Pick the right little word, so or because, and the two strangers in a journal become one story.',
  ],
};
STORIES['text-features'] = {
  about: 'a chapter a boy understood in two minutes, before he had read a single paragraph',
  more: [{ serial: 'S1338', after: 0, alt: 'A boy stuck on the first page of a thick book, his dinner plate waiting on the table' }, { serial: 'S1339', after: 2, alt: 'A volcano photo in a textbook with a caption strip under it, the boy studying it' }, { serial: 'S1872', after: 3, alt: 'Magma glowing deep underground beneath a quiet mountain' }, { serial: 'S1873', after: 4, alt: 'Red-hot lava flowing down the side of a volcano into the sea' }, { serial: 'S1874', after: 5, alt: 'The boy and his dad paging through the front of the book together' }],
  ...
  words: [
    ...
    'The next night his dad showed him a trick. Don\'t read the chapter yet, he said. Just look at it. Marcus thought that was cheating. How could looking at a chapter tell you what it said?',
    'He read the headings first: what a volcano is, why it erupts, kinds of volcanoes. Then the captions under the pictures. Then the words in bold, the ones the book wanted him to learn. Two minutes, and he knew the shape of the whole chapter.',
    'When he did read it, every sentence had a place to go. The bold word magma showed up, and he already knew it was important.',
    'Then his dad showed him the back of the book. The index listed every topic in alphabetical order, with the pages where it appeared. Marcus found lava on three different pages in ten seconds. The glossary, a tiny dictionary just for this book, told him that magma is melted rock underground and lava is the same melted rock once it reaches the surface.',
    'At the front, the table of contents listed the chapters in order. The volcano chapter was the fourth.',
    'Headings, bold words and captions guide you through a page. The contents, the index and the glossary guide you through a whole book. Read the signposts first, and you never get lost.',
  ],
};
STORIES['comparing-texts'] = {
  about: 'one storm told by a poem and by a newspaper, and what the two said together',
  more: [{ serial: 'S1341', after: 0, alt: 'The poem\'s page, a sky cracked open in a drawing beside the words' }, { serial: 'S1342', after: 1, alt: 'A flooded street where a car sits in water up to its doors' }, { serial: 'S2030', after: 2, alt: 'The newspaper\'s rain map with two inches marked' }, { serial: 'S2031', after: 3, alt: 'A rain gauge in a backyard filled just past the two-inch line' }, { serial: 'S2032', after: 4, alt: 'A reporter with a notebook and a poet with a pen, writing about the same storm' }],
  ...
  words: [
    ...
    'Owen wanted proof anyway, so he found a third source: the rain gauge in his own backyard. It held just over two inches. The newspaper had measured right. And the photo on the newspaper\'s front page showed a car up to its doors in water, which the poem had said first.',
    'His mother asked why each writer wrote. The reporter wanted readers to know what happened, so every sentence carried a number, a time or a place. The poet wanted readers to feel the storm, so every line reached for a picture. The purpose shaped the words.',
...
STORIES['reading-an-argument'] = {
  ...
  more: [{ serial: 'S1344', after: 0, alt: 'A girl reading the school newspaper, nodding at its first line' }, { serial: 'S1345', after: 1, alt: 'The letter with one sentence about a cousin circled in red' }, { serial: 'S2033', after: 3, alt: 'The girl opening the research report and reading a chart' }, { serial: 'S2034', after: 4, alt: 'A school bus route map pinned beside a letter to the editor' }, { serial: 'S2035', after: 5, alt: 'A letter with its claim, reasons and evidence underlined in three colors' }],
  ...
  words: [
    ...
    'Lena opened the study herself. It said who was studied, how many, and for how long, and it compared schools that started earlier with schools that started later. Good evidence tells you where it came from, so you can check it.',
    'She wrote her own letter back. She agreed with the claim, added the study as her evidence, and answered the strongest reason against it: buses would have to change their routes. An argument that answers the other side is harder to knock down.',
...
STORIES['text-structures-7'] = {
  ...
  more: [{ serial: 'S1350', after: 1, alt: 'An article with the words however and similarly highlighted, two columns drawn around it' }, { serial: 'S1351', after: 2, alt: 'An article with the trouble was and then one answer, a knot and a scissors drawn beside it' }],
...
STORIES['properties-of-matter-4'] = {
  ...
  more: [{ serial: 'S1359', after: 0, alt: 'A box of odd objects tipped onto a table and lined up by size' }, { serial: 'S1360', after: 2, alt: 'A nail jumping to a magnet while a cork lies still, a coin resting on the bottom of a bowl of water' }, { serial: 'S1890', after: 3, alt: 'A metal spoon and a wooden spoon standing in a steaming mug of hot water, the girl touching the handles' }, { serial: 'S1891', after: 4, alt: 'A sugar cube dissolving in a glass of water as a spoon stirs' }, { serial: 'S1892', after: 5, alt: 'A thermometer standing in a mug of hot water' }],
  title: 'Four tests', art: 'S1358', cast: [],
  alt: 'A girl at a science table with a nail, a cork, a coin, a metal spoon, a wooden spoon and a sugar cube, a magnet and a bowl of water',
  words: [
    'Leila\'s teacher tipped a box onto the table: a nail, a cork, a coin, a metal spoon, a wooden spoon and a sugar cube. Sort them, she said. Leila lined them up by size. Then by color. Neither felt like science.',
    'The teacher set out four tools beside them: a magnet, a bowl of water, a mug of hot water and a thermometer. Try each test on each object, she said, and write down what happens. Leila thought the answers would be boring.',
    'The magnet grabbed the nail and ignored the cork. Iron is magnetic, and cork is not. In the bowl, the cork floated and the coin sank with a clink. The cork is less dense than water, and the coin is more.',
    'Then she stood both spoons in the hot water. In less than a minute, the metal handle was too warm to hold. The wooden handle stayed cool. Metal conducts heat fast. Wood insulates, and keeps the heat from traveling.',
    'Last, she stirred the sugar cube into a cup of water. It shrank, then vanished. It had not disappeared. It had dissolved, spreading through the water in pieces too small to see. Leave the cup on a sunny sill until the water dries up, and the sugar is left behind.',
    'The thermometer measured the hot water. Mass, volume and temperature are properties you measure with tools. Floating, magnetism, conducting and dissolving are properties you test.',
    'Every kind of matter has properties. Measure what you can, test the rest, and a box of odd objects sorts itself.',
  ],
};
STORIES['food-webs-4'] = {
  about: 'a meadow of animal cards tied together with string, and what happened when one card came out',
  more: [{ serial: 'S1362', after: 1, alt: 'Crossing strings on a classroom floor that look like a giant spider web' }, { serial: 'S1363', after: 2, alt: 'A mouse card being lifted and three strings going slack' }, { serial: 'S1893', after: 3, alt: 'A hawk card still held tight by strings from the snake and bird cards' }, { serial: 'S1894', after: 4, alt: 'Glowing arrows flowing from grass to grasshopper to bird to hawk, like energy moving' }, { serial: 'S1895', after: 5, alt: 'Mushrooms growing on a fallen log, turning it back into soil beside green grass' }],
  ...
  words: [
    'Mr. Ortiz laid cards on the classroom floor: grass, grasshopper, mouse, snake, bird and hawk. Each student held a string running from a thing that gets eaten to the thing that eats it. Grass to mouse. Mouse to snake. Mouse to hawk. Grass to grasshopper to bird to hawk. Snake to hawk.',
    'Soon the strings crossed everywhere. It looked less like a chain and more like a spider web, which, Mr. Ortiz said, was the whole idea.',
    'Then he picked up the mouse card. Three strings dropped to the floor. The class expected the hawk to fall too. It ate mice, after all. But the hawk card did not move. Why not?',
    'Because the hawk still had the snake and the bird. A food chain is one line. A food web is all the lines at once, and an animal that eats more than one thing has more than one string holding it up. A web bends where a chain would break.',
    'The arrows in a food web run the same way as the strings, from the eaten to the eater. They show where the energy goes. And every string, followed back far enough, starts at a plant.',
    'Mr. Ortiz added one last card: mushrooms. Decomposers break down dead plants and animals and return them to the soil, which feeds the grass. The web closed into a loop.',
    'More links mean more ways to survive a loss. That is why a meadow full of different living things stays alive.',
  ],
};
export const STORY_WORD_LIMIT = { early: 200, older: 350 };
export function storyFor(moduleId) { return STORIES[moduleId] || null; }

// What a whole course is reaching for, in one line (2026-09-24, Mikey): the subtitle on a printed story book's cover,
// the goal all of its stories add up to.
export const COURSE_GOALS = {
  'very-first-steps-pk3': 'Noticing what is the same, what is different, and what there is more of',
  ...
  'music-1': 'Feeling the beat and hearing high, low, loud and soft',
  'numbers-2': 'Reading, adding and subtracting numbers to a thousand, and telling time and money',
  'reading-2': 'Reading longer words and longer stories and working out what they mean',
  'writing-2': 'Writing complete sentences that describe and tell what happened',
  'science-2': 'Knowing materials by their properties and animals by their homes',
  'civics-2': 'Seeing how a community works, from then and now to earning and saving',
  'fractions-intro': 'Understanding what a fraction is and how fractions compare',
  'multiplication-3': 'Multiplying, dividing and measuring with numbers to a thousand',
  'reading-3': 'Reading to understand what a text means and how it is built',
  'writing-3': 'Writing a paragraph that explains, instructs or gives a reason',
  'science-3': 'Explaining how the everyday world works, from matter to weather to sound',
  'civics-3': 'Understanding how communities decide, govern and earn',
  'art-3': 'Looking at pictures with a maker\'s eye and making the first ones',
  'tech-3': 'Thinking the way a computer thinks: inputs, steps and loops',
  'math-4': 'Working confidently with bigger numbers, fractions and decimals',
  'reading-4': 'Reading between the lines to find what a text does not say outright',
  'writing-4': 'Writing paragraphs that state a point, hold an opinion or tell a small story',
  'science-4': 'Tracing energy, land, living things and machines through the world',
  'history-4': 'Knowing the story of Texas from its first people to statehood',
  'art-4': 'Using balance, space and story to make a picture say something',
  'music-4': 'Reading music: how long a note lasts, where it sits, how fast and how loud',
  'health-4': 'Understanding sleep, food, the heart and screens well enough to choose wisely',
  'math-5': 'Reasoning with decimals, fractions, volume and the coordinate plane',
  'reading-5': 'Reading with judgment: theme, point of view, evidence and argument',
  'writing-5': 'Writing several paragraphs that inform, persuade or tell a true story',
  'science-5': 'Explaining mixtures, the sky, the water cycle and how living things carry traits',
  'history-5': 'Knowing the story of the United States from the colonies to the growing cities',
  'tech-5': 'Writing programs that remember, decide and get fixed when they break',
  'math-6': 'Reasoning with ratios, negative numbers, equations and data',
  'reading-6': 'Reading like a thinker: claims, tone, roots, ideas and the shape of a story',
  'writing-6': 'Writing with a purpose: to argue, to compare and to tell a story with talk in it',
  'science-6': 'Understanding matter, energy, the moving Earth and the web of living things',
  'history-6': 'Reading the world through its maps, cultures, governments and economies',
  'math-7': 'Reasoning with proportions, percents, integers, circles and chance',
  'reading-7': 'Reading with an eye for craft: purpose, evidence, connotation and figure',
  'writing-7': 'Writing about what you read: summaries, counterclaims and explanations',
  'science-7': 'Understanding bodies, weather, selection and the flow of energy through life',
  'history-7': 'Knowing Texas from its first peoples to the modern state',
  'tech-7': 'Understanding bits, networks and how to stay safe on them',
  'math-8': 'Reasoning with lines, powers, roots and the language of functions',
  'reading-8': 'Reading with a critical eye: flawed reasoning, irony, bias and theme across texts',
  'writing-8': 'Writing an essay from a thesis through proof to a conclusion',
  'science-8': 'Understanding atoms, forces, reactions and the scale of the universe',
  'history-8': 'Knowing the United States from its founding documents through Reconstruction',
  'math-9': 'Thinking in algebra: equations, functions, systems and growth',
  'reading-9': 'Reading as a critic: appeals, developing themes, word choice and credibility',
  'writing-9': 'Writing analysis, a narrative with a turn and a rhetorical study',
  'science-9': 'Understanding life at the level of DNA, cells and evolution',
  'history-9': 'Reading the earth: its shape, climates, maps, peoples and resources',
  'math-10': 'Reasoning in geometry: angles, similarity, transformations and trigonometry',
  'reading-10': 'Reading closely for bias, precision, complex characters and symbols',
  'writing-10': 'Writing literary analysis, sourced argument and reflection',
  'science-10': 'Understanding chemistry from the periodic table to reactions and solutions',
  'history-10': 'Knowing world history from the first civilizations to the industrial age',
  'math-11': 'Working in Algebra 2: quadratics, sequences, logarithms and absolute value',
  'reading-11': 'Reading arguments and craft: counterclaims, satire, sentences and sufficiency',
  'writing-11': 'Writing with sources: synthesis, literary argument and the op-ed',
  'science-11': 'Understanding physics: motion, energy, waves, electricity and momentum',
  'history-11': 'Knowing the United States from the Gilded Age to the present',
  'math-12': 'Preparing for calculus: functions, the unit circle, decay and polynomials',
  'reading-12': 'Reading two sources at once, finding assumptions and weighing every word',
  'writing-12': 'Writing for the world: research, a personal essay and a letter to an editor',
  'science-12': 'Understanding the Earth and space, from the rock cycle to the life of a star',
  'government-12': 'Understanding how the United States government is built and checked',
  'economics-12': 'Understanding markets, money, the economy and personal finance',
  'math-college': 'Reasoning with statistics: averages, spread, chance, interest and cause',
  'reading-college': 'Reading academic work: theses, arguments, numbers and consistency',
  'history-college': 'Thinking like a historian: sources, time, cause and the big turns',
};

// Coloring pages from lessons (2026-09-24, Mikey): every pre-K to grade 2 lesson has its own Leonardo coloring page,
// [serial, scene]. A page joins Let's Color once its lesson is passed and its art exists in art/coloring/<serial>.webp;
// without art it is never listed. Prompts and what to count before saving are in docs/ART-REQUESTS.md.
export const COLOR_PAGES = {
  'red-and-blue': ['D28', 'Two big balls side by side on the grass, ready to color one red and one blue'],
  'find-the-match': ['D29', 'Two matching mittens side by side, just alike'],
  'match-the-animals': ['D30', 'Two ducklings that look just alike, standing side by side'],
  'big-and-small': ['D31', 'A big dog and a small dog sitting side by side'],
  'one-and-two': ['D32', 'One duck on the left side of a pond and two ducks on the right side'],
  ...
  'listen-and-tap-pictures': ['D43', 'A dog, a cup and a hat in a row'],
  'animal-sounds': ['D44', 'A cow, a duck and a cat looking over a farm fence'],
  'colours': ['D45', 'A rainbow arching over a backyard with puddles'],
  'same-and-different': ['D46', 'Two striped socks side by side'],
  'match-the-vehicles': ['D47', 'Two toy cars that look just alike, and one toy truck'],
  'match-the-things': ['D48', 'Two cups, two spoons and two plates set in matching pairs on a table'],
  'match-the-water-animals': ['D49', 'Two fish and two frogs in a pond'],
  'match-the-land-animals': ['D50', 'Two rabbits, two cows and one pig behind a farm fence'],
  'match-the-shapes': ['D51', 'A wooden shape sorter with a triangle, a circle and a square block beside it'],
  'match-the-solids': ['D52', 'Two cubes and two balls on the floor'],
  'more-and-fewer-5': ['D53', 'Five ducks on one side of a pond and two ducks on the other'],
  'bigger-and-smaller': ['D54', 'Pumpkins of many sizes in a pumpkin patch with a little wagon'],
  'patterns': ['D55', 'A string of beads in a repeating pattern: round, square, round, square'],
  'count-to-3': ['D56', 'Three smooth stones in a row on a flat rock by a creek'],
  'first-strokes': ['D57', 'A rainy window with a few finger-drawn lines on the foggy glass'],
  'connect-the-dots': ['D58', 'A friendly fish with small dots along its outline'],
  'draw-the-shapes': ['D59', 'A big circle, a big square and a big triangle to color'],
  'taking-turns': ['D60', 'Two children at one swing, one swinging high and one waiting with a smile'],
  'big-bigger-biggest': ['D61', 'Three bears in a row, little, middle-sized and big, each holding a bowl'],
  'helpers-all-around': ['D62', 'A crossing guard helping a child across the street by a school bus'],
  'listen-for-rhymes': ['D63', 'A frog on a log and a dog on a rug'],
  'first-sounds': ['D64', 'A bear, a ball and a bee'],
  'which-came-first': ['D65', 'A duck and a cow in a farmyard, the duck quacking'],
  'which-came-second': ['D66', 'A kettle, a clock and a dog in a cozy kitchen'],
  'big-letters': ['D67', 'A school bus at a bus stop with a small boy pointing at it'],
  'first-letter-tracing': ['D68', 'A child drawing in wet sand with a stick, waves rolling in behind'],
  'more-big-letters': ['D69', 'Colored craft sticks laid out in straight lines on a table'],
  'trace-straight-letters': ['D70', 'A ladder, a table and a flag, all made of straight lines'],
  'day-and-night': ['D71', 'A farm split down the middle: a rooster under the sun on one side, the moon and stars on the other'],
  'kinds-of-weather': ['D72', 'A sun, a rain cloud and a snowflake above a garden gate'],
  'living-or-not': ['D73', 'A snail beside a rock on a garden path'],
  'what-plants-need': ['D74', 'A bean plant in a pot on a sunny windowsill, a watering can beside it'],
  'hot-and-cold': ['D75', 'A steaming cup of cocoa beside a snow cone'],
  'rules-and-helpers': ['D76', 'Children waiting their turn in a line at the top of a slide'],
  'needs-and-wants': ['D77', 'A loaf of bread and a toy robot side by side on a store counter'],
  'our-flag-and-holidays': ['D78', 'Fireworks bursting over a small town while a family watches from a picnic blanket'],
  'jobs-people-do': ['D79', 'A baker with a rolling pin, a nurse with a stethoscope and a mail carrier with a bag of letters'],
  'voting-in-class': ['D80', 'Children on a classroom rug raising their hands to vote'],
  'our-two-flags': ['D81', 'The Texas flag waving on a pole: a tall band with one star on the left and two wide stripes on the right'],
  'washing-hands': ['D82', 'Two soapy hands scrubbing under a running faucet, bubbles floating up'],
  'brushing-teeth': ['D83', 'A toothbrush with toothpaste beside a big smiling tooth'],
  'sleep-k': ['D84', 'A child asleep in bed hugging a teddy bear, the moon in the window'],
  'my-plate': ['D85', 'A plate half filled with fruits and vegetables, a glass of water beside it'],
  'count-to-5': ['D86', 'A mother duck with five ducklings in a line behind her'],
  'count-to-10': ['D87', 'A tall slide with a child climbing the ladder'],
  'tracing-numbers': ['D88', 'A child tracing big curvy lines on paper with a fat crayon'],
  'one-more-one-less': ['D89', 'A plate of cookies with one more cookie on the way from a hand'],
  'joining-and-taking-away': ['D90', 'A toy garage with little cars driving in and out'],
  'comparing-numbers': ['D91', 'Two towers of blocks on a rug, one much taller than the other'],
  'shapes': ['D92', 'A round clock with a plain face and a square window in a bedroom'],
  'tracing-shapes': ['D93', 'A big square and a big circle with a crayon lying beside them'],
  'counting-by-tens': ['D94', 'Children in a row holding up all ten fingers'],
  'longer-and-heavier': ['D95', 'A long stick lying across a creek and a big heavy rock on the bank'],
  'sorting': ['D96', 'A pile of socks sorted into three small piles'],
  'solids': ['D97', 'A ball, a block, a can and a party hat in a row'],
  'making-ten': ['D98', 'Two open hands held up, fingers spread, ready to count'],
  'more-and-fewer-10': ['D99', 'Two buckets of seashells on the beach, one fuller than the other'],
  'letter-names': ['D100', 'Children on a school bus singing together'],
  'big-and-small-letters': ['D101', 'A big mother goose and a small gosling walking side by side'],
  'letter-sounds': ['D102', 'A boy bouncing a big ball beside a bear and a bus'],
  'beginning-sounds': ['D103', 'A mitten, a moon and a mouse'],
  'ending-sounds': ['D104', 'A cat, a boat and a kite'],
  'rhymes': ['D105', 'A sleepy cat, a floppy hat and a baseball bat'],
  'tracing-letters': ['D106', 'A tall tree and a toy train'],
  'tracing-small-letters': ['D107', 'An apple and an alligator'],
  'tracing-more-letters': ['D108', 'An elephant beside a big egg'],
  'syllables': ['D109', 'Children clapping in a circle with a drum in the middle'],
  'sounding-out': ['D110', 'A cat sitting on a mat behind a little open door'],
  'which-way-we-read': ['D111', 'A child reading a big book on a rug, one finger following along the line'],
  'word-meanings': ['D112', 'A dog, a sun and a fish'],
  'trace-slant-letters': ['D113', 'A van, an apple and a bird nest'],
  'teen-numbers': ['D114', 'Two rows of five apples in a wooden crate, ten in all, and three more apples beside the crate'],
  'adding-to-20': ['D115', 'Marbles pouring from two pockets into one big glass jar'],
  'subtracting-to-20': ['D116', 'Birds sitting on a wire, a few of them flying away'],
  'tens-and-ones': ['D117', 'Bundles of ten sticks tied with bands, and a few loose sticks beside them'],
  'comparing-to-100': ['D118', 'Two big jars of buttons side by side, one much fuller than the other'],
  'writing-numbers': ['D119', 'A child at a small desk writing with a fat pencil, tongue poking out in concentration'],
  'read-the-word': ['D120', 'A big folded map spread open on a garage floor beside its cardboard box'],
  'sh-ch-th': ['D121', 'A seashell, a beach chair and a hand giving a thumbs up'],
  'silent-e': ['D122', 'A baseball cap and a superhero cape hanging side by side on hooks'],
  'read-the-sentence': ['D123', 'A child reading a big book, one finger at the start of the line'],
  'what-happened': ['D124', 'A kite caught high in a tree while a dad stands on tiptoe reaching for it'],
  'tracing-more-small-letters': ['D125', 'A goat, a mouse and a zebra standing in a row'],
  'trace-small-letters-3': ['D126', 'An igloo, a turtle and a kite'],
  'trace-small-letters-4': ['D127', 'A cat, a violin and a xylophone'],
  'trace-small-letters-5': ['D128', 'A bird nest, an open umbrella and a rabbit'],
  'sun-moon-patterns': ['D129', 'The sun rising over a backyard fence'],
  'water-changes': ['D130', 'An ice cube melting into a little puddle on a sunny step'],
  'animal-needs': ['D131', 'A puppy with a food bowl, a water dish and a soft bed'],
  'leaders-near-and-far': ['D132', 'A small town hall, a bigger state capitol and the White House in a row'],
  'goods-and-services': ['D133', 'A hat shop beside a barber shop with a striped barber pole'],
  'maps-of-my-world': ['D134', 'A simple map of a backyard seen from above, with a compass rose of four points in the corner'],
  'signs-around-town': ['D135', 'An eight-sided street sign on a corner with a car stopped in front of it'],
  'symbols-of-our-country': ['D136', 'The Liberty Bell with its crack beside the front of the Alamo'],
  'the-steady-beat': ['D137', 'A drum and a ticking clock side by side'],
  'high-and-low': ['D138', 'A little bird singing on a high branch above a big cow in a field'],
  'loud-and-soft': ['D139', 'A big marching drum beside a baby sleeping in a stroller'],
  'hundreds-tens-ones': ['D140', 'A big jar of pennies tipped over, with neat stacks of coins beside it'],
  'adding-with-regrouping': ['D141', 'Sheets of stickers in long strips and a handful of loose stickers'],
  'subtracting-with-regrouping': ['D142', 'Strings of beads and a half-made necklace on a craft table'],
  'telling-time': ['D143', 'A tall clock tower with a plain clock face and two hands, standing in a small town square'],
  'money': ['D144', 'Coins in a row on a store counter beside a smiling piggy bank'],
  'rows-and-columns': ['D145', 'An open egg carton with two neat rows of eggs'],
  'quarter-hours': ['D146', 'A kitchen wall clock with a plain face above a table with a cereal bowl and a school bag'],
  'vowel-teams': ['D147', 'A little boat on a pond and a goat on the grassy shore'],
  'two-syllable-words': ['D148', 'A rabbit peeking out of a vegetable garden'],
  'reading-for-meaning': ['D149', 'A dog digging a hole on a sunny beach beside a sand bucket'],
  'word-meaning-from-context': ['D150', 'An enormous shaggy dog stretched across a boy on a couch'],
  'complete-sentences': ['D151', 'A girl running fast across a field, her hair flying'],
  'describing-sentences': ['D152', 'A fluffy cat sitting very still on a warm sunny step'],
  'tell-a-story-2': ['D153', 'A boy holding up a tiny tooth in his palm, a pillow behind him'],
  'then-and-now': ['D154', 'An old one-room schoolhouse with a bell on the roof'],
  'good-citizens': ['D155', 'A boy handing a lost wallet back to a grateful man on a sidewalk'],
  'producers-and-consumers': ['D156', 'A lemonade stand where a child hands a cup to a smiling neighbor'],
  'maps-of-our-town': ['D157', 'A simple town map seen from above: little houses, a library, a park and straight streets'],
  'services-in-our-town': ['D158', 'A fire truck driving past a library and a park'],
  'saving-for-a-goal': ['D159', 'A glass jar of coins with a kite leaning beside it'],
  'hard-or-soft': ['D160', 'A rock, a pillow, a sponge and a towel laid out on a mat'],
  'magnets': ['D161', 'A horseshoe magnet lifting a chain of paper clips'],
  'habitats': ['D162', 'A hermit crab beside a spiral shell in a tide pool'],
};
