...
STORIES['looking-at-a-picture'] = {
  ...
  more: [{ serial: 'S501', after: 1, alt: 'Her finger listing what is in the painting, plainly' }, { serial: 'S502', after: 3, alt: 'The same painting, now with arrows showing where the eye is led' }],
...
STORIES['art-tells-a-story'] = {
  ...
  more: [{ serial: 'S576', after: 1, alt: 'Painted animals running along the cave ceiling' }, { serial: 'S577', after: 3, alt: 'A wall of pictures from many times and places, each with a purpose written beneath' }],
...
STORIES['steps-in-order'] = {
  ...
  more: [{ serial: 'S1203', after: 1, alt: 'The instructions with a missing step circled' }, { serial: 'S1204', after: 3, alt: 'The same instructions rewritten, numbered, a proper sandwich beside them' }],
...
STORIES['passwords-and-privacy'] = {
  ...
  more: [{ serial: 'S1224', after: 1, alt: 'A long passphrase written as four random words' }, { serial: 'S1225', after: 3, alt: 'A second proof: a code arriving on a different device' }],
...
STORIES['washing-hands'] = {
  ...
  more: [{ serial: 'S1227', after: 1, alt: 'Hands under water, glitter still shining' }, { serial: 'S1228', after: 3, alt: 'Soapy hands, fingers scrubbing between each other' }],
  title: 'The glitter', art: 'S1226', cast: [],
  alt: 'A girl at a bathroom sink with glitter on both hands, soap bubbles starting to form',
  words: [
    'Mia had glitter on both hands. She rinsed them. Water only. Some glitter stayed.',
    'Rinsing was not enough. The glitter hid between her fingers.',
    'Soap, and count to twenty. Between the fingers. Around the thumbs. Gone.',
    'Wash with soap before eating and after the bathroom.',
  ],
};
STORIES['brushing-teeth'] = {
  about: 'a fence of teeth, and the pickets that got missed',
  more: [{ serial: 'S1230', after: 1, alt: 'A fence with two pickets unpainted' }, { serial: 'S1231', after: 3, alt: 'A timer at two minutes, all four corners done' }],
  title: 'The fence of teeth', art: 'S1229', cast: [],
  alt: 'A boy brushing his teeth in a mirror, a fence drawn faintly over his smile',
  words: [
    'Leo brushed fast. Front teeth only. Done in ten seconds.',
    'His dentist said the back pickets were unpainted. Both sides.',
    'A fence of teeth. Every picket needs paint, both sides. Two minutes. Top right, top left, bottom left, bottom right.',
    'Brush two times a day for two minutes.',
  ],
};
STORIES['sleep-k'] = {
  about: 'a phone that charged all night, and a boy who did not',
  more: [{ serial: 'S1233', after: 1, alt: 'The phone at one hundred, the boy at fifty' }, { serial: 'S1234', after: 3, alt: 'The boy asleep early, the phone charging in the kitchen' }],
  title: 'The phone and the boy', art: 'S1232', cast: [],
  alt: 'A boy yawning in bed while his phone on the dresser shows a full battery',
  words: [
    'The phone charged all night. Sam stayed up.',
    'In the morning the phone was at a hundred. Sam was at fifty, and grumpy.',
    'Kids need ten to twelve hours to fill up. Sam went to bed earlier. Same quiet steps each night. He woke up at a hundred.',
...
STORIES['my-plate'] = {
  ...
  more: [{ serial: 'S1236', after: 1, alt: 'A plate with only beige food on it' }, { serial: 'S1237', after: 3, alt: 'Red, orange, green and purple filling half the plate' }],
  title: 'The rainbow plate', art: 'S1235', cast: [],
  alt: 'A girl at a table with a plate half full of colorful fruits and greens, a glass of water beside it',
  words: [
    'Ana\'s plate was all one color. Beige. Bread and crackers.',
    'Her tummy was full. Her body was not happy.',
    'Red tomatoes. Orange carrots. Green peas. Purple grapes. Half the plate, all colors. A glass of water beside it.',
...
STORIES['reading-a-food-label'] = {
  ...
  more: [{ serial: 'S1242', after: 1, alt: 'Two labels side by side with different serving sizes' }, { serial: 'S1243', after: 3, alt: 'The ingredient list with sugar near the top' }],
