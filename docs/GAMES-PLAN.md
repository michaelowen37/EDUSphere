...
Generated in pass CO (2026-09-24). Every course has its own game, or two, chosen to suit its subject and grade; finishing the course unlocks them. Inside a grade the same kind is avoided wherever today's kinds allow. A course that no game suits yet has a quick fire of its own lessons, and so does a history course whose only game is a map still waiting for its painting.

Starter, open from the first day: Star. Kinds repeated inside a grade: 28. Courses holding two games of one kind: science-11. The rules test holds both numbers as ceilings, so each new kind must bring them down.

## New kinds to build, in order
...
1. Sentence builder, for reading and writing: drag word tiles into a sentence that makes sense, then into one that says more.
2. Fix it, for reading and writing: tap the one word, comma or capital that is wrong in a short passage.
...
| Grade | Course | Games |
|---|---|---|
| PK3 | Very first steps | House (dots) |
| PK3 | Listen and point | Red and Blue (sort) |
| PK4 | First steps | Puzzle (jigsaw) |
| PK4 | First sounds and letters | Fish (dots) |
...
| 3 | Reading to understand | Quick fire: Reading to understand (sprint) |
| 3 | How the world works | In order: how things happen (order); Grade 3 science words (pairs) |
| 3 | Writing a paragraph | Quick fire: Writing a paragraph (sprint) |
| 3 | Multiplication and division | Fraction twins (pairs) |
| 3 | Looking and making | Quick fire: Looking and making (sprint) |
| 3 | How computers think | Computer words (pairs) |
...
| 4 | Writing paragraphs | Quick fire: Writing paragraphs (sprint) |
...
| 4 | Color, shape and story | Quick fire: Color, shape and story (sprint) |
| 4 | Reading music | Music words (pairs) |
| 4 | A body that works well | Healthy words (pairs) |
| 5 | Decimals, fractions and volume | Step on the multiples of 4 (path); Catch the halves (catch) |
| 5 | Reading with judgment | Quick fire: Reading with judgment (sprint) |
| 5 | Mixtures, sky and water | Mammal or not (buckets); Grade 5 science words (pairs) |
| 5 | Writing several paragraphs | Quick fire: Writing several paragraphs (sprint) |
| 5 | The story of the United States | In order: timeline (order) |
| 5 | Programs that decide | Pong (pong) |
...
| 7 | Writing about what you read | Quick fire: everything (sprint) |
...
| 9 | Writing about texts and turns | Quick fire: Writing about texts and turns (sprint) |
...
| 10 | Writing about texts | Quick fire: Writing about texts (sprint) |
